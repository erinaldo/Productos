...
public class SeleccionarCobranza extends Presentador
{
	...
	private void generarCobranza()
	{
		try
		{
            if (mAccion.equals(Enumeradores.Acciones.ACCION_SELECCIONAR_COBRANZA_SIMPLE))
			    mVista.iniciarActividadConResultado(ICapturaCobranzaDocs.class, 0, Enumeradores.Acciones.ACCION_GENERAR_COBRANZA_SIMPLE);
            else
	...
	public boolean quitarAsociacionAbono(String abnid)
	{
		try
		{
			Cobranza.quitarAsociacionCobranza(abnid);
			return true;
		}
