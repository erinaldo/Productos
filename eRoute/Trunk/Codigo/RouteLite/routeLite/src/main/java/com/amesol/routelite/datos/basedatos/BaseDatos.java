...
public class BaseDatos
{
	...
	public synchronized void crearInstancia() throws Exception
	{
		...
		try
		{
            ...
            if (bHabilitarLog) {
                ...
                logFile.appendLog(Generales.getFechaHoraActualStr("hh:mm:ss") + " | crearInstancia");
            }
		}
	...
	public void commit() throws Exception
	{
        ...
        if (bHabilitarLog && bGuardarLog)
            logFile.appendLog(Generales.getFechaHoraActualStr("hh:mm:ss") + " | " + sLogOrigen + " | " + "commit");
	...
	public void rollback() throws Exception
	{
        ...
        if (bHabilitarLog && bGuardarLog)
            logFile.appendLog(Generales.getFechaHoraActualStr("hh:mm:ss") + " | " + sLogOrigen + " | " + "rollback");
...
//                }
	...
	public void writeInLog(String texto){
		try{
			...
			//Si falla no deberia detenerse la operacion
		}
	}
