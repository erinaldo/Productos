...
public class SeleccionarFacturacion extends Presentador
{
	...
	public  VistaSpinner getTipoPago(){
		VistaSpinner vs;
		try{
			if (datoFiscal.TipoPago != null && datoFiscal.TipoPago>0){
				vs = new VistaSpinner(datoFiscal.TipoPago.toString(), ValoresReferencia.getDescripcion("TIPAGO", datoFiscal.TipoPago.toString()));
				return vs;
			}
		}catch (Exception ex){
...
//		}
		...
		trpFiscal.TipoPago = mVista.getTipoDePagoSeleccionado();
