...
public class CapturarLiquidacionConsignacion extends Presentador
{
	...
	public static TransProd transVtaRespaldo;
		...
		switch(paso)
		{
			...
			case CONTINUA_VTA:
...

				{
					...
					if(transVtaRespaldo == null){
						transVtaRespaldo = new TransProd();
						transVtaRespaldo.TransProdID = transVta.TransProdID;
						BDVend.recuperar(transVtaRespaldo);
					}
