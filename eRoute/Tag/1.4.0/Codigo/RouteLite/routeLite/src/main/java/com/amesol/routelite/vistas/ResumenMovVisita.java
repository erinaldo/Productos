...
public class ResumenMovVisita extends Vista implements IResumenMovVisita
{
  ...
  /*  public void handleUncaughtException (Thread thread, Throwable e)
    {
        mostrarError("Error mio:" + e.getMessage() + e.getStackTrace());
	...
	public void mostrarTransacciones()
	{
		...
		try
		{
           ...
           /* if (detalle.getAdapter() != null){
                stopManagingCursor(((Cursor) (((resumenMovsAdapter) detalle.getAdapter()).getCursor())));
                ((Cursor) (((SimpleCursorAdapter) detalle.getAdapter()).getCursor())).close();
            }*/
   ...
   /* @Override
    public void onDestroy()
    {
        ...
        ListView detalle = (ListView) findViewById(R.id.lstResumenMov);
        if (detalle.getAdapter() != null){
            stopManagingCursor(((Cursor) (((SimpleCursorAdapter) detalle.getAdapter()).getCursor())));
            ((Cursor) (((SimpleCursorAdapter) detalle.getAdapter()).getCursor())).close();
        }
    }
*/
