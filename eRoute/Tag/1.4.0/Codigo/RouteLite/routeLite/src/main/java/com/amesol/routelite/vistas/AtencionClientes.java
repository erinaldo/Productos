...
public class AtencionClientes extends Vista implements IAtencionClientes
{
	...
	//NFC
	private final String TAG = AtencionClientes.class.getName();
	private Context context = AtencionClientes.this;
	...
	public void onNewIntent(final Intent newIntent)
	{
		...
		if (Intent.ACTION_SEARCH.equals(queryAction))
		{
			...
			if(codigoCliente != null) {
				...
				Toast.makeText(this,getString(R.string.nfc_read_error), Toast.LENGTH_LONG ).show();
		...
		switch (item.getItemId())
		{
            ...
            case R.id.nfc:
				...
				if(write(sClienteClave,tag) )
					Toast.makeText(context,getString(R.string.nfc_write_ok),Toast.LENGTH_LONG).show();
				 else
					Toast.makeText(context,getString(R.string.nfc_write_error),Toast.LENGTH_LONG).show();
