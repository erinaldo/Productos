...
public class Promociones2
{
                        ...
                        if (dsCantProd.getFloat("Cantidad") > 0) {
                            ...
                            if (oProm.AplicarKit) {
                                ...
                                if (oProm.TipoRango == Enumeradores.Promocion.TipoRango.Cantidad) {
                                    ...
                                    if (oProm.CantidadKit == 0 || oProm.CantidadKit > nCantKit)
	...
	private void ObtenerPromocionesAAplicar() throws Exception
	{
		...
		try
		{
			...
			if (aPromocionProducto != null && indiceAPromocionProducto < aPromocionProducto.size())
			{
				...
				if ((promocionActual.Tipo == Enumeradores.Promocion.Tipo.ProductoAcumulado || promocionActual.Tipo == Enumeradores.Promocion.Tipo.EsquemaProducto ) &&
    ...
    public void SiguientePromocion() throws Exception
	{
		...
		if (promocionActual != null && promocionActual.Tipo != Enumeradores.Promocion.Tipo.ProductoAcumulado && promocionActual.Tipo != Enumeradores.Promocion.Tipo.EsquemaProducto)
		{
