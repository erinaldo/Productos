...
public interface IVista {	
    ...
    void mostrarError(String mensaje, Integer tipoMensaje);
	...
	void mostrarPromocionProducto(String promocionClave, String promocionReglaID, int CantidadGrupoApp, String SubEmpresaId, int cantidad, String productoDisparador, String cadenaListasPrecio);
	void mostrarObligatorio(String mensaje, final int tipoMensaje, String...titulo);
	...
	void setImprimiendo(boolean imprimiendo);
	boolean getImprimiendo();
}
