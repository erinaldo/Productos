...
public class CobranzaDetAdapter extends ArrayAdapter<Cobranza.VistaDetalle>
{
	...
	public CobranzaDetAdapter(Context context, int textViewResourceId, CapturarCobranzaDet mPresenta, ArrayList<Cobranza.VistaDetalle> objects, LinkedList<Cobranza.VistaSpinner> pagos, LinkedList<Cobranza.VistaSpinner> monedas, LinkedList<Cobranza.VistaSpinner> bancos, ArrayList<Integer> tiposCP, boolean habilitar, boolean mostrarCuenta)
	{
