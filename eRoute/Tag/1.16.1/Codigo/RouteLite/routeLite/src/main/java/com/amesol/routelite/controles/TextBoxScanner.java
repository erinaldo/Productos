...
//                    break;
    ...
    public void setOcultarTexto(){
        txtScanner.setTextColor(Color.WHITE);
        txtScanner.setCursorVisible(false);
        txtScanner.setInputType(InputType.TYPE_NULL);
    }

    public void setTecladoNumerico(){
        txtScanner.setInputType(InputType.TYPE_CLASS_NUMBER);
    }
}
