...
//		btnContinuar.performClick();
	...
	@Override
	public String getTipoDePagoSeleccionado()
	{
		String index =((SeleccionarFacturacion.VistaSpinner)((Spinner) findViewById(R.id.spnTipoPago)).getSelectedItem()).getId();
		return index;
	}
	@Override
...
//			if(getFormaDeVentaSeleccionada()==2){
//				fila.findViewById(R.id.lblMetodoPago).setVisibility(View.GONE);
//				fila.findViewById(R.id.lblCuenta).setVisibility(View.GONE);
//				fila.findViewById(R.id.lblBanco).setVisibility(View.GONE);
//			}
			if(isSoloLectura()){
