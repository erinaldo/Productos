...
public class SeleccionActividadesVisita extends Vista implements ISeleccionActividadesVisita, OnItemClickListener
{
	...
	public void terminarVisita() {
		BDVend.setOrigenLog("SeleccionActividadesVisita:terminarVisita");
		...
		if (requestCode == Enumeradores.Solicitudes.SOLICITUD_AUTORIZARMOVIMIENTO) {
			...
			if (actividad != null) {
				if (actividad.getTipoIndice() == TiposModuloMovDetalle.COBRANZAMULTIPLE) { // Cobranza
					BDVend.setOrigenLog("SeleccionActividadesVisita:Fin CobranzaMultiple") ;
					...
					BDVend.setOrigenLog("SeleccionActividadesVisita:Fin Pedido"); ;
					if (resultCode == Resultados.RESULTADO_MAL) {
					...
					BDVend.setOrigenLog("SeleccionActividadesVisita:Fin DevolucionClientes"); ;
					if (resultCode == Resultados.RESULTADO_MAL) {
					...
					BDVend.setOrigenLog("SeleccionActividadesVisita:Fin Actividad"); ;
				}
			}
		}
    }
	...
	public boolean validarTiempoCliente()
	{
		...
		try
		{
			BDVend.setOrigenLog("SeleccionActividadesVisita:validarTiempoCliente"); ;
			BDVend.recuperar(visita);
