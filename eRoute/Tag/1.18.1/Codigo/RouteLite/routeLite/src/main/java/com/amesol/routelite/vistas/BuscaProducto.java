...
public class BuscaProducto extends Vista implements IBuscaProducto, CalcularPorKiloListener
{
		...
		try
		{
			...
			if (((ConfigParametro) Sesion.get(Campo.ConfigParametro)).existeParametro("InventarioPorLotes") && ((ConfigParametro) Sesion.get(Campo.ConfigParametro)).get("InventarioPorLotes").equals("1"))
			{
				...
				adapter = new MySimpleCursorAdapter(this, R.layout.lista_busqueda_producto, productos,
						new String[]
								{ "Unidad", "ProductoClave", "Nombre", "Existencia", "Precio", "Cantidad", "PrecioSugerido", "SaldoEnvase", "ValorPuntos" },
						new int[]
								{ R.id.txtUnidad, R.id.txtClave, R.id.txtDescripcion, R.id.txtExistencia, R.id.txtPrecio, R.id.npCantidad, R.id.txtPrecioSugerido, R.id.txtSaldoEnvase, R.id.txtValorPuntos });
			}
	...
	protected void onPause() {
		try{
			...
			String filePath = directorio + "logcat.txt";
			try{
