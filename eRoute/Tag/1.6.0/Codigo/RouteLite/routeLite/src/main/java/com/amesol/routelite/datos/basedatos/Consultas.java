...
public final class Consultas
{
	...
	public static final class ConsultasVendedor
	{
        ...
        public static HashMap<Short, SaldoCambiosVendedor> obtenerSaldoCambiosVendedor() throws Exception
        {
            String vendedorId =  ((Vendedor)Sesion.get(Campo.VendedorActual)).VendedorId ;
            Short frecuencia  = ((Dia)Sesion.get(Campo.DiaActual)).Frecuencia ;
            HashMap<Short,SaldoCambiosVendedor> resultado = new HashMap<Short,SaldoCambiosVendedor>();

            ISetDatos setDatos = BDVend.consultar("Select VendedorId, Frecuencia, Clasificacion from SaldoCambiosVendedor where VendedorId = '" + vendedorId + "' and Frecuencia =" + frecuencia.toString() );
            while (setDatos.moveToNext())
            {
                ...
                saldoCambiosVendedor.Frecuencia = setDatos.getShort("Frecuencia");
                saldoCambiosVendedor.Clasificacion = setDatos.getShort("Clasificacion");
                BDVend.recuperar(saldoCambiosVendedor);
                resultado.put(setDatos.getShort("Clasificacion"), saldoCambiosVendedor);
            }
            setDatos.close();
            return resultado;
        }
	...
	public static final class ConsultasPrecioProductoVig
	{
		...
		public static float obtenerPrecioProducto(String ProductoClave, short TipoUnidad, String listasPrecios)
		{
			try
			{
	...
	public static final class ConsultasTransProd
	{
		...
		public static SeleccionarPedido.VistaPedidos[] obtenerPedidosPorVisita(Dia dia, Cliente cliente, Visita visita) throws Exception
		{
           ...
           /* if(Integer.parseInt(Sesion.get(Campo.TipoModulo).toString()) == Enumeradores.TiposModulos.PREVENTA){
                consulta.append("where TRP.Tipo in (21) ");
            }else {
                consulta.append("where TRP.Tipo in (1) ");
            }*/
...
//				sConsulta.append("AND Visita.DiaClave='" + diaClave + "'");
		...
		public static ISetDatos obtenerTotalPedidosCostena(String tipoFase, Boolean GrupoMasivo) throws Exception{
            StringBuilder consulta = new StringBuilder();
            if (!GrupoMasivo) {
        ...
        public static ISetDatos obtenerPedidosPagoAnticipado() throws Exception
        {
            ...
            StringBuilder consulta = new StringBuilder();
            consulta.append("SELECT TRP.TransProdID as _id, TRP.Folio as Folio, TRP.TipoPedido as TipoPedido, TRP.TipoFase as TipoFase, datetime(TRP.FechaCaptura) as FechaCaptura, TRP.Subtotal as Subtotal, TRP.Impuesto as Impuesto, TRP.Total as Total, TRP.Saldo as Saldo, ");
        ...
        public static ISetDatos obtenerClientesEnAgenda(String ruta, String diaClave) throws Exception{
            ...
            StringBuilder consulta = new StringBuilder();
            consulta.append("SELECT DISTINCT C.RazonSocial, CASE WHEN E.Fase = 2 THEN 'Si' ELSE 'No' END Encuestado FROM Agenda A inner join Dia D on A.DiaClave = D.DiaClave ")
                    .append("inner join Cliente C on A.ClienteClave = C.ClienteClave ")
                    .append("left join CenCli Cen  on A.ClienteClave = Cen.ClienteClave ")
                    .append("left join Encuesta E on Cen.CENClave = E.CENClave ")
                    .append("left join Visita V on E.VisitaClave = V.VisitaClave ")
                    .append("WHERE A.RUTClave = '" + ruta + "' and A.DiaClave = '" + diaClave + "'");
		...
		public static ISetDatos obtenerConteoVisitadosEnFrecuencia(String ruta,String diaClave) throws Exception{
			...
			consulta.append("select distinct count(a.ClienteClave) from Agenda a ")
					...
					.append("inner join Visita v on v.ClienteClave = a.ClienteClave and v.FueraFrecuencia = 0 and v.RUTClave = '" + ruta + "' ")
					.append("WHERE a.DiaClave = '" + diaClave + "'");

			return  BDVend.consultar(consulta.toString());
		}

		public static ISetDatos obtenerConteoVisitadosNoFrecuencia(String ruta) throws Exception{

			StringBuilder consulta = new StringBuilder();
			consulta.append("select distinct count(a.ClienteClave) from Agenda a ")
					.append("inner join Dia d on a.DiaClave = d.DiaClave and d.FueraFrecuencia = 1 ")
					.append("inner join Visita v on a.ClienteClave = v.ClienteClave and v.FueraFrecuencia = 1 and v.RUTClave = '" + ruta + "' ")
					.append("where a.RUTClave = '" + ruta + "'");
        ...
        public static ISetDatos obtenerConteoNoVisitadosEnFrecuencia(String ruta,String diaClave) throws Exception{
            ...
            consulta.append("select distinct  count(a.ClienteClave) from Agenda a  ")
                    .append("inner join Dia d on a.DiaClave = d.DiaClave and d.FueraFrecuencia = 0 and a.RUTClave = '" + ruta + "' ")
                    .append("WHERE a.DiaClave = '" + diaClave + "' and a.ClienteClave not in (select ClienteClave from Visita where DiaClave = '" + diaClave + "')");

            return  BDVend.consultar(consulta.toString());
        }

		public static ISetDatos obtenerConteoVisitadosConVenta(String ruta) throws Exception{

			StringBuilder consulta = new StringBuilder();
			consulta.append("select distinct count(v.ClienteClave) from Visita v ")
					.append("inner join TransProd t on v.ClienteClave = t.ClienteClave and v.VisitaClave = t.VisitaClave and t.Tipo = 1 and t.TipoFase != 0 ")
					.append("where v.FueraFrecuencia = 0 and v.RUTClave = '" + ruta + "'");

			return  BDVend.consultar(consulta.toString());
		}

		public static ISetDatos obtenerConteoVisitadosConVentaFueraFrecuencia(String ruta) throws Exception{

			StringBuilder consulta = new StringBuilder();
			consulta.append("select distinct count(v.ClienteClave) from Visita v ")
					.append("inner join TransProd t on v.ClienteClave = t.ClienteClave and v.VisitaClave = t.VisitaClave and t.Tipo = 1 and t.TipoFase != 0 ")
					.append("where v.FueraFrecuencia = 1 and v.RUTClave = '" + ruta + "'");

			return  BDVend.consultar(consulta.toString());
		}

		public static ISetDatos obtenerConteoVisitadosSinVenta(String ruta) throws Exception{

			StringBuilder consulta = new StringBuilder();
			consulta.append("select distinct count(v.ClienteClave) from Visita v ")
					.append("left join TransProd t on v.ClienteClave = t.ClienteClave ")
					.append("where v.FueraFrecuencia = 0 and v.RUTClave = '" + ruta + "' and t.TransProdID is null");

			return  BDVend.consultar(consulta.toString());
		}

		public static ISetDatos obtenerConteoVisitadosSinVentaFueraFrecuencia(String ruta) throws Exception{

			StringBuilder consulta = new StringBuilder();
			consulta.append("select distinct count(v.ClienteClave) from Visita v ")
					.append("left join TransProd t on v.ClienteClave = t.ClienteClave ")
					.append("where v.FueraFrecuencia = 1 and v.RUTClave = '" + ruta + "' and t.TransProdID is null");

			return  BDVend.consultar(consulta.toString());
		}

		public static ISetDatos obtenerEncuestasAplicadas(String ruta) throws Exception{

			StringBuilder consulta = new StringBuilder();
			consulta.append("select count(cen.CENClave) from CenCli cen ")
					.append("inner join Encuesta e on cen.CENClave = e.CENClave ")
					.append("inner join Visita v on e.VisitaClave = v.VisitaClave and v.ClienteClave = cen.ClienteClave and v.FueraFrecuencia = 0 and v.RUTClave = '"+ruta+"'");

			return BDVend.consultar(consulta.toString());
		}

		public static ISetDatos obtenerEncuestasAplicadasFueraFrecuencia(String ruta) throws Exception{

			StringBuilder consulta = new StringBuilder();
			consulta.append("select count(cen.CENClave) from CenCli cen ")
					.append("inner join Encuesta e on cen.CENClave = e.CENClave ")
					.append("inner join Visita v on e.VisitaClave = v.VisitaClave and v.ClienteClave = cen.ClienteClave and v.FueraFrecuencia = 1 and v.RUTClave = '"+ruta+"'");

			return BDVend.consultar(consulta.toString());
		}

		public static ISetDatos obtenerEncuestasNoAplicadas() throws Exception{

			StringBuilder consulta = new StringBuilder();
			consulta.append("select count(cen.CENClave) from CenCli cen ")
					.append("inner join Encuesta e on cen.CENClave != e.CENClave ")
					.append("inner join Visita v on e.VisitaClave = v.VisitaClave and v.ClienteClave != cen.ClienteClave");

			return BDVend.consultar(consulta.toString());
		}

		public static ISetDatos obtenerClientesEncuestados(String ruta) throws Exception{

			StringBuilder consulta = new StringBuilder();
			consulta.append("select count(v.ClienteClave) from Visita v ")
					.append("inner join Encuesta e on v.VisitaClave = e.VisitaClave ")
					.append("where v.FueraFrecuencia = 0 and v.RUTClave = '"+ruta+"'");

			return BDVend.consultar(consulta.toString());
		}

		public static ISetDatos obtenerClientesEncuestadosFueraFrecuencia(String ruta) throws Exception{
		...
		public static ISetDatos obtenerClientesNoEncuestados(String ruta) throws Exception{

			StringBuilder consulta = new StringBuilder();
			consulta.append("select count(v.ClienteClave) from Visita v ")
					.append("left join Encuesta e on v.VisitaClave != e.VisitaClave ")
					.append("where v.FueraFrecuencia = 0 and v.RUTClave = '"+ruta+"'");

			return BDVend.consultar(consulta.toString());
		}

		public static ISetDatos obtenerClientesNoEncuestadosFueraFrecuencia(String ruta) throws Exception{
		...
		public static ISetDatos obtenerCodigosLeidos(String ruta) throws Exception{

			StringBuilder consulta = new StringBuilder();
			consulta.append("select distinct count(v.ClienteClave) from Visita v ")
					.append("where v.FueraFrecuencia = 0 and v.CodigoLeido = 1 and v.RUTClave = '"+ruta+"'");

			return BDVend.consultar(consulta.toString());
		}

		public static ISetDatos obtenerCodigosLeidosFueraFrecuencia(String ruta) throws Exception{

			StringBuilder consulta = new StringBuilder();
			consulta.append("select distinct count(v.ClienteClave) from Visita v ")
					.append("where v.FueraFrecuencia = 1 and v.CodigoLeido = 1 and v.RUTClave = '"+ruta+"'");

			return BDVend.consultar(consulta.toString());
		}

		public static ISetDatos obtenerCodigosNoLeidos(String ruta) throws Exception{

			StringBuilder consulta = new StringBuilder();
			consulta.append("select distinct count(v.ClienteClave) from Visita v ")
					.append("where v.FueraFrecuencia = 0 and v.CodigoLeido = 0 and v.RUTClave = '"+ruta+"'");

			return BDVend.consultar(consulta.toString());
		}

		public static ISetDatos obtenerCodigosNoLeidosFueraFrecuencia(String ruta) throws Exception{

			StringBuilder consulta = new StringBuilder();
			consulta.append("select distinct count(v.ClienteClave) from Visita v ")
					.append("where v.FueraFrecuencia = 1 and v.CodigoLeido = 0 and v.RUTClave = '"+ruta+"'");
		...
		public static ISetDatos obtenerRecoleccionEnvase(String tiposMotivo) throws Exception{
			...
			if(!tiposMotivo.equals(""))
				sConsulta.append("and TRP.TipoMotivo in (" + tiposMotivo + ") ");
...
//	}
    ...
    public static final class ConsultasPedidosConfirmadosSAP{
        ...
        public static ISetDatos obtenerReporteConfirmadosSAP(String filtroFecha, String clienteClave)throws  Exception {
            ...
            sConsulta.append("TPD.ProductoClave, PRO.Nombre, TPD.TipoUnidad, TPD.CantidadOriginal,TPD. Cantidad, TPD.Total, TRP.Folio ");
            sConsulta.append("FROM TransProd TRP ");
            ...
            sConsulta.append("order by CLI.ClienteClave, TVA.PedidoAdicional, TRP.FechaCaptura, TPD.ProductoClave ");
    ...
    public static final class ConsultaResumenMovimientos{
        ...
        public static ISetDatos obtenerResumenMovimientos(String diaClave, String vendedorID)throws Exception
        {
            StringBuilder consulta = new StringBuilder();

            consulta.append("Select Distinct TP.Tipo as Tipo, ")
                    .append("( TP.Folio || (case when tp.VisitaClave IS Not null then ' - ' || C.NombreCorto || ', '||C.RazonSocial END)) AS FolioMovimiento,  ")
                    .append("TPD.ProductoClave || ' ' || P.Nombre AS Producto, ")
                    .append("TPD.TipoUnidad as TipoUnidad,  ")
                    .append("TPD.Cantidad as Cantidad, ")
                    .append("(TPD.Cantidad * PD.Factor) As TotalPiezas   ")
                    .append("from  TransProd TP  ")
                    .append("inner join Visita V on v.VisitaClave = TP.VisitaClave or v.VisitaClave = TP.VisitaClave1 and TP.Tipo in(2,3,4,6,7,8,9,21) and TP.TipoFase <> 0 ")
                    ...
                    .append("inner join Producto P on P.ProductoClave = TPD.ProductoClave ")
                    .append("inner join ProductoDetalle PD on PD.ProductoClave = P.ProductoClave  ")
                    .append("where ")
                    .append("TP.DiaClave = '"+ diaClave +"' ")
                    .append("and V.VendedorID = '"+ vendedorID +"' ")
                    .append(" ")
                    .append("union ")
                    .append(" ")
                    .append("Select Distinct TP.Tipo as Tipo, ")
                    .append("( TP.Folio || (case when tp.VisitaClave IS Not null then ' - ' || C.NombreCorto || ', '||C.RazonSocial END)) AS FolioMovimiento,  ")
                    .append("TPD.ProductoClave || ' ' || P.Nombre AS Producto, ")
                    .append("TPD.TipoUnidad as TipoUnidad,  ")
                    .append("TPD.Cantidad as Cantidad, ")
                    .append("(TPD.Cantidad * PD.Factor) As TotalPiezas  ")
                    .append("From TransProd TP  ")
                    .append("inner join Visita V on V.VisitaClave = TP.VisitaClave or v.VisitaClave = TP.VisitaClave1 and V.FueraFrecuencia = 0 and TP.Tipo = 24 and TP.TipoFase <> 8 ")
                    .append("inner join cliente C on C.ClienteClave = V.ClienteClave  ")
                    .append("inner join Dia D on D.DiaClave = TP.DiaClave or D.DiaClave = TP.DiaClave1 ")
                    .append("inner join TransProdDetalle TPD on TPD.TransProdID = TP.TransProdID  ")
                    .append("inner join Producto P on P.ProductoClave = TPD.ProductoClave ")
                    .append("inner join ProductoDetalle PD on PD.ProductoClave = P.ProductoClave  ")
                    .append("where ")
                    ...
                    .append("(TPD.Cantidad * PD.Factor) As TotalPiezas  ")
                    .append("From TransProd TP ")
                    .append("inner join Visita V on  v.VisitaClave = TP.VisitaClave or v.VisitaClave = TP.VisitaClave1 and V.FueraFrecuencia = 0 and TP.Tipo = 1 and TP.TipoFase = 2 ")
                    .append("inner join cliente C on C.ClienteClave = V.ClienteClave ")
                    .append("inner join Dia D on D.DiaClave = TP.DiaClave or D.DiaClave = TP.DiaClave1 ")
                    .append("inner join TransProdDetalle TPD on TPD.TransProdID = TP.TransProdID ")
                    .append("inner join Producto P on P.ProductoClave = TPD.ProductoClave ")
                    ...
                    .append("and V.VendedorID = '"+ vendedorID +"' ")
                    .append(" ")
                    .append("order by TP.Tipo, FolioMovimiento ");
