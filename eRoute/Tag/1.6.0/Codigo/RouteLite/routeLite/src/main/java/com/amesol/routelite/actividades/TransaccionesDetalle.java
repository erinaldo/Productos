...
public class TransaccionesDetalle
{
	...
	public static class Pedidos
	{
		...
		{		
			float nPrecio = ListaPrecio.BuscarPrecio(ProductoClave, Short.parseShort(String.valueOf(TipoUnidad)), listasPrecios);
			if (nPrecio >= 0)
			{
				String sUsuarioID = ((Usuario) Sesion.get(Campo.UsuarioActual)).USUId;
	...
	public static class Cambios
	{
		...
		public static TransProdDetalle GenerarDetalleCambio(String TransProdId, String ProductoClave, int TipoUnidad, float Cantidad, float CantidadOriginal, String listaPrecios) throws Exception
		{
			...
			float nPrecio = ListaPrecio.BuscarPrecio(ProductoClave, Short.parseShort(String.valueOf(TipoUnidad)), listaPrecios);
			if (nPrecio >= 0)
			{
				String sUsuarioID = ((Usuario) Sesion.get(Campo.UsuarioActual)).USUId;
	...
	public static class Reparto{
		...
		{		
			float nPrecio = ListaPrecio.BuscarPrecio(Detalle.ProductoClave, Short.parseShort(String.valueOf(Detalle.TipoUnidad)), listasPrecios);
			if (nPrecio >= 0)
			{
				String sUsuarioID = ((Usuario) Sesion.get(Campo.UsuarioActual)).USUId;
		...
		public static void Actualizar(TransProdDetalle oTransProdDetalle, String listasPrecios) throws Exception{
			...
			//{
				...
				{*/
					...
					float nPrecio = ListaPrecio.BuscarPrecio(oTPD.ProductoClave, (short) oTPD.TipoUnidad, listasPrecios);
					if (nPrecio >= 0)
					{
						oTPD.Precio = nPrecio;
						if (oTPD.Cantidad == 0)
