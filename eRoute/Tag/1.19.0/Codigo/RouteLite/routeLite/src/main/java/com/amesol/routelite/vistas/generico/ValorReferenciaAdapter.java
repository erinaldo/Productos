...
public class ValorReferenciaAdapter extends ArrayAdapter<ValorReferencia>
{
	...
	public class CustomComparatorNumber implements Comparator<ValorReferencia>
	{
		...
		public int compare(ValorReferencia o1, ValorReferencia o2)
		{
			...
			try {
				Integer.parseInt(o1.getDescripcion().substring(0, 2));
				numero1 = Integer.parseInt(o1.getDescripcion().substring(0, 2));
			} catch (Exception exc) {
				numero1 = Integer.parseInt(o1.getVavclave());
			}

			try {
				Integer.parseInt(o2.getDescripcion().substring(0, 2));
				numero2 = Integer.parseInt(o2.getDescripcion().substring(0, 2));
			} catch (Exception exc) {
				numero2 = Integer.parseInt(o2.getVavclave());
			}
