...
public abstract class Vista extends FragmentActivity
{
	...
	private Intent getActividad(Class<?> vista)
	{
		...
		else if (vista.equals(ISeleccionPedidoBackOrder.class))
		{
			intent = new Intent(this, SeleccionPedidoBackOrder.class);
		}
		...
		else if (vista.equals(ICapturaDepositoVinculado.class))
		{
			intent = new Intent(this, CapturaDepositoVinculado.class);
		}
        ...
        else if (vista.equals(ISeleccionSolicitud.class))
            intent = new Intent(this, SeleccionSolicitud.class);
        else if (vista.equals(ICapturaSolicitud.class))
            intent = new Intent(this, CapturaSolicitud.class);
        else if (vista.equals(IHistoricoVentas.class))
            intent = new Intent(this, HistoricoVentas.class);
        else if (vista.equals(IHistoricoEstadisticas.class))
            intent = new Intent(this, HistoricoEstadisticas.class);
		else if (vista.equals(ISeleccionGastos.class))
			intent = new Intent(this, SeleccionGastos.class);
		else if (vista.equals(ICapturaGastos.class))
			intent = new Intent(this, CapturaGastos.class);
	    else if (vista.equals(ICapturaMontoPorDoc.class))
			intent = new Intent(this, CapturaMontoPorDoc.class);
        else if (vista.equals(ICapturaCanje.class))
            intent = new Intent(this, CapturaCanje.class);
        else if (vista.equals(ISeleccionActivo.class))
            intent = new Intent(this, SeleccionActivo.class);
        else if (vista.equals(ICapturaActivo.class))
            intent = new Intent(this, CapturaActivo.class);
		else if (vista.equals(IDisInformacionGeneralDatos.class))
			intent = new Intent(this, DisConsultaInformacionGeneralDatos.class);
		else if (vista.equals(IDisInformacionGeneralAlarmas.class))
			intent = new Intent(this, DisConsultaInformacionGeneralAlarmas.class);
		else if (vista.equals(IDisInformacionGeneralPromociones.class))
			intent = new Intent(this, DisConsultaInformacionGeneralPromociones.class);
		else if (vista.equals(IDisComportamientoCompra.class))
			intent = new Intent(this, DisConsultaComportamiendoCompra.class);
		else if (vista.equals(IDisUltimoPedido.class))
			intent = new Intent(this, DisConsultaUltimosPedidos.class);
		else if (vista.equals(IDisInventarioMaterialesCliente.class))
			intent = new Intent(this, DisConsultaInventarioMaterialesCliente.class);
		else if (vista.equals(IDisPoliticaTradeComercial.class))
			intent = new Intent(this, DisConsultaPoliticaTradeComercial.class);
		else if (vista.equals(IDisPortafolioRecomendado.class))
			intent = new Intent(this, DisPortafolioRecomendado.class);
		else if (vista.equals(IDisObjetivoMensual.class))
			intent = new Intent(this, DisConsultaObjetivoMensual.class);
        else if (vista.equals(IAseguraActivo.class))
            intent = new Intent(this, AseguraActivo.class);
		else if (vista.equals(ISeleccionConteoInventario.class))
			intent = new Intent(this, SeleccionConteoInventario.class);
		else if (vista.equals(ICapturaConteoInventario.class))
			intent = new Intent(this, CapturaConteoInventario.class);
		return intent;
	}
	...
	public boolean onBluetoothOtherDevices() throws Exception
	{
		boolean enable = true;
		if (!bluetoothEncendido())
		{
	...
	public void mostrarMensajeConTitulo(final String mensaje, final String titulo, final Integer tipoMensaje)
	{
		DialogoAlerta dialogo = new DialogoAlerta(this);
		dialogo.setMessage(mensaje);
	...
	public void setImprimiendo(boolean bImprimiendo){
		this.imprimiendo = bImprimiendo;
	}
