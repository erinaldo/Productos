...
public class CapturarDeposito extends Presentador
{
	...
	public void activarDevoluciones()
	{
		...
		try
		{
            ...
            float TotalEFectivoPre = Consultas.ConsultaDeposito.obtenerTotalEfectivoPreliquidacion();
			mVista.setTotalEfyDep(TotalD);
			mVista.setTotalDevoluciones(TotalDev);
			mVista.setTotalDeposito(TotalE);
			mVista.setTotalDepositar(TotalD - (TotalEFectivoPre + TotalE + TotalDev));
            mVista.setTotalEfectivoPre(TotalEFectivoPre);
	...
	public void SetValoresDefault()
	{
		try
		{
			...
			mVista.setTotalEfyDep(TotalD);
			mVista.setTotalDeposito(TotalE);
			mVista.setTotalDepositar(TotalD - (TotalEfectivoPre + TotalE));
			mVista.refrescarDeposito();
            mVista.setTotalEfectivoPre(TotalEfectivoPre);
		}
		catch (Exception e)
