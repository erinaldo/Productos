...
public class PromocionDetalle {
	...
	public PromocionDetalle(String promocionClave, String productoClave, String nombre, int tipoUnidad, String unidad, float cantidad, boolean seleccion, boolean captura, int decimalProducto, int factor, boolean pendienteEntrega){
