...
public final class Consultas
{
	public static final class ConsultasValorReferencia
	{
        ...
        public static ISetDatos obtenerValoresOrdenadoDescripcion(String VARCodigo, String SoloEstosValores) throws Exception
        {
            StringBuilder consulta = new StringBuilder();
            consulta.append("select * from (");
            consulta.append("select VAD.VAVClave as _id, VAD.VAVClave, VAD.Descripcion from ValorReferencia VR ");
	...
	public static final class ConsultasProducto
	{
		...
		public static Cursor obtenerProductosExistencia(String filtro, String listasPrecios, boolean filtrarProductos, String transProdIds, int tipoTransProd, boolean validarExistencia, int tipoMovimiento, String esquemasModulo, int ubicacionExistencia, boolean excluirCanjes) throws Exception
		{
			...
			while (limit + 6000 < rows)
			{
				...
				consulta.append(", 0 as checked, 0 as Cantidad from producto PRO inner join productounidad PRU on PRO.ProductoClave = PRU.ProductoClave and PRU.TipoEstado in(1,3) ");
...
//				sConsulta.append("AND Visita.DiaClave='" + diaClave + "'");
	...
	public static final class ConsultasTransProdDetalle
	{
		...
		public static ISetDatos obtenerDetalleDobleUnidad(String transProdId) throws Exception
		{
			...
			consulta.append(" PRU.DecimalProducto as DecimalProd1, PRU2.DecimalProducto as DecimalProd2, PRO.SubEmpresaId, PRO.Venta, PRO.Contenido ");
			consulta.append("from TransProdDetalle TPD inner join Producto PRO on PRO.ProductoClave = TPD.ProductoClave ");
...
//			return datos;
	...
	public static final class ConsultasPromocion
	{
        ...
        public static HashMap<String, ArrayList<Promociones2.PromocionProducto>> obtenerProductosTrans(String sPromocionesClave, String sTransProdId, HashMap<String, ArrayList<Promociones2.PromocionProducto>> promocionProducto) throws Exception
        {
            ...
            sConsulta.append("where PRM.PromocionClave in (" + sPromocionesClave + ") and TPD.TransProdID = '" + sTransProdId + "' AND IFNULL(TPD.Promocion,0) <> 2 AND IFNULL(TPD.Promocion,0) <> 3 ");
...
//	}
	...
	public static final class ConsultasReportesFamo{
		...
		public static double obtenerTotalCobranza(String DiaClave) throws Exception{
			StringBuilder consulta = new StringBuilder();
			consulta.append("SELECT IFNULL(SUM(Importe),0) AS Total FROM AbnTrp ");
			consulta.append("WHERE TransProdID IN(");
			consulta.append("SELECT TransProdID FROM TransProd WHERE Tipo = 1 AND TipoFase <> 0 AND CFVTipo = 2)");
