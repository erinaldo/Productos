...
public class Envio {
    ...
    public static final Class<?>[] TABLAS_ENVIO_MOV_SIN_INV_SIN_VISITA = new Class<?>[]{TransProd.class, TransProdDetalle.class, PedidoModificado.class, TPDImpuesto.class, TrpPrp.class, TpdDes.class, TPDDesVendedor.class, TpdPun.class};
