...
public class Transacciones
{
	...
	public static void recolectarEnvasesAutomaticamente(TransProd oTransProd, ISetDatos productos) throws Exception{
		String folio = null;
		if (oTransProd.DevolucionID == null || oTransProd.DevolucionID == ""){
			...
			if(Integer.parseInt(Sesion.get(Campo.TipoModulo).toString()) == TiposModulos.REPARTO && 
				...
				transProdDev.VisitaClave = oTransProd.VisitaClave1;
			}else{
				transProdDev.VisitaClave = oTransProd.VisitaClave;
			}
			...
			do{
                if(productos.getFloat("Diferencia") > 0){
                    //generar los detalles
                    TransProdDetalle transProdDetalle = TransaccionesDetalle.DevolucionesCliente.GenerarDetalleDevolucionEnvase(transProdDev.TransProdID,productos.getString("ProductoDetClave"),productos.getShort("TipoUnidad"),productos.getFloat("Diferencia"),transProdDev.TipoMotivo);
...
/*		public static void EliminarPedido(String TransProdId) throws Exception
	...
	public static class Deposito
	{
		...
		public static com.amesol.routelite.datos.Deposito GenerarDeposito(int TipoBanco, String Ficha, float Deposito, ArrayList<ABNDetalle> aAbd) throws ControlError, Exception
		{
