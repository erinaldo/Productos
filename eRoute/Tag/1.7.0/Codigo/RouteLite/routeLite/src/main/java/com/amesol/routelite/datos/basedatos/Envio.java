...
public class Envio {
	...
	private static ISetDatos obtenerDatos(Class<?> clase) throws Exception{
        ...
        /*if (clase.equals(TransProd.class)) {
            return BDVend.consultar(clase, null, "Enviado = 0 and (Escritorio = 0 or Escritorio is null) and (Tipo= 9 or Tipo = 3) and TipoMovimiento = 1 ", null);
        }*/
