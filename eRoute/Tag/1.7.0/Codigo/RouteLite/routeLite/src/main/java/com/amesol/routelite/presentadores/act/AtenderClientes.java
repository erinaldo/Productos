...
public class AtenderClientes extends Presentador
{
	...
	{
		AseguramientoVisita aseguramiento = obtenerAseguramiento();
		if (aseguramiento.TipoContrasena != 0 && (aseguramiento.TipoAseguramiento == 1 || aseguramiento.TipoAseguramiento == 4 || aseguramiento.TipoAseguramiento == 5 || aseguramiento.TipoAseguramiento == 6) )
		{
