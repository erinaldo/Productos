...
public class ControlError extends Exception{
	...
	public ControlError(String codigo){
		this.codigo = codigo;
	...
	public ControlError(String codigo, ArrayList<ParametroMSG> parametros, String tabla, String campo){ //, boolean posicionar){
		this.codigo = codigo;
		this.parametros = parametros;
		this.tabla = tabla;
		this.campo = campo;
	...
	public ControlError(String codigo, ArrayList<ParametroMSG> parametros, String tabla, String campo, String msgProveedor){ //, boolean posicionar){
		this.codigo = codigo;
		this.parametros = parametros;
		this.campo = campo;
