...
public class ConfigurarTerminal extends Presentador
{
	...
	public void iniciar()
	{
        ...
        mVista.setHabilitarLog((Boolean) configuracion.getValor(CampoConfiguracion.HABILITAR_LOG));
	...
	public void continuar()
	{
        ...
        configuracion.setValor(ArchivoConfiguracion.CampoConfiguracion.HABILITAR_LOG, mVista.isHabilitarLog());
