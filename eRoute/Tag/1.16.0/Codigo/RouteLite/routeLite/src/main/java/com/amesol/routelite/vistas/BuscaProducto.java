	...
	public void onCreate(Bundle savedInstanceState)
	{
		try {
			...
			try {
				...
				ClaveModulo = mmd.ModuloMovDetalleClave;
				mmd = null;
			}catch(Exception ex){
			...
			if(tipoTransProd == TiposTransProd.DESCARGAS) {
				if (((ConfigParametro) Sesion.get(Campo.ConfigParametro)).existeParametro("CapturarCantidadCero", ClaveModulo)) {
					capturarCantidadCero = ((ConfigParametro) Sesion.get(Campo.ConfigParametro)).get("CapturarCantidadCero", ClaveModulo).toString().equals("1");
				}
			}
