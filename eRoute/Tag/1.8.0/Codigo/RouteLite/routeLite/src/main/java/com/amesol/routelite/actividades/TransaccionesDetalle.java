...
public class TransaccionesDetalle
{
	...
	public static class Pedidos {
        ...
        public static TransProdDetalle GuardarDetalleRegalados(TransProd oTransProd, String ProductoClave, int TipoUnidad, float Cantidad, String PromocionClave, int TipoValidacionInventario, boolean PendienteEntrega, String ProductoDisparador) throws Exception {
            String sUsuarioID = ((Usuario) Sesion.get(Campo.UsuarioActual)).USUId;
