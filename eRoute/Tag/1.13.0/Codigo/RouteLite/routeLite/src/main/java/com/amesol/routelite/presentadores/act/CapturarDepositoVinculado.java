...
public class CapturarDepositoVinculado  extends Presentador
{
    ...
    public void AgregarDeposito(String TipoBanco, String Ficha, float Deposito, ArrayList<ABNDetalle> abdVinculados)
    {
    try
    {
        com.amesol.routelite.datos.Deposito mGenerarDeposito = Transacciones.Deposito.GenerarDeposito(Integer.parseInt(TipoBanco), Ficha, Deposito, abdVinculados);
