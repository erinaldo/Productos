...
public class Promociones2
{
	...
	public class Regla
	{
		...
		private boolean OtorgarProducto() throws Exception
		{
			...
			mVista.mostrarPromocionProducto(oPromocion.PromocionClave, oReglaApp.PromocionReglaID, oPromocion.CantidadGrupoApp, oTransProd.SubEmpresaId, oReglaApp.Cantidad, oProducto.ProductoClave);
