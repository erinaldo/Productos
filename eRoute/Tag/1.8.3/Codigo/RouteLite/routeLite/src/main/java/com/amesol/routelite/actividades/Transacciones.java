		...
		if (oTransProd.DevolucionID == null || oTransProd.DevolucionID == ""){
			...
			do{
                if(productos.getFloat("Diferencia") > 0){
                    ...
                    TransProdDetalle transProdDetalle = TransaccionesDetalle.DevolucionesCliente.GenerarDetalleDevolucionEnvase(transProdDev.TransProdID,productos.getString("ProductoDetClave"),productos.getInt("TipoUnidad"),productos.getFloat("Diferencia"),transProdDev.TipoMotivo);
