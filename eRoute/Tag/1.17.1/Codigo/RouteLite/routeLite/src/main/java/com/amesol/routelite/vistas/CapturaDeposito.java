...
public class CapturaDeposito extends Vista implements ICapturaDeposito
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		try
		{
            ...
            mTexto = (TextView) findViewById(R.id.lblEfectivoPre);
            mTexto.setText("Total Preliquidación (Efectivo)");
			mTexto = (TextView) findViewById(R.id.lblTotalaDepositar);
			mTexto.setText("Total Depósitos");
    ...
    @Override
    public void setTotalEfectivoPre(float Total)
    {
        EditText mTexto = (EditText) findViewById(R.id.txtTotalEfectivoPre);
        mTexto.setText("$" + Generales.getRound(Total, 2));
        mTexto.setEnabled(false);
    }
