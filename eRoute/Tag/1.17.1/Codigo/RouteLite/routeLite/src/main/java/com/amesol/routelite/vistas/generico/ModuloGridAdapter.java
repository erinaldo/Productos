...
public class ModuloGridAdapter extends BaseAdapter
{
	...
	public Integer[] ObteinIconsVisits()
	{
		try
		{
			...
			{
				if (mmdArray[i].getTipoIndice() == 30 || mmdArray[i].getTipoIndice() == 21)
                ...
                if(mmdArray[i].getTipoIndice() == 35)
                    imageVisit[i] = R.drawable.mmd35;
				if(mmdArray[i].getTipoIndice() == 36)
					imageVisit[i] = R.drawable.mmd36;
				if(mmdArray[i].getTipoIndice() == 37)
					imageVisit[i] = R.drawable.mmd37;
				if(mmdArray[i].getTipoIndice() == 38)
					imageVisit[i] = R.drawable.mmd38;
				if(mmdArray[i].getTipoIndice() == 39)
					imageVisit[i] = R.drawable.mmd39;
				if(mmdArray[i].getTipoIndice() == 40)
					imageVisit[i] = R.drawable.mmd40;
				if(mmdArray[i].getTipoIndice() == 41)
					imageVisit[i] = R.drawable.mmd41;
