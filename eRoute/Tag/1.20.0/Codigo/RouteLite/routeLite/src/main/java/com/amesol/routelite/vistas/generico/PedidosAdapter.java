...
public class PedidosAdapter extends ArrayAdapter<SeleccionarPedido.VistaPedidos>
{
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
        ...
        ImageView iconoQR = (ImageView) fila.findViewById(R.id.iconoQR);
        if(pedido.getExtras() != ""){
            //validar tipo motivo guardado en extras
            if (pedido.getExtras().equalsIgnoreCase("TraspasoRutas")){
                iconoQR.setVisibility(View.VISIBLE);
            }else{
                iconoQR.setVisibility(View.GONE);
            }
        }else{
            iconoQR.setVisibility(View.GONE);
        }
