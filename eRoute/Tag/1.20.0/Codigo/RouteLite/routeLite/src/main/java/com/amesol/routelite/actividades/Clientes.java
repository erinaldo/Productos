	...
	public static List<Map<String, String>> generarListaInfo(Cliente oCliente)
	{
		try
		{
			...
			while (domicilios.hasNext())
			{
				...
				if (domicilio.Tipo == 2)
					domPuntoEnt = domicilio.Calle + " " + (domicilio.Numero == null ? "" : "" + domicilio.Numero) + (domicilio.NumInt == null ? "" : " Int. " + domicilio.NumInt) + (domicilio.Colonia == null ? "" : ", " + "Col. " + domicilio.Colonia) + (domicilio.Localidad == null ? "" : ", " + "Loc. " + domicilio.Localidad) + (domicilio.Poblacion == null ? "" : ", " + "Pob. " + domicilio.Poblacion) + (domicilio.Entidad == null ? "" : ", " + domicilio.Entidad) + (domicilio.Pais == null ? "" : ", " + domicilio.Pais) + (domicilio.CodigoPostal == null ? "" : ", " + "C.P. " + domicilio.CodigoPostal) + (domicilio.ReferenciaDom == null ? "" : ", " + "Ref. " + domicilio.ReferenciaDom);
				//domPuntoEnt = domicilio.Calle + " " + domicilio.Numero + " " + domicilio.NumInt + " " + domicilio.Localidad;

				if (domicilio.Tipo == 1)
					domFiscal = domicilio.Calle + " " + (domicilio.Numero == null ? "" : "" + domicilio.Numero) + (domicilio.NumInt == null ? "" : " Int. " + domicilio.NumInt) + (domicilio.Colonia == null ? "" : ", " + "Col. " + domicilio.Colonia) + (domicilio.Localidad == null ? "" : ", " + "Loc. " + domicilio.Localidad) + (domicilio.Poblacion == null ? "" : ", " + "Pob. " + domicilio.Poblacion) + (domicilio.Entidad == null ? "" : ", " + domicilio.Entidad) + (domicilio.Pais == null ? "" : ", " + domicilio.Pais) + (domicilio.CodigoPostal == null ? "" : ", " + "C.P. " + domicilio.CodigoPostal) + (domicilio.ReferenciaDom == null ? "" : ", " + "Ref. " + domicilio.ReferenciaDom);
