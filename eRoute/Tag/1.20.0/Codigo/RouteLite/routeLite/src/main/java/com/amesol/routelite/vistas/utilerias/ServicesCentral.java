...
public class ServicesCentral
{
	...
	{
		TipoProductoIncorrecto("TipoProductoIncorrecto"),
		RFCIncorrecto ("RFCIncorrecto"),
	...
	public static InputStream DescargarImagenes(String nombreArchivo, int[] tamanioArchivo) throws Exception
	{

		ConfiguracionLocal config = (ConfiguracionLocal) Sesion.get(Campo.ConfiguracionLocal);
		String sUrl = Uri.withAppendedPath(Uri.parse(config.get(CampoConfiguracion.URL).toString()), "imagenes").toString();
		sUrl = Uri.withAppendedPath(Uri.parse(sUrl), nombreArchivo + ".zip").toString();
		URL url = new URL(sUrl);
		URLConnection conexion = url.openConnection();
		conexion.connect();
	...
	public static String WSVendedorObtenerImagenes(Date FechaUltimaMod, boolean Nuevo) throws Exception
	{
		String nombreArchivo = "";
		...
		String message = "<soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\" " +
				"xmlns:tem=\"http://tempuri.org/services/MobileClient\">" +
				"<soap:Body>" +
				"<WSVendedorObtenerImagenes xmlns=\"http://tempuri.org/services/MobileClient\">" +
				"<pardFechaUltimaMod>" + formato.format(FechaUltimaMod) + "</pardFechaUltimaMod>"+
				"<pardNuevo>" + Nuevo + "</pardNuevo>"+
				"</WSVendedorObtenerImagenes>" +
				"</soap:Body>" +
				"</soap:Envelope>";
		String url = Uri.withAppendedPath(Uri.parse(config.get(CampoConfiguracion.URL).toString()), "ServiceMobileClient.asmx").toString();
		...
		/** Some web servers requires these properties */
		hc.setRequestMethod("POST");
		hc.setRequestProperty("SOAPAction", "http://tempuri.org/services/MobileClient/WSVendedorObtenerImagenes");
		hc.setRequestProperty("User-Agent", "Profile/MIDP-1.0 Configuration/CLDC-1.0");
		hc.setRequestProperty("Content-Type", "text/xml;charset=utf-8");
		hc.setRequestProperty("Content-Length", Integer.toString(message.length()));
		hc.setRequestProperty("Connection", "close");
		...
		if (hc.getResponseCode() == 200)
		{
			...
			isr.close();
			Document doc = DocumentoXML.XMLfromString(outputString);
			Node nodo = doc.getElementsByTagName("WSVendedorObtenerImagenesResponse").item(0);
			if (nodo.getChildNodes().item(0).getChildNodes().item(0) == null)
			{
				if (nodo.getChildNodes().item(1).getChildNodes().item(0) != null)
				{
	...
	public static boolean WSEliminarArchivoImagenes(String nombreArchivo)
	{
		...
		String message = "<soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\" " +
				"xmlns:tem=\"http://tempuri.org/services/MobileClient\">" +
				"<soap:Body>" +
				"<WSEliminarArchivoImagenes xmlns=\"http://tempuri.org/services/MobileClient\">" +
				"<parsNombreArchivo>" + nombreArchivo + "</parsNombreArchivo>" +
				"</WSEliminarArchivoImagenes>" +
				"</soap:Body>" +
				"</soap:Envelope>";
		...
		try{
			...
			/** Some web servers requires these properties */
			hc.setRequestMethod("POST");
			hc.setRequestProperty("SOAPAction", "http://tempuri.org/services/MobileClient/WSEliminarArchivoImagenes");
			hc.setRequestProperty("User-Agent", "Profile/MIDP-1.0 Configuration/CLDC-1.0");
			hc.setRequestProperty("Content-Type", "text/xml;charset=utf-8");
			hc.setRequestProperty("Content-Length", Integer.toString(message.length()));
			hc.setRequestProperty("Connection", "close");
	...
	//Imagen Logo
	@SuppressWarnings("deprecation")
	public static String WSVendedorObtenerLogo(Date FechaUltimaMod, boolean Nuevo) throws Exception
	{
		String nombreArchivo = "";
		...
		String message = "<soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\" " +
				"xmlns:tem=\"http://tempuri.org/services/MobileClient\">" +
				"<soap:Body>" +
				"<WSVendedorObtenerLogo xmlns=\"http://tempuri.org/services/MobileClient\">" +
				"<pardFechaUltimaMod>" + formato.format(FechaUltimaMod) + "</pardFechaUltimaMod>"+
				"<pardNuevo>" + Nuevo + "</pardNuevo>"+
				"</WSVendedorObtenerLogo>" +
				"</soap:Body>" +
				"</soap:Envelope>";
		String url = Uri.withAppendedPath(Uri.parse(config.get(CampoConfiguracion.URL).toString()), "ServiceMobileClient.asmx").toString();
		...
		/** Some web servers requires these properties */
		hc.setRequestMethod("POST");
		hc.setRequestProperty("SOAPAction", "http://tempuri.org/services/MobileClient/WSVendedorObtenerLogo");
		hc.setRequestProperty("User-Agent", "Profile/MIDP-1.0 Configuration/CLDC-1.0");
		hc.setRequestProperty("Content-Type", "text/xml;charset=utf-8");
		hc.setRequestProperty("Content-Length", Integer.toString(message.length()));
		hc.setRequestProperty("Connection", "close");
		...
		if (hc.getResponseCode() == 200)
		{
			...
			isr.close();
			Document doc = DocumentoXML.XMLfromString(outputString);
			Node nodo = doc.getElementsByTagName("WSVendedorObtenerLogoResponse").item(0);
			if (nodo.getChildNodes().item(0).getChildNodes().item(0) == null)
			{
				if (nodo.getChildNodes().item(1).getChildNodes().item(0) != null)
				{
	...
	public static boolean WSEliminarArchivoLogo(String nombreArchivo)
	{
		...
		String message = "<soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\" " +
				"xmlns:tem=\"http://tempuri.org/services/MobileClient\">" +
				"<soap:Body>" +
				"<WSEliminarArchivoLogo xmlns=\"http://tempuri.org/services/MobileClient\">" +
				"<parsNombreArchivo>" + nombreArchivo + "</parsNombreArchivo>" +
				"</WSEliminarArchivoLogo>" +
				"</soap:Body>" +
				"</soap:Envelope>";
		...
		try{
			...
			/** Some web servers requires these properties */
			hc.setRequestMethod("POST");
			hc.setRequestProperty("SOAPAction", "http://tempuri.org/services/MobileClient/WSEliminarArchivoLogo");
			hc.setRequestProperty("User-Agent", "Profile/MIDP-1.0 Configuration/CLDC-1.0");
			hc.setRequestProperty("Content-Type", "text/xml;charset=utf-8");
			hc.setRequestProperty("Content-Length", Integer.toString(message.length()));
			hc.setRequestProperty("Connection", "close");
	...
	public static boolean WSValidarParametro(String parametro)throws Exception
	{
		...
		String message = "<soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\" " +
				"xmlns:tem=\"http://tempuri.org/services/MobileClient\">" +
				"<soap:Body>" +
				"<WSValidarParametro xmlns=\"http://tempuri.org/services/MobileClient\">" +
				"<pardParam>" + parametro + "</pardParam>"+
				"</WSValidarParametro>" +
				"</soap:Body>" +
				"</soap:Envelope>";
		String url = Uri.withAppendedPath(Uri.parse(config.get(CampoConfiguracion.URL).toString()), "ServiceMobileClient.asmx").toString();
		...
		/** Some web servers requires these properties */
		hc.setRequestMethod("POST");
		hc.setRequestProperty("SOAPAction", "http://tempuri.org/services/MobileClient/WSValidarParametro");
		hc.setRequestProperty("User-Agent", "Profile/MIDP-1.0 Configuration/CLDC-1.0");
		hc.setRequestProperty("Content-Type", "text/xml;charset=utf-8");
		hc.setRequestProperty("Content-Length", Integer.toString(message.length()));
		hc.setRequestProperty("Connection", "close");
		...
		if (hc.getResponseCode() == 200)
		{
			...
			isr.close();
			Document doc = DocumentoXML.XMLfromString(outputString);
			Node nodo = doc.getElementsByTagName("WSValidarParametroResponse").item(0);
			if (nodo.getChildNodes().item(0).getChildNodes().item(0) == null)
			{
				if (nodo.getChildNodes().item(1).getChildNodes().item(0) != null)
				{
			...
			{
				if(nodo.getChildNodes().item(0).getChildNodes().item(0).getNodeValue()!="0")
					Activo = true;
				else
					Activo = false;
			}
	...
	public static boolean WSObtenerConfirmacionPedidoProtheus(Date fechaInicial, Date fechaFinal, String vendedorID) throws Exception
	{
		boolean res = false;
		...
		String message = "<soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\" " +
				"xmlns:tem=\"http://tempuri.org/services/MobileClient\">" +
				"<soap:Body>" +
				"<WSObtenerConfirmacionPedidoProtheus xmlns=\"http://tempuri.org/services/MobileClient\">" +
				"<pardFechaInicial>" + Generales.getPrimerHora(fechaInicial, "yyyy-MM-dd'T'HH:mm:ss'Z'") + "</pardFechaInicial>" +
				"<pardFechaFinal>" + Generales.getUltimaHora(fechaFinal, "yyyy-MM-dd'T'HH:mm:ss'Z'") + "</pardFechaFinal>" +
				"<parsVendedorID>" + vendedorID + "</parsVendedorID>" +
				"</WSObtenerConfirmacionPedidoProtheus>" +
				"</soap:Body>" +
				"</soap:Envelope>";
		...
		hc.setRequestProperty("SOAPAction", "http://tempuri.org/services/MobileClient/WSObtenerConfirmacionPedidoProtheus");
		hc.setRequestProperty("User-Agent", "Profile/MIDP-1.0 Configuration/CLDC-1.0");
		hc.setRequestProperty("Content-Type", "text/xml;charset=utf-8");
		hc.setRequestProperty("Content-Length", Integer.toString(message.length()));
		hc.setRequestProperty("Connection", "close");
		...
		try
		{
			...
			Document doc = DocumentoXML.XMLfromString(outputString);
			Node nodo = doc.getElementsByTagName("WSObtenerConfirmacionPedidoProtheusResponse").item(0);
			if (nodo.getChildNodes().item(0) != null)
			{
				res = Boolean.parseBoolean(nodo.getChildNodes().item(0).getNodeValue());
				if (!res)
				{
					nodo = doc.getElementsByTagName("WSObtenerConfirmacionPedidoProtheusResult").item(0);
					if (nodo.getChildNodes().item(0) == null)
					{
						throw new Exception(nodo.getChildNodes().item(0).getNodeValue());
					}
