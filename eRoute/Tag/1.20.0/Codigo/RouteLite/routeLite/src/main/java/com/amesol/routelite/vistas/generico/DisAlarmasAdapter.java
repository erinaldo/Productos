...
import com.amesol.routelite.vistas.DisConsultaInformacionGeneralAlarmas;
 ...
 */
public class DisAlarmasAdapter extends BaseAdapter {

    Context context;
    protected ArrayList<DisConsultaInformacionGeneralAlarmas.ListaAlarmas> items;

    public DisAlarmasAdapter(Context context, ArrayList<DisConsultaInformacionGeneralAlarmas.ListaAlarmas> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        DisConsultaInformacionGeneralAlarmas.ListaAlarmas item = items.get(position);


        TextView col1 = (TextView) view.findViewById(R.id.txtCol1);
        col1.setText(item.getInformacion());
