...
public class AtencionClientes extends Vista implements IAtencionClientes {
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo) {
        ...
        if (v instanceof ListView && !optionsFlag) {
            ...
            menu.getItem(11).setTitle(Mensajes.get("XClientesBackOrder"));
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        if (item.getMenuInfo() != null) {
            ...
            if (Integer.parseInt(Sesion.get(Campo.TipoModulo).toString()) == Enumeradores.TiposModulos.REPARTO && clientesPedido.equals("1")) {
                ...
                sClienteClave = (cli != null ? cli.get_clienteClave() : null);
            } else {
            ...
            switch (item.getItemId()) {
               ...
               /*checarNFC();
                ...
                case R.id.porrecolectar:
                    ...
                    return true;
                case R.id.backorder:
                    mPresenta.mostrarClientes(VistaClientes.VISTA_CLIENTES_BACKORDER, null);
                    return true;
                default:
                    return super.onOptionsItemSelected(item);
            }
    ...
    public void mostrarClientes(ISetDatos clientes, int vista) {
        ...
        switch (vista) {
            ...
            case VistaClientes.VISTA_CLIENTES_BACKORDER:
                lblTitulo.setText(Mensajes.get("XClientesBackOrder") + ": " + clientes.getCount());
                break;
            default:
                break;
        }
