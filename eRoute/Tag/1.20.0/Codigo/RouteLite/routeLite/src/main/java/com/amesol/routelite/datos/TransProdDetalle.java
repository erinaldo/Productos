...
public class TransProdDetalle extends Entidad {
	...
	public float CantidadInventario;
    ...
    @Hijos(tablaHijos=TPDDesProntoPago.class)
    public List<TPDDesProntoPago> TPDDesProntoPago;
	...
	public TransProdDetalle(){
        ...
        TPDDesProntoPago = new ArrayList<TPDDesProntoPago>();
	}	
