...
import com.amesol.routelite.datos.AddendaFactura;
...
import com.amesol.routelite.datos.EnvioPendientePDF;
...
public class Envio {
	...
	public static final Class<?>[] TABLAS_ENVIO_JORNADA = new Class<?>[]{Cliente.class, ClienteDomicilio.class, ClienteEsquema.class, CLIFormaVenta.class, Visita.class, VisitaHist.class, VisitaModificada.class, Agenda.class, TiempoMuerto.class, PuntoGPS.class, TransProd.class, TransProdDetalle.class, TPDImpuesto.class, TrpPrp.class, TrpTpd.class, TpdDes.class, TPDDesVendedor.class, TPDDesProntoPago.class, TpdPun.class, TPDDatosExtra.class, TRPVtaAcreditada.class, AddendaFactura.class, VendedorMensaje.class, Abono.class, AbonoHist.class, ABNDetalle.class, AbnTrp.class, AbnTrpHist.class, TRPCheque.class, CuotaCumplida.class, CucCcu.class, CupCcu.class, CueCcu.class, FolioReservacion.class, FolioFiscal.class, Ruta.class, PLBPLE.class, PreLiquidacion.class,PedidoModificado.class, VendedorJornada.class, Tripulacion.class, CamionVendedor.class, UsuarioSustituto.class,InventarioTraspaso.class, ImproductividadVenta.class, TRPDatoFiscal.class,Encuesta.class, ENCPregunta.class, ENPRespCodigo.class,ENPRespGPS.class,ENPRespImagen.class,ENPRespMatricial.class,ENPRespNumero.class, ENPRespOpcional.class,ENPRespTexto.class, LoteCaducidad.class, InventarioMercadeo.class, InventarioMercadeoDetalle.class, ProductoNegado.class, SaldoCambiosVendedor.class, MercadeoProducto.class, MercadeoMarca.class, MERDetalle.class, TRPDescCalculadora.class, Deposito.class, Solicitud.class, EnvioPendientePDF.class ,AbdDep.class, Gasto.class, Secuencia.class, CenCli.class, ProductoPrestamoCli.class, Punto.class, ActivoDetalle.class, ActivoClienteHist.class, SaldoDeposito.class, TPDImpuestoEliminado.class};
	//Vendedor Jornada no se manda parcial porque si no causa problemas con la validacion final.
	public static final Class<?>[] TABLAS_ENVIO_PARCIAL = new Class<?>[]{Cliente.class, ClienteDomicilio.class, ClienteEsquema.class, CLIFormaVenta.class, Visita.class, VisitaHist.class, VisitaModificada.class, Agenda.class, TiempoMuerto.class, PuntoGPS.class, TransProd.class, TransProdDetalle.class, TPDImpuesto.class, TrpPrp.class, TrpTpd.class, TpdDes.class, TPDDesVendedor.class, TPDDesProntoPago.class, TpdPun.class, TPDDatosExtra.class, TRPVtaAcreditada.class, AddendaFactura.class, VendedorMensaje.class, Abono.class, AbonoHist.class, ABNDetalle.class, AbnTrp.class, AbnTrpHist.class, TRPCheque.class, CuotaCumplida.class, CucCcu.class, CupCcu.class, CueCcu.class, FolioReservacion.class, FolioFiscal.class, Ruta.class,PreLiquidacion.class,PedidoModificado.class, ImproductividadVenta.class, TRPDatoFiscal.class,Encuesta.class, ENCPregunta.class, ENPRespCodigo.class,ENPRespGPS.class,ENPRespImagen.class,ENPRespMatricial.class,ENPRespNumero.class, ENPRespOpcional.class,ENPRespTexto.class, LoteCaducidad.class,  InventarioMercadeo.class, InventarioMercadeoDetalle.class, ProductoNegado.class, SaldoCambiosVendedor.class, MercadeoProducto.class, MercadeoMarca.class, MERDetalle.class, TRPDescCalculadora.class, Solicitud.class, EnvioPendientePDF.class , Deposito.class, AbdDep.class, Gasto.class,Secuencia.class, CenCli.class, Punto.class, ActivoDetalle.class, ActivoClienteHist.class, SaldoDeposito.class,  TPDImpuestoEliminado.class};
	public static final Class<?>[] TABLAS_ENVIO_PENDIENTES = new Class<?>[]{ VendedorMensaje.class };
    public static final List<?> TABLAS_CON_SALDO = Arrays.asList(TransProd.class, Abono.class, Cliente.class, ABNDetalle.class, PromocionAplicacion.class);
    public static final Class<?>[] TABLAS_ENVIO_MOV_SIN_INV_SIN_VISITA = new Class<?>[]{TransProd.class, TransProdDetalle.class, PedidoModificado.class, TPDImpuesto.class, TrpPrp.class, TpdDes.class, TPDDesVendedor.class, TPDDesProntoPago.class, TpdPun.class};
	...
	public static String fileDatosEnviar( Class<?>... clases) throws Exception{
        ...
        //Se comenta ya que se movio la validación a otro punto del código
		//if (!hayDatosSinEnviar(entidadesEnviar)){
        //    Sesion.set(Campo.DetonarEnvioParcialAutomatico, "0");
		//	throw new Exception(Mensajes.get("I0162"));
		//}
		...
		for(EntidadEnvio e: entidadesEnviar){
			...
			try{
				...
				String comando = "INSERT into " + e.getNombreTabla() + " SELECT * from 'original'." + e.getNombreTabla() + " WHERE Enviado=0 or Enviado is null ";
    ...
    public static String fileDatosEnviarMSISV( Class<?>... clases) throws Exception{
        String nombreBD = "";
        if((clases == null)||(clases.length == 0)){
            String ruta = "com.amesol.routelite.datos";
            Enumeration<URL> elementos = Thread.currentThread().getContextClassLoader().getResources(ruta.replace('.', '/'));
	...
	private static ISetDatos obtenerDatos(Class<?> clase) throws Exception{
        ...
        //Este método busca todos los registros con enviado = 0, no se puede agregar mas filtros aqui, ya que
        //eso afectaria los datos que se envían al server en envioParcial por ejemplo.
        if (Sesion.get(Campo.tipoEnvioInformacion) == TipoEnvioInfo.ENVIO_JORNADA  && clase.equals(TransProd.class)) {
            Sesion.remove(Campo.tipoEnvioInformacion);
            return BDVend.consultar(clase, null, "Enviado = 0 and (Escritorio = 0 or Escritorio is null) ", null);
        }
	...
	private static String obtenerConsulta(Class<?> clase) throws Exception{
        ...
        if(Sesion.get(Campo.Envio_Mov_Sin_Inv_Sin_Visita)==true){
            if(clase.equals(TransProd.class)){
                return "SELECT t.* FROM 'original'.Transprod t WHERE t.Tipo=19 and (t.Enviado=0 or t.Enviado is null)";
            }
            if(clase.equals(TransProdDetalle.class)){
                return "SELECT td.* FROM 'original'.Transprod t inner join 'original'.TransprodDetalle td  on t.TransprodId=td.TransprodId WHERE t.Tipo=19 and (td.Enviado=0 or td.Enviado is null)";
            }
            if(clase.equals(PedidoModificado.class)){
                return "SELECT pm.* FROM 'original'.Transprod t inner join 'original'.PedidoModificado pm  on t.TransprodId=pm.TransprodId WHERE t.Tipo=19 and (pm.Enviado=0 or pm.Enviado is null)";
            }
            if(clase.equals(TPDImpuesto.class)){
                return "SELECT ti.* FROM 'original'.Transprod t inner join 'original'.TPDImpuesto ti  on t.TransprodId=ti.TransprodId WHERE t.Tipo=19 and (ti.Enviado=0 or ti.Enviado is null)";
            }
            if(clase.equals(TrpPrp.class)){
                return "SELECT tp.* FROM 'original'.Transprod t inner join 'original'.TrpPrp tp  on t.TransprodId=tp.TransprodId WHERE t.Tipo=19 and (tp.Enviado=0 or tp.Enviado is null)";
            }
            if(clase.equals(TpdDes.class)){
                return "SELECT td.* FROM 'original'.Transprod t inner join 'original'.TpdDes td  on t.TransprodId=td.TransprodId WHERE t.Tipo=19 and (td.Enviado=0 or td.Enviado is null)";
            }
            if(clase.equals(TPDDesVendedor.class)){
                return "SELECT tdv.* FROM 'original'.Transprod t inner join 'original'.TpdDesVendedor tdv  on t.TransprodId=tdv.TransprodId WHERE t.Tipo=19 and (tdv.Enviado=0 or tdv.Enviado is null)";
            }
            if(clase.equals(TPDDesProntoPago.class)){
                return "SELECT tp.* FROM 'original'.Transprod t inner join 'original'.TPDDesProntoPago tp on t.TransprodId=tp.TransprodId WHERE t.Tipo=19 and (tp.Enviado=0 or tp.Enviado is null)";
            }
            if(clase.equals(TpdPun.class)){
                return "SELECT tp.* FROM 'original'.Transprod t inner join 'original'.TpdPun tp  on t.TransprodId=tp.TransprodId WHERE t.Tipo=19 and (tp.Enviado=0 or tp.Enviado is null)";
            }
        }
	...
	public static void marcarEnviados(int tipoEnvioInfo, Class<?>... clases) throws Exception {
		...
		for(EntidadEnvio entidad:entidades){
            if(Sesion.get(Campo.Envio_Mov_Sin_Inv_Sin_Visita)==true){
                BDVend.ejecutarComando("UPDATE "+ entidad.getNombreTabla() + " SET Enviado = 1 WHERE TransprodId in (select TransprodId from Transprod where Tipo=19)");
            }else {
                ...
                } else if (TABLAS_CON_SALDO.contains(entidad.getEntidad())) {
                    switch (entidad.getNombreTabla().toUpperCase()) {
                        case "TRANSPROD":
                            BDVend.ejecutarComando("UPDATE " + entidad.getNombreTabla() + " SET Enviado = 1, SaldoCarga=Saldo WHERE Enviado IS NULL or Enviado=0 ");
                            break;
                        case "ABONO":
                            BDVend.ejecutarComando("UPDATE " + entidad.getNombreTabla() + " SET Enviado = 1, SaldoCarga=Saldo WHERE Enviado IS NULL or Enviado=0 ");
                            break;
                        case "CLIENTE":
                            BDVend.ejecutarComando("UPDATE " + entidad.getNombreTabla() + " SET Enviado = 1, SaldoEfectivoCarga=SaldoEfectivo WHERE Enviado IS NULL or Enviado=0 ");
                            break;
                        case "ABNDETALLE":
                            BDVend.ejecutarComando("UPDATE " + entidad.getNombreTabla() + " SET Enviado = 1, SaldoCarga=SaldoDeposito WHERE Enviado IS NULL or Enviado=0 ");
                            break;
                        case "PROMOCIONAPLICACION":
                            BDVend.ejecutarComando("UPDATE " + entidad.getNombreTabla() + " SET Enviado = 1, SaldoCarga=SaldoProducto WHERE Enviado IS NULL or Enviado=0 ");
                            break;
                    }
                } else {
                    BDVend.ejecutarComando("UPDATE " + entidad.getNombreTabla() + " SET Enviado = 1");
