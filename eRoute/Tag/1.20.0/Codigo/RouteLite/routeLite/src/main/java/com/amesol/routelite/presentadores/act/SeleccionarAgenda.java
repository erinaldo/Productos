	...
	public void iniciar()
	{
		...
		try
		{
			if ((mAccion != null) && (mAccion.equals(Enumeradores.Acciones.ACCION_ATENDER_CLIENTES_DIA))
					...
					|| (mAccion.equals(Enumeradores.Acciones.ACCION_CAPTURAR_DEPOSITO_VINCULADO))
					...
					|| (mAccion.equals(Enumeradores.Acciones.ACCION_MOSTRAR_GASTOS))
					|| (mAccion.equals(Enumeradores.Acciones.ACCION_SELECCIONAR_CONTEO_INVENTARIO)))
			{
					...
					if (mVista.validarJornadaTrabajo())
					{
						if (validarKilometraje()){
							if (!mVista.getValidando())
								...
								else if ((mAccion.equals(Enumeradores.Acciones.ACCION_CAPTURAR_DEPOSITO_VINCULADO)))
									mVista.iniciarActividad(ISeleccionAgenda.class, Enumeradores.Acciones.ACCION_CAPTURAR_DEPOSITO_VINCULADO_RUTA, null, false);
								...
								else if ((mAccion.equals(Enumeradores.Acciones.ACCION_MOSTRAR_GASTOS)))
									mVista.iniciarActividad(ISeleccionAgenda.class, Enumeradores.Acciones.ACCION_MOSTRAR_GASTOS_RUTAS, null, false);
								else if ((mAccion.equals(Enumeradores.Acciones.ACCION_SELECCIONAR_CONTEO_INVENTARIO)))
									mVista.iniciarActividad(ISeleccionAgenda.class, Enumeradores.Acciones.ACCION_SELECCIONAR_CONTEO_INVENTARIO_RUTA, null, false);
			...
			else if ((mAccion != null) && (mAccion.equals(Enumeradores.Acciones.ACCION_CAPTURAR_DEPOSITO_VINCULADO_RUTA)))
			{
				ISetDatos rutas = Consultas.ConsultasRuta.obtenerRutas();
				if (validarMostrarRutas(rutas))
				{
				...
				{
					mVista.finalizar();
					mVista.iniciarActividadConResultado(ICapturaDepositoVinculado.class, 0, Enumeradores.Acciones.ACCION_CAPTURAR_DEPOSITO_VINCULADO);
				}
			}
			...
			}else if ((mAccion != null) && (mAccion.equals(Enumeradores.Acciones.ACCION_MOSTRAR_GASTOS_RUTAS))) {
				ISetDatos rutas = Consultas.ConsultasRuta.obtenerRutas();
				if (validarMostrarRutas(rutas)) {
					mVista.mostrarRutasTrabajo(rutas);
				} else {
					mVista.finalizar();
					//mVista.iniciarActividadConResultado(ISeleccionGastos.class, 0, Enumeradores.Acciones.ACCION_MOSTRAR_GASTOS);
					mVista.iniciarActividad(ISeleccionGastos.class, false);
				}
			}else if ((mAccion != null) && (mAccion.equals(Enumeradores.Acciones.ACCION_SELECCIONAR_CONTEO_INVENTARIO_RUTA)))
			{
				ISetDatos rutas = Consultas.ConsultasRuta.obtenerRutas();
				if (validarMostrarRutas(rutas))
				{
				...
				{
					mVista.finalizar();
					mVista.iniciarActividadConResultado(ISeleccionConteoInventario.class, 0, Enumeradores.Acciones.ACCION_SELECCIONAR_CONTEO_INVENTARIO);
				}
			}
	...
	public void seleccionar()
	{
				...
				|| (mAccion.equals(Enumeradores.Acciones.ACCION_SELECCIONAR_CONTEO_INVENTARIO)))
		{
			...
			try
			{
				...
				boolean existeSustituto = !claveTitular.equalsIgnoreCase(claveActual);
				...
				{
					if(existeSustituto){
                        UsuarioSustituto usuSust = Consultas.ConsultasUsuarioSustituto.obtenerUltimoSustituto(mVista.getDia());
                        if (usuSust != null && usuSust.USUIdSustituto.equals(((Usuario)Sesion.get(Campo.UsuarioActual)).USUId)){
			...
			catch (ParseException e)
			{
                ...
                if (e!= null && e.getMessage() != null)
                    ...
                    mVista.mostrarError("Error al obtener el usuario.");
            }
		...
		if (((Vendedor)Sesion.get(Campo.VendedorActual)).Kilometraje){
			try{
				if (Consultas.ConsultasKilometraje.existeKilometrajeCapturado()){
                    ...
                    BDVend.recuperar(mCamionVendedor);
                    mCamionVendedor.DiaClave = dia.DiaClave;
