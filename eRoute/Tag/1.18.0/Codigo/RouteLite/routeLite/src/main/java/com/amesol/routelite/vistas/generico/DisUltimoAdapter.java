 ...
 */
public class DisUltimoAdapter extends BaseAdapter {

    Context context;
    protected ArrayList<DisConsultaUltimosPedidos.ListaUltimo> items;

    public DisUltimoAdapter(Context context, ArrayList<DisConsultaUltimosPedidos.ListaUltimo> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        DisConsultaUltimosPedidos.ListaUltimo item = items.get(position);
        ...
        col2.setText(item.getUltimaFecha());
