...
public class Producto extends Entidad {
    ...
    public void obtenerExcepcionSubEmpresaID(String clienteClave){
        String sExcepcion = Consultas.ConsultasProducto.obtenerExcepcionSubEmpresaID(this.ProductoClave, clienteClave);
        if (sExcepcion != "")
            SubEmpresaId = sExcepcion;
    }
