...
public class BuscaProducto extends Vista implements IBuscaProducto, CalcularPorKiloListener
{
	...
	private class MySimpleCursorAdapter extends SimpleCursorAdapter
	{
		...
		public View getView(final int pos, View v, ViewGroup parent)
		{
			...
			String clave = (((TextView) v.findViewById(R.id.txtClave)).getText().toString() + "|" + ((TextView) v.findViewById(R.id.txtUnidad)).getTag().toString() + "|" + ((TextView) v.findViewById(R.id.txtExistencia)).getText().toString() + "|" + (c.isNull(c.getColumnIndex("Precio")) ? null : c.getFloat(c.getColumnIndex("Precio"))) + "|" + c.getInt(c.getColumnIndex("DecimalProducto")) + "|" + pos + "|" + c.getString(c.getColumnIndex("PrecioClave")));
			et.setTag(clave);
				...
				default:
					if (viewId != R.id.npCantidad)
					{
                        ...
                        if (viewId == R.id.txtClave || viewId == R.id.txtDescripcion) {
							...
							try{
								if (cursor.isNull(cursor.getColumnIndex("SaldoEnvase")) || cursor.getString(cursor.getColumnIndex("SaldoEnvase")).equals("")){
									texto.setVisibility(View.GONE);
								}
							}catch (Exception ex){
