...
public class FoliosFiscales
{
	...
	public static List<FolioFiscal> obtenerFolioFiscal(String subEmpresaID) throws FoliosFiscalesException{
		List<FolioFiscal> listFolios = null;
		try{
			listFolios = Consultas.ConsultasFoliosFiscales.obtieneFoliosFiscalesPorCentroExp(subEmpresaID);
		}catch(Exception ex){
			Log.e(ex);
