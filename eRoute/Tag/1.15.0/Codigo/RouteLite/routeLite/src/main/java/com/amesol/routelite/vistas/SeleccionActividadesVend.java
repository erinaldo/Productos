	...
	private void validarPermisoAcceso(String tipoIndice, int tipoPermiso)//Metodo que valida permisos ldelatorre
	{
		...
		try
		{
			...
			else
			{
				...
				if(tipoPermiso == Enumeradores.TipoPermiso.ACCESAR && permiso.equals("") && ((tipoIndice.equals("15") && solicitarContrasenaDescarga == 1) || (tipoIndice.equals("8") && solicitarContrasenaDevoAlmacen == 1)))
				{
