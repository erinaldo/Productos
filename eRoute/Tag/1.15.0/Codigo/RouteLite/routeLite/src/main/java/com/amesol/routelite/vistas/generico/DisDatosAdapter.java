 ...
 */
public class DisDatosAdapter extends BaseAdapter {

    Context context;
    protected ArrayList<DisConsultaInformacionGeneralDatos.ListaDatos> items;

    public DisDatosAdapter(Context context, ArrayList<DisConsultaInformacionGeneralDatos.ListaDatos> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        DisConsultaInformacionGeneralDatos.ListaDatos item = items.get(position);


        TextView col1 = (TextView) view.findViewById(R.id.txtCol1);
        col1.setText(item.getDato());

        TextView col2 = (TextView) view.findViewById(R.id.txtCol2);
        col2.setText(item.getInformacion());
