	...
	public void seleccionar()
	{
		...
		switch (mVista.getActividad().getTipoIndice())
		{
			case TiposModuloMovDetalle.MOV_SIN_INV_CON_VISITA:
				BDVend.setOrigenLog("SeleccionActividadesVisita");
				BDVend.writeInLog("SeleccionActividadesVisita:Inicio MovSinInvConVisita") ;
			...
			case TiposModuloMovDetalle.CAMBIOS: // cambios
				BDVend.setOrigenLog("SeleccionActividadesVisita");
				BDVend.writeInLog("SeleccionActividadesVisita:Inicio Cambios") ;
			...
			case TiposModuloMovDetalle.IMPRESION:
				BDVend.setOrigenLog("SeleccionActividadesVisita");
				BDVend.writeInLog("SeleccionActividadesVisita:Inicio Impresion") ;
			...
			case TiposModuloMovDetalle.COBRANZAMULTIPLE:
				BDVend.setOrigenLog("SeleccionActividadesVisita");
				BDVend.writeInLog("SeleccionActividadesVisita:Inicio CobranzaMultiple") ;
            ...
            case TiposModuloMovDetalle.COBRANZASIMPLE:
				BDVend.setOrigenLog("SeleccionActividadesVisita");
				BDVend.writeInLog("SeleccionActividadesVisita:Inicio CobranzaSimple") ;
			...
			case TiposModuloMovDetalle.DEVOLUCIONCLIENTES:
				BDVend.setOrigenLog("SeleccionActividadesVisita");
				BDVend.writeInLog("SeleccionActividadesVisita:Devolucion Clientes") ;
			...
			case TiposModuloMovDetalle.NO_VENTA:
				BDVend.setOrigenLog("SeleccionActividadesVisita");
				BDVend.writeInLog("SeleccionActividadesVisita:Inicio ImproductividadVenta") ;
				try{
					if (((ConfigParametro) Sesion.get(Campo.ConfigParametro)).existeParametro("ImproductividadVentas")){
						if (((ConfigParametro) Sesion.get(Campo.ConfigParametro)).get("ImproductividadVentas").equalsIgnoreCase("1")) {
			...
			case TiposModuloMovDetalle.CONSIGNACION:
				BDVend.setOrigenLog("SeleccionActividadesVisita");
				BDVend.writeInLog("SeleccionActividadesVisita:Inicio Consignacion") ;
			...
			case TiposModuloMovDetalle.FACTURACION:
				BDVend.setOrigenLog("SeleccionActividadesVisita");
				BDVend.writeInLog("SeleccionActividadesVisita:Inicio Facturacion") ;
			...
			case TiposModuloMovDetalle.ENCUESTAS:
				BDVend.setOrigenLog("SeleccionActividadesVisita");
				BDVend.writeInLog("SeleccionActividadesVisita:Inicio Encuestas") ;
            ...
            case TiposModuloMovDetalle.MERCADEO:
				BDVend.setOrigenLog("SeleccionActividadesVisita");
				BDVend.writeInLog("SeleccionActividadesVisita:Inicio Mercadeo") ;
            ...
            case TiposModuloMovDetalle.SOLICITUDES:
				BDVend.setOrigenLog("SeleccionActividadesVisita");
				BDVend.writeInLog("SeleccionActividadesVisita:Inicio Solicitudes") ;
            ...
            case TiposModuloMovDetalle.HISTORICOVENTAS:
				BDVend.setOrigenLog("SeleccionActividadesVisita");
				BDVend.writeInLog("SeleccionActividadesVisita:Inicio HistoricoVentas") ;
			...
			case TiposModuloMovDetalle.CANCELACION_MOV_ENVIADOS:
				BDVend.setOrigenLog("SeleccionActividadesVisita");
				BDVend.writeInLog("SeleccionActividadesVisita:Inicio CancelacionMovEnviados") ;
            ...
            case TiposModuloMovDetalle.CANJES:
				BDVend.setOrigenLog("SeleccionActividadesVisita");
				BDVend.writeInLog("SeleccionActividadesVisita:Inicio Canjes") ;
            ...
            case TiposModuloMovDetalle.ACTIVOS:
				BDVend.setOrigenLog("SeleccionActividadesVisita");
				BDVend.writeInLog("SeleccionActividadesVisita:Inicio Activos") ;
