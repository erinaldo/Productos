...
public class SeleccionarActividadesVend extends Presentador
{
	...
	public void seleccionar(ValorReferencia valorReferencia)
	{
		...
		{
			BDVend.setOrigenLog("SeleccionActividadesVend");
			BDVend.writeInLog("SeleccionActividadesVend:Inicio RevisisonPendientes") ;
			mVista.finalizar();
			mVista.iniciarActividad(IRevisionPendientes.class, false);
		}
		else if (valorReferencia.getVavclave().equals("5")) {
			BDVend.setOrigenLog("SeleccionActividadesVend");
			BDVend.writeInLog("SeleccionActividadesVend:Inicio SolicitudAgenda");
		...
		{
			BDVend.setOrigenLog("SeleccionActividadesVend");
			BDVend.writeInLog("SeleccionActividadesVend:Inicio EnvioDeInformacion") ;
			...
			BDVend.setOrigenLog("SeleccionActividadesVend");
			BDVend.writeInLog("SeleccionActividadesVend:Inicio Recepcion de InfoVendedor") ;
		...
		{
			BDVend.setOrigenLog("SeleccionActividadesVend");
			BDVend.writeInLog("SeleccionActividadesVend:Inicio AtenderClientes") ;
			mVista.finalizar();
			...
			BDVend.setOrigenLog("SeleccionActividadesVend");
			BDVend.writeInLog("SeleccionActividadesVend:Inicio ConsultaIndicadores");
			...
			BDVend.setOrigenLog("SeleccionActividadesVend");
			BDVend.writeInLog("SeleccionActividadesVend:Inicio MovSinInvSinVisita");
			mVista.iniciarActividad(ISeleccionAgenda.class, Enumeradores.Acciones.ACCION_CAPTURAR_MOVIMIENTO_SIN_INVENTARIO, null, false);
				...
				BDVend.setOrigenLog("SeleccionActividadesVend");
				BDVend.writeInLog("SeleccionActividadesVend:Inicio Ajustes");
			...
			BDVend.setOrigenLog("SeleccionActividadesVend");
			BDVend.writeInLog("SeleccionActividadesVend:Inicio Descarga");
			...
			BDVend.setOrigenLog("SeleccionActividadesVend");
			BDVend.writeInLog("SeleccionActividadesVend:Inicio Preliquidacion");
			mVista.iniciarActividad(ICapturaPreLiquidacion.class, false);
		}else if (valorReferencia.getVavclave().equals("21")) {
			BDVend.setOrigenLog("SeleccionActividadesVend");
			BDVend.writeInLog("SeleccionActividadesVend:Inicio ConteoInventario");
			...
			BDVend.setOrigenLog("SeleccionActividadesVend");
			BDVend.writeInLog("SeleccionActividadesVend:Inicio Depositos");
			...
			BDVend.setOrigenLog("SeleccionActividadesVend");
			BDVend.writeInLog("SeleccionActividadesVend:Inicio Devolucion");
			...
			BDVend.setOrigenLog("SeleccionActividadesVend");
			BDVend.writeInLog("SeleccionActividadesVend:Inicio Cargas");
			...
			BDVend.setOrigenLog("SeleccionActividadesVend");
			BDVend.writeInLog("SeleccionActividadesVend:Inicio CapturarTraspaso");
			...
			BDVend.setOrigenLog("SeleccionActividadesVend");
			BDVend.writeInLog("SeleccionActividadesVend:Inicio CapturaKilometraje");
			...
			BDVend.setOrigenLog("SeleccionActividadesVend");
			BDVend.writeInLog("SeleccionActividadesVend:Inicio Inicio Jornada");
			...
			BDVend.setOrigenLog("SeleccionActividadesVend");
			BDVend.writeInLog("SeleccionActividadesVend:Inicio Reportes");
			...
			BDVend.setOrigenLog("SeleccionActividadesVend");
			BDVend.writeInLog("SeleccionActividadesVend:Inicio EnvioParcial");
        ...
        {
			BDVend.setOrigenLog("SeleccionActividadesVend");
			BDVend.writeInLog("SeleccionActividadesVend:Inicio Envio Agenda");
            final AlertDialog.Builder alert = new AlertDialog.Builder(mVista.getContext());
			...
			BDVend.setOrigenLog("SeleccionActividadesVend");
			BDVend.writeInLog("SeleccionActividadesVend:Inicio DepositoVinculado");
			...
			BDVend.setOrigenLog("SeleccionActividadesVend");
			BDVend.writeInLog("SeleccionActividadesVend:Inicio Gastos");
