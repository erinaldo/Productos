...
import com.amesol.routelite.vistas.DisConsultaInformacionGeneralDatos;
 ...
 */
public class DisPromoAdapter  extends BaseAdapter {

    Context context;
    protected ArrayList<DisConsultaInformacionGeneralPromociones.ListaPromo> items;

    public DisPromoAdapter(Context context, ArrayList<DisConsultaInformacionGeneralPromociones.ListaPromo> items) {
