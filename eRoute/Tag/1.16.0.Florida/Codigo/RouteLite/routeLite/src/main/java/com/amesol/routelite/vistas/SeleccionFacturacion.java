...
public class SeleccionFacturacion extends Vista implements ISeleccionFacturacion
{
	...
	{
		/* Agregar labels */
		BDVend.setOrigenLog("Facturacion:Inicio");
		BDVend.writeInLog("Facturacion:Inicio");
		...
		switch (keyCode)
		{
			case KeyEvent.KEYCODE_BACK:
				if(validarSalida()){
					...
					BDVend.setOrigenLog("Facturacion:Finalizar");
					BDVend.writeInLog("Facturacion:Finalizar");
					this.finalizar();
					return true;
				}
		}
