...
public class SeleccionActividadesVisita extends Vista implements ISeleccionActividadesVisita, OnItemClickListener
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		try{
			...
			if(aseguramiento.TipoAseguramiento == Enumeradores.TipoAseguramiento.NFC_INI_FIN  || aseguramiento.TipoAseguramiento == Enumeradores.TipoAseguramiento.COD_BARRAS_NFC_INI_FIN){
				checarNFC();
			}
		}catch(Exception e){
			e.printStackTrace();
	...
	public void terminarVisita() {
		...
		BDVend.writeInLog("SeleccionActividadesVisita:terminarVisita");

		if (validarTiempoCliente()) {
			try {
			...
			/*If oVendedor.TipoModulo = ServicesCentral.TiposModulos.Venta Or oVendedor.TipoModulo = ServicesCentral.TiposModulos.Distribucion Then
			If oVendedor.motconfiguracion.VentasFacturas Then
			If Not ValidarVentasFacturadas() Then
			Return False
			End If
			End If
			End If*/
	...
	private void validarFinVisita(){
		try{
			...
			}else if (aseguramiento.TipoAseguramiento == Enumeradores.TipoAseguramiento.NFC_INI_FIN && !NFCleido && codigoLeido == 1){
	...
	public void resultadoActividad(int requestCode, int resultCode, Intent data)
	{
        ...
        if (actividad != null) {
            if (actividad.getTipoIndice() == TiposModuloMovDetalle.COBRANZAMULTIPLE) { // Cobranza
				BDVend.setOrigenLog("SeleccionActividadesVisita");
				BDVend.writeInLog("SeleccionActividadesVisita:Fin CobranzaMultiple") ;
				...
				BDVend.setOrigenLog("SeleccionActividadesVisita");
				BDVend.writeInLog("SeleccionActividadesVisita:Fin Pedido") ;
                if (resultCode == Resultados.RESULTADO_MAL) {
				...
				BDVend.setOrigenLog("SeleccionActividadesVisita");
				BDVend.writeInLog("SeleccionActividadesVisita:Fin DevolucionClientes") ;
				if (resultCode == Resultados.RESULTADO_MAL) {
				...
				BDVend.setOrigenLog("SeleccionActividadesVisita");
				BDVend.writeInLog("SeleccionActividadesVisita:Fin Actividad") ;
			}
		}
    }
	...
	public boolean validarTiempoCliente()
	{
		...
		{
			BDVend.setOrigenLog("SeleccionActividadesVisita");
			BDVend.writeInLog("SeleccionActividadesVisita:validarTiempoCliente") ;
			BDVend.recuperar(visita);
