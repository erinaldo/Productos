...
public class BDVend{
	...
	public static void writeInLog(String sTexto){
		bd.writeInLog(sTexto);
	}
	public static boolean getHabilitarLog(){
		return bd.getHabilitarLog() ;
	}
	public static String getDirHistoricosLog(){
		return bd.getDirHistoricosLog() ;
	}
	public static void enviarCorreoLog(Vista vista){
		 bd.enviarCorreoLog(vista);
	}
}
