 ...
 * @author Mouse
 */
public final class NumeroALetra {
    ...
    public static String Convertir(Float number, boolean mayusculas) {
    	String numero = String.valueOf(number);
    	return Convertir(numero, mayusculas);
    }
    ...
    public static String Convertir(String numero, boolean mayusculas) {
        ...
        if (Pattern.matches("\\d{1,9},\\d{1,2}", numero)) {
            ...
            parte_decimal = (Num[1]+"0").substring(0,2) + "/100 M.N.";
