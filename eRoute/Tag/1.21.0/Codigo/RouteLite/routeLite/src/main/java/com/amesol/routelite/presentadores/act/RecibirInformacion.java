...
private String mAccion; 
	...
	public void recibirInformacion(){
        ...
        bCobranza[0] = false;
        boolean bPromociones[] = new boolean[1];
        bPromociones[0] = false;
		boolean bProductos[] = new boolean[1];
		bProductos[0] = false;
		String tablasActualizar = mVista.obtenerTablas(bRecargas, bPrecios, bCobranza, bPromociones, bProductos);
        ...
        parametros.put("Promociones", bPromociones[0]);
		parametros.put("Productos", bProductos[0]);
		if((mAccion!= null)&&(mAccion.equals(Enumeradores.Acciones.ACCION_RECIBIR_INFO_TERMINAL))){
