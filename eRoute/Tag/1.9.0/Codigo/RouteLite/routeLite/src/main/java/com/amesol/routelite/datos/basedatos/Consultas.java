...
//				sConsulta.append("AND Visita.DiaClave='" + diaClave + "'");
	...
	public static final class ConsultasTransProdDetalle
	{
		...
		public static ISetDatos obtenerDetalle(String transProdId) throws Exception
		{
			...
			consulta.append("case when INV.Disponible is null then 0 else CAST(((INV.Disponible-INV.Apartado-INV.NoDisponible-INV.Contenido)/PDE.Factor) as int) end as Existencia, PRO.DecimalProducto, PRO.SubEmpresaId, PRO.Venta, PRO.Contenido, P.Nombre ");
...
//			return datos;
	...
	public static final class ConsultasAbono
	{
		...
		public static ISetDatos obtenerDocumentosCriterio(ArrayList<String> transprodids, short tipoCobranza) throws Exception
		{
			...
			//Todo: la variable trueType quedara amarrada con el valor 0 para que tome por fecha facturacion para el proyecto Avila
