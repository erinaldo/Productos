...
public class ConfigParametro
{
    ...
    public boolean existeParametro(String parametro, String ID){
        if (datos.containsKey(parametro)){
            if (datos.get(parametro).containsKey(ID)) {
                return true;
            }
        }
        return false;
    ...
    public Hashtable<String,String> getColeccion(String parametro) throws Exception{
        try{
