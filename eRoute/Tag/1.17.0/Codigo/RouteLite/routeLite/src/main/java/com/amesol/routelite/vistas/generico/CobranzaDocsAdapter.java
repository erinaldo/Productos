		...
		try{
			...
			if(texto != null) {
                if (documento.getFecha() != null)
                    texto.setText(Mensajes.get("MDB0409") + ": " + DateFormat.format("dd/MM/yyyy", documento.getFecha()));
                else
                    texto.setText(Mensajes.get("MDB0409") + ": ");
            }
			...
			if(texto != null) {
                if (documento.getFechaCobranza() != null)
                    texto.setText(Mensajes.get("XCobranza") + ": " + DateFormat.format("dd/MM/yyyy", documento.getFechaCobranza()));
                else
