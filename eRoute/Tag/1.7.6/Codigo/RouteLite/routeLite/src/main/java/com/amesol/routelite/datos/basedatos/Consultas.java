...
//				sConsulta.append("AND Visita.DiaClave='" + diaClave + "'");
	...
	public static final class ConsultasTransProdDetalle
	{
		...
		{
			return BDVend.consultar("SELECT SUM(SubTotal) as SubTDetalle, SUM(Impuesto) as Impuesto, SUM(Total) as Total FROM TransProdDetalle WHERE TransProdId = '" + transProdId + "'"); // GROUP																																															// BY																																															// ProductoClave");
		}
