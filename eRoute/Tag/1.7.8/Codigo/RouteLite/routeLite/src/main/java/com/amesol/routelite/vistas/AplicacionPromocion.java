	...
	public void onCreate(Bundle savedInstanceState)
	{
		try
		{
            ...
            if (oPromocion.TipoAplicacion == com.amesol.routelite.actividades.Enumeradores.Promocion.TipoAplicacion.Canje){
                promocionDetalle = Consultas.ConsultasPromocion.obtenerVistaDetalle(oPromocion, cantidadGrupo);
                if (promocionDetalle != null ) {
                    ...
                    for (PromocionDetalle promoDet: promocionDetalle){
                        ...
                        float nPrecio = ListaPrecio.BuscarPrecio(promoDet.getProductoClave(), (short) promoDet.getPRUTipoUnidad(), cadenaListasPrecios, sPrecioClave);
                        if (nPrecio >= 0) {
