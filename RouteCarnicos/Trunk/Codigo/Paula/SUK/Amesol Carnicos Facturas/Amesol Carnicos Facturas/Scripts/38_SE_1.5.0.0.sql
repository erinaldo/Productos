IF (SELECT isnullable FROM SysColumns WHERE Name = 'FolioId' AND Id = (SELECT Id FROM SysObjects WHERE Name = 'TRPDatoFiscal')) = 0
BEGIN
	...
	CREATE TABLE dbo.Tmp_TRPDatoFiscal
		...
		FolioId varchar(16) NULL,
		FOSId varchar(16) NULL,
