...
Namespace com.tralix.pac
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "2.0.50727.4927"),  _
     ...
     System.Web.Services.WebServiceBindingAttribute(Name:="TimbradoCFDBinding", [Namespace]:="http://www.sat.gob.mx/cfd/3")>  _
    Partial Public Class TimbradoCFDService
        ...
        Public Function TimbradoCFD(<System.Xml.Serialization.XmlElementAttribute([Namespace]:="http://www.sat.gob.mx/cfd/3")> ByVal Comprobante As Comprobante) As <System.Xml.Serialization.XmlElementAttribute("TimbreFiscalDigital", [Namespace]:="http://www.sat.gob.mx/cfd/3")> TimbreFiscalDigital
            Dim results() As Object = Me.Invoke("TimbradoCFD", New Object() {Comprobante})
            Return CType(results(0),TimbreFiscalDigital)
        End Function
        
        '''<remarks/>
        Public Overloads Sub TimbradoCFDAsync(ByVal Comprobante As Comprobante)
            Me.TimbradoCFDAsync(Comprobante, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub TimbradoCFDAsync(ByVal Comprobante As Comprobante, ByVal userState As Object)
            ...
            End If
            Me.InvokeAsync("TimbradoCFD", New Object() {Comprobante}, Me.TimbradoCFDOperationCompleted, userState)
        End Sub
