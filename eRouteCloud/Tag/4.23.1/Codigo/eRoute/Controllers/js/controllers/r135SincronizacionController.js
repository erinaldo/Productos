(function () {
    angular
        .module('eRouteApp')
        .controller('r135SincronizacionController', r135SincronizacionController)
    r135SincronizacionController.$inject = ['$scope', '$http', 'cfpLoadingBar', '$filter', "valorReferencia"];

    function r135SincronizacionController($scope, $http, cfpLoadingBar, $filter, valorReferencia) {
