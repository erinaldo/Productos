(function () {
    angular
        .module('eRouteApp')
        .controller('reporteClienteVisVsPlanTrabajoController', reporteClienteVisVsPlanTrabajoController)
    reporteClienteVisVsPlanTrabajoController.$inject = ['$scope', '$http', '$mdToast', '$q', '$timeout', 'NgMap', 'cfpLoadingBar', '$filter', "menuServices", "reportServices", "valorReferencia"];

    function reporteClienteVisVsPlanTrabajoController($scope, $http, $mdToast, $q, $timeout, NgMap, cfpLoadingBar, $filter, menuServices, reportServices, valorReferencia) {
