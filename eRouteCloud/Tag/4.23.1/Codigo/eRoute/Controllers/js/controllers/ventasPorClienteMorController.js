(function () {
    angular
        .module('eRouteApp')
        .controller('ventasPorClienteMorController', ventasPorClienteMorController)
    ventasPorClienteMorController.$inject = ['$scope', '$http', '$mdToast', '$q', '$timeout', 'NgMap', 'cfpLoadingBar', '$filter', "menuServices", "reportServices", "valorReferencia"];

    function ventasPorClienteMorController($scope, $http, $mdToast, $q, $timeout, NgMap, cfpLoadingBar, $filter, menuServices, reportServices, valorReferencia) {
