(function () {
    angular
        .module('eRouteApp')
        .controller('plandeTrabajoSemanalController', plandeTrabajoSemanalController)
    plandeTrabajoSemanalController.$inject = ['$scope', '$http', '$mdToast', '$q', '$timeout', 'NgMap', 'cfpLoadingBar', '$filter', "menuServices", "reportServices", "valorReferencia"];

    function plandeTrabajoSemanalController($scope, $http, $mdToast, $q, $timeout, NgMap, cfpLoadingBar, $filter, menuServices, reportServices, valorReferencia) {
