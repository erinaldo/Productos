(function () {
    angular
        .module('eRouteApp')
        .controller('cargasRealesporPedidoController', cargasRealesporPedidoController)
    cargasRealesporPedidoController.$inject = ['$scope', '$http', '$mdToast', '$q', '$timeout', 'NgMap', 'cfpLoadingBar', '$filter', "menuServices", "reportServices", "valorReferencia"];

    function cargasRealesporPedidoController($scope, $http, $mdToast, $q, $timeout, NgMap, cfpLoadingBar, $filter, menuServices, reportServices, valorReferencia) {
