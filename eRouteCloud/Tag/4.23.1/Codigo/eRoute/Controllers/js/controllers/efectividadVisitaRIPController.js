(function () {
    angular
        .module('eRouteApp')
        .controller('efectividadVisitaRIPController', efectividadVisitaRIPController)
    efectividadVisitaRIPController.$inject = ['$scope', '$http', '$mdToast', '$q', '$timeout', 'NgMap', 'cfpLoadingBar', '$filter', "menuServices", "reportServices", "valorReferencia"];

    function efectividadVisitaRIPController($scope, $http, $mdToast, $q, $timeout, NgMap, cfpLoadingBar, $filter, menuServices, reportServices, valorReferencia) {
