(function () {
    angular
        .module('eRouteApp')
        .controller('puntosGpsController', puntosGpsController)
    puntosGpsController.$inject = ['$scope', '$http', '$mdToast', '$q', '$timeout', 'NgMap', 'cfpLoadingBar', '$filter', "menuServices", "reportServices", "valorReferencia"];

    function puntosGpsController($scope, $http, $mdToast, $q, $timeout, NgMap, cfpLoadingBar, $filter, menuServices, reportServices, valorReferencia) {
        ...
        //muestra el panel de rutas y vendedores hasta que se selecciona un cedi
        ...
        ////Cedis config
        //var load = [GetCedis()]
        ////espera a la carga del load para continuar la ejecucion
        ...
        //crea un objeto para mostrar los cedis
        function loadAll(s) {
            var allstates = s;
