(function () {
    angular
        .module('eRouteApp')
        .controller('facturaGlobalPDRController', facturaGlobalPDRController)
    facturaGlobalPDRController.$inject = ['$scope', '$http', '$mdToast', '$q', '$timeout', 'NgMap', 'cfpLoadingBar', '$filter', "menuServices", "reportServices", "valorReferencia"];

    function facturaGlobalPDRController($scope, $http, $mdToast, $q, $timeout, NgMap, cfpLoadingBar, $filter, menuServices, reportServices, valorReferencia) {
