(function () {
    angular
        .module('eRouteApp')
        .controller('r010DevolucionesYCambiosDelClienteController', r010DevolucionesYCambiosDelClienteController)
    r010DevolucionesYCambiosDelClienteController.$inject = ['$scope', '$http', 'cfpLoadingBar', '$filter', "valorReferencia"];

    function r010DevolucionesYCambiosDelClienteController($scope, $http, cfpLoadingBar, $filter, valorReferencia) {
