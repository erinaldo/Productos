(function () {
    angular
        .module('eRouteApp')
        .controller('ventasPorDiaMorController', ventasPorDiaMorController)
    ventasPorDiaMorController.$inject = ['$scope', '$http', '$mdToast', '$q', '$timeout', 'NgMap', 'cfpLoadingBar', '$filter', "menuServices", "reportServices", "valorReferencia"];

    function ventasPorDiaMorController($scope, $http, $mdToast, $q, $timeout, NgMap, cfpLoadingBar, $filter, menuServices, reportServices, valorReferencia) {
