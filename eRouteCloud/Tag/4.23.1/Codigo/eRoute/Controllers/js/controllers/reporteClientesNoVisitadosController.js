(function () {
    angular
        .module('eRouteApp')
        .controller('reporteClientesNoVisitadosController', reporteClientesNoVisitadosController)
    reporteClientesNoVisitadosController.$inject = ['$scope', '$http', '$mdToast', '$q', '$timeout', 'NgMap', 'cfpLoadingBar', '$filter', "menuServices", "reportServices", "valorReferencia"];

    function reporteClientesNoVisitadosController($scope, $http, $mdToast, $q, $timeout, NgMap, cfpLoadingBar, $filter, menuServices, reportServices, valorReferencia) {
