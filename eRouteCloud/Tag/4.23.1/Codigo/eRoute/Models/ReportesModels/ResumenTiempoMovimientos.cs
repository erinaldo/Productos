...
namespace eRoute.Models.ReportesModels
{
    public class ResumenTiempoMovimientos
    {
        ...
        public XtraReport GetReport(string NombreReporte, string NombreEmpresa, string pvCondicion, string RutasSplit, string FechaInicial, string FechaFinal, string nombreCedis, string pvCondicion1)
        {
            try
            {
