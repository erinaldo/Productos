...
namespace eRoute.Models.ReportesModels
{
    public class PromocionesNvoMOR
    {
        ...
        public bool GetReport(string AlmacenID, string AlmacenNombre, string FechaIni, string FechaFin, string VendedorID)
        {
            try
            {
                DateTime dFechaIni;
        ...
        private ArchivoXlsModel GenerarExcel(DataTable dtPromos)
        {
            ...
            MyOpenXML.createCell(2, ref Rows, "B2", CellValues.String, ValorReferencia.ObtenerDescripcion("REPORTEW", "245", "EM"));

            MyOpenXML.createRow(3, ref Rows);
            MyOpenXML.createCell(3, ref Rows, "B3", CellValues.String, Mensaje.ObtenerDescripcion("XCEDI", "EM") + ": ");
            MyOpenXML.createCell(3, ref Rows, "C3", CellValues.String, sAlmacenNombre);

            MyOpenXML.createRow(4, ref Rows);
            MyOpenXML.createCell(4, ref Rows, "B4", CellValues.String, Mensaje.ObtenerDescripcion("XFecha", "EM") + ": ");
            MyOpenXML.createCell(4, ref Rows, "C4", CellValues.String, sFiltroFecha);
            ...
            if (sVendedorID != "") { 
                ...
                MyOpenXML.createCell(5, ref Rows, "B5", CellValues.String, Mensaje.ObtenerDescripcion("XVendedor", "EM") + ": ");
                MyOpenXML.createCell(5, ref Rows, "C5", CellValues.String, sVendedorNombre);
            }
