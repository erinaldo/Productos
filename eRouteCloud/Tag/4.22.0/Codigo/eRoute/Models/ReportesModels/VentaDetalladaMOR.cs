...
namespace eRoute.Models.ReportesModels
{
    public class VentaDetalladaMOR
    {
        ...
        public XtraReport GetReport(string pvCondicion, string RutasSplit, string ClientesSplit, string FechaInicial, string FechaFinal, string Cedis, string nombreCedis)
        {
            try
            {
