...
namespace eRoute.Models.ReportesModels
{
    public class MReporteVentaClienteOportuno
    {
        ...
        decimal p6 = 0;
        int cont;
        public XtraReport GetReport(string pvCondicion, string RutasSplit, string FechaInicial, string FechaFinal, string Cedis, string nombreCedis, string Presupuesto, string promocion)
        {                               
            try
            {
