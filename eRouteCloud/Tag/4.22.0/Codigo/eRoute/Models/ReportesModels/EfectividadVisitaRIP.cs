...
namespace eRoute.Models.ReportesModels
{
    public class EfectividadVisitaRIP
    {
        ...
        public XtraReport GetReport(string sCondicion, string sCondicionDia1, string FechaInicial, string FechaFinal, string Cedis, string nombreCedis, string nombreReport)
        {
            try
            {
