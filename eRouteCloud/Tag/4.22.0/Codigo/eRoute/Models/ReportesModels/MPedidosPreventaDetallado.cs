...
namespace eRoute.Models.ReportesModels
{
    public class MPedidosPreventaDetallado
    {
        ...
        public XtraReport GetReport(string pvCondicion, string pvCondicion1, string pvCondicion2, string Vendedor, string FechaInicial, string FechaFinal, string nombreCedis,string Cedi, string Presupuesto)
        {
            try
            {
                ...
                sConsulta.AppendLine("Select Top 1 @FechaCaptura = FechaCaptura from Dia (NOLOCK) where 1=1 and convert(datetime,Convert(varchar(20),Dia.FechaCaptura,112)) <= '" + FechaFinal + "'  and convert(datetime,Convert(varchar(20),Dia.FechaCaptura,112)) >= '" + FechaInicial + "'    ");
                ...
                sConsulta.AppendLine(pvCondicion + "and TRP.Tipo = 1 and TRP.TipoFase in(0, 1) ");
                ...
                sConsulta.AppendLine(pvCondicion + "and TRP.Tipo = 1 and TRP.TipoFase in(0, 1) and ALM.Clave = '" + ClaveAlmacen + "'");
