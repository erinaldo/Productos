            ...
            try
            {
                ...
                switch (VAVClave)
                {
                    ...
                    case 9:
                        ...
                        //}
                        //Rutas,FechaInicial, FechaFinal, Cedis
                        response = new TiemposEnRuta().GetReport(Rutas, RutasSplit, FechaInicial, FechaFinal, Cedis, Vendedor); //report.strWhereVendedores(Vendedor, "VEN.VendedorID"), report.strWhereRutas(Rutas, "RUT.RUTClave"), report.strWhereCedis(Cedis, "ALN.AlmacenID"), report.GetDateQuery(dateStatus, FechaInicial, FechaFinal, false, "Dia.FechaCaptura"));
                        break;
                    case 10:
