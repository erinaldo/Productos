(function () {
    angular
        .module('eRouteApp')
        .controller('tiemposEnRutaINDARController', tiemposEnRutaINDARController)
    tiemposEnRutaINDARController.$inject = ['$scope', '$http', '$mdToast', '$q', '$timeout', 'NgMap', 'cfpLoadingBar', '$filter', "menuServices", "reportServices", "valorReferencia"];

    function tiemposEnRutaINDARController($scope, $http, $mdToast, $q, $timeout, NgMap, cfpLoadingBar, $filter, menuServices, reportServices, valorReferencia) {
