(function () {
    angular
        .module('eRouteApp')
        .controller('informeCLientesSinVisitaSinVentaController', informeCLientesSinVisitaSinVentaController)
    informeCLientesSinVisitaSinVentaController.$inject = ['$scope', '$http', '$mdToast', '$q', '$timeout', 'NgMap', 'cfpLoadingBar', '$filter', "menuServices", "reportServices", "valorReferencia"];

    function informeCLientesSinVisitaSinVentaController($scope, $http, $mdToast, $q, $timeout, NgMap, cfpLoadingBar, $filter, menuServices, reportServices, valorReferencia) {
