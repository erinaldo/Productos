(function () {
    angular
        .module('eRouteApp')
        .controller('r259DocumentosConSaldoController', r259DocumentosConSaldoController)
    r259DocumentosConSaldoController.$inject = ['$scope', '$http', 'cfpLoadingBar', '$filter', "valorReferencia"];

    function r259DocumentosConSaldoController($scope, $http, cfpLoadingBar, $filter, valorReferencia) {
