(function () {
    angular
        .module('eRouteApp')
        .controller('liquidacionLaFloridaController', liquidacionLaFloridaController)
    liquidacionLaFloridaController.$inject = ['$scope', '$http', '$mdToast', '$q', '$timeout', 'NgMap', 'cfpLoadingBar', '$filter', "menuServices", "reportServices", "valorReferencia"];

    function liquidacionLaFloridaController($scope, $http, $mdToast, $q, $timeout, NgMap, cfpLoadingBar, $filter, menuServices, reportServices, valorReferencia) {
