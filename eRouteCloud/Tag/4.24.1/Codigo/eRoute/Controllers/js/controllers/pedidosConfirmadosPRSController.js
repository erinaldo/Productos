(function () {
    angular
        .module('eRouteApp')
        .controller('pedidosConfirmadosPRSController', pedidosConfirmadosPRSController)
    pedidosConfirmadosPRSController.$inject = ['$scope', '$http', '$mdToast', '$q', '$timeout', 'NgMap', 'cfpLoadingBar', '$filter', "menuServices", "reportServices", "valorReferencia"];

    function pedidosConfirmadosPRSController($scope, $http, $mdToast, $q, $timeout, NgMap, cfpLoadingBar, $filter, menuServices, reportServices, valorReferencia) {
