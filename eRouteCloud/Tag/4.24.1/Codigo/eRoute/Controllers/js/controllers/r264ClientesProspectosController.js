(function () {
    angular
        .module('eRouteApp')
        .controller('r264ClientesProspectosController', r264ClientesProspectosController)
    r264ClientesProspectosController.$inject = ['$scope', '$http', '$mdToast', '$q', '$timeout', 'NgMap', 'cfpLoadingBar', '$filter', "menuServices", "reportServices", "valorReferencia"];

    function r264ClientesProspectosController($scope, $http, $mdToast, $q, $timeout, NgMap, cfpLoadingBar, $filter, menuServices, reportServices, valorReferencia) {
