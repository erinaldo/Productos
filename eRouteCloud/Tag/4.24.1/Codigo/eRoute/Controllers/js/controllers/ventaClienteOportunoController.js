(function () {
    angular
        .module('eRouteApp')
        .controller('ventaClienteOportunoController', ventaClienteOportunoController)
    ventaClienteOportunoController.$inject = ['$scope', '$http', '$mdToast', '$q', '$timeout', 'NgMap', 'cfpLoadingBar', '$filter', "menuServices", "reportServices", "valorReferencia"];

    function ventaClienteOportunoController($scope, $http, $mdToast, $q, $timeout, NgMap, cfpLoadingBar, $filter, menuServices, reportServices, valorReferencia) {
