(function () {
    angular
        .module('eRouteApp')
        .controller('ventaDiarioCOSController', ventaDiarioCOSController)
    ventaDiarioCOSController.$inject = ['$scope', '$http', '$mdToast', '$q', '$timeout', 'NgMap', 'cfpLoadingBar', '$filter', "menuServices", "reportServices", "valorReferencia"];

    function ventaDiarioCOSController($scope, $http, $mdToast, $q, $timeout, NgMap, cfpLoadingBar, $filter, menuServices, reportServices, valorReferencia) {
