(function () {
    angular
        .module('eRouteApp')
        .controller('clientesSinVentaMapFilterController', clientesSinVentaMapFilterController)
    clientesSinVentaMapFilterController.$inject = ['$scope', '$http', '$mdToast', '$q', '$timeout', 'NgMap', 'cfpLoadingBar', '$filter', "menuServices", "reportServices", "mapServices"];

    function clientesSinVentaMapFilterController($scope, $http, $mdToast, $q, $timeout, NgMap, cfpLoadingBar, $filter, menuServices, reportServices, mapServices) {
