(function () {
    angular
        .module('eRouteApp')
        .controller('ventasvsAnioAnteriorController', ventasvsAnioAnteriorController)
    ventasvsAnioAnteriorController.$inject = ['$scope', '$http', '$mdToast', '$q', '$timeout', 'NgMap', 'cfpLoadingBar', '$filter', "menuServices", "reportServices", "valorReferencia"];

    function ventasvsAnioAnteriorController($scope, $http, $mdToast, $q, $timeout, NgMap, cfpLoadingBar, $filter, menuServices, reportServices, valorReferencia) {
