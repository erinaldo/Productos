        ...
        public ActionResult Index(string VAVClave)
        {
            if (Session["URL"] != null)
            {
                ...
                switch (Clave)
                {
                    ...
                    case 34:
                        return View("FiltroUno"); //return View("IndicadoresDeVenta");
                    case 37:
                ...
                switch (VAVClave)
                {
                    ...
                    case 153:
                        if (Rutas != "")
                        {
                            ...
                            pvCondicion1 = report.GetDateQuery("Igual", FechaInicial, FechaFinal, false, "Dia.FechaCaptura");
                        }
                    ...
                    case 246:
                        ...
                        if (!rptCarMen.GetReport(ReportName, CompanyName, CompanyLogo, ObjectName, NameCEDIS, StatusDate, CEDIS, InitialDate, FinalDate, Routes))
                            response = null;
                        break;
                    case 247:
                        if (Rutas != "")
                        ...
                        response = new MDiarioDeActividadesTiemposPDR().GetReport(pvCondicion, pvCondicion1, RutasSplit, FechaInicial, FechaFinal, nombreCedis);
                        break;
                    case 248:
                    ...
                    case 251:
                        ...
                        if (!rptVCMLPBYD.GetReport(Cedis, nombreCedis, pvCondicion, FechaInicial, FechaFinal))
                            response = null;
                        break;
                    case 257:
                        response = new MFacturaGlobalPDR().GetReport(FechaInicial, FechaFinal, Vendedor);
                        ...
                        break;
                    case 258:
                        response = new MIndicadoresDeVentaPDR().GetReport(Cedis, FechaInicial, FechaFinal, Vendedor, Rutas, nombreCedis, VendedorSplit, RutasSplit);
                        break;
                    case 259:
