(function () {
    angular
        .module('eRouteApp')
        .controller('devolucionesCambiosporVendedorController', devolucionesCambiosporVendedorController)
    devolucionesCambiosporVendedorController.$inject = ['$scope', '$http', '$mdToast', '$q', '$timeout', 'NgMap', 'cfpLoadingBar', '$filter', "menuServices", "reportServices", "valorReferencia"];

    function devolucionesCambiosporVendedorController($scope, $http, $mdToast, $q, $timeout, NgMap, cfpLoadingBar, $filter, menuServices, reportServices, valorReferencia) {
