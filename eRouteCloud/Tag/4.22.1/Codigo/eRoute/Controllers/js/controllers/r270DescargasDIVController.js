app.controller('r270DescargasDIVController', ['$scope', '$mdToast', '$q', '$timeout', 'valorReferencia', '$http', 'cfpLoadingBar', function ($scope, $mdToast, $q, $timeout, valorReferencia, $http, cfpLoadingBar) {
    ...
    function SubmitForm() {
        ...
        if (!$scope.selectAllRoutes && rutas.length <= 0) {
