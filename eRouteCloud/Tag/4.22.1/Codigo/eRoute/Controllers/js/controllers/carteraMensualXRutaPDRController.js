(function () {
    ...
    carteraMensualXRutaPDRController.$inject = ['$scope', '$http', '$mdToast', '$q', '$timeout', 'NgMap', 'cfpLoadingBar', '$filter', "menuServices", "reportServices", "valorReferencia"];

    function carteraMensualXRutaPDRController($scope, $http, $mdToast, $q, $timeout, NgMap, cfpLoadingBar, $filter, menuServices, reportServices, valorReferencia) {
        ...
        self.SubmitForm = function () {
            ...
            if (rutas.length <= 0 && $scope.RutaID == undefined) {
