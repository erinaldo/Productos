...
namespace eRoute.Models.ReportesModels
{
    public class VentasPorDiaMOR
    {
        ...
        public ArchivoXlsModel GetReport(string nombreReport, string nombreCedis, string FechaInicial, string FechaFinal, string Cedis, int vavclave, string dateStatus, string unidadMedida, string pvCondicion, string RutasSplit)
        {
            try
            {
                ...
                string filename = nombreReport + fechaHora.ToString("yyyy'-'MM'-'dd'T'HH':'mm':'ss") + ".xlsx";
                ...
                createCell(currentRow, ref Rows, "E" + currentRow, CellValues.String, nombreReport.ToUpper(), 4);
                currentRow++;
