...
namespace eRoute.Models.ReportesModels
{
    public class LibroRutaVitere
    {
        ...
        public XtraReport GetReport(string pvCondicion, string pvCondicion1, string RutasSplit, string FechaInicial, string FechaFinal, string NomCEDI, string NomReporte)
        {
            try
            {
                //LIBRODERUTAS
                ...
                sConsulta.AppendLine("SELECT RUTP.RUTClave as 'Ruta',VIS.Numero as 'orden', SEC.RUTClave, RUTR.Descripcion AS RUTDescripcion, CLI.Clave AS CLIClave, CLI.RazonSocial AS CLIRazonSocial, ISNULL( CLI.NombreCorto, '') AS CLINombreCorto, ");
                ...
                sConsulta.AppendLine("ORDER BY TRP.Folio, VIS.Numero, SEC.RUTClave, CLI.Clave, TRP.Tipo, PRO.Nombre");
                ...
                if (Principal.Count != 0)
                {
                    ...
                    reportDis.Name = NomReporte + "_" + DateTime.Now.ToString("yyyy-MM-ddTHH_mm_ss");
