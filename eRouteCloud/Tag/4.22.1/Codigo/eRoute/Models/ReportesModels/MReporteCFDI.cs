...
namespace eRoute.Models.ReportesModels
{
    public class MReporteCFDI
    {
        ...
        public XtraReport GetReport(string pvCondicion, string RutasSplit, string FechaInicial, string FechaFinal, string nombreCedis, string Presupuesto, string Promocion)
        {
            try
            {
                ...
                if (Promocion != "True")
                {
                    ...
                    if (cfdi.Count != 0)
                    {
                        ...
                        report.agencia.Text = nombreEmpresa;
