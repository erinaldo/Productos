...
namespace eRoute.Models.ReportesModels
{
    public class MPlandeTrebajoSemanal
    {
        ...
        public XtraReport GetReport(string pvCondicion, string pvCondicion1, string RutasSplit, string FechaInicial, string FechaFinal, string Cedis, string nombreCedis, string Presupuesto, string promocion)
        {
            try
            {
