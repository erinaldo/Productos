...
namespace eRoute.Models.ReportesModels
{
    public class VendedorCliModelListPreBYD
    {
        ...
        public bool GetReport(string Cedis, string nombreCedis, string pvCondicion, string FechaInicial, string FechaFinal)
        {
            try
            {
                var wheredateInit = "";
        ...
        {
            string fileName = "VendedorClienteModeloLista_" + DateTime.Now.ToString("ddMMyyyy_hhmmss") + ".xlsx";
            ...
            Sheet sheet = new Sheet() { Id = workbookPart.GetIdOfPart(worksheetPart), SheetId = 1, Name = "REPORTE DE CIFRAS DE CONTROL" };
            sheets.Append(sheet);
            ...
            MyOpenXML.createCell(2, ref Rows, "B2", CellValues.String, "Reporte Vendedor Cliente Modelo Lista de Precios", 5);
            ...
            MyOpenXML.createCell(5, ref Rows, "A5", CellValues.String, "Fecha(s): " + fecha, 4);
