...
namespace eRoute.Models.ReportesModels
{
    public class CarteraMensualXRutaPDR
    {
        ...
        public bool GetReport(string NombreReporte, string NombreEmpresa, MemoryStream LogoEmpresa, string NombreVendedor, string NombreCEDIS, string DateStatus, string CEDIS, string FechaInicial, string FechaFinal, string Rutas)
        {
            try
            {
                //Fecha
        ...
        private ArchivoXlsModel GenerarExcel(string FechaIni, string FechaFin, List<CarteraMensual> Detalle, CarteraMensualVis Visita, CarteraMensualSin SinVis)
        {
            ...
            solidBlue.ForegroundColor = new ForegroundColor { Rgb = HexBinaryValue.FromString("000099FF") }; // blue fill
