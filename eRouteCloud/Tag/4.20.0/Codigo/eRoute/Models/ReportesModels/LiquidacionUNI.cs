...
namespace eRoute.Models.ReportesModels
{
    public class LiquidacionUNI
    {
        ...
        public XtraReport GetReport(string pvCondicion, string pvCondicion1, string pvCondicion2, string pvCondicion3, string pvCondicion4, string pvCondicion5, string pvCondicion6, string RutasSplit, string FechaInicial, string FechaFinal, string nombreCedis, string Presupuesto)
        {
            try
            {
