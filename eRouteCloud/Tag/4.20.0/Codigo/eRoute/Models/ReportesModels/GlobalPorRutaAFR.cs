...
namespace eRoute.Models.ReportesModels
{
    public class GlobalPorRutaAFR
    {
        ...
        public bool GetReport(string FechaIni, string FechaFin, string Rutas)
        {
            try
            {
                DateTime dFechaIni;
        ...
        {            
            string fileName = "GlobalPorRuta_" + DateTime.Now.ToString("ddMMyyyy_hhmmss") + ".xlsx";
            ...
            using (SpreadsheetDocument document = SpreadsheetDocument.Create(ms, SpreadsheetDocumentType.Workbook))            
            {
                ...
                Sheet sheet = new Sheet() { Id = workbookPart.GetIdOfPart(worksheetPart), SheetId = 1, Name = "Reporte Global por Ruta" };
                sheets.Append(sheet);
                ...
                row = new Row();
                row.Append(MyOpenXML.ConstructCell(ValorReferencia.ObtenerDescripcion("REPORTEW", "241", "EM"), CellValues.String));
                sheetData.AppendChild(row);
