...
namespace eRoute.Models.ReportesModels
{
    public class GAPMOR
    {
        ...
        public ArchivoXlsModel GetReport(string nombreReport, string nombreCedis, string FechaInicial, string FechaFinal, int vavclave, string pvProductos, string sEsquemasProd, string pvCondicion, string RutasSplit, string sFechaAnioActual, string sFechaAnioAnterior)
        {
            try
            {
