(function () {
    angular
        .module('eRouteApp')
        .controller('diarioDeActividadesController', diarioDeActividadesController)
    diarioDeActividadesController.$inject = ['$scope', '$http', '$mdToast', '$q', '$timeout', 'NgMap', 'cfpLoadingBar', '$filter', "menuServices", "reportServices"];

    function diarioDeActividadesController($scope, $http, $mdToast, $q, $timeout, NgMap, cfpLoadingBar, $filter, menuServices, reportServices) {
