(function () {
    angular
        .module('eRouteApp')
        .controller('clientesNoVisitadosMapFilterController', clientesNoVisitadosMapFilterController)
    clientesNoVisitadosMapFilterController.$inject = ['$scope', '$http', '$mdToast', '$q', '$timeout', 'NgMap', 'cfpLoadingBar', '$filter', "menuServices", "reportServices", "mapServices"];

    function clientesNoVisitadosMapFilterController($scope, $http, $mdToast, $q, $timeout, NgMap, cfpLoadingBar, $filter, menuServices, reportServices, mapServices) {
        ...
        function SubmitForm() {
            ...
            if (countRoutes <= 0) {
                ...
                .then(function successCallback(response) {
                    ...
                    if (response.data.Rutas.length > 0) {
