(function () {
    angular
        .module('eRouteApp')
        .controller('clientesPorRutaController', clientesPorRutaController)
    clientesPorRutaController.$inject = ['$scope', '$http', '$mdToast', '$q', '$timeout', 'NgMap', 'cfpLoadingBar', '$filter', "menuServices", "reportServices", "valorReferencia"];

    function clientesPorRutaController($scope, $http, $mdToast, $q, $timeout, NgMap, cfpLoadingBar, $filter, menuServices, reportServices, valorReferencia) {
        ...
        self.SelectAllChekboxesSellers = function (selectAll) {
            ...
            if (selectAll == undefined || selectAll == false) {
                ...
                self.GetClients(null, null, self.sellers);
            } else {
                angular.forEach(self.sellers, function (item) {
                    item.Checked = false;
                });
        ...
        self.SubmitForm = function () {
            ...
            var clientes = GetArrayValues(self.ListClients);
