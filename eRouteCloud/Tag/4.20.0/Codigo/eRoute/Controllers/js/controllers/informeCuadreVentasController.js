(function () {
    angular
        .module('eRouteApp')
        .controller('informeCuadreVentasController', informeCuadreVentasController)
    informeCuadreVentasController.$inject = ['$scope', '$http', '$mdToast', '$q', '$timeout', 'NgMap', 'cfpLoadingBar', '$filter', "menuServices", "reportServices"];

    function informeCuadreVentasController($scope, $http, $mdToast, $q, $timeout, NgMap, cfpLoadingBar, $filter, menuServices, reportServices) {
        ...
        function SubmitForm(Cedis, dateStatus, Routes, Clientes, pvEsFecha, campoFecha) {
            ...
            if (ctrl.selectedItem == undefined || ctrl.selectedItem == null) {
                ...
                var data = {
                    ...
                    CENClave: '',
                    promocion:ctrl.Radio,
                    Presupuesto: ctrl.estatus
                }
                ...
                .success(function (data, status, headers, config) {
                    ...
                    window.open(url + "/Reports/Ver?VAVClave=" + data.VAVClave + "&Cedis=" + data.Cedis.replace(/\+/g, "%2B") + "&nombreReport=" + data.nombreReport + "&nombreCedis=" + data.nombreCedis + "&FechaInicial=" + data.FechaInicial + "&FechaFinal=" + data.FechaFinal + "&dateStatus=" + data.Rango + "&Rutas=" + data.Rutas + "&Clientes=" + data.Clientes + "&Vendedor=" + data.Vendedor + "&detallado="
                       ...
                       + "&CENClave=" + data.CENClave + "&promocion=" + data.promocion + "&Presupuesto=" + data.Presupuesto + "&TipoDoc=" + data.TipoDoc + "&Estatus=" + data.Estatus
                        , "_blank");
