(function () {
    angular
        .module('eRouteApp')
        .controller('devolucionesCambiosporClienteController', devolucionesCambiosporClienteController)
    devolucionesCambiosporClienteController.$inject = ['$scope', '$http', '$mdToast', '$q', '$timeout', 'NgMap', 'cfpLoadingBar', '$filter', "menuServices", "reportServices", "valorReferencia"];

    function devolucionesCambiosporClienteController($scope, $http, $mdToast, $q, $timeout, NgMap, cfpLoadingBar, $filter, menuServices, reportServices, valorReferencia) {
        ...
        self.GetCustomers = function (clientScheme, routes) {
            ...
            $http.post(url + '/Reports/GetObjectString', {
                ...
                $http({
                    url: url + '/API/GetModel/GetClients?clientScheme=' + clientScheme + '&routes=' + dataRoutes,
                    method: 'GET',
                    headers: {
                        Authorization: window.sessionStorage.getItem('Token'),
                        'Content-Type': 'application/json'
        ...
        self.GetProductSchemes = function (selectedItem) {
            ...
            $http({
                url: url + '/API/GetModel/GetSchemes?cedis=' + selectedItem.replace(/\+/g, "%2B") + '&types=' + 2 + '&levels=' + '0,1,2',
                method: 'GET',
                headers: {
                    Authorization: window.sessionStorage.getItem('Token'),
                    'Content-Type': 'application/json'
        ...
        self.GetProducts = function (productSchemes) {
            ...
            }).success(function (dataProductSchemes, status, headers, config) {
                $http({
                    url: url + '/API/GetModel/GetProducts?productSchemes=' + dataProductSchemes,
                    method: 'GET',
                    headers: {
                        Authorization: window.sessionStorage.getItem('Token'),
                        'Content-Type': 'application/json'
