...
namespace eRoute.Models.ReportesModels
{
    public class NecesidadesDeCargaUNI
    {
        ...
        public XtraReport GetReport(string pvCondicion, string pvCondicion1, string RutasSplit, string ClientesSplit, string FechaInicial, string FechaFinal, string Cedis, string nombreCedis)
        {
            try
            {
