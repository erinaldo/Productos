...
namespace eRoute.Models.ReportesModels
{
    public class CargasRealesporPedido
    {
        ...
        public XtraReport GetReport(int VAVClave, string nombreReport, string pvCondicion, string RutasSplit, string FechaInicial, string Cedis, string nombreCedis, string unidadMedida)
        {
            try
            {
                //Logo Empresa
            ...
            {
                return new ReporteCargasRealesporPedido();
            }
        }
