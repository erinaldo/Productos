...
namespace eRoute.Models.ReportesModels
{
    public class VentasvsAnioAnterior
    {
        ...
        public XtraReport GetReport(int VAVClave, string nombreReport, string pvCondicion, string pvCondicion1, string VendedorSplit, string FechaInicial, string FechaFinal, string Cedis, string nombreCedis, string unidadMedida)
        {
            try
            {
                //Logo Empresa
            ...
            {
                return new ReporteVentasvsAnioAnterior();
            }
        }
