(function () {
    angular
        .module('eRouteApp')
        .controller('reporteCFDIController', reporteCFDIController)
    reporteCFDIController.$inject = ['$scope', '$http', '$mdToast', '$q', '$timeout', 'NgMap', 'cfpLoadingBar', '$filter', "menuServices", "reportServices"];

    function reporteCFDIController($scope, $http, $mdToast, $q, $timeout, NgMap, cfpLoadingBar, $filter, menuServices, reportServices) {
