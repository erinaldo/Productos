...
app.controller("promocionesCtrl", ["$scope", "$http", "translationService", "valorReferencia", "defaultBox", "messageBoxAux", "messageBox", function ($scope, $http, translationService, valorReferencia, defaultBox, messageBoxAux, messageBox) {
    ...
    $scope.RemoverCliente = function (index, Clave) {
        ...
        if ($scope.EsquemasClientes.length > 0) {
            ...
            if (aux == true) {
                ...
                if ($scope.EsquemasClientes[$scope.EsquemasClientes.length - 1].Nombre == "") {
                    ...
                    $scope.EsquemasClientes.push({ 'Clave': "", 'Nombre': "", 'EsquemaID': "", 'Estado': "", 'Editable': "0" });
                }
            }
        }
        else {
    ...
    $scope.AddCliente = function (Clave, Nombre, EsquemaID) {
        ...
        if (!aux) {
            $scope.EsquemasCliNuevo.push({ 'Clave': Clave, 'Nombre': Nombre, 'EsquemaID': EsquemaID, 'Estado': 1, 'Editable': "0" });
        }
        else {
    ...
    $scope.AddFinalC = function () {
        for (var i = 0; i < $scope.EsquemasCliNuevo.length; i++) {
            ...
            if (!aux) {
                $scope.EsquemasClientes.push({ 'Clave': $scope.EsquemasCliNuevo[i].Clave, 'Nombre': $scope.EsquemasCliNuevo[i].Nombre, 'EsquemaID': $scope.EsquemasCliNuevo[i].EsquemaID, 'Estado': 1, 'Editable': "0" });
            }
        }
        //$scope.Ordenar();
        $scope.EsquemasCliNuevo = [];
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ////Remover Elemento de la lista y agregarlo a la final
    $scope.RemoverModulo = function (index, Clave) {
        ...
        if ($scope.EsquemasModulos.length > 0) {
            ...
            if (aux == true) {
                ...
                if ($scope.EsquemasModulos[$scope.EsquemasModulos.length - 1].Nombre == "") {
                    ...
                    $scope.EsquemasModulos.push({ 'Modulo': "", 'Nombre': "", 'Estado': "", 'AplicaDescuento': "0", 'Editable': "0" });
                }
            }
        }
        else {
    ...
    $scope.AddFinalM = function () {
        for (var i = 0; i < $scope.EsquemasModNuevo.length; i++) {
            ...
            if (!aux) {
                $scope.EsquemasModulos.push({ 'Modulo': $scope.EsquemasModNuevo[i].Modulo, 'Nombre': $scope.EsquemasModNuevo[i].Nombre, 'Estado': $scope.EsquemasModNuevo[i].Estado, 'AplicaDescuento': "0", 'Editable': "1" });
            }
        }
        //$scope.Ordenar();
        $scope.EsquemasModNuevo = [];
    ...
    //Editar Promoción
    $scope.EditarPromocion = function (Clave, Permiso, SoloLectura) {
        $scope.Permiso = Permiso;
        if (Clave != "") {
            $http({
