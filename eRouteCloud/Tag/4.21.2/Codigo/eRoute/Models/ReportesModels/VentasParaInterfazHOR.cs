...
namespace eRoute.Models.ReportesModels
{
    public class VentasParaInterfazHOR
    {
        ...
        public bool GetReport(string FechaInicial, string FechaFinal, string Vendedor)
        {
            try
            {
                //Fecha
        ...
        private ArchivoXlsModel GenerarExcel(string FechaIni, string FechaFin, List<VentasParaInterfaz> Detalle)
        {
            ...
            string fileName = "VentasParaInterfaz_" + DateTime.Now.ToString("ddMMyyyy_hhmmss") + ".xlsx";
