...
namespace eRoute.Models.ReportesModels
{
    public class InformecCienteSINVisitaVenta
    {
        ...
        public XtraReport GetReport(string pvCondicion, string pvCondicion1, string pvCondicion2, string pvCondicion3, string pvCondicion4, string pvCondicion5, string RutasSplit, string FechaInicial, string FechaFinal, string Cedis, string nombreCedis, string Presupuesto, string promocion)
        {
            try
            {
                ...
                if (clientesVV.Count != 0)
                {
                    ...
                    report.logo1.Image = Image.FromStream(mStream);
                    report.logo1.Sizing = DevExpress.XtraPrinting.ImageSizeMode.StretchImage;
                    report.logo2.Image = Image.FromStream(mStream);
                    report.logo2.Sizing = DevExpress.XtraPrinting.ImageSizeMode.StretchImage;
