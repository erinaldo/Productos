...
namespace eRoute.Models.ReportesModels
{
    public class ImproductividadXCliente
    {
        ...
        public XtraReport GetReport(string pvCondicion, string pvCondicion1, string RutasSplit, string FechaInicial, string FechaFinal, string NomCEDI, string NomReporte, string Cedis)
        {
