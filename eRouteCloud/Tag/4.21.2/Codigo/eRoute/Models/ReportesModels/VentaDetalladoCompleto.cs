...
namespace eRoute.Models.ReportesModels
{
    public class VentaDetalladoCompleto
    {
        ...
        public XtraReport GetReport(string pvCondicion, string RutasSplit, string ClientesSplit, string FechaInicial, string Cedis, bool detallado,int nPresupuesto)
        {
            try { 
