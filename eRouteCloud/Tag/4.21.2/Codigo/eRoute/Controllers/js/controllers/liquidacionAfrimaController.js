(function () {
    angular
        .module('eRouteApp')
        .controller('liquidacionAfrimaController', liquidacionAfrimaController)
    liquidacionAfrimaController.$inject = ['$scope', '$http', '$mdToast', '$q', '$timeout', 'NgMap', 'cfpLoadingBar', '$filter', "menuServices", "reportServices", "valorReferencia"];

    function liquidacionAfrimaController($scope, $http, $mdToast, $q, $timeout, NgMap, cfpLoadingBar, $filter, menuServices, reportServices, valorReferencia) {
