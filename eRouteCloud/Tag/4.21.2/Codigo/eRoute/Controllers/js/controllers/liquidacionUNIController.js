(function () {
    angular
        .module('eRouteApp')
        .controller('liquidacionUNIController', liquidacionUNIController)
    liquidacionUNIController.$inject = ['$scope', '$http', '$mdToast', '$q', '$timeout', 'NgMap', 'cfpLoadingBar', '$filter', "menuServices", "reportServices"];

    function liquidacionUNIController($scope, $http, $mdToast, $q, $timeout, NgMap, cfpLoadingBar, $filter, menuServices, reportServices) {
