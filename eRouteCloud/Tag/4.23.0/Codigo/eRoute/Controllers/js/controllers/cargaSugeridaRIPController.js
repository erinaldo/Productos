(function () {
    angular
        .module('eRouteApp')
        .controller('cargaSugeridaRIPController', cargaSugeridaRIPController)
    cargaSugeridaRIPController.$inject = ['$scope', '$http', '$mdToast', '$q', '$timeout', 'NgMap', 'cfpLoadingBar', '$filter', "menuServices", "reportServices", "valorReferencia"];

    function cargaSugeridaRIPController($scope, $http, $mdToast, $q, $timeout, NgMap, cfpLoadingBar, $filter, menuServices, reportServices, valorReferencia) {
