(function () {
    angular
        .module('eRouteApp')
        .controller('resumenTiempoMovimientoController', resumenTiempoMovimientoController)
    resumenTiempoMovimientoController.$inject = ['$scope', '$http', '$mdToast', '$q', '$timeout', 'NgMap', 'cfpLoadingBar', '$filter', "menuServices", "reportServices", "valorReferencia"];

    function resumenTiempoMovimientoController($scope, $http, $mdToast, $q, $timeout, NgMap, cfpLoadingBar, $filter, menuServices, reportServices, valorReferencia) {
