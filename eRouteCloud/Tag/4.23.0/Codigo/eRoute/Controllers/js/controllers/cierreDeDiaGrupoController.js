(function () {
    angular
        .module('eRouteApp')
        .controller('cierreDeDiaGrupoController', cierreDeDiaGrupoController)
    cierreDeDiaGrupoController.$inject = ['$scope', '$http', '$mdToast', '$q', '$timeout', 'NgMap', 'cfpLoadingBar', '$filter', "menuServices", "reportServices", "valorReferencia"];

    function cierreDeDiaGrupoController($scope, $http, $mdToast, $q, $timeout, NgMap, cfpLoadingBar, $filter, menuServices, reportServices, valorReferencia) {
        ...
        function SubmitForm(Cedis, dateStatus, Routes, Clientes, pvEsFecha, campoFecha) {
            ...
            if (countRoutes <= 0 || countSellers <= 0) {
                ...
                //    //}, function errorCallBack(response) {
                //    //});
                //    if (response.data.Cedis == undefined)
                //        response.data.Cedis = "";
