(function () {
    angular
        .module('eRouteApp')
        .controller('movimientosPorLoteDELController', movimientosPorLoteDELController)
    movimientosPorLoteDELController.$inject = ['$scope', '$http', '$mdToast', '$q', '$timeout', 'NgMap', 'cfpLoadingBar', '$filter', "menuServices", "reportServices", "valorReferencia"];

    function movimientosPorLoteDELController($scope, $http, $mdToast, $q, $timeout, NgMap, cfpLoadingBar, $filter, menuServices, reportServices, valorReferencia) {
        ...
        self.GetLotes = function (estado) {
            ...
            $http({
                url: url + '/API/GetModel/GetLots?estado=' + estado,
                method: 'GET',
                headers: {
