            ...
            try
            {
                ...
                switch (VAVClave)
                {
                    ...
                    case 37:
                        ...
                        break;
                    case 46:
                        response = new ClientesPorRuta().GetReport(ReportName, CompanyName, CompanyLogo, NameCEDIS, CEDIS, StatusDate, InitialDate, FinalDate, Routes, Sellers, ReportFilter);
                        break;
                    case 52:
                    ...
                    case 79: //Encuestas Disposur
                        ...
                        if (!rptEnc.GetReport(nombreReport, CompanyName, VAVClave, CENClave, FechaInicial, FechaFinal, Rutas))
                            response = null;
                        break;
                    case 53:
                    ...
                    case 130:
                        ...
                        response = new MPedidosPreventaDetallado().GetReport(nombreReport, CompanyName, pvCondicion, pvCondicion1, pvCondicion2, Vendedor, FechaInicial, FechaFinal, nombreCedis, Cedis, Presupuesto);
                        break;
                    case 135:
                        response = new MReportedeSincronizacion().GetReport(nombreReport, CompanyName, pvCondicion, RutasSplit, FechaInicial, FechaFinal, Cedis, nombreCedis, Presupuesto, promocion);
                        break;
                    case 136:
                        if (Rutas != "")
                        {
                    ...
                    case 153:
                        ...
                        response = new LibroRutaVitere().GetReport(nombreReport, CompanyName, pvCondicion, pvCondicion1, RutasSplit, FechaInicial, FechaFinal, nombreCedis);
                        break;
                    case 157:
                        if (Rutas != "")
                        {
                    ...
                    case 227:
                        ...
                        response = new VentasBYD().GetReport(nombreReport, CompanyName, VAVClave, pvCondicion, RutasSplit, VendedorSplit, ClientesSplit, FechaInicial, FechaFinal, Cedis, nombreCedis);
                        break;
                    case 228:
                    ...
                    case 241:
                        ...
                        break;
                    case 242:
                        response = new MLiquidacionPDR().GetReport(ReportName, CompanyName, CompanyLogo, NameCEDIS, CEDIS, StatusDate, InitialDate, Sellers);
                        break;
                    case 243:
                        if (Rutas == "")
                        {
