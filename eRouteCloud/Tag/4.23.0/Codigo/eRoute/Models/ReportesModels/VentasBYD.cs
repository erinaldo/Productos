...
namespace eRoute.Models.ReportesModels
{
    public class VentasBYD
    {
        ...
        public XtraReport GetReport(string NombreReporte, string NombreEmpresa, int VAVClave, string pvCondicion, string RutasSplit, string VendedorSplit, string ClienteSplit, string FechaInicial, string FechaFinal, string Cedis, string nombreCedis)
        {
            try
            {
                //Logo Empresa
