...
namespace eRoute.Models.ReportesModels
{
    public class ComparativoVentaMensualMOO
    {
        ...
        public ArchivoXlsModel GetReport(string NombreReporte, string NombreEmpresa, int VAVClave, string nombreCedis, string pvCondicion, string FechaInicial, string FechaFinal, string Cedis, string unidadMedida, string sFechaAnioActual, string sFechaAnioAnterior)
        {
            try
            {
                ...
                createCell(2, ref Rows, "A2", CellValues.String, "Reporte: " + NombreReporte);
                ...
                sheet.Name = NombreReporte.Substring(0,31);//el nombre de la hoja no puede de mas de 31 caracteres
                sheet.SheetId = 1;
