(function () {
    ...
    clientesNoVisitadosMapFilterController.$inject = ['$scope', '$http', '$mdToast', '$q', '$timeout', 'cfpLoadingBar', "mapServices"];

    function clientesNoVisitadosMapFilterController($scope, $http, $mdToast, $q, $timeout, cfpLoadingBar, mapServices) {
