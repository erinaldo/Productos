app.controller('r021MovSinInventarioEnVisitaGUAController', ['valorReferencia', '$http', 'cfpLoadingBar', function (valorReferencia, $http, cfpLoadingBar) {
    ...
    self.Submit = function () {
        ...
        if (self.selectedClientScheme != undefined) {
            scheme = GetArrayValues(self.schemes, self.selectedClientScheme);
        }
        else if (!self.selectAllClients) {
