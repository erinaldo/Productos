app.controller('r066ClientesYActivosController', ['valorReferencia', '$http', 'cfpLoadingBar', function (valorReferencia, $http, cfpLoadingBar) {
    ...
    self.Submit = function () {
        ...
        if (routes.length <= 0 && !self.selectAllRoutes && self.selectedSeller === undefined) {
            ...
            var data = {
                ...
                Routes: routes,
                Customers: clients,
                ReportType: self.inactCustomers
            }
