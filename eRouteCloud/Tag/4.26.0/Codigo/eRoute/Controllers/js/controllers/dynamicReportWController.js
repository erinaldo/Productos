app
    ...
    .controller('dynamicReportWController', ['$scope', 'valorReferencia', 'reportServices', '$http', 'cfpLoadingBar', function ($scope, valorReferencia, reportServices, $http, cfpLoadingBar) {
        var self = this;
        ...
        function FiltersRequired() {
            ...
            //});
            self.filtersList = [
                { "TipoFiltro": 1, "Opciones": "RSAA", "Descripcion": "CEDI" },
                { "TipoFiltro": 2, "Opciones": "RMAE", "Descripcion": "RUTA" },
                { "TipoFiltro": 3, "Opciones": "RSIE", "Descripcion": "VENDEDOR" },
                { "TipoFiltro": 4, "Opciones": "RIAE", "Descripcion": "FECHA" },
                { "TipoFiltro": 6, "Opciones": "OSAI", "Descripcion": "ESQCLI" },
                { "TipoFiltro": 7, "Opciones": "OMAI", "Descripcion": "CLIENTE" }
            ];
            self.GetConditionedFilter();
        }
