(function () {
    ...
    ctrReporte.$inject = ['$scope', '$http', '$mdToast', '$q', '$timeout', 'NgMap', 'cfpLoadingBar', '$filter', "valorReferencia"];

    function ctrReporte($scope, $http, $mdToast, $q, $timeout, NgMap, cfpLoadingBar, $filter, valorReferencia) {
