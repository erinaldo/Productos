...
namespace eRoute.Models.ReportesModels
{
    public class CoberturaPorProductoMOR
    {
        ...
        public ArchivoXlsModel GetReport(string NombreReporte, string NombreEmpresa, string nombreCedis, string FechaInicial, string FechaFinal, string Cedis, string whereAlmacen, string whereFechaDia, string whereEsquema, int vavclave, string dateStatus, string unidadMedida, string pvProductos, string nombreProductos)
        {
