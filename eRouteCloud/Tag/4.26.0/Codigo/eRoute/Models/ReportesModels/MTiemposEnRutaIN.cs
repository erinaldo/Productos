...
namespace eRoute.Models.ReportesModels
{
    public class MTiemposEnRutaIN
    {
        ...
        public XtraReport GetReport(string NombreReporte, string NombreEmpresa, string pvCondicion, string RutasSplit, string FechaInicial, string FechaFinal, string pvCondicionKm)
        {
            #region reporte
