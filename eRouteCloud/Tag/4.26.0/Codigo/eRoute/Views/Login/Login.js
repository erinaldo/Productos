           ...
           function SendLogin() {
               ...
               .then(function (data) {
                   $http.post(VirtualPath + '/Login/SetSession', {
                       ...
                       USUId: data.data.USUId,
                       PERClave: data.data.PERClave
                   })
                   .then(function (data2) {                      
                       if (data2.status === 200) {
                           window.sessionStorage.setItem('Clave', data.data.Clave);
                           window.sessionStorage.setItem('PERClave', data.data.PERClave);
                           window.sessionStorage.setItem('USUId', data.data.USUId);
