...
public class VentaDiarioCOS : DevExpress.XtraReports.UI.XtraReport
{
    ...
    public XtraReport GetReport(string NombreReporte, string NombreEmpresa, MemoryStream LogoEmpresa, string NombreVendedor, string NombreCEDIS, string CEDIS, string Rutas, string Vendedores, string FechaInicial, string FechaFinal, bool FiltroReporte)
    {
...
"uta])) / ToDouble([].Sum([TotalClienteFueraRuta])))";
    ...
    private int CountRows()
    {
        ...
        List<object> objectData = Connection.Query<object>(QueryString, null, null, true, 9000).ToList();
