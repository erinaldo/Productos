...
namespace eRoute.Models.ReportesModels
{
    public class PromocionClientesMOR
    {
        ...
        public XtraReport GetReport(string NombreReporte, string NombreEmpresa, string ftPromo, string ftAlmacen, string ftRuta, string ftFecha, string ftFechaCentro, string promocion, string nombreCedis, string Rutas, string FechaInicial, string FechaFinal)
        {
            try
            {
