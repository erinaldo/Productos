...
namespace eRoute.Models.ReportesModels
{
    public class PromocionesMOR
    {
        ...
        public ArchivoXlsModel GetReport(string NombreReporte, string NombreEmpresa, string nombreCedis, string FechaInicial, string FechaFinal, string Cedis, string pvCondition, string sFecha, int VAVClave)
        {
            try
            {
