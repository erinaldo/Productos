(function () {
    angular
        .module('eRouteApp')
        .controller('inventarioAlmacenController', inventarioAlmacenController)
    inventarioAlmacenController.$inject = ['$scope', '$http', '$mdToast', '$q', '$timeout', 'NgMap', 'cfpLoadingBar', '$filter', "menuServices", "reportServices", "valorReferencia"];

    function inventarioAlmacenController($scope, $http, $mdToast, $q, $timeout, NgMap, cfpLoadingBar, $filter, menuServices, reportServices, valorReferencia) {
