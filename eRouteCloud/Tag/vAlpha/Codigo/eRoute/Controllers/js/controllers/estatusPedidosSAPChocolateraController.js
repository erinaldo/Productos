(function () {
    angular
        .module('eRouteApp')
        .controller('estatusPedidosSAPChocolateraController', estatusPedidosSAPChocolateraController)
    estatusPedidosSAPChocolateraController.$inject = ['$scope', '$http', '$mdToast', '$q', '$timeout', 'NgMap', 'cfpLoadingBar', '$filter', "menuServices", "reportServices", "valorReferencia"];

    function estatusPedidosSAPChocolateraController($scope, $http, $mdToast, $q, $timeout, NgMap, cfpLoadingBar, $filter, menuServices, reportServices, valorReferencia) {
