(function () {
    angular
        .module('eRouteApp')
        .controller('r130PedidosPreventaDetalladoController', r130PedidosPreventaDetalladoController)
    r130PedidosPreventaDetalladoController.$inject = ['$scope', '$http', 'cfpLoadingBar', '$filter', "valorReferencia"];

    function r130PedidosPreventaDetalladoController($scope, $http, cfpLoadingBar, $filter, valorReferencia) {
