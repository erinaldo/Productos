(function () {
    ...
    listaDeSurtimientoCOSController.$inject = ['$scope', '$http', 'cfpLoadingBar', '$filter', "valorReferencia"];

    function listaDeSurtimientoCOSController($scope, $http, cfpLoadingBar, $filter, valorReferencia) {
