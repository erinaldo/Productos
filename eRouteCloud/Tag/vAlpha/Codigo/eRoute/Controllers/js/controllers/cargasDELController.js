(function () {
    ...
    cargasController.$inject = ['$scope', '$http', '$mdToast', '$q', '$timeout', 'NgMap', 'cfpLoadingBar', '$filter', "menuServices", "reportServices", "valorReferencia"];

    function cargasController($scope, $http, $mdToast, $q, $timeout, NgMap, cfpLoadingBar, $filter, menuServices, reportServices, valorReferencia) {
        ...
        function SubmitForm(Cedis, dateStatus, Routes, Clientes, pvEsFecha, campoFecha, lote) {
            ...
            if (ctrl.Lote == undefined || ctrl.Lote == "") {
                alert("Ingrese el lote");
                cfpLoadingBar.complete();
            }
            else if (countRoutes <= 0 || countSellers <= 0) {
