(function () {
    angular
        .module('eRouteApp')
        .controller('indicadoresDeVentaController', indicadoresDeVentaController)
    indicadoresDeVentaController.$inject = ['$scope', '$http', '$mdToast', '$q', '$timeout', 'NgMap', 'cfpLoadingBar', '$filter', "menuServices", "reportServices", "valorReferencia"];

    function indicadoresDeVentaController($scope, $http, $mdToast, $q, $timeout, NgMap, cfpLoadingBar, $filter, menuServices, reportServices, valorReferencia) {
        ...
        function SubmitForm(Cedis, Routes, Sellers) {
