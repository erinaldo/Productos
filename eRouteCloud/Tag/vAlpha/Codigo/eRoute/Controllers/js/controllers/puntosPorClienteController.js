(function () {
    ...
    puntosPorClienteController.$inject = ['$scope', '$http', '$mdToast', '$q', '$timeout', 'NgMap', 'cfpLoadingBar', '$filter', "menuServices", "reportServices", "valorReferencia"];

    function puntosPorClienteController($scope, $http, $mdToast, $q, $timeout, NgMap, cfpLoadingBar, $filter, menuServices, reportServices, valorReferencia) {
        ...
        ctrl.CountClients = function () {
            ...
            if (count == ctrl.ListClients.length) {
                $scope.selectAllClients = true;
            } else {
                $scope.selectAllClients = false;
            }
