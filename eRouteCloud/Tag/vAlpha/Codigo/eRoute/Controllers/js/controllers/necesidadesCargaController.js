(function () {
    angular
        .module('eRouteApp')
        .controller('necesidadesCargaController', necesidadesCargaController)
    necesidadesCargaController.$inject = ['$scope', '$http', '$mdToast', '$q', '$timeout', 'NgMap', 'cfpLoadingBar', '$filter', "menuServices", "reportServices", "valorReferencia"];


    function necesidadesCargaController($scope, $http, $mdToast, $q, $timeout, NgMap, cfpLoadingBar, $filter, menuServices, reportServices, valorReferencia) {
