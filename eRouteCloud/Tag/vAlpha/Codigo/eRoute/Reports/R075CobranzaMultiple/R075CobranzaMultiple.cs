...
/// <summary>
/// Summary description for R075CobranzaMultiple
/// </summary>
public class R075CobranzaMultiple : DevExpress.XtraReports.UI.XtraReport
{
    ...
    public XtraReport GetReport(string NombreReporte, string NombreEmpresa, MemoryStream LogoEmpresa, string NombreVendedor, string NombreCEDIS, string CEDIS, string Vendedores, string FechaInicial, string FechaFinal)
   {
    ...
    private void InitializeComponent()
    {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(R075CobranzaMultiple));
            ...
            queryParameter4.Value = new DevExpress.DataAccess.Expression("[Parameters.parameterFechaFinal]", typeof(string));
            ...
            this.reportHeaderBand1.HeightF = 100.2083F;
            ...
            this.parameterFechaFinal.ValueInfo = "2019-12-26";
            ...
            this.xrSubreport2.LocationFloat = new DevExpress.Utils.PointFloat(430.4583F, 0F);
            ...
            this.xrSubreport2.ParameterBindings.Add(new DevExpress.XtraReports.UI.ParameterBinding("parameterVENDEDOR", this.parameterVendedores));
            this.xrSubreport2.ParameterBindings.Add(new DevExpress.XtraReports.UI.ParameterBinding("parameterFINICIO", this.parameterFechaInicial));
            this.xrSubreport2.ParameterBindings.Add(new DevExpress.XtraReports.UI.ParameterBinding("parameterFFINAL", this.parameterFechaFinal));
            this.xrSubreport2.ReportSource = new R075CobranzaMultiple3();
            this.xrSubreport2.SizeF = new System.Drawing.SizeF(647.8749F, 23F);
            // 
            // xrSubreport1
            // 
            this.xrSubreport1.Dpi = 100F;
            this.xrSubreport1.LocationFloat = new DevExpress.Utils.PointFloat(0.6249905F, 0F);
            ...
            this.xrSubreport1.ParameterBindings.Add(new DevExpress.XtraReports.UI.ParameterBinding("parameterVENDEDOR", this.parameterVendedores));
            this.xrSubreport1.ParameterBindings.Add(new DevExpress.XtraReports.UI.ParameterBinding("parameterFINICIO", this.parameterFechaInicial));
            this.xrSubreport1.ParameterBindings.Add(new DevExpress.XtraReports.UI.ParameterBinding("parameterFFINAL", this.parameterFechaFinal));
            this.xrSubreport1.ReportSource = new R075CobranzaMultiple1();
            this.xrSubreport1.SizeF = new System.Drawing.SizeF(429.8333F, 23F);
            // 
            // R075CobranzaMultiple
            // 
            ...
            this.DataField});
            this.Version = "16.1";
            this.DataSourceDemanded += new System.EventHandler<System.EventArgs>(this.CobranzaMtp_DataSourceDemanded);
            this.BeforePrint += new System.Drawing.Printing.PrintEventHandler(this.CobranzaMtp_BeforePrint);
    ...
    private int CountRows()
    {
        ...
        sConsulta.AppendLine("EXEC [dbo].[stpr_Reporte75Cobranza] ");
    ...
    private void CobranzaMtp_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
    {
    ...
    private void CobranzaMtp_DataSourceDemanded(object sender, EventArgs e)
    {
