...
namespace eRoute.Models.ReportesModels
{
    public class DescargaEnvaseALT
    {
        ...
        public ArchivoXlsModel GetReport(string nombreReport, string FechaInicial, string FechaFinal, string sCondicion, string sCondicion2, string RutasSplit)
        {
            try
            {
                ...
                createCell(1, ref Rows, "A1", CellValues.String, nombreReport);

                createRow(2, ref Rows);
                createCell(2, ref Rows, "A2", CellValues.String, "Fecha");
                createCell(2, ref Rows, "B2", CellValues.String, sFecha.ToString("dd/MM/yyyy") + ((sFechaFin == sFecha)? "": " - "+  sFechaFin.ToString("dd/MM/yyyy")));

                createRow(3, ref Rows);
                createCell(3, ref Rows, "A3", CellValues.String, "Ruta");
                createCell(3, ref Rows, "B3", CellValues.String, RutasSplit);
                ...
                sheet.Name = nombreReport.Substring(0, 31);
                sheet.SheetId = 1;
