...
namespace eRoute.Models.ReportesModels
{
    public class VentasporCodigoDetalladoUNI
    {
        ...
        public XtraReport GetReport(int VAVClave, string nombreReport, bool detallado, string pvCondicion, string sEsquemasProd, string nombreProductos, string RutasSplit, string pvProductos, string FechaInicial, string Cedis, string nombreCedis, string unidadMedida)
        {
            try
            {
                //Logo Empresa
            ...
            {
                return new ReporteVentasporCodigoDetalladoUNI();
            }
        }
