            ...
            else if (ctrl.date1 > ctrl.maxDate)
            {
                ...
                .success(function (data, status, headers, config) {
                    if (data.Cedis == undefined)
                        data.Cedis = "";
                    window.open(url + "/Reports/Ver?VAVClave=" + data.VAVClave + "&nombreReport=" + data.nombreReport + "&nombreCedis=" + data.nombreCedis + "&FechaInicial=" + data.FechaInicial + "&dateStatus=" + data.Rango + "&detallado=false", "_blank");                    
                    cfpLoadingBar.complete();
                })
