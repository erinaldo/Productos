(function () {
    angular
        .module('eRouteApp')
        .controller('ventaDetalladoCompletoController', ventaDetalladoCompletoController)
    ventaDetalladoCompletoController.$inject = ['$scope', '$http', '$mdToast', '$q', '$timeout', 'NgMap', 'cfpLoadingBar', '$filter', "menuServices", "reportServices"];

    function ventaDetalladoCompletoController($scope, $http, $mdToast, $q, $timeout, NgMap, cfpLoadingBar, $filter, menuServices, reportServices) {
        ...
        function SubmitForm(Cedis, dateStatus, Routes, Clientes, pvEsFecha, campoFecha) {
            ...
            if (ctrl.presupuesto === undefined) {
                alert("El presupuesto no debe de estar vacio");
                cfpLoadingBar.complete();
            } else if (isNaN(ctrl.presupuesto)) {
                alert("El presupuesto debe de ser un número valido");
                cfpLoadingBar.complete();
            } else if (ctrl.presupuesto < 0) {
                alert("El presupuesto debe de ser mayor a cero.");
                cfpLoadingBar.complete();
            }
            else if (ctrl.routeOne === undefined) {
