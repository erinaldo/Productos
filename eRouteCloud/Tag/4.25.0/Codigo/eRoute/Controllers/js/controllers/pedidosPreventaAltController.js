app.controller('pedidosPreventaAltController', ['$scope', '$mdToast', '$q', '$timeout', 'valorReferencia', '$http', 'cfpLoadingBar', function ($scope, $mdToast, $q, $timeout, valorReferencia, $http, cfpLoadingBar) {
    var ctrl = this;
    ...
    function SubmitForm(Cedis, dateStatus, Routes, Clientes, pvEsFecha, campoFecha) {
        ...
        if (countRoutes <= 0 || countSellers <= 0) {
            ...
            var data = {
                ...
                end: moment(ctrl.date1).format('YYYY-MM-DD'),
