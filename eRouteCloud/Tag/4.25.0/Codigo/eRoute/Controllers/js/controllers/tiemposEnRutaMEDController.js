app.controller('tiemposEnRutaMEDController', ['$scope', 'valorReferencia', '$http', 'cfpLoadingBar', function ($scope, valorReferencia, $http, cfpLoadingBar) {
    ...
    self.SubmitForm = function () {
        ...
        if (rutas.length <= 0 && !$scope.selectAll && vendedores.length <= 0 && !$scope.selectAllSellers) {
            ...
            var data = {
                ...
                FinalDate: self.date2 ? moment(self.date2).format('YYYY-MM-DD') : moment(self.date1).format('YYYY-MM-DD'),
