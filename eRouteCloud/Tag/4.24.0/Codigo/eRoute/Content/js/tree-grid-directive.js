        ...
        .run([
            ...
            function ($templateCache) {
                $templateCache.put('template/treeGrid/treeGrid.html',
                    ...
                    "<a  ng-if=\"!expandingProperty.cellTemplate\" ng-show=\"functDel == 'Index'\" class=\"indented tree-label trash-seg\"  ng-click=\"on_click_del(row.branch)\"><i class=\"fa fa-trash-o fa-lg\" aria-hidden=\"true\"></i></a>\n" +
                    ...
                    "              ng-dblclick=\"on_user_dblclick(row.branch)\" ng-click=\"on_user_click(row.branch)\" compile=\"expandingProperty.cellTemplate\"></span>" +
                    "              <span  ng-if=\"!expandingProperty.cellTemplate\" class=\"indented tree-label\" ng-click=\"on_user_click(row.branch)\" ng-dblclick=\"on_user_dblclick(row.branch)\">\n" +
            ...
            function ($timeout,
                ...
                return {
                    ...
                    link: function (scope, element, attrs) {
                        ...
                        scope.dirDel = scope.functDel;
                        scope.on_user_dblclick = function (branch) {
                            if (scope.onDblClick) {
                                scope.onDblClick({
                                    branch: branch
                                });
                        ...
                        scope.on_click_del = function (branch) {
