...
namespace eRoute.Models.ReportesModels
{
    public class MIndicadoresDeVenta
    {
        ...
        public XtraReport GetReport(string NombreReporte, string NombreEmpresa, string Cedi, string FechaInicial, string FechaFinal, string Vendedor, string Ruta, string NombreCedis, string VendedorSplit, string RutasSplit)
        {
            try
            {
