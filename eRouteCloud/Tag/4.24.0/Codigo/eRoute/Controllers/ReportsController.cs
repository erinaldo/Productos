...
namespace eRoute.Controllers
{
    public class ReportsController : Controller
    {
        ...
        public ActionResult SetCondition(List<GetModel>[] dataListObject, string[] dataList, List<GetModel> Routes, List<GetModel> Customers, List<GetModel> Sellers, List<GetModel> Lots, List<GetModel> Products, List<GetModel> Supervisors, List<GetModel> ProductSchemes, List<GetModel> CustomerSchemes, List<GetModel> PriceList, List<GetModel> Polls, List<GetModel> ObjectName, List<GetModel> Warehouses, int VAVClave = 0, bool ReportType = false, bool ReportFilter = false, string InitialDate = "", string FinalDate = "", string CEDIS = "", string NameCEDIS = "", int Budget = 0, string ReportName = "", string Promotion = "", string UnitMeasure = "", string StatusDate = "")
        {
            try
            {
            ...
            try
            {
                ...
                switch (VAVClave)
                {
                    ...
                    case 265:
                        ...
                        if (!excel.GetReport(CompanyName, ReportName, listObject, query, parameters))
                            response = null;
                        break;
                    case 266:
