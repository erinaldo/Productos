(function () {
    angular
        .module('eRouteApp')
        .controller('coberturaPorProductoMorController', coberturaPorProductoMorController)
    coberturaPorProductoMorController.$inject = ['$scope', '$http', '$mdToast', '$q', '$timeout', 'NgMap', 'cfpLoadingBar', '$filter', "menuServices", "reportServices", "valorReferencia"];

    function coberturaPorProductoMorController($scope, $http, $mdToast, $q, $timeout, NgMap, cfpLoadingBar, $filter, menuServices, reportServices, valorReferencia) {
