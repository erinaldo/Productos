(function () {
    angular
        .module('eRouteApp')
        .controller('r016VentaEsquemaProductoController', r016VentaEsquemaProductoController)
    r016VentaEsquemaProductoController.$inject = ['$scope', '$http', '$mdToast', '$q', '$timeout', 'NgMap', 'cfpLoadingBar', '$filter', "menuServices", "reportServices", "valorReferencia"];

    function r016VentaEsquemaProductoController($scope, $http, $mdToast, $q, $timeout, NgMap, cfpLoadingBar, $filter, menuServices, reportServices, valorReferencia) {
