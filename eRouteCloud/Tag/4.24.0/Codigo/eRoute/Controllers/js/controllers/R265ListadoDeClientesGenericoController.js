(function () {
    angular
        .module('eRouteApp')
        .controller('R265ListadoDeClientesGenericoController', R265ListadoDeClientesGenericoController)
    R265ListadoDeClientesGenericoController.$inject = ['$scope', '$http', 'cfpLoadingBar', "valorReferencia"];

    function R265ListadoDeClientesGenericoController($scope, $http, cfpLoadingBar, valorReferencia) {
        ...
        self.GetRoutes = function (cedis) {
            ...
            }).success(function (dataCedis, headers) {
                $http({
