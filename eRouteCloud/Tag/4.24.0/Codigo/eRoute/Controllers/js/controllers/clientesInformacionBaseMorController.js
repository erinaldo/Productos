(function () {
    angular
        .module('eRouteApp')
        .controller('clientesInformacionBaseMorController', clientesInformacionBaseMorController)
    clientesInformacionBaseMorController.$inject = ['$scope', '$http', '$mdToast', '$q', '$timeout', 'NgMap', 'cfpLoadingBar', '$filter', "menuServices", "reportServices", "valorReferencia"];

    function clientesInformacionBaseMorController($scope, $http, $mdToast, $q, $timeout, NgMap, cfpLoadingBar, $filter, menuServices, reportServices, valorReferencia) {
