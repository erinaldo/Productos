(function () {
    angular
        .module('eRouteApp')
        .controller('r266ListaDePreciosGenericoController', r266ListaDePreciosGenericoController)
    r266ListaDePreciosGenericoController.$inject = ['$scope', '$http', 'cfpLoadingBar', "valorReferencia"];

    function r266ListaDePreciosGenericoController($scope, $http, cfpLoadingBar, valorReferencia) {
        ...
        function GetPriceList() {
            ...
            self.priceList = null;
            $http({
                url: url + '/API/GetModel/GetPriceList',
                method: 'GET',
                headers: {
