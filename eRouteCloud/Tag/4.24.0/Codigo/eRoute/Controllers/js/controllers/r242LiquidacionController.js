(function () {
    angular
        .module('eRouteApp')
        .controller('r242LiquidacionController', r242LiquidacionController)
    r242LiquidacionController.$inject = ['$scope', '$http', 'cfpLoadingBar', '$filter', "valorReferencia"];

    function r242LiquidacionController($scope, $http, cfpLoadingBar, $filter, valorReferencia) {
