(function () {
    angular
        .module('eRouteApp')
        .controller('ventaDetalladaMorController', ventaDetalladaMorController)
    ventaDetalladaMorController.$inject = ['$scope', '$http', '$mdToast', '$q', '$timeout', 'NgMap', 'cfpLoadingBar', '$filter', "menuServices", "reportServices", "valorReferencia"];

    function ventaDetalladaMorController($scope, $http, $mdToast, $q, $timeout, NgMap, cfpLoadingBar, $filter, menuServices, reportServices, valorReferencia) {
