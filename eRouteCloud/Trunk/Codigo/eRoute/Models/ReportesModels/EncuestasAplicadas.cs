...
namespace eRoute.Models.ReportesModels
{
    public class EncuestasAplicadas
    {
        ...
        public bool GetReport(string NombreReporte, string NombreEmpresa, int Reporte, string CENClave, string FechaInicial, string FechaFinal, string Rutas)
        {
                ...
                sConsulta.AppendLine("SET @FechaIni = '" + FechaInicial + "' ");
                sConsulta.AppendLine("SET @FechaFin = '" + FechaFinal + "' ");
