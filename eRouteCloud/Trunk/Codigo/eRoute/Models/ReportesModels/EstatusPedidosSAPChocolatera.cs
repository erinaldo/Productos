...
namespace eRoute.Models.ReportesModels
{
    public class EstatusPedidosSAPChocolatera
    {
        ...
        public XtraReport GetReport(string NombreReporte, string NombreEmpresa, string pvCondicion, string FechaInicial, string FechaFinal, string NombreCedis, string Vendedor)
        {
            #region reporte
