...
namespace eRoute.Models.ReportesModels
{
    public class CierreDeDiaGrupoMOR
    {
        ...
        public ArchivoXlsModel GetReport(string NombreReporte, string NombreEmpresa, int VAVClave, string nombreCedis, string pvCondicion, string FechaInicial, string FechaFinal, string Cedis, string unidadMedida)
        {
            ...
            createCell(2, ref Rows, "A2", CellValues.String, NombreReporte, false);
