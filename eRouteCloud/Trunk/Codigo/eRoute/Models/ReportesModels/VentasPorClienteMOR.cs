...
namespace eRoute.Models.ReportesModels
{
    public class VentasPorClienteMOR
    {
        ...
        public ArchivoXlsModel GetReport(string NombreReporte, string NombreEmpresa, string nombreCedis, string FechaInicial, string FechaFinal, string Cedis, string sFecha1, int vavclave, string dateStatus, string unidadMedida, string pvProductos, string nombreProductos, string sEsquemasProd, string pvCondicion, string pvCondicionProd, string RutasSplit)
        {
            ...
            List<VPCMORClientesModel> Clientes = Connection.Query<VPCMORClientesModel>(QueryString, null, null, true, 5000).ToList();
            if (Clientes.Count() <= 0)
            {
                return null;
            }
            ...
            List<VPCMORProductosModel> Productos = Connection.Query<VPCMORProductosModel>(QueryString, null, null, true, 5000).ToList();
            ...
            List<VPCMORTotalProductosModel> TotalProductos = Connection.Query<VPCMORTotalProductosModel>(QueryString, null, null, true, 5000).ToList();
