app.controller('informeVentasROVController', ['$scope', '$mdToast', '$q', '$timeout', 'valorReferencia', '$http', 'cfpLoadingBar', function ($scope, $mdToast, $q, $timeout, valorReferencia, $http, cfpLoadingBar) {
    ...
    function SubmitForm(Cedis) {
        ...
        if (self.State == undefined) {
            ...
            var data = {
                ...
                Routes: rutas,
                Sellers: vendedores,
                ClientsSchemes: EsquemaCli,
                Clients: Clientes,
                ProductsSchemes: EsquemaPro,
            }
