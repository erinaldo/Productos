app.controller('r133ArrastreInventarioALTController', ['valorReferencia', '$http', 'cfpLoadingBar', function (valorReferencia, $http, cfpLoadingBar) {
    ...
    self.GetDates = function () {
        ...
        $http({
            ...
            self.State = self.dateState[1].Nombre;
    ...
    self.OnChangeProEnv = function () {
        self.ResetItems();
        if (self.selectedSwitchProEnv) {
            self.textSwitchProEnv = 'Producto';
        } else {
            self.textSwitchProEnv = 'Envase';
        }
    }
    ...
    self.Submit = function () {
        ...
        if (self.State === undefined) {
            ...
            var data = {
                ...
                ReportType: self.selectedSwitchProEnv
            }
