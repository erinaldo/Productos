app.controller('descargaEnvaseAltController', ['$scope', '$mdToast', '$q', '$filter', '$timeout', 'menuServices', 'valorReferencia', '$http', 'cfpLoadingBar', function ($scope, $mdToast, $q, $filter, $timeout, menuServices, valorReferencia, $http, cfpLoadingBar) {
