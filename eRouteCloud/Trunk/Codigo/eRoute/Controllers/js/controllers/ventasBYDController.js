app.controller('ventasBYDController', ['$scope', '$mdToast', '$q', '$timeout', 'valorReferencia', '$http', 'cfpLoadingBar', function ($scope, $mdToast, $q, $timeout, valorReferencia, $http, cfpLoadingBar) {
    ...
    self.GetClients = function (routes, sellers) {
        ...
        $scope.selectAllClients = false;
        $http({
            url: url + '/API/GetReportFilters/GetClients?routes=' + routes + '&sellers=' + sellers,
            method: 'GET',
            headers: {
                Authorization: window.sessionStorage.getItem('Token'),
                'Content-Type': 'application/json'
