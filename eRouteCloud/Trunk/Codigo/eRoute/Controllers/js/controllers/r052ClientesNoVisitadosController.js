app.controller('r052ClientesNoVisitadosController', ['$scope', 'valorReferencia', '$http', 'cfpLoadingBar', function ($scope, valorReferencia, $http, cfpLoadingBar) {
    ...
    function SubmitForm() {
        ...
        if (routes.length <= 0) {
            ...
            var data = {
                ...
                FinalDate: (self.date2 == undefined ? self.date2 : moment(self.date2).format('YYYY-MM-DD')),
                Routes: routes
            }
