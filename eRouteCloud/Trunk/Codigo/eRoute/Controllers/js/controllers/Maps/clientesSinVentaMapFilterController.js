(function () {
    ...
    clientesSinVentaMapFilterController.$inject = ['$scope', '$http', '$mdToast', '$q', '$timeout', 'cfpLoadingBar', "mapServices"];

    function clientesSinVentaMapFilterController($scope, $http, $mdToast, $q, $timeout, cfpLoadingBar, mapServices) {
