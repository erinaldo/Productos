...
app.controller('crtlValorReferencia', ["$scope", "$http", 'valorReferencia', "messageBox", "translationService", function ($scope, $http, valorReferencia, messageBox, translationService) {
        ...
        if (VARCodigo != "") {
            $http({
                ...
                angular.forEach(data, function (it) {
                    ...
                    $scope.TipoAplicacion = it.TipoAplicacion.toString();
    ...
    $scope.EliminarValor = function (value) {
        ...
        $scope.catch = { message: error, status: status };
        console.log($scope.catch);
    });
    }
    ...
    function ObtenerValores() {
        ...
        $http({
            ...
            var tam = $scope.valoresReferencia.length;
...
app.factory('valorReferencia', ["$http", function ($http) {
    ...
    return {
        ...
        'obtenerFiltros': function (callback) {
            var url = window.sessionStorage.getItem('URL');
            $http({
                url: url + '/api/ValorReferencia/ObtenerFiltros',
                method: 'GET',
                headers: {
                    Authorization: window.sessionStorage.getItem('Token'),
                    'Content-Type': 'application/json'
        ...
        'obtenerFiltrosDinamicos': function (VAVClave, callback) {
            var url = window.sessionStorage.getItem('URL');
            $http({
                url: url + '/api/ValorReferencia/ObtenerFiltrosDinamicos?RepDinID=' + VAVClave,
                method: 'GET',
                headers: {
                    Authorization: window.sessionStorage.getItem('Token'),
                    'Content-Type': 'application/json'
