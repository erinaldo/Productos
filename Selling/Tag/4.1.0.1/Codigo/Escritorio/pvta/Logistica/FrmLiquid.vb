...
#End Region
                    ...
                    If b.DialogResult = DialogResult.OK Then
                        If Not b.drAbonos Is Nothing AndAlso b.drAbonos.Length > 0 Then
                            ...
                            For i = 0 To b.drAbonos.Length - 1
                                ModPOS.Aplica_Pagos(dtDoctos, dtDoctos.Rows(0)("CTEClave"), b.drAbonos(i)("ID"), b.drAbonos(i)("TipoPago"), b.drAbonos(i)("Saldo"), CAJClave, b.drAbonos(i)("Tipo"))
                            Next
                        End If
                    End If
                End If
                            ...
                            Select Case CInt(cmbTipo.SelectedValue)
                                ...
                                Case Is = 2 'Factura
                                    ...
                                    If foundRows(0)("TipoCF") = 2 AndAlso foundRows(0)("Estado") = "Activa" Then
                                        ...
                                        If ModPOS.cancelarXML(dtPAC, sFolio, sUUID, eRFC, sVersionCF) = False Then
                                            Exit Sub
                                        End If
        ...
        If validaTransaccion() Then
            If sDocumentoSelected <> "" Then
                ...
                If cmbTipo.SelectedValue = 2 Then
                    ...
                    ModPOS.SendMail(VersionCF, sMailCliente, iTipoCF, FormatoFactura, dFecha, sFolio, sDocumentoSelected, dTotalDoc, MailAdress, MailUser, MailPassword, HostSMTP, MailPort, MailSSL, DisplayName, PathXML, SUCClave, TipoCambio, MonRef, MonDesc)

                   
                ElseIf cmbTipo.SelectedValue = 3 Then


                    ModPOS.SendMailNC(VersionCF, sMailCliente, iTipoCF, FormatoNC, dFecha, sFolio, sDocumentoSelected, dTotalDoc, MailAdress, MailUser, MailPassword, HostSMTP, MailPort, MailSSL, DisplayName, PathXML, SUCClave, TipoCambio, MonDesc, MonRef, True)


                  
                ElseIf cmbTipo.SelectedValue = 5 Then

                    ModPOS.SendMailCargo(VersionCF, sMailCliente, FormatCargo, dFecha, sFolio, sDocumentoSelected, dTotalDoc, MailAdress, MailUser, MailPassword, HostSMTP, MailPort, MailSSL, DisplayName, PathXML, TipoCambio, MonDesc, MonRef, True)
    ...
    Private Sub Imprimir()
        ...
        If cmbTipo.SelectedValue = 2 Then
            ...
            ModPOS.previewFactura(iTipoCF, sFormato, sDocumentoSelected, dTotalDoc, SUCClave, TipoCambio, MonDesc, MonRef, sVersionCF)


        ElseIf cmbTipo.SelectedValue = 3 Then

            ModPOS.previewNC(iTipoCF, sFormato, sDocumentoSelected, dTotalDoc, SUCClave, TipoCambio, MonDesc, MonRef, sVersionCF)

           

        ElseIf cmbTipo.SelectedValue = 5 Then ' Nota Cargo

            ModPOS.previewCargo(sFormato, sDocumentoSelected, dTotalDoc, TipoCambio, MonDesc, MonRef, sVersionCF)
