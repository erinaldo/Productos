...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents txtOtroPagos As System.Windows.Forms.TextBox
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.txtOtroPagos = New System.Windows.Forms.TextBox()
        ...
        'TxtRef
        '
        Me.TxtRef.Location = New System.Drawing.Point(580, 187)
        Me.TxtRef.Name = "TxtRef"
        Me.TxtRef.Size = New System.Drawing.Size(177, 20)
        Me.TxtRef.TabIndex = 101
        '
        'LblNoCta
        '
        Me.LblNoCta.Location = New System.Drawing.Point(362, 190)
        Me.LblNoCta.Name = "LblNoCta"
        Me.LblNoCta.Size = New System.Drawing.Size(230, 16)
        Me.LblNoCta.TabIndex = 102
        Me.LblNoCta.Text = "No. Cta, Tarjeta, Teléfono celular o CLABE"
        '
        'CmbMetodoPago
        '
        ...
        Me.LblSubtotal.Location = New System.Drawing.Point(8, 508)
        Me.LblSubtotal.Name = "LblSubtotal"
        Me.LblSubtotal.Size = New System.Drawing.Size(84, 15)
        Me.LblSubtotal.TabIndex = 98
        Me.LblSubtotal.Text = "Percepciones"
        '
        'LblIVA
        '
        ...
        Me.LblIVA.Location = New System.Drawing.Point(220, 508)
        ...
        Me.TxtDeducciones.Location = New System.Drawing.Point(297, 503)
        Me.TxtDeducciones.Name = "TxtDeducciones"
        Me.TxtDeducciones.ReadOnly = True
        Me.TxtDeducciones.Size = New System.Drawing.Size(98, 26)
        ...
        Me.TxtIngreso.Location = New System.Drawing.Point(87, 502)
        Me.TxtIngreso.Name = "TxtIngreso"
        Me.TxtIngreso.ReadOnly = True
        Me.TxtIngreso.Size = New System.Drawing.Size(127, 26)
        ...
        Me.Label1.Location = New System.Drawing.Point(401, 507)
        Me.Label1.Name = "Label1"
        Me.Label1.Size = New System.Drawing.Size(54, 15)
        Me.Label1.TabIndex = 100
        Me.Label1.Text = "O. Pagos"
        '
        'txtOtroPagos
        '
        Me.txtOtroPagos.Anchor = CType((System.Windows.Forms.AnchorStyles.Bottom Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        Me.txtOtroPagos.Enabled = False
        Me.txtOtroPagos.Font = New System.Drawing.Font("Microsoft Sans Serif", 12.0!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.txtOtroPagos.Location = New System.Drawing.Point(464, 502)
        Me.txtOtroPagos.Name = "txtOtroPagos"
        Me.txtOtroPagos.ReadOnly = True
        Me.txtOtroPagos.Size = New System.Drawing.Size(108, 26)
        Me.txtOtroPagos.TabIndex = 99
        Me.txtOtroPagos.TextAlign = System.Windows.Forms.HorizontalAlignment.Right
        '
        'FrmReciboNomina
        '
        ...
        Me.Controls.Add(Me.txtOtroPagos)
...
#Region "Variables Publicas"
    ...
    Public Deducciones, OtrosPagos As Double
...
#Region "Variables Privadas"
    ...
    Private formaDePago, Referencia As String
    Private metodoDePago As Integer
    ...
    Private dtDetalle, dtIncapacidad, dtHorasExtra, dtAcciones, dtJubilacion, dtSeparacion, dtCompensacion As DataTable
...
#Region "ReciboNomina"
    ...
    Private Sub FrmReciboNomina_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Padre = "Agregar" Then
            ...
            dtAcciones = ModPOS.CrearTabla("Acciones", _
                                           ...
                                           "PrecioAlOtorgante", "System.Double", _
                                            "CONClave", "System.String", _
                                            "REDClave", "System.String")
            ...
            dtJubilacion = ModPOS.CrearTabla("Jubilacion", _
                                           ...
                                           "IngresoNoAcumulable", "System.Double", _
                                            "CONClave", "System.String", _
                                                   "REDClave", "System.String")
        ...
        Else
            ...
            metodoDePago = IIf(dt.Rows(0)("MetodoPago").GetType.Name = "DBNull", 0, dt.Rows(0)("MetodoPago"))
            ...
            CmbMetodoPago.SelectedValue = metodoDePago
            ...
            dtAcciones = ModPOS.Recupera_Tabla("sp_recupera_accion", "@RENClave", RENClave)
            dtJubilacion = ModPOS.Recupera_Tabla("sp_recupera_jubilacion", "@RENClave", RENClave)
            dtSeparacion = ModPOS.Recupera_Tabla("sp_recupera_separacion", "@RENClave", RENClave)
            dtCompensacion = ModPOS.Recupera_Tabla("sp_recupera_compensacion", "@RENClave", RENClave)

        End If



        If CmbMetodoPago.SelectedValue = 5 OrElse CmbMetodoPago.SelectedValue = 6 Then
    ...
    Private Sub actualizaTotales()
        Dim fI, fD, fO As Janus.Windows.GridEX.GridEXFilterCondition
        ...
        fO = New Janus.Windows.GridEX.GridEXFilterCondition(col, Janus.Windows.GridEX.ConditionOperator.Equal, 3)
        ...
        Deducciones = GridDetalle.GetTotal(GridDetalle.CurrentTable.Columns(5), Janus.Windows.GridEX.AggregateFunction.Sum, fD)
        OtrosPagos = GridDetalle.GetTotal(GridDetalle.CurrentTable.Columns(5), Janus.Windows.GridEX.AggregateFunction.Sum, fO)

        TotalaPagar = PercepcionesGravadas + PercepcionesExentas - Deducciones + OtrosPagos

        TxtIngreso.Text = Format(CStr(ModPOS.Redondear(PercepcionesGravadas + PercepcionesExentas, 2)), "Currency")
        TxtDeducciones.Text = Format(CStr(ModPOS.Redondear(Deducciones, 2)), "Currency")
        txtOtroPagos.Text = Format(CStr(ModPOS.Redondear(OtrosPagos, 2)), "Currency")
    ...
    Public Sub AddAcciones( _
    ByVal dValorMarcado As Double, _
    ByVal dPrecioOtorgante As Double, _
     ByVal sCONClave As String, _
    ByVal sREDClave As String)
        ...
        'declara el nombre de la fila
        row1.Item("ValorMercado") = dValorMarcado
        row1.Item("PrecioAlOtorgante") = dPrecioOtorgante
        row1.Item("CONClave") = sCONClave
        row1.Item("REDClave") = sREDClave
    ...
    Public Sub AddJubilacion( _
     ByVal sTipo As String, _
     ByVal dImporte As Double, _
     ByVal dMontoDiario As Double, _
     ByVal dIngresoAcumulable As Double, _
     ByVal dIngresoNoAcumulable As Double, _
      ByVal sCONClave As String, _
    ByVal sREDClave As String)
        ...
        row1.Item("MontoDiario") = dMontoDiario
        row1.Item("IngresoAcumulable") = dIngresoAcumulable
        row1.Item("IngresoNoAcumulable") = dIngresoNoAcumulable
        row1.Item("CONClave") = sCONClave
        row1.Item("REDClave") = sREDClave
    ...
    Public Sub AddSeparacion( _
     ByVal dTotalPagado As String, _
     ByVal iNumAños As Integer, _
     ByVal dUltimoSueldo As Double, _
     ByVal dIngresoAcumulable As Double, _
     ByVal dIngresoNoAcumulable As Double, _
      ByVal sCONClave As String, _
    ByVal sREDClave As String)
        ...
        row1.Item("TotalPagado") = dTotalPagado
        row1.Item("AñosServicio") = iNumAños
        row1.Item("UltimoSueldo") = dUltimoSueldo
        row1.Item("IngresoAcumulable") = dIngresoAcumulable
        row1.Item("IngresoNoAcumulable") = dIngresoNoAcumulable
        row1.Item("CONClave") = sCONClave
        row1.Item("REDClave") = sREDClave
    ...
    Public Sub AddCompensaciones( _
    ByVal dSaldoFavor As Double, _
    ByVal iAño As Integer, _
    ByVal dRemanente As Double, _
     ByVal sCONClave As String, _
    ByVal sREDClave As String)
        ...
        'declara el nombre de la fila
        row1.Item("SaldoFavor") = dSaldoFavor
        row1.Item("Año") = iAño
        row1.Item("Remanente") = dRemanente
        row1.Item("CONClave") = sCONClave
        row1.Item("REDClave") = sREDClave
    ...
    Private Sub BtnGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnGuardar.Click
        ...
        If (CmbMetodoPago.SelectedValue = 5 OrElse CmbMetodoPago.SelectedValue = 6) Then
            If TxtRef.Text.Length < 10 Then
                Beep()
                MessageBox.Show("La referencia debe contener al menos 10 carates o digitos.Se puede registrar el número de cuenta bancaria (11 posiciones), número de teléfono celular (10 posiciones), número de tarjeta de crédito, débito o de servicios (15 o 16 posiciones), la CLABE (18 posiciones), o número de monedero electrónico, en donde el empleador realiza el depósito de la nómina al trabajador", "Error", MessageBoxButtons.OK, MessageBoxIcon.Stop)
                Exit Sub
            End If
        Else
            TxtRef.Text = ""
        ...
        If cmbBanco.SelectedValue Is Nothing AndAlso (CmbMetodoPago.SelectedValue = 5 OrElse CmbMetodoPago.SelectedValue = 6) Then
            Beep()
        ...
        Select Case Me.Padre
            Case "Agregar"
                ...
                metodoDePago = CmbMetodoPago.SelectedValue
               
                Referencia = TxtRef.Text

                If cmbBanco.SelectedValue Is Nothing OrElse Not (CmbMetodoPago.SelectedValue = 5 OrElse CmbMetodoPago.SelectedValue = 6) Then
                    TipoBanco = 0
                Else
                ...
                ModPOS.Ejecuta("sp_inserta_reciboNomina", _
                                   ...
                                   "@VersionCF", VersionCF, _
                                    ...
                                    "@TotalDeducciones", Deducciones, _
                                    "@TotalOtrosPagos", OtrosPagos, _
                ...
                If dtAcciones.Rows.Count > 0 Then
                    For fila = 0 To dtAcciones.Rows.Count - 1
                        ModPOS.Ejecuta("sp_inserta_acciones", _
                                            "@REDClave", dtAcciones.Rows(fila)("REDClave"), _
                                            "@ValorMercado", dtAcciones.Rows(fila)("ValorMercado"), _
                                            "@PrecioAlOtorgante", dtAcciones.Rows(fila)("PrecioAlOtorgante"))
                    Next
                End If

                If dtJubilacion.Rows.Count > 0 Then
                    For fila = 0 To dtJubilacion.Rows.Count - 1
                        ModPOS.Ejecuta("sp_inserta_jubilaciones", _
                                            "@REDClave", dtJubilacion.Rows(fila)("REDClave"), _
                                            "@Tipo", dtJubilacion.Rows(fila)("Tipo"), _
                                            "@Importe", dtJubilacion.Rows(fila)("Importe"), _
                                            "@MontoDiario", dtJubilacion.Rows(fila)("MontoDiario"), _
                                            "@IngresoAcumulable", dtJubilacion.Rows(fila)("IngresoAcumulable"), _
                                            "@IngresoNoAcumulable", dtJubilacion.Rows(fila)("IngresoNoAcumulable"))
                    Next
                End If


                If dtSeparacion.Rows.Count > 0 Then
                    For fila = 0 To dtSeparacion.Rows.Count - 1
                        ModPOS.Ejecuta("sp_inserta_separaciones", _
                                            "@REDClave", dtSeparacion.Rows(fila)("REDClave"), _
                                            "@TotalPagado", dtSeparacion.Rows(fila)("TotalPagado"), _
                                            "@AñosServicio", dtSeparacion.Rows(fila)("AñosServicio"), _
                                            "@UltimoSueldo", dtSeparacion.Rows(fila)("UltimoSueldo"), _
                                            "@IngresoAcumulable", dtSeparacion.Rows(fila)("IngresoAcumulable"), _
                                            "@IngresoNoAcumulable", dtSeparacion.Rows(fila)("IngresoNoAcumulable"))
                    Next
                End If
                ...
                If dtCompensacion.Rows.Count > 0 Then
                    For fila = 0 To dtSeparacion.Rows.Count - 1
                        ModPOS.Ejecuta("sp_inserta_compensaciones", _
                                            "@REDClave", dtCompensacion.Rows(fila)("REDClave"), _
                                            "@SaldoFavor", dtCompensacion.Rows(fila)("SaldoFavor"), _
                                            "@Año", dtCompensacion.Rows(fila)("Año"), _
                                            "@Remanente", dtCompensacion.Rows(fila)("Remanente"))
                    Next
                End If
                guardado = True
                Me.Close()
            ...
            Case "Modificar"
                ...
                If Not (editado = False AndAlso _
                    CmbMetodoPago.SelectedValue = metodoDePago AndAlso _
...
#End Region
        ...
        If GridDetalle.Row >= 0 Then
            ...
            Select Case MessageBox.Show("Se eliminara del recibo de nómina actual el concepto :" & GridDetalle.GetValue("Concepto"), "Advertencia", MessageBoxButtons.YesNo, MessageBoxIcon.Warning)
                Case DialogResult.Yes
                    ...
                    foundRows = dtAcciones.Select("CONClave = '" & sCONCLAVE & "'")
                    If foundRows.Length > 0 Then
                        For i = 0 To foundRows.GetUpperBound(0)
                            dtAcciones.Rows.Remove(foundRows(i))
                        Next
                    End If

                    foundRows = dtJubilacion.Select("CONClave = '" & sCONCLAVE & "'")
                    If foundRows.Length > 0 Then
                        For i = 0 To foundRows.GetUpperBound(0)
                            dtJubilacion.Rows.Remove(foundRows(i))
                        Next
                    End If

                    foundRows = dtSeparacion.Select("CONClave = '" & sCONCLAVE & "'")
                    If foundRows.Length > 0 Then
                        For i = 0 To foundRows.GetUpperBound(0)
                            dtSeparacion.Rows.Remove(foundRows(i))
                        Next
                    End If

                    foundRows = dtCompensacion.Select("CONClave = '" & sCONCLAVE & "'")
                    If foundRows.Length > 0 Then
                        For i = 0 To foundRows.GetUpperBound(0)
                            dtCompensacion.Rows.Remove(foundRows(i))
                        Next
                    End If
    ...
    Private Sub CmbMetodoPago_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CmbMetodoPago.SelectedIndexChanged
        If cargado = True AndAlso (CmbMetodoPago.SelectedValue = 5 OrElse CmbMetodoPago.SelectedValue = 6) Then
            cmbBanco.Visible = True
            TxtRef.Visible = True
            cmbBanco.SelectedValue = TipoBanco
        Else
