...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.GrpMoneda.Size = New System.Drawing.Size(513, 103)
        ...
        Me.PictureBox2.Location = New System.Drawing.Point(336, 48)
        ...
        Me.ChkEstado.Location = New System.Drawing.Point(362, 16)
        ...
        'TxtDescripcion
        '
        Me.TxtDescripcion.Location = New System.Drawing.Point(107, 46)
        ...
        Me.PictureBox1.Location = New System.Drawing.Point(233, 18)
        ...
        Me.Label4.Location = New System.Drawing.Point(233, 25)
        ...
        Me.GrpDenominaciones.Location = New System.Drawing.Point(7, 111)
        Me.GrpDenominaciones.Name = "GrpDenominaciones"
        Me.GrpDenominaciones.Size = New System.Drawing.Size(618, 218)
        ...
        Me.GridDenominaciones.Size = New System.Drawing.Size(509, 195)
...
#End Region
    ...
    Private Function validaForm() As Boolean
        ...
        If CDbl(Me.NumTipoCambio.Text) = 0 Then
            i += 1
        ...
        If validaForm() Then
            Select Case Me.Padre
                Case "Agregar"
                    ...
                    TipoCambio = Math.Abs(CDbl(NumTipoCambio.Text))
                    ModPOS.Ejecuta("sp_inserta_moneda", "@MONClave", MONClave, "@Referencia", Referencia, "@Descripcion", Descripcion, "@TipoCambio", TipoCambio, "@Usuario", ModPOS.UsuarioActual)
                ...
                Case "Modificar"
                    If Not (Estado = ChkEstado.GetEstado AndAlso Descripcion = TxtDescripcion.Text AndAlso TipoCambio = Math.Abs(CDbl(NumTipoCambio.Text))) Then

                        Me.Descripcion = UCase(Trim(Me.TxtDescripcion.Text))
                        Me.Estado = ChkEstado.GetEstado
                        TipoCambio = Math.Abs(CDbl(NumTipoCambio.Text))

                        ModPOS.Ejecuta("sp_actualiza_moneda", "@MONClave", MONClave, "@Descripcion", Descripcion, "@Estado", Estado, "@TipoCambio", TipoCambio, "@Usuario", ModPOS.UsuarioActual)
