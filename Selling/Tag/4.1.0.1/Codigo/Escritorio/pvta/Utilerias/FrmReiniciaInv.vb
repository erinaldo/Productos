...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.GrpClas.Size = New System.Drawing.Size(276, 470)
        ...
        Me.cmbGrupo.Location = New System.Drawing.Point(6, 19)
        ...
        Me.TreeViewClass.Anchor = CType(((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Bottom) _
            Or System.Windows.Forms.AnchorStyles.Left), System.Windows.Forms.AnchorStyles)
        Me.TreeViewClass.Location = New System.Drawing.Point(6, 43)
        Me.TreeViewClass.Name = "TreeViewClass"
        Me.TreeViewClass.Size = New System.Drawing.Size(260, 420)
        ...
        Me.GrpProductos.Location = New System.Drawing.Point(289, 0)
        Me.GrpProductos.Name = "GrpProductos"
        Me.GrpProductos.Size = New System.Drawing.Size(592, 470)
        ...
        Me.lblPorc.Location = New System.Drawing.Point(354, 443)
        Me.lblPorc.Name = "lblPorc"
        Me.lblPorc.Size = New System.Drawing.Size(40, 16)
        ...
        Me.PBar.Name = "PBar"
        Me.PBar.Size = New System.Drawing.Size(276, 21)
        ...
        Me.BtnGuardar.Location = New System.Drawing.Point(496, 427)
        ...
        Me.BtnCancelar.Location = New System.Drawing.Point(400, 427)
        ...
        Me.GridProductos.Size = New System.Drawing.Size(579, 330)
...
#End Region
    ...
    Private Sub ActualizaDetalle(ByVal Tipo As Integer, ByVal iClase As Integer)
        ...
        If Tipo = 1 Then
                dtConteo = ModPOS.Recupera_Tabla("sp_consulta_productos", "@Class", iClase, "@ALMClave", CmbAlmacen.SelectedValue)
        Else
            dtConteo = ModPOS.Recupera_Tabla("sp_busca_prod", "@Campo", CmbCampo.SelectedValue, "@Busca", TxtBuscar.Text.ToUpper.Trim, "@ALMClave", CmbAlmacen.SelectedValue, "@Char", cReplace)
        End If
        ...
        If dtConteo.Rows.Count > 0 Then
            ...
            GridProductos.RootTable.Columns("Exist").FormatString = "0.00"
    ...
    Private Sub FrmReinicaInv_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Cargado = True
        ActualizaDetalle(1, TreeViewClass.TopNode.Tag)
