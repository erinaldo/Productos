                        ...
                        Case Is = "Factura"
                            ...
                            Select Case sFormato
                                Case Is = "Clasico"
                                    ...
                                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_sello_fac", "@FACClave", foundRows(i)("ID")("FACClave")))


                                    Select Case iTipoCF
                                        Case Is = 1
                                            pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_metodopago_fac", "@FACClave", foundRows(i)("ID")("FACClave")))
                                            OpenReport.Print(iCopias, "CRIngresoCFD.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(foundRows(i)("Total") / TipoCambio, 2), MonDesc, MonRef).ToUpper, sImpresora)
                                        Case Is = 2
                                            OpenReport.Print(iCopias, "CRIngresoCFDI.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(foundRows(i)("Total") / TipoCambio, 2), MonDesc, MonRef).ToUpper, sImpresora)
                                        Case Is = 3
                                            pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_metodopago_fac", "@FACClave", foundRows(i)("ID")("FACClave")))
                                            OpenReport.Print(iCopias, "CRIngresoCBB.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(foundRows(i)("Total") / TipoCambio, 2), MonDesc, MonRef).ToUpper, sImpresora)
                                ...
                                Case Is = "Con Notas"
                                    ...
                                    Select Case iTipoCF
                                        Case Is = 1
                                            ...
                                            OpenReport.Print(iCopias, "CRIngresoNCFD.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(foundRows(i)("Total") / TipoCambio, 2), MonDesc, MonRef).ToUpper, sImpresora)
                                        Case Is = 2
                                            OpenReport.Print(iCopias, "CRIngresoNCFDI.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(foundRows(i)("Total") / TipoCambio, 2), MonDesc, MonRef).ToUpper, sImpresora)
                                        Case Is = 3
                                            pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_metodopago_fac", "@FACClave", foundRows(i)("ID")))
                                ...
                                Case Is = "Pagare"
                                    ...
                                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_encabezado_fac_radec", "@FACClave", foundRows(i)("ID")))
                                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_detalle_fac_radec", "@FACClave", foundRows(i)("ID")))
                                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_venta_fac_radec", "@FACClave", foundRows(i)("ID")))
                                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_sello_fac", "@FACClave", foundRows(i)("ID")))

                                    OpenReport.Print(iCopias, "CFDIPagare.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(foundRows(i)("Total") / TipoCambio, 2), MonDesc, MonRef).ToUpper, sImpresora)
                                ...
                                Case Is = "Radec"
                                    ...
                                    OpenReport.Print(iCopias, "CFDFactura.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(foundRows(i)("Total") / TipoCambio, 2), MonDesc, MonRef).ToUpper, sImpresora)
                                ...
                                Case Is = "LaLa"
                                    ...
                                    OpenReport.Print(iCopias, "CFDFacturaLaLa.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(foundRows(i)("Total") / TipoCambio, 2), MonDesc, MonRef).ToUpper, sImpresora)
                                Case Is = "Aseguradora"
                                    ...
                                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_venta_fac_radec", "@FACClave", foundRows(i)("ID")))
                                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_sello_fac", "@FACClave", foundRows(i)("ID")))
                                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_complemento_fac_radec", "@FACClave", foundRows(i)("ID")))

                                    OpenReport.Print(iCopias, "CFDFacturaAseg.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(foundRows(i)("Total") / TipoCambio, 2), MonDesc, MonRef).ToUpper, sImpresora)
                        ...
                        Case Is = "NC"
                            ...
                            Select Case Formato
                                Case Is = "Clasico"
                                    ...
                                    If iTipoCF = 1 Then
                                        OpenReport.Print(iCopias, "CREgresoCFD.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(foundRows(i)("Total") / TipoCambio, 2), MonDesc, MonRef).ToUpper, sImpresora)
                                    ElseIf iTipoCF = 2 Then
                                        OpenReport.Print(iCopias, "CREgresoCFDI.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(foundRows(i)("Total") / TipoCambio, 2), MonDesc, MonRef).ToUpper, sImpresora)

                                    ElseIf iTipoCF = 3 Then
                                        OpenReport.Print(iCopias, "CREgresoCBB.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(foundRows(i)("Total") / TipoCambio, 2), MonDesc, MonRef).ToUpper, sImpresora)
                                    End If
                                Case Is = "Radec"
                                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_encabezado_nc_radec", "@NCClave", foundRows(i)("ID")))
                                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_detalle_nc_radec", "@NCClave", foundRows(i)("ID")))
                                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_sello_nc", "@NCClave", foundRows(i)("ID")))

                                    OpenReport.Print(iCopias, "CFDNotaCredito.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(foundRows(i)("Total") / TipoCambio, 2), MonDesc, MonRef).ToUpper, sImpresora)
                        ...
                        Case Is = "NotaCargo"
                            ...
                            Select Case Formato
                                Case Is = "Clasico"
                                    ...
                                    OpenReport.Print(iCopias, "CRNotaCargo.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(foundRows(i)("Total") / TipoCambio, 2), MonDesc, MonRef).ToUpper, sImpresora)
                                Case Is = "Radec"
                                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_encabezado_cargo_radec", "@CARClave", foundRows(i)("ID")))
                                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_detalle_cargo_radec", "@CARClave", foundRows(i)("ID")))
                                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_sello_cargo", "@CARClave", foundRows(i)("ID")))

                                    OpenReport.Print(iCopias, "CFDNotaCargo.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(foundRows(i)("Total") / TipoCambio, 2), MonDesc, MonRef).ToUpper, sImpresora)
