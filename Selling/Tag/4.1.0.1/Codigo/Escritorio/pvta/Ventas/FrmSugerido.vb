        ...
        If Not dtProductos Is Nothing AndAlso dtProductos.Rows.Count > 0 Then
            ...
            If foundRows.GetLength(0) > 0 Then
                ...
                For i = 0 To foundRows.GetUpperBound(0)
                    ...
                    dt = ModPOS.SiExisteRecupera("sp_venta_producto", "@Tipo", 1, "@Busca", foundRows(i)("Clave"), "@ListaPrecio", ListaPrecio, "@Cantidad", foundRows(i)("Cant"), "@Char", cReplace)
                    ModPOS.Mostradores(numMostrador).AgregaPartida(dt, True, False, False, True, False)
                    dt.Dispose()
                Next
                Me.Close()
            Else
