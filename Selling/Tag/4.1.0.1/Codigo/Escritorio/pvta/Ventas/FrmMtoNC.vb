...
#End Region
    ...
    Private Sub BtnReimpresion_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnReimpresion.Click
        ...
        If foundRows.GetLength(0) = 1 Then
            ...
            ModPOS.previewNC(iTipoCF, FormatNC, foundRows(0)("NCClave"), foundRows(0)("Total"), CmbSucursal.SelectedValue, TipoCambio, MonDesc, MonRef, VersionCF)
        Else
    ...
    Private Sub BtnReNC_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnReNC.Click
        ...
        If foundRows.GetLength(0) > 0 Then
            ...
            For i = 0 To foundRows.GetUpperBound(0)
                ...
                ModPOS.imprimirNC(iTipoCF, FormatNC, foundRows(i)("NCClave"), foundRows(i)("Total"), CmbSucursal.SelectedValue, TipoCambio, MonDesc, MonRef, sImpresora, iCopias, VersionCF)
                ...
                For i = 0 To foundRows.GetUpperBound(0)
                    ...
                    If eMailCte <> "" Then
                        If eMailCte <> "Salir" Then
                            ...
                            sError = ModPOS.SendMailNC(VersionCF, eMailCte, iTipoCF, FormatNC, CDate(foundRows(i)("Fecha")), foundRows(i)("Folio"), foundRows(i)("NCClave"), foundRows(i)("Total"), MailAdress, MailUser, MailPassword, HostSMTP, MailPort, MailSSL, DisplayName, PathXML, sSUCClave, TipoCambio, MonDesc, MonRef, IIf(foundRows.Length = 1, True, False))
                    ...
                    If a.DialogResult = DialogResult.OK Then
                        If a.Autorizado Then
                            ...
                            If TipoCF = 2 AndAlso foundRows(0)("Estado") = "Activa" Then
                                ...
                                Dim eRFC, sCTEClave, VersionCF As String
                                ...
                                If ModPOS.cancelarXML(dtPAC, foundRows(0)("Folio"), sUUID, eRFC, VersionCF) = False Then
                                    Exit Sub
                                End If
                            ...
                            If foundRows(0)("Tipo") = "Devolución" Then
                                ...
                                ModPOS.ActualizaExistAlm(2, 4, foundRows(0)("NCClave"), foundRows(0)("ALMClave"))
                                ModPOS.ActualizaExistUbc(2, 4, foundRows(0)("NCClave"), foundRows(0)("ALMClave"))
                            End If
