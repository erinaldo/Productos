...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.LblClave.Location = New System.Drawing.Point(107, 9)
        ...
        Me.BtnUbicacion.Location = New System.Drawing.Point(602, 6)
        ...
        Me.picKeyboard.Location = New System.Drawing.Point(561, 7)
...
#End Region
    ...
    Private Sub RecalculaPrecio(ByVal obj As String)
        ...
        Select Case obj
            ...
            Case Is = "Cantidad"
                ...
                End If
            Case Is = "Unidad"
                    If KgLt = 1 AndAlso UnidadesKilo <> CDec(TxtUndKg.Text) Then
    ...
    Private Sub FrmAddProducto_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If KgLt = 1 Then
            ...
            If Peso > 0 AndAlso dCantidad > 0 Then
                TxtUndKg.Text = dCantidad / Peso
            Else
                TxtUndKg.Text = 0
            End If
        End If
