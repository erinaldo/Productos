...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.TxtSubtotal.Location = New System.Drawing.Point(335, 497)
        ...
        Me.TxtTotal.Location = New System.Drawing.Point(660, 498)
        ...
        Me.LblTotal.Location = New System.Drawing.Point(600, 505)
        ...
        Me.LblSubtotal.Location = New System.Drawing.Point(296, 503)
...
#End Region
    ...
    Private Sub CargaDetalle()
        ...
        ModPOS.ActualizaGrid(False, Me.GridDetalle, "sp_muestra_detalle_com", "@COVClave", COVClave)
        ...
        TxtSubtotal.Text = Format(Redondear(dSubtotal + dImpuesto, 2).ToString, "Currency")

        TxtTotal.Text = Format(Redondear((CDbl(TxtPorc.Text) / 100) * (dSubtotal + dImpuesto), 2).ToString, "Currency")
    End Sub
    ...
    Private Sub BtnGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnGuardar.Click
        ...
        a.Sucursal = SUCClave
        a.MontodeAutorizacion = CDbl(TxtTotal.Text)
        ...
        imprimeRecibo(CDbl(TxtTotal.Text), Referencia & "-" & CStr(Folio), Impresora, Me.PrintGeneric, Ticket, RazonSocial)
    ...
    Private Sub TxtPorc_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles TxtPorc.Leave
        If CDbl(TxtSubtotal.Text) > 0 And CDbl(TxtPorc.Text) > 0 Then
            TxtTotal.Text = Format(Redondear((CDbl(TxtPorc.Text) / 100) * CDbl(TxtSubtotal.Text), 2).ToString, "Currency")
        End If
    End Sub
