...
#End Region
    ...
    Private Sub BtnGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnGuardar.Click
        ...
        For k = 0 To dtFacturas.Rows.Count - 1
            ...
            If CDec(dtFacturas.Rows(k)("Saldo")) > 0 AndAlso CDec(dtFacturas.Rows(k)("Saldo")) <= CDec(dtFacturas.Rows(k)("Bonificar")) Then
                ModPOS.Ejecuta("sp_paga_documento", _
                               ...
                               "@Pago", CDec(dtFacturas.Rows(k)("Saldo")), _
                               "@AcumulaPuntos", 0, _
                               "@Tipo", -1, _
                               "@Usuario", ModPOS.UsuarioActual)
            ...
            ElseIf CDec(dtFacturas.Rows(k)("Saldo")) > CDec(dtFacturas.Rows(k)("Bonificar")) Then
                ...
                ModPOS.Ejecuta("sp_actualiza_saldo", _
                                "@CAJClave", CAJClave, _
                               "@ABNClave", NCClave, _
                               "@Pago", CDec(dtFacturas.Rows(k)("Bonificar")), _
                               "@TipoDoc", 2, _
                               "@Documento", dtFacturas.Rows(k)("FACClave"), _
                               "@Tipo", -1, _
        ...
        For k = 0 To dtFacturas.Rows.Count - 1
            dtMetodosPago = ModPOS.Recupera_Tabla("st_recupera_metodospago_fac", "@FacturaID", dtFacturas.Rows(k)("FacturaID"))
            If dtMetodosPago.Rows.Count > 0 Then
                If ImportePago = 0 OrElse ImportePago < CDbl(dtMetodosPago.Rows(0)("Importe")) Then
                    ImportePago = CDbl(dtMetodosPago.Rows(0)("Importe"))
