...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'BtnBuscaDev
        '
        Me.BtnBuscaDev.Anchor = CType((System.Windows.Forms.AnchorStyles.Bottom Or System.Windows.Forms.AnchorStyles.Left), System.Windows.Forms.AnchorStyles)
        ...
        'TxtDevolucion
        '
        Me.TxtDevolucion.Anchor = CType((System.Windows.Forms.AnchorStyles.Bottom Or System.Windows.Forms.AnchorStyles.Left), System.Windows.Forms.AnchorStyles)
...
#End Region
    ...
    Private Function imprimeDevolucion(ByVal Devolucion As String, ByVal Impresora As String, ByVal Ticket As String, ByVal Saldo As Double, ByVal Cte As String, ByVal FolioVta As String) As Boolean
        Dim dTotalVenta, dArticulos As Double
    ...
    Private Sub BtnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnOK.Click
        If Not dtDetalle Is Nothing Then
            ...
            If foundRows.GetLength(0) > 0 Then
                ...
                Dim Ref As String = ModPOS.obtenerLlave
                ...
                For i = 0 To foundRows.GetUpperBound(0)
                    ...
                    dSubtotal = Math.Round(foundRows(i)("PrecioBruto") * foundRows(i)("Devolución"), 2)
                    dDescuento = Math.Round(dSubtotal * foundRows(i)("PorcDesc"), 2)
                    dImpuesto = Math.Round((dSubtotal - dDescuento) * foundRows(i)("PorcImp"), 2)
                    ...
                    ModPOS.Ejecuta("sp_inserta_devdet", _
                                    ...
                                    "@Puntos", foundRows(i)("PuntosImp") / foundRows(i)("Devolución"), _
                                    "@Total", dSubtotal - dDescuento + dImpuesto)
                    ...
                    If Stage <> "" Then
                        ...
                        If 1 <> EstadoPEU Then
                            ...
                            row1.Item("Bloquear") = foundRows(i)("Devolución")
                ...
                Else
                    ModPOS.ActualizaExistUbc(1, 3, DEVClave, ALMClave, Stage)
                ...
                If ActivaCaja = True AndAlso Efectivo > 0 Then
                    Select Case MessageBox.Show("¿Desea aplicar un reembolso por " & Format(CStr(ModPOS.Redondear(Efectivo, 2)), "Currency") & "?", "Pregunta", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
