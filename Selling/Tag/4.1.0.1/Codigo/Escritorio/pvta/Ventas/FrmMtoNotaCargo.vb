...
#End Region
    ...
    Private Sub BtnReimpresion_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnReimpresion.Click
        ...
        If foundRows.GetLength(0) = 1 Then
            Imprimir(foundRows(0)("CARClave"), foundRows(0)("Total"))
        Else
    ...
    Private Sub Imprimir(ByVal sCARClave As String, ByVal dTotal As Decimal)
        ...
        ModPOS.previewCargo(FormatCargo, sCARClave, dTotal, TipoCambio, MonDesc, MonRef, VersionCF)
    ...
    Private Sub BtnReFac_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnReCargo.Click
        ...
        If foundRows.GetLength(0) > 0 Then
            ...
            For i = 0 To foundRows.GetUpperBound(0)
                ...
                ModPOS.imprimirCargo(FormatCargo, foundRows(i)("CARClave"), foundRows(i)("Total"), TipoCambio, MonDesc, MonRef, sImpresora, iCopias, VersionCF)
                ...
                For i = 0 To foundRows.GetUpperBound(0)
                    ...
                    If eMailCte <> "" Then
                        If eMailCte <> "Salir" Then
                            ...
                            sError = ModPOS.SendMailCargo(VersionCF, eMailCte, FormatCargo, foundRows(i)("Fecha"), foundRows(i)("Folio"), foundRows(i)("CARClave"), foundRows(i)("Total"), MailAdress, MailUser, MailPassword, HostSMTP, MailPort, MailSSL, DisplayName, PathXML, TipoCambio, MonDesc, MonRef, IIf(foundRows.Length = 1, True, False))
