...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.LblTotal.Location = New System.Drawing.Point(186, 432)
        ...
        Me.LblTot.Font = New System.Drawing.Font("Microsoft Sans Serif", 15.75!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
...
#End Region
                    ...
                    If b.DialogResult = DialogResult.OK Then
                        If Not b.drAbonos Is Nothing AndAlso b.drAbonos.Length > 0 Then
                            ...
                            For i = 0 To b.drAbonos.Length - 1
                                ModPOS.Aplica_Pagos(dtDoctos, sCTEClave, b.drAbonos(i)("ID"), b.drAbonos(i)("TipoPago"), b.drAbonos(i)("Saldo"), CAJClave, b.drAbonos(i)("Tipo"))
                            Next
                        End If
                    End If
                End If
                    ...
                    If a.DialogResult = DialogResult.OK Then
                        If a.detallePago.Rows.Count > 0 Then
                            ...
                            For i = 0 To a.detallePago.Rows.Count - 1
                                ModPOS.Aplica_Pagos(dtDoctos, sCTEClave, a.detallePago.Rows(i)("ABNClave"), a.detallePago.Rows(i)("TipoPago"), a.detallePago.Rows(i)("Saldo"), CAJClave, 1)
                            Next

                            If MessageBox.Show("¿Desea imprimir comprobante de pago?", "Pregunta", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
                                ...
                                pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_encabezado_rec", "@ABNClave", a.detallePago.Rows(0)("ABNClave")))
                                pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_detalle_rec", "@ABNClave", a.detallePago.Rows(0)("ABNClave")))
    ...
    Private Sub GridCxC_CellValueChanged1(ByVal sender As Object, ByVal e As Janus.Windows.GridEX.ColumnActionEventArgs) Handles GridCxC.CellValueChanged
        ...
        Me.LblTotal.Text = Format(CStr(ModPOS.Redondear(dSaldo, 2)), "Currency")
                ...
                For i = 0 To foundRows.GetUpperBound(0)
                    ...
                    Select Case CInt(foundRows(i)("TipoDocumento"))
                        ...
                        Case Is = 6 'Nota de Cargo
                            ...
                            ModPOS.previewCargo(sFormato, foundRows(i)("ID"), foundRows(i)("Total"), TipoCambio, MonDesc, MonRef, sVersionCF)
