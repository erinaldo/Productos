...
#End Region
    ...
    Private Sub BtnConsultar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnConsultar.Click
        ...
        If foundRows.GetLength(0) = 1 Then
            ...
            ModPOS.previewFactura(iTipoCF, sFormato, foundRows(0)("FACClave"), foundRows(0)("Total"), sSUCClave, TipoCambio, MonDesc, MonRef, sVersionCF)
    ...
    Private Sub BtnReFac_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnReFac.Click
        ...
        If foundRows.GetLength(0) > 0 Then
            ...
            For i = 0 To foundRows.GetUpperBound(0)
                ...
                ModPOS.imprimirFactura(iTipoCF, sFormato, foundRows(i)("FACClave"), foundRows(i)("Total"), sSUCClave, TipoCambio, MonDesc, MonRef, sImpresora, iCopias, sVersionCF)
                ...
                For i = 0 To foundRows.GetUpperBound(0)
                    ...
                    If eMailCte <> "" Then
                        If eMailCte <> "Salir" Then
                            ...
                            sError = ModPOS.SendMail(sVersionCF, eMailCte, iTipoCF, sFormato, foundRows(i)("Fecha"), foundRows(i)("Folio"), foundRows(i)("FACClave"), foundRows(i)("Total"), MailAdress, MailUser, MailPassword, HostSMTP, MailPort, MailSSL, DisplayName, PathXML, sSUCClave, TipoCambio, MonRef, MonDesc, IIf(foundRows.Length = 1, True, False))
                ...
                Case DialogResult.Yes
                    ...
                    If a.DialogResult = DialogResult.OK Then
                        If a.Autorizado Then
                            ...
                            Dim eRFC, sCTEClave, CAJClave, Stage As String
                            ...
                            If TipoCF = 2 AndAlso foundRows(0)("Estado") = "Activa" Then
                                ...
                                bCancela = ModPOS.cancelarXML(dtPAC, foundRows(0)("Folio"), sUUID, eRFC, VersionCF)
                            ...
                            ModPOS.ActualizaExistAlm(1, 2, foundRows(0)("FACClave"), ALMClave)
                            If Stage <> "" Then
                                ModPOS.ActualizaExistUbc(1, 2, foundRows(0)("FACClave"), ALMClave, Stage)
                            Else
                                ModPOS.ActualizaExistUbc(1, 2, foundRows(0)("FACClave"), ALMClave)
                            End If
