...
#End Region
    ...
    Private Sub obtenerPrecio()
        If GridProductos.RowCount > 0 AndAlso Not GridProductos.GetValue("ID") Is Nothing Then
            ...
            Me.TxtPrecio.Text = ModPOS.TruncateToDecimal(dt.Rows(0)(0), 2)
            dt.Dispose()
        End If
    End Sub
    ...
    Private Sub BtnAgregar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnAgregar.Click
        ...
        Else
            If bVentaConvencional = False Then
                If Tipo = 1 Then
                    bError = ModPOS.Mostradores(numMostrador).AgregaGTIN(sClave, True, True)
                End If
            Else
                If Padre = "" Then
                    ModPOS.PreVenta.AgregaGTIN(sClave, True, True)
                Else
                    ModPOS.Afiliado.AgregaGTIN(sClave, True, True)
                End If
            End If
        End If
        Me.Close()
