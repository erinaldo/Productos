...
#End Region
    ...
    Private Sub BtnImprimir_Click(sender As Object, e As EventArgs) Handles BtnImprimir.Click
        If sPREClave <> "" Then
            ...
            a.Titulo = "Lista de Precio: " & sListaPrecio
            a.textolbl = "Sucursal"
            ...
            If a.DialogResult = System.Windows.Forms.DialogResult.OK Then
                ...
                pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_rep_lista_precio", "@SUCClave", a.Origen, "@PREClave", sPREClave))
                pvtaDataSet.DataSetName = "reportDataSet"
                OpenReport.PrintPreview(sListaPrecio, "CRvwListaPrecio.rpt", pvtaDataSet, "")
