...
#End Region
    ...
    Private Sub FrmCompra_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        TxtSubtotal.Text = Format(CStr(ModPOS.Redondear(SubTotal, 6)), "Currency")
        TxtDscto.Text = Format(CStr(ModPOS.Redondear(Descuento, 6)), "Currency")
        TxtIVA.Text = Format(CStr(ModPOS.Redondear(Impuesto, 6)), "Currency")
        TxtTotal.Text = Format(CStr(ModPOS.Redondear(Total, 6)), "Currency")
