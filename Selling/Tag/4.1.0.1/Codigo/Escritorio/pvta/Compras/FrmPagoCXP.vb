...
#End Region
    ...
    Private Sub RecuperaFolios()
        ...
        If Not cmbPlazo.SelectedItem Is Nothing Then
            ...
            dtCxP = ModPOS.Recupera_Tabla("sp_recupera_cxp", "@Plazo", cmbPlazo.SelectedItem, "@COMClave", ModPOS.CompanyActual)
    ...
    Private Sub Aplica_NC(ByVal foundRows() As DataRow, ByVal PRVClave As String, ByVal NCPClave As String, ByVal TotalAbono As Double, ByVal SaldoVenta As Double, ByVal TotalCambio As Double)
        Dim i As Integer
                ...
                If b.DialogResult = DialogResult.OK Then
                    If Not b.drAbonos Is Nothing AndAlso b.drAbonos.Length > 0 Then
                        ...
                        For i = 0 To b.drAbonos.Length - 1
                            Aplica_NC(foundRows, foundRows(0)("PRVClave"), b.drAbonos(i)("ID"), b.drAbonos(i)("Saldo"), DSaldo, IIf(b.drAbonos(i)("Saldo") > DSaldo, b.drAbonos(i)("Saldo") - DSaldo, 0))
                        Next
