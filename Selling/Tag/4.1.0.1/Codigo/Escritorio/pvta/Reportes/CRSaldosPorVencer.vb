...
Public Class CRSaldosPorVencer
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRSaldosPorVencer.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRSaldosPorVencer
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRSaldosPorVencer = New CRSaldosPorVencer()
        rpt.Site = Me.Site
        Return rpt
    End Function
