...
Public Class CRNotaCreditoDet
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRNotaCreditoDet.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRNotaCreditoDet
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRNotaCreditoDet = New CRNotaCreditoDet()
        rpt.Site = Me.Site
        Return rpt
    End Function
