...
Public Class CRIngresoNCFD
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRIngresoNCFD.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRIngresoNCFD
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRIngresoNCFD = New CRIngresoNCFD()
        rpt.Site = Me.Site
        Return rpt
    End Function
