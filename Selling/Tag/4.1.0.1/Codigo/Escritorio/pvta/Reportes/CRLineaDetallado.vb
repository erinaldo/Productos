...
Public Class CRLineaDetallado
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRLineaDetallado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRLineaDetallado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRLineaDetallado = New CRLineaDetallado()
        rpt.Site = Me.Site
        Return rpt
    End Function
