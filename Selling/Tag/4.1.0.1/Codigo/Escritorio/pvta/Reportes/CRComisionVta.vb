...
Public Class CRComisionVta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRComisionVta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRComisionVta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRComisionVta = New CRComisionVta()
        rpt.Site = Me.Site
        Return rpt
    End Function
