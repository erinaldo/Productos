...
Public Class CRClienteMensual
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRClienteMensual.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRClienteMensual
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRClienteMensual = New CRClienteMensual()
        rpt.Site = Me.Site
        Return rpt
    End Function
