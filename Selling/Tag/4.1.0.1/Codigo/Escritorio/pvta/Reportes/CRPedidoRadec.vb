...
Public Class CRPedidoRadec
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRPedidoRadec.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRPedidoRadec
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRPedidoRadec = New CRPedidoRadec()
        rpt.Site = Me.Site
        Return rpt
    End Function
