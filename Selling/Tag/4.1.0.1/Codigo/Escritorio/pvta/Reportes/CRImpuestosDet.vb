...
Public Class CRImpuestosDet
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRImpuestosDet.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRImpuestosDet
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRImpuestosDet = New CRImpuestosDet()
        rpt.Site = Me.Site
        Return rpt
    End Function
