...
Public Class CRReciboNomina
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRReciboNomina.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRReciboNomina
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRReciboNomina = New CRReciboNomina()
        rpt.Site = Me.Site
        Return rpt
    End Function
