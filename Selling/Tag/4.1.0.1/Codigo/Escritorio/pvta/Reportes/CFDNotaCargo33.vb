...
Public Class CFDNotaCargo33
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CFDNotaCargo33.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCFDNotaCargo33
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CFDNotaCargo33 = New CFDNotaCargo33()
        rpt.Site = Me.Site
        Return rpt
    End Function
