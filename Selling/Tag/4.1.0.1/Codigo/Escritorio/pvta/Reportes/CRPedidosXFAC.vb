...
Public Class CRPedidosXFAC
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRPedidosXFAC.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRPedidosXFAC
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRPedidosXFAC = New CRPedidosXFAC()
        rpt.Site = Me.Site
        Return rpt
    End Function
