...
Public Class CRMovimientos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRMovimientos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRMovimientos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRMovimientos = New CRMovimientos()
        rpt.Site = Me.Site
        Return rpt
    End Function
