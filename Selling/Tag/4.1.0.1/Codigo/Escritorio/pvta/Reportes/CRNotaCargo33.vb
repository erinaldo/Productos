...
Public Class CRNotaCargo33
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRNotaCargo33.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRNotaCargo33
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRNotaCargo33 = New CRNotaCargo33()
        rpt.Site = Me.Site
        Return rpt
    End Function
