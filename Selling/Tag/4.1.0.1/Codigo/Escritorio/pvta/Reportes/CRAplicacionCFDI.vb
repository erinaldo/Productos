...
Public Class CRAplicacionCFDI
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRAplicacionCFDI.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRAplicacionCFDI
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRAplicacionCFDI = New CRAplicacionCFDI()
        rpt.Site = Me.Site
        Return rpt
    End Function
