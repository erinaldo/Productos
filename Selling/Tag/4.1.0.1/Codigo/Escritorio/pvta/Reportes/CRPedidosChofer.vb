...
Public Class CRPedidosChofer
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRPedidosChofer.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRPedidosChofer
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRPedidosChofer = New CRPedidosChofer()
        rpt.Site = Me.Site
        Return rpt
    End Function
