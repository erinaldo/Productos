...
Public Class CFDFacturaAseg33
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CFDFacturaAseg33.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCFDFacturaAseg33
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CFDFacturaAseg33 = New CFDFacturaAseg33()
        rpt.Site = Me.Site
        Return rpt
    End Function
