...
Public Class CRvwListaPrecio
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRvwListaPrecio.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRvwListaPrecio
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRvwListaPrecio = New CRvwListaPrecio()
        rpt.Site = Me.Site
        Return rpt
    End Function
