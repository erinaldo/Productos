...
Public Class CFDFacturaAseg
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CFDFacturaAseg.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCFDFacturaAseg
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CFDFacturaAseg = New CFDFacturaAseg()
        rpt.Site = Me.Site
        Return rpt
    End Function
