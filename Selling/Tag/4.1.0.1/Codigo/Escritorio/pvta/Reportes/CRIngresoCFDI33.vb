...
Public Class CRIngresoCFDI33
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRIngresoCFDI33.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRIngresoCFDI33
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRIngresoCFDI33 = New CRIngresoCFDI33()
        rpt.Site = Me.Site
        Return rpt
    End Function
