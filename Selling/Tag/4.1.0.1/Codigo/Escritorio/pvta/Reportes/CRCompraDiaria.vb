...
Public Class CRCompraDiaria
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRCompraDiaria.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRCompraDiaria
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRCompraDiaria = New CRCompraDiaria()
        rpt.Site = Me.Site
        Return rpt
    End Function
