...
Public Class CRListaPrecio
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRListaPrecio.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRListaPrecio
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRListaPrecio = New CRListaPrecio()
        rpt.Site = Me.Site
        Return rpt
    End Function
