...
#End Region
    ...
    Private Transito, ReciboRF, Picking, SurtidoRF As Boolean
        ...
        Else
            ...
            If Inventario = True Then
                If Cantidad > Disponible Then
                    MessageBox.Show("La cantidad registrada del producto " & Clave & " excede la cantidad disponible en el almacén origen, el disponible actual es de: " & CStr(Disponible), "Información", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    Exit Sub
                End If
            End If
    ...
    Private Sub BtnGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnGuardar.Click
        If validaForm() Then
            ...
            If EstadoActual = 1 Then
                ...
                If Picking = True And UBCClave = "" Then
                ...
                Else
                    ...
                    ModPOS.Ejecuta("sp_elimina_trasladodetalle", "@TRSClave", TRSClave)
                ...
                If Inventario = True Then
                    ...
                    ElseIf Picking = True Then
                        If VerificaExistencia(8, TRSClave, ALMClave) = False Then
                            Exit Sub
                        End If
                    End If
                End If
                ...
                If Picking = True Then
                    Select Case MessageBox.Show("¿Desea Reimprimir la Hoja de Recolección?", "Pregunta", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
                        Case DialogResult.Yes
                            ModPOS.ImprimirSurtido(8, TRSClave, True, True)
                    End Select
