...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.cmbTipo.Items.AddRange(New Object() {"Traslado", "Compra"})
...
#End Region
        ...
        If Estado < 2 Then
            If validaForm() Then
                ...
                If dRecibido > 0 OrElse Movilidad = True Then
                    ...
                    ModPOS.Ejecuta("sp_act_reciboalmacen", "@IdRecibo", IdRecibo, "@Folio", TxtFolio.Text.ToUpper.Trim, _
                    ...
                    For i = 0 To dtDetalle.Rows.Count - 1
                        ModPOS.Ejecuta("sp_act_reciboAlmacenD", "@IdRecibo", IdRecibo, "@DOCClave", dtDetalle.Rows(i)("DOCClave"), "@Tipo", dtDetalle.Rows(i)("Tipo"), "@DETClave", dtDetalle.Rows(i)("DETClave"), "@Recibido", dtDetalle.Rows(i)("Recibido"), "@TipoRechazo", dtDetalle.Rows(i)("TipoRechazo"), "@Usuario", ModPOS.UsuarioActual, "@UBCClave", dtDetalle.Rows(i)("UBCClave"))
                    Next
    ...
    Private Sub btnFinalizar_Click(sender As Object, e As EventArgs) Handles btnFinalizar.Click
        If Estado = 1 Then
            ...
            If au.DialogResult = DialogResult.OK Then
                If au.Autorizado Then
                    Dim frmStatusMessage As New frmStatus
                    frmStatusMessage.Show("Procesando información...")

                    If Movilidad = False Then
                        'Ingresa a ubicacion asignada en la estrategia.
                        ModPOS.ActualizaExistUbc(1, 9, IdRecibo, ALMClave)
                        ' Ingresa mercancia a almacen 
                        ModPOS.ActualizaExistAlm(1, 9, IdRecibo, ALMClave)
                    End If

                    ModPOS.GeneraMovInv(1, 9, 9, IdRecibo, ALMClave, Folio, au.Autoriza)
    ...
    Private Sub Clock_Tick(sender As Object, e As EventArgs) Handles Clock.Tick
        If Estado < 2 AndAlso Movilidad = False AndAlso GridDetalle.RowCount > 0 Then
            If validaForm() Then
                Dim dRecibido As Double = dtDetalle.Compute("SUM(Recibido)", "")
                If dRecibido > 0 Then
                    BtnGuardar.PerformClick()
                End If
            End If
            ...
            If dRecibido > 0 Then
                ...
                If dtValida.Rows.Count > 0 Then
                    ...
                    If MessageBox.Show("¿Esta seguro de que desea realizar el envio parcial del Recibo actual?.", "Confirmación", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
                        ...
                        foundRows = dtDetalle.Select("Recibido > 0 and Cantidad > Recibido and (TipoRechazo = 0 or TipoRechazo is Null)")
                        If foundRows.GetLength(0) > 0 Then
                            MessageBox.Show("No se ha especificado tipo de Rechazo de los materiales o productos que no fueron recibidos", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                            Exit Sub
                        End If
