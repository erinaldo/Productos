    ...
    Public Sub AgregarFolio()
        If validaForm() Then
            ...
            If Not dtPicking Is Nothing Then
                dtPicking.Dispose()
            End If
            dtPicking = ModPOS.Recupera_Tabla("sp_obtener_picking", "@ALMClave", ALMClave, "@Inicio", Inicio, "@Fin", Fin.AddHours(23.9999), "@PIN", PIN, "@PFN", PFN, "@SurtidoRF", SurtidoRF, "@MostradorRF", MostradorRF)
