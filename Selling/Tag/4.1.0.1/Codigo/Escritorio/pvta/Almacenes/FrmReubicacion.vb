Public Class FrmReubicacion
    ...
    Private Sub recuperar(ByVal ALMClave As String, ByVal Texto As String, ByVal Tipo As Integer)
        ...
        If Tipo = 3 Then
            ...
            dtDestinoManual = ModPOS.Recupera_Tabla("sp_muestra_ubicados", "@Tipo", Tipo, "@ALMClave", ALMClave, "@Clave", Texto.ToUpper.Trim.Replace("'", "''"), "@Char", cReplace)
        ...
        Else
            ...
            dtOrigen = ModPOS.Recupera_Tabla("sp_muestra_ubicados", "@Tipo", Tipo, "@ALMClave", ALMClave, "@Clave", Texto.ToUpper.Trim.Replace("'", "''"), "@Char", cReplace)
            GridOrigen.DataSource = dtOrigen
            GridOrigen.RetrieveStructure()
            GridOrigen.AutoSizeColumns()
            GridOrigen.RootTable.Columns("PROClave").Visible = False
