...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.BtnSalir.Location = New System.Drawing.Point(117, 396)
        ...
        Me.BtnDevolucion.Location = New System.Drawing.Point(230, 396)
        ...
        Me.BtnFacturar.Location = New System.Drawing.Point(343, 396)
        ...
        Me.BtnCancelar.Location = New System.Drawing.Point(456, 396)
        ...
        Me.BtnModificar.Location = New System.Drawing.Point(569, 396)
...
#End Region
    ...
    Public Sub ActualizaGridTransac()
        ...
        dtTran = ModPOS.Recupera_Tabla("sp_recupera_vta_tran", "@PDVClave", PDVClave, "@Inicio", cmbInicio.Value, "@Fin", cmbFin.Value.AddHours(23.9999))
        With GridPedidos
            .DataSource = dtTran
            .RetrieveStructure()
            .AutoSizeColumns()
                    ...
                    Case DialogResult.Yes
                        ...
                        If a.DialogResult = DialogResult.OK Then
                            If a.Autorizado Then
                                ...
                                ModPOS.GeneraMovInv(1, 5, 1, foundRows(0)("VENClave"), ALMClave, foundRows(0)("Folio"), Autoriza)
                                ModPOS.ActualizaExistAlm(1, 1, foundRows(0)("VENClave"), ALMClave)
                                If StageCancelacion <> "" Then
                                    ModPOS.ActualizaExistUbc(1, 1, foundRows(0)("VENClave"), ALMClave, StageCancelacion)
                                Else
                                    ModPOS.ActualizaExistUbc(1, 1, foundRows(0)("VENClave"), ALMClave)
                                End If
    ...
    Private Sub Imprimir()
        ...
        pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_encabezado_ped", "@VENClave", GridPedidos.GetValue("VENClave")))
        pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_detalle_ped", "@VENClave", GridPedidos.GetValue("VENClave")))
        ...
        OpenReport.PrintPreview("Venta", "CRPedido.rpt", pvtaDataSet, ModPOS.Letras(ModPOS.Redondear(GridPedidos.GetValue("Total"), 2)).ToUpper)
        Exit Sub
    End Sub
    ...
    Private Sub BtnReimprimir_Click(sender As Object, e As EventArgs) Handles BtnReimprimir.Click
        ...
        If foundRows.GetLength(0) > 0 Then
            ...
            For i = 0 To foundRows.GetUpperBound(0)
                ...
                Dim OpenReport As New Report
                Dim pvtaDataSet As New DataSet
                pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_encabezado_pedido", "@VENClave", foundRows(i)("VENCLave"), "@Estado", foundRows(i)("iEstado")))
                pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_detalle_pedido", "@VENClave", foundRows(i)("VENCLave"), "@Estado", foundRows(i)("iEstado")))
                ...
                pvtaDataSet.DataSetName = "pvtaDataSet"
                OpenReport.PrintPreview("Pedido", "CRPedidoTPV.rpt", pvtaDataSet, ModPOS.Letras(ModPOS.TruncateToDecimal(foundRows(i)("Total"), 2)).ToUpper)
