...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.BtnImprimir.Location = New System.Drawing.Point(3, 135)
        ...
        Me.UiTab1.Location = New System.Drawing.Point(2, 177)
        Me.UiTab1.Name = "UiTab1"
        Me.UiTab1.Size = New System.Drawing.Size(779, 337)
        ...
        Me.UiTabGeneral.Size = New System.Drawing.Size(777, 315)
        ...
        Me.GrpRecibos.Size = New System.Drawing.Size(773, 309)
        ...
        Me.ChkMarcaTodos.Size = New System.Drawing.Size(69, 19)
        ...
        Me.LblTotal.Location = New System.Drawing.Point(589, 285)
        ...
        Me.LblTot.Location = New System.Drawing.Point(541, 288)
        ...
        Me.GridRecibos.Size = New System.Drawing.Size(759, 245)
        ...
        Me.BtnTimbrar.Location = New System.Drawing.Point(97, 135)
        ...
        Me.BtnRecibo.Location = New System.Drawing.Point(285, 135)
        ...
        Me.BtnCancelar.Location = New System.Drawing.Point(191, 135)
        ...
        Me.mcPeriodo.Location = New System.Drawing.Point(533, 10)
        ...
        'LblClave
        '
        Me.LblClave.Location = New System.Drawing.Point(7, 10)
        ...
        'TxtNumNomina
        '
        Me.TxtNumNomina.Location = New System.Drawing.Point(102, 10)
        ...
        'TxtNumDiasPagados
        '
        Me.TxtNumDiasPagados.Location = New System.Drawing.Point(102, 39)
        ...
        Me.dtFechaInicial.Location = New System.Drawing.Point(333, 10)
        ...
        Me.dtFechaFinal.Location = New System.Drawing.Point(333, 41)
        ...
        'Label3
        '
        Me.Label3.Location = New System.Drawing.Point(238, 45)
        ...
        Me.BtnGuardar.Location = New System.Drawing.Point(690, 520)
        ...
        Me.btnSalir.Location = New System.Drawing.Point(594, 520)
        ...
        Me.PictureBox4.Location = New System.Drawing.Point(309, 47)
        ...
        Me.PictureBox3.Location = New System.Drawing.Point(309, 14)
        ...
        Me.BtnEditarRecibo.Location = New System.Drawing.Point(379, 135)
        ...
        Me.PictureBox5.Location = New System.Drawing.Point(59, 71)
        ...
        Me.CmbSucursal.Location = New System.Drawing.Point(102, 67)
...
#End Region
    ...
    Private Moneda, regimenFiscal As String
    ...
    Public Sub actualizaGridRecibos()
        ...
        GridRecibos.RootTable.Columns("MonedaRef").Visible = False
        ...
        If dtRecibos.Rows.Count > 0 Then
            ...
            If ChkMarcaTodos.Checked Then
                For i = 0 To dtRecibos.Rows.Count - 1
                    dtRecibos.Rows(i)("Marca") = True
                Next
            Else
                For i = 0 To dtRecibos.Rows.Count - 1
                    dtRecibos.Rows(i)("Marca") = False
                Next
            End If
        End If
                ...
                Select Case MessageBox.Show("Se Timbraran todos los recibos marcados que se encuentren pendientes, esta de acuerdo?", "Pregunta", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
                    Case DialogResult.Yes
                        ...
                        For i = 0 To foundRows.GetUpperBound(0)
                            ...
                            dt = ModPOS.Recupera_Tabla("sp_recupera_empleado", "@EMPClave", foundRows(i)("EMPClave"))
                            ...
                            oCFD.TipoRegimen = dt.Rows(0)("TipoRegimen")
                            ...
                            ' Recupera Empleado Detalle

                            dt = ModPOS.Recupera_Tabla("sp_recupera_empleadoDet", "@EMPClave", foundRows(i)("EMPClave"))
                            ...
                            dt = ModPOS.Recupera_Tabla("sp_recupera_reciboNomina", "@RENClave", foundRows(i)("RENClave"))
                            ...
                            oCFD.Moneda = dt.Rows(0)("MONClave")
                            ...
                            oCFD.TotalGravadoD = dt.Rows(0)("TotalGravadoDeducciones")
                            oCFD.TotalExentoD = dt.Rows(0)("TotalExentoDeducciones")
                            ...
                            oCFD.descuento = oCFD.TotalExentoD + oCFD.TotalGravadoD - ISR

                            oCFD.RENClave = foundRows(i)("RENClave")

                            oCFD.cadenaOriginal = generarCadenaOriginalNomina(oCFD, dtConcepto, dtImpuesto)
                            ...
                            iPac = ModPOS.crearXMLNomina(dtPAC, PathXML, oCFD.Serie & oCFD.Folio, oCFD.RENClave, oCFD.tipoDeComprobante, oCFD, dtConcepto, dtImpuesto)
                        ...
                        If a.DialogResult = DialogResult.OK Then
                            If a.Autorizado Then
                                ...
                                ElseIf foundRows(0)("Estado") = "Activo" Then 'Timbrado
                                    ...
                                    If ModPOS.cancelarXML(dtPAC, foundRows(0)("Folio"), foundRows(0)("uuid"), eRFC) = False Then
                                        Exit Sub
                                    End If
                ...
                Select Case MessageBox.Show("Se imprimiran todos los recibos Activos que se encuentren marcados , esta de acuerdo?", "Pregunta", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
                    Case DialogResult.Yes
                        ...
                        For i = 0 To foundRows.GetUpperBound(0)
                            ...
                            OpenReport.Print("CRReciboNomina.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.Redondear(foundRows(i)("Total") / foundRows(i)("TipoCambio"), 2), foundRows(i)("Moneda"), foundRows(i)("MonedaRef")).ToUpper, sImpresora)
