...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(MeFiltroAlmHist))
        ...
        Me.GroupBox1.Size = New System.Drawing.Size(433, 44)
        ...
        Me.PictureBox4.Location = New System.Drawing.Point(397, 19)
        ...
        Me.PictureBox3.Location = New System.Drawing.Point(233, 19)
        ...
        Me.BtnOK.Location = New System.Drawing.Point(347, 121)
        Me.BtnOK.Name = "BtnOK"
        ...
        Me.BtnCancel.Location = New System.Drawing.Point(251, 121)
        ...
        Me.Combo.Location = New System.Drawing.Point(67, 40)
        Me.Combo.Name = "Combo"
        Me.Combo.Size = New System.Drawing.Size(360, 21)
        Me.Combo.TabIndex = 38
        '
        'lblCombo
        '
        Me.lblCombo.ForeColor = System.Drawing.SystemColors.ActiveCaptionText
        Me.lblCombo.Location = New System.Drawing.Point(7, 44)
        Me.lblCombo.Name = "lblCombo"
        Me.lblCombo.Size = New System.Drawing.Size(54, 14)
        Me.lblCombo.TabIndex = 37
        ...
        Me.Label3.Text = "Periodo de Historico"
        '
        'CmbPeriodo
        '
        ...
        Me.CmbPeriodo.Location = New System.Drawing.Point(119, 9)
        Me.CmbPeriodo.Name = "CmbPeriodo"
        Me.CmbPeriodo.Size = New System.Drawing.Size(120, 21)
        Me.CmbPeriodo.TabIndex = 74
        '
        'PictureBox2
        '
        Me.PictureBox2.Anchor = CType((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        Me.PictureBox2.Image = CType(resources.GetObject("PictureBox2.Image"), System.Drawing.Image)
        Me.PictureBox2.Location = New System.Drawing.Point(252, 12)
        ...
        Me.ClientSize = New System.Drawing.Size(446, 167)
...
#End Region
    ...
    Private Sub MeFiltroAlmHist_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
        If bError Then
            e.Cancel = True
        End If
    End Sub
    ...
    Private Sub BtnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnOK.Click
        If validaForm() Then
            ...
            If CmbFechaFin.Value.Year > CInt(CmbPeriodo.SelectedValue) Then
                bError = True
                Beep()
                MessageBox.Show("El rango de fechas proporcionada esta fuera del periodo historico seleccionado", "Error", MessageBoxButtons.OK, MessageBoxIcon.Stop)
                Me.DialogResult = System.Windows.Forms.DialogResult.Cancel
                Exit Sub
            End If

            Year = CmbPeriodo.SelectedValue
            FechaIni = CStr(cmbFechaInicio.Value)
            FechaFin = CStr(CmbFechaFin.Value.AddHours(23.9999))
            AlmSuc = Combo.SelectedValue
            bError = False
        Else
            bError = True
            Beep()
    ...
    Private Sub MeFiltroAlmHist_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        With Me.CmbPeriodo
            ...
            .ProcedimientoAlmacenado = "sp_filtra_periodo_hist"
            .llenar()
        End With
