                ...
                If Padre = "Nuevo" Then
                    ...
                    If (EstadoActual = 2 OrElse EstadoActual = 4) AndAlso Estado = 1 Then
                        If Tipo = 3 Then
                            ...
                            ModPOS.GeneraMovInv(2, 8, 6, ACOClave, ALMClave, Folio, Autoriza)
                            ModPOS.ActualizaExistAlm(2, 6, ACOClave, ALMClave)
                            ModPOS.ActualizaExistUbc(2, 6, ACOClave, ALMClave)
                        ...
                        Else
                            ModPOS.GeneraMovInv(Tipo, 8, 6, ACOClave, ALMClave, Folio, Autoriza)
                            ModPOS.ActualizaExistAlm(Tipo, 6, ACOClave, ALMClave)
                            ModPOS.ActualizaExistUbc(Tipo, 6, ACOClave, ALMClave)
                        End If
                        Estado = EstadoActual
                    End If
