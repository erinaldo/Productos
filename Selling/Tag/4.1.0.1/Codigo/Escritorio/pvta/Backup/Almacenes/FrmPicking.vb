...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.cmbTipo.Items.AddRange(New Object() {"Venta", "Traslado", "Traspaso"})
...
#End Region
    ...
    ByVal sRuta As String)
        ...
        If foundRows.Length = 0 Then
            ...
            ModPOS.Ejecuta("sp_agrega_picking", "@Tipo", iTipo, "@PICClave", PICClave, "@DOCClave", sDOCClave, "@Usuario", ModPOS.UsuarioActual)
            If iTipo = 1 Then
    ...
    Private Sub addDetalle(ByVal sDOCClave As String, _
        ...
        ByVal dVol As Double)

        Dim foundRows() As Data.DataRow
        foundRows = dtDetalle.Select("Tipo = " & CStr(iTipo) & " and DOCClave = '" & sDOCClave & "' and PROClave = '" & sPROClave & "'")
    ...
    Private Sub FrmPicking_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        With AircraftTypeValueListItemCollection
            ...
            dtTipoRechazo = ModPOS.Recupera_Tabla("sp_filtra_valorref", "@Tabla", "SurtidoDetalle", "@Campo", "TipoRechazo")
    ...
    Private Sub BtnGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnGuardar.Click
        ...
        If bSurtido = False Then
            ...
            If dSurtido = 0 Then
                MessageBox.Show("No es posible confirmar el surtido sin por lo menos una mercancia entregada, si no desea realizar el surtido debera cancelar el documento", "Advertencia", MessageBoxButtons.YesNo, MessageBoxIcon.Warning)
                Exit Sub
            End If
            ...
            For i = 0 To dtDetalle.Rows.Count - 1
                    ...
                    For j = 0 To dtVentaDetalle.Rows.Count - 1
                        If dtVentaDetalle.Rows(j)("Cantidad") >= Faltante Then
                            ModPOS.Ejecuta("sp_actualiza_detalle_picking", _
                                                          ...
                                                          "@Faltante", Faltante, _
                                                          "@UBCClave", dtDetalle.Rows(i)("Ubicación"), _
                                                          "@TipoRechazo", dtDetalle.Rows(i)("TipoRechazo"))
                            Exit For
                        Else
                            ModPOS.Ejecuta("sp_actualiza_detalle_picking", _
                                                                      "@ALMClave", ALMClave, _
                ...
                If dtDetalle.Rows(i)("Surtido") > 0 Then
                    ModPOS.Ejecuta("sp_surtido_picking", "@Tipo", dtDetalle.Rows(i)("Tipo"), "@DOCClave", dtDetalle.Rows(i)("DOCClave"), "@ALMClave", ALMClave, "@PROClave", dtDetalle.Rows(i)("PROClave"), "@UBCClave", dtDetalle.Rows(i)("Ubicación"), "@Cantidad", dtDetalle.Rows(i)("Surtido"))
                End If
            ...
            If dtDoctos.Rows.Count > 0 Then
                For i = 0 To dtDoctos.Rows.Count - 1
                    If dtDoctos.Rows(i)("Tipo") = 1 Then
                        ...
                        OpenReport.Print("CRPedido.rpt", pvtaDataSet, ModPOS.Letras(ModPOS.Redondear(dtDoctos.Rows(i)("Total"), 2)).ToUpper, sImpresora)
                    ElseIf dtDoctos.Rows(i)("Tipo") = 8 Then
                        Dim OpenReport As New Report
                        Dim pvtaDataSet As New DataSet
                        pvtaDataSet.DataSetName = "pvtaDataSet"
                        ...
                        OpenReport.Print("CRTraslado.rpt", pvtaDataSet, "", sImpresora)
                    ...
                    ElseIf dtDoctos.Rows(i)("Tipo") = 6 Then
                        ...
                        OpenReport.Print("CRTransferencia.rpt", pvtaDataSet, "", sImpresora)
    ...
    Private Sub BtnDel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnDel.Click
        If DOCClave <> "" Then
            ...
            If MessageBox.Show("¿Esta seguro de remover el ticket " & GridDoctos.GetValue("Folio") & " ?", "Pregunta", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
                ...
                'Elimina Pedido
                foundRows = dtDoctos.Select("Tipo = " & CStr(GridDoctos.GetValue("Tipo")) & " and DOCClave = '" & DOCClave & "'")
                If foundRows.GetLength(0) > 0 Then
    ...
    Private Function CargaDatosTicket(ByVal sTipo As String, ByVal Periodo As Integer, ByVal Mes As Integer, ByVal Folio As String) As Boolean
        ...
        ElseIf sTipo = "Traspaso" Then
            ...
            If Not dt Is Nothing AndAlso dt.Rows.Count > 0 Then
                ...
                Return True
            Else
                MessageBox.Show("El folio de Traspaso introducido no esta disponible para Recolectar", "Información", MessageBoxButtons.OK, MessageBoxIcon.Stop)
                Return False
            End If
        End If
    End Function
