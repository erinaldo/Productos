...
#End Region
    ...
    Private Sub FrmMtoCliente_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        ModPOS.ActualizaGrid(True, Me.GridClientes, "sp_muestra_clientes", "@Class", TreeViewClass.TopNode.Tag, "@Responsable", iResponsable)
                ...
                Select Case MessageBox.Show("Se eliminara el Cliente :" & sNombre, "Advertencia", MessageBoxButtons.YesNo, MessageBoxIcon.Warning)
                    Case DialogResult.Yes
                        ...
                        If Not TreeViewClass.SelectedNode.Tag Is Nothing Then
                            ...
                            ModPOS.ActualizaGrid(True, Me.GridClientes, "sp_muestra_clientes", "@Class", TreeViewClass.SelectedNode.Tag, "@Responsable", iResponsable)
                            Me.GridClientes.RootTable.Columns("ID").Visible = False
    ...
    Private Sub CmbAlmacen_SelectedValueChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmbResponsable.SelectedValueChanged
        If bload = True AndAlso Not cmbResponsable.SelectedValue Is Nothing Then
            ModPOS.ActualizaGrid(True, Me.GridClientes, "sp_muestra_clientes", "@Class", TreeViewClass.TopNode.Tag, "@Responsable", cmbResponsable.SelectedValue)
            Me.GridClientes.RootTable.Columns("ID").Visible = False
            Cursor.Current = Cursors.Default
        End If
    End Sub
    ...
    Public Sub actGrid(ByVal tag As String)
        ...
        ModPOS.ActualizaGrid(True, Me.GridClientes, "sp_muestra_clientes", "@Class", tag, "@Responsable", iResponsable)
        Me.GridClientes.RootTable.Columns("ID").Visible = False
    ...
    Private Sub BtnListado_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnListado.Click
        ...
        If a.DialogResult = DialogResult.OK Then
            ...
            pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_rep_listadocliente", "@Cliente", a.Cliente, "@Almacen", a.SucursalOrigen))
