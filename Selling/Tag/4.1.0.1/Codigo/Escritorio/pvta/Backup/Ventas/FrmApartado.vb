...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.TxtTotalApartados.Location = New System.Drawing.Point(232, 138)
        Me.TxtTotalApartados.Name = "TxtTotalApartados"
        Me.TxtTotalApartados.ReadOnly = True
        Me.TxtTotalApartados.Size = New System.Drawing.Size(113, 26)
        ...
        Me.Label1.Location = New System.Drawing.Point(414, 146)
        ...
        Me.TxtSaldoApartados.Location = New System.Drawing.Point(524, 138)
        Me.TxtSaldoApartados.Name = "TxtSaldoApartados"
        Me.TxtSaldoApartados.ReadOnly = True
        Me.TxtSaldoApartados.Size = New System.Drawing.Size(140, 26)
        ...
        Me.TxtSaldoDocumento.Location = New System.Drawing.Point(299, 17)
        Me.TxtSaldoDocumento.Name = "TxtSaldoDocumento"
        Me.TxtSaldoDocumento.ReadOnly = True
        Me.TxtSaldoDocumento.Size = New System.Drawing.Size(113, 26)
        ...
        Me.LblIVA.Location = New System.Drawing.Point(245, 23)
        ...
        Me.TxtTotalDocumento.Location = New System.Drawing.Point(459, 15)
        Me.TxtTotalDocumento.Name = "TxtTotalDocumento"
        Me.TxtTotalDocumento.ReadOnly = True
        Me.TxtTotalDocumento.Size = New System.Drawing.Size(140, 26)
        ...
        Me.LblTotal.Location = New System.Drawing.Point(417, 24)
...
#End Region
    ...
    Private TotalDoc As Double
    Private SaldoDoc As Double
    ...
    Private Sub CargaTickets(ByVal Clave As String)
        ...
        If dtAsignados Is Nothing OrElse dtAsignados.Rows.Count = 0 Then
            TxtTotalApartados.Text = Format(CStr(0), "Currency")
            TxtSaldoApartados.Text = Format(CStr(0), "Currency")
            TotalDoc = 0
            SaldoDoc = 0
            TxtSaldoDocumento.Text = Format(CStr(0), "Currency")
            TxtTotalDocumento.Text = Format(CStr(0), "Currency")
        End If
    ...
    Public Sub CargaDetalleTicket(ByVal VENClave As String)
        ...
        TxtSaldoDocumento.Text = Format(Redondear(SaldoDoc, 2).ToString, "Currency")
        TxtTotalDocumento.Text = Format(Redondear(TotalDoc, 2).ToString, "Currency")
    End Sub
    ...
    Private Sub BtnBuscaCte_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnBuscaCte.Click
        ...
        If a.DialogResult = DialogResult.OK Then
            If Not a.valor Is Nothing Then
                ...
                Dim dtCliente As DataTable = ModPOS.SiExisteRecupera("sp_consulta_clienteapartado", "@Cliente", a.Descripcion, "@COMClave", ModPOS.CompanyActual)
                If Not dtCliente Is Nothing Then
                    ...
                    TxtTotalApartados.Text = Format(CStr(ModPOS.Redondear(dtCliente.Rows(0)("Total"), 2)), "Currency")
    ...
    Private Sub TxtClave_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TxtClave.KeyPress
        If Asc(e.KeyChar) = 13 Then
            If Not TxtClave.Text = vbNullString Then
                Dim dtCliente As DataTable = ModPOS.SiExisteRecupera("sp_consulta_clienteapartado", "@Cliente", TxtClave.Text.ToUpper.Trim.Replace("'", "''"), "@COMClave", ModPOS.CompanyActual)
                If Not dtCliente Is Nothing Then
    ...
    Private Sub BtnPagos_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnPagos.Click
        If VENClave <> "" Then
            ...
            If a.DialogResult = DialogResult.OK Then
                ...
                Dim SalidaInventario As Boolean = False

                If ClienteClave = a.CTEClave Then
                    AcumulaPuntos = 0
                Else
                    AcumulaPuntos = 1
                End If
                ...
                ModPOS.Ejecuta("sp_act_saldo_cte", "@Tipo", 2, "@Cliente", ClienteClave, "@Importe", a.TotalAbono)

                If TotalPagoAplicar > 0 Then
                    ...
                    msg.TxtMsg2 = Letras(CStr(ModPOS.Redondear(a.TotalCambio, 2))).ToUpper
                    msg.ShowDialog()
                    msg.Dispose()

                    SaldoApartados -= TotalPagoAplicar
                    TxtSaldoApartados.Text = Format(CStr(ModPOS.Redondear(SaldoApartados, 2)), "Currency")
                    ...
                    Select Case MessageBox.Show("¿Desea imprimir un recibo de los pagos realizados?", "Pregunta", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
                        Case DialogResult.Yes
                            imprimeRecibo(a.AbonoClave, a.TotalAbono, a.TotalCambio, Impresora, PrintGeneric, Recibo, AtiendeNombre)
                        Case Else
                    End Select


                    If SalidaInventario Then
        ...
        If VENClave <> "" Then
            Select Case MessageBox.Show("Se cancelara la venta con apartado :" & LstApartados.SelectedItem(1), "Advertencia", MessageBoxButtons.YesNo, MessageBoxIcon.Warning)
                Case DialogResult.Yes
                    ...
                    a.Sucursal = SUCClave
                    a.MontodeAutorizacion = TotalDoc
                    a.StartPosition = FormStartPosition.CenterScreen
                    a.ShowDialog()
                    If a.DialogResult = DialogResult.OK Then
                        If a.Autorizado Then
                            If TotalDoc > SaldoDoc Then
                                ModPOS.Ejecuta("sp_cancela_pagos_apartados", "@VENClave", VENClave, "@CAJClave", CAJClave, "@CTEClave", ClienteClave, "@Importe", TotalDoc - SaldoDoc, "@Usuario", ModPOS.UsuarioActual)

                                Dim msg As New FrmMeMsg
                                msg.TxtTiulo = "la devolución de su anticipo es:"
                                msg.TxtMsg = Format(CStr(ModPOS.Redondear(TotalDoc - SaldoDoc, 2)), "Currency")
                                msg.TxtMsg2 = Letras(CStr(ModPOS.Redondear(TotalDoc - SaldoDoc, 2))).ToUpper
                                msg.ShowDialog()
                                msg.Dispose()
                                imprimeDevolucion(TxtClave.Text.ToUpper.Trim.Replace("'", "''"), LstApartados.SelectedItem(1), TotalDoc - SaldoDoc, Impresora, PrintGeneric, Recibo, AtiendeNombre, TxtRazonSocial.Text.ToUpper.Trim.Replace("'", "''"))
                            ...
                            End If
                            ModPOS.Ejecuta("sp_cancela_venta", "@VENClave", VENClave, "@TipoDoc", 4)
                            ModPOS.Ejecuta("sp_cancela_puntos", "@Documento", VENClave, "@Tipo", 1)
                            ModPOS.Ejecuta("sp_act_saldo_cte", "@Tipo", 2, "@Cliente", ClienteClave, "@Importe", SaldoDoc)
                ...
                If a.SeCancela Then
                    If Redondear(TotalDoc, 2) = Redondear(a.PrecioNetoDetalle * a.CantidadCancelada, 2) Then
                        If TotalDoc > SaldoDoc Then
                            ...
                            ModPOS.Ejecuta("sp_act_saldo_cte", "@Tipo", 2, "@Cliente", ClienteClave, "@Importe", SaldoDoc)
                        Else
                            ModPOS.Ejecuta("sp_act_saldo_cte", "@Tipo", 2, "@Cliente", ClienteClave, "@Importe", TotalDoc)
                        End If
                    ...
                    If TotalDoc > SaldoDoc Then
                        ...
                        If Redondear(SaldoDoc, 2) < Redondear(a.PrecioNetoDetalle * a.CantidadCancelada, 2) Then
                            ...
                            ModPOS.Ejecuta("sp_cancela_pagos_apartados", "@VENClave", VENClave, "@CAJClave", CAJClave, "@CTEClave", ClienteClave, "@Importe", ImporteDevolucion, "@Usuario", ModPOS.UsuarioActual)
                            Dim msg As New FrmMeMsg
                            msg.TxtTiulo = "la devolución de su anticipo es:"
                            msg.TxtMsg = Format(CStr(ModPOS.Redondear(ImporteDevolucion, 2)), "Currency")
                            msg.TxtMsg2 = Letras(CStr(ModPOS.Redondear(ImporteDevolucion, 2))).ToUpper
                            msg.ShowDialog()
                            msg.Dispose()
                            imprimeDevolucion(TxtClave.Text.ToUpper.Trim.Replace("'", "''"), LstApartados.SelectedItem(1), ImporteDevolucion, Impresora, PrintGeneric, Recibo, AtiendeNombre, TxtRazonSocial.Text.ToUpper.Trim.Replace("'", "''"))
                            ...
                            End If
                        Else
                            ModPOS.Ejecuta("sp_act_saldo_cte", "@Tipo", 2, "@Cliente", ClienteClave, "@Importe", Redondear(a.PrecioNetoDetalle * a.CantidadCancelada, 2))
                        End If
                    End If
