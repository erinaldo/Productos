...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmAddCtes))
        ...
        Me.GrpClas.Size = New System.Drawing.Size(200, 428)
        ...
        Me.TreeViewClass.Size = New System.Drawing.Size(186, 406)
        ...
        Me.GrpClientes.Size = New System.Drawing.Size(531, 428)
        ...
        Me.PBar.Anchor = CType(((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Left) _
                    Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        Me.PBar.Location = New System.Drawing.Point(93, 13)
        Me.PBar.Name = "PBar"
        Me.PBar.Size = New System.Drawing.Size(388, 21)
        Me.PBar.TabIndex = 120
        '
        'ChkMarcaTodos
        '
        Me.ChkMarcaTodos.Enabled = False
        Me.ChkMarcaTodos.Location = New System.Drawing.Point(7, 16)
        Me.ChkMarcaTodos.Name = "ChkMarcaTodos"
        Me.ChkMarcaTodos.Size = New System.Drawing.Size(94, 17)
        ...
        Me.GridClientes.Size = New System.Drawing.Size(518, 383)
        ...
        Me.BtnCancelar.Location = New System.Drawing.Point(552, 433)
        ...
        Me.BtnAgregar.Location = New System.Drawing.Point(648, 433)
...
#End Region
    ...
    Public WindowsForm As String = "DesCte"
    ...
    Private Sub actualizaTree()
        dataSetArbol = ModPOS.recuperaTabla_DTS("sp_recupera_clasificacion", "Clasificacion", "@Tipo", 1, "@COMClave", ModPOS.CompanyActual)
    ...
    Private Sub ActualizaGrid(ByVal tag As Integer)
        ...
        If WindowsForm = "DesCte" Then
            dtClientes = ModPOS.Recupera_Tabla("sp_muestra_SinDescuento", "@Descuento", Clave, "@Class", tag, "@COMClave", ModPOS.CompanyActual)
        Else
            dtClientes = ModPOS.Recupera_Tabla("sp_muestra_SinAddenda", "@Class", tag, "@COMClave", ModPOS.CompanyActual)
        End If
    ...
    Private Sub FrmAddCteDes_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
        ModPOS.AddCtes.Dispose()
        ModPOS.AddCtes = Nothing
    End Sub
        ...
        If Not dtClientes Is Nothing AndAlso dtClientes.Rows.Count > 0 Then
            ...
            If foundRows.GetLength(0) > 0 Then
                ...
                For i = 0 To foundRows.GetUpperBound(0)
                    If WindowsForm = "DesCte" Then
                        ModPOS.DesCte.addClienteDetalle(foundRows(i)("ID"), foundRows(i)("Clave").ToString, foundRows(i)("Razón Social"), IIf(foundRows(i)("RFC").GetType.FullName = "System.DBNull", "", foundRows(i)("RFC")))
                    Else
                        ModPOS.Addenda.addClienteDetalle(foundRows(i)("ID"), foundRows(i)("Clave").ToString, foundRows(i)("Razón Social"), IIf(foundRows(i)("RFC").GetType.FullName = "System.DBNull", "", foundRows(i)("RFC")))
                    End If
                    PBar.Value = i + 1
