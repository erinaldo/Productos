...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.GrpCosto.Size = New System.Drawing.Size(514, 181)
        ...
        Me.BtnAgregar.Location = New System.Drawing.Point(431, 194)
...
#End Region
    ...
    Private Sub FrmPAC_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If cmbTipoPAC.SelectedValue = 2 OrElse cmbTipoPAC.SelectedValue = 3 Then
    ...
    Private Function validaForm() As Boolean
        ...
        If Me.TxtUserId.Text = "" AndAlso (cmbTipoPAC.SelectedValue = 2 OrElse cmbTipoPAC.SelectedValue = 3) Then
            i += 1
        ...
        If Me.TxtServidorTimbrado.Text = "" Then
            i += 1
        ...
        If Me.TxtServidorCancelacion.Text = "" Then
            i += 1
    ...
    Private Sub BtnAgregar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnAgregar.Click
        If Me.validaForm Then
            ModPOS.Compania.AddPAC(Me.cmbTipoPAC.SelectedValue, cmbTipoPAC.SelectedItem(1), Me.TxtCustomerKey.Text, Me.TxtServidorTimbrado.Text, Me.TxtServidorCancelacion.Text, TxtUserId.Text, TxtTimbres.Text)
            Me.Close()
        Else
            Beep()
