...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.PictureBox1.Location = New System.Drawing.Point(542, 45)
        ...
        Me.PictureBox2.Location = New System.Drawing.Point(622, 89)
        ...
        Me.TxtNombre.Anchor = CType(((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Left) _
                    Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        Me.TxtNombre.Location = New System.Drawing.Point(107, 89)
        ...
        'LblNombre
        '
        Me.LblNombre.Location = New System.Drawing.Point(13, 89)
        ...
        'LblClave
        '
        Me.LblClave.Location = New System.Drawing.Point(13, 45)
        ...
        Me.GrpCuentas.Controls.Add(Me.BtnModificaSub)
        ...
        Me.BtnAgregarSub.Location = New System.Drawing.Point(679, 16)
        ...
        'GridCuentas
        '
        Me.GridCuentas.AllowEdit = Janus.Windows.GridEX.InheritableBoolean.[False]
        ...
        Me.GridCuentas.Location = New System.Drawing.Point(7, 15)
        Me.GridCuentas.Name = "GridCuentas"
        Me.GridCuentas.RecordNavigator = True
        Me.GridCuentas.Size = New System.Drawing.Size(667, 257)
        ...
        Me.BtnModificaSub.ToolTipText = "Modifica la cuenta seleccionada"
...
#End Region
    ...
    Public Sub AddCuenta(ByVal sCNTAClave As String, ByVal sReferencia As String, ByVal iEstado As Integer)

        Dim foundRows() As Data.DataRow
        foundRows = dtCuentas.Select("CNTAClave Like '" & sCNTAClave & "' and Baja = 0")

        If foundRows.Length = 0 Then

            foundRows = dtCuentas.Select("Referencia = '" & Trim(sReferencia) & "' and Baja = 0")
            If foundRows.Length = 0 Then
                ...
                row1.Item("CNTAClave") = sCNTAClave
            ...
            Else
                Beep()
                MessageBox.Show("¡La referencia de No. Cuenta que intenta agregar ya existe para el Banco actual!", "Error", MessageBoxButtons.OK, MessageBoxIcon.Stop)
            End If

        Else
            Dim foundRows2() As Data.DataRow
            foundRows2 = dtCuentas.Select("Referencia = '" & Trim(sReferencia) & "' and Baja = 0")
            If foundRows2.Length = 0 Then

                foundRows(0)("Referencia") = sReferencia
    ...
    Private Sub FrmBank_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        GridCuentas.RootTable.Columns("iEstado").Visible = False
        ...
        If validaForm() Then
            ...
            Select Case Me.Padre
                Case "Agregar"
                    ...
                    ModPOS.Ejecuta("sp_inserta_bank", "@BNKClave", BNKClave, "@Referencia", Referencia, "@Nombre", Nombre, "@Estado", Estado, "@Usuario", ModPOS.UsuarioActual)
                ...
                Case "Modificar"
                    If Not (Nombre = UCase(Trim(Me.TxtNombre.Text)) AndAlso Estado = ChkEstado.GetEstado) Then
                        ...
                        ModPOS.Ejecuta("sp_actualiza_bank", "@BNKClave", BNKClave, "@Nombre", Nombre, "@Estado", Estado, "@Usuario", ModPOS.UsuarioActual)
                    ...
                    If foundRows.Length <> 0 Then
                        ...
                        For z = 0 To foundRows.GetUpperBound(0)
                            ...
                            ModPOS.Ejecuta("sp_actualiza_count", _
                            "@BNKClave", BNKClave, _
                            "@CNTAClave", foundRows(z)("CNTAClave"), _
                            "@Referencia", foundRows(z)("Referencia"), _
                            "@Estado", foundRows(z)("iEstado"), _
                    ...
                    foundRows = dtCuentas.Select(" Baja = 1 ")

                    If foundRows.Length <> 0 Then
                        Dim z As Integer
                        For z = 0 To foundRows.GetUpperBound(0)

                            ModPOS.Ejecuta("sp_elimina_count", _
                            "@BNKClave", BNKClave, _
                            "@CNTAClave", foundRows(z)("CNTAClave"), _
                            "@Usuario", ModPOS.UsuarioActual)
                        Next
    ...
    Public Sub modificarCuentas()
        If sCountSelected <> "" Then
            Dim a As New FrmCount
            a.Padre = "Modificar"
            a.CNTAClave = sCountSelected
            a.Referencia = GridCuentas.GetValue("Referencia")
            a.Estado = GridCuentas.GetValue("iEstado")
            a.ShowDialog()
        End If
    End Sub

    Private Sub GridCuentas_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles GridCuentas.DoubleClick
        modificarCuentas()
    End Sub
    ...
    Private Sub GridCuentas_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles GridCuentas.KeyDown
