...
#End Region
    ...
    Private Sub ImprimirPedido(ByVal Venta As String, ByVal Total As Decimal)
        Dim OpenReport As New Report
        Dim pvtaDataSet As New DataSet
        pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_encabezado_ped_radec", "@VENClave", Venta))
        pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_detalle_ped_radec", "@VENClave", Venta))
        pvtaDataSet.DataSetName = "pvtaDataSet"
