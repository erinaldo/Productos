...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.TxtConfirmar.Anchor = CType(((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Left) _
                    Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        Me.TxtConfirmar.Location = New System.Drawing.Point(60, 45)
        ...
        Me.PictureBox2.Location = New System.Drawing.Point(318, 20)
        ...
        Me.TxtFirma.Anchor = CType(((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Left) _
                    Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        Me.TxtFirma.Location = New System.Drawing.Point(60, 18)
...
#End Region
    ...
    Private Sub BtnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnOK.Click
        If validaForm() Then
            Dim Nueva As String = ModPOS.EncryptText(TxtFirma.Text.Trim, "AlpeGroup")

            If Firma = Nueva Then
                MsgBox("La Nueva Firma debe ser diferente a la anterior", MsgBoxStyle.Critical, "Error")
                Autorizado = False
                Exit Sub
            End If
