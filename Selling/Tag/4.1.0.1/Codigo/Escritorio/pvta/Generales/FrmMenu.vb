        ...
        Select Case e.Item.Key
            ...
            Case "331"
                ...
                If a.DialogResult = System.Windows.Forms.DialogResult.OK Then
                    ...
                    Dim pvtaDataSet As New DataSet
                    pvtaDataSet.DataSetName = "reportDataSet"
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_rep_venta_diaria", "@SUCClave", a.Origen, "@Inicial", CDate(a.FechaInicio), "@Final", CDate(a.FechaFinal)))
                    ...
                    Else
                        ...
                        If B.DialogResult = DialogResult.OK Then
                            If B.IdCorte <> "" Then
                                ...
                                pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_rep_corte", "@IdCorte", B.IdCorte))
                                pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_corte_creditos", "@IdCorte", B.IdCorte))

                                ' pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_rep_balanza", "@ID", B.IdCorte))
            ...
            Case "359"
                ...
                If a.DialogResult = System.Windows.Forms.DialogResult.OK Then
                    ...
                    Dim pvtaDataSet As New DataSet
                    pvtaDataSet.DataSetName = "reportDataSet"
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_rep_cobranza", "@ALMClave", a.SucursalOrigen, "@Dias", a.VencimientoDias, "@USRClave", a.Usuario, "@Zona", a.Zona))
            ...
            Case "361"
                ...
                If a.DialogResult = System.Windows.Forms.DialogResult.OK Then
                    ...
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_rep_precios", "@SUCClave", a.Origen, "@CTEClave", a.Cliente, "@Lista", a.ListaPrecio, "@Linea", a.LineaCVE, "@Sublinea", a.SublineaCVE))
