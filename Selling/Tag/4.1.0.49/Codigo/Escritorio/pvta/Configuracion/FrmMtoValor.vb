...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'GrpValor
        '
        Me.GrpValor.Controls.Add(Me.btnImportar)
        ...
        Me.GridValores.FilterRowButtonStyle = Janus.Windows.GridEX.FilterRowButtonStyle.ConditionOperatorDropDown
        ...
        Me.btnImportar.Location = New System.Drawing.Point(366, 337)
        Me.btnImportar.Name = "btnImportar"
        Me.btnImportar.Size = New System.Drawing.Size(90, 37)
        Me.btnImportar.TabIndex = 160
        Me.btnImportar.Text = "Importar"
        Me.btnImportar.ToolTipText = "Importar valores"
            ...
            If (openDlg.ShowDialog() = DialogResult.OK) Then
                ...
                If dtTemporal.Rows.Count > 0 Then
                    ...
                    For i = 0 To dtTemporal.Rows.Count - 1
                        ...
                        ' valida el producto
                        If dtTemporal.Rows(i)("Serie").GetType.FullName <> "System.DBNull" AndAlso _
                            dtTemporal.Rows(i)("Folio").GetType.FullName <> "System.DBNull" AndAlso _
                            dtTemporal.Rows(i)("ClaveProducto").GetType.FullName <> "System.DBNull" AndAlso _
                            dtTemporal.Rows(i)("Cantidad").GetType.FullName <> "System.DBNull" AndAlso _
                            dtTemporal.Rows(i)("IdMotivo").GetType.FullName <> "System.DBNull" Then

                            msg = ModPOS.Ejecuta("sp_modifica_valorref", _
                             "@Tabla", dtTemporal.Rows(i)("Serie"), _
                             "@Campo", dtTemporal.Rows(i)("Folio"), _
                             "@Valor", dtTemporal.Rows(i)("ClaveProducto"), _
                             "@Tipo", "U", _
                             "@Clave", dtTemporal.Rows(i)("Cantidad"), _
                             "@Descripcion", dtTemporal.Rows(i)("IdMotivo"), _
                             "@Orden", i + 1, _
                        ...
                        Else
                            ...
                            'declara el nombre de la fila
                            row1.Item("Fila") = i + 1
                            row1.Item("Error") = "La fila se encuentra vacia"
                            dtError.Rows.Add(row1)
                        End If
                    Next
                    ...
                    Cursor.Current = Cursors.Default
                Else
                    MessageBox.Show("El archivo no cuenta con el formato: Tabla,Campo,Valor,Clave,Descripcion", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                End If
            End If
