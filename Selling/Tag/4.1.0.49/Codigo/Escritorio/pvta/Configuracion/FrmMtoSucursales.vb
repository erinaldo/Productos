        ...
        If sSucursalSelected <> "" Then
            ...
            If ModPOS.Sucursal Is Nothing Then
                ...
                With ModPOS.Sucursal
                    ...
                    .UbicacionRecibo = IIf(dt.Rows(0)("UbicacionRecibo").GetType.Name = "DBNull", False, dt.Rows(0)("UbicacionRecibo"))
                    ...
                    .Oficina = IIf(dt.Rows(0)("OficinaVentas").GetType.Name = "DBNull", "", dt.Rows(0)("OficinaVentas"))
                    .TipoResponsable = IIf(dt.Rows(0)("TipoResponsable").GetType.Name = "DBNull", 0, dt.Rows(0)("TipoResponsable"))

                    .TipoCanal = IIf(dt.Rows(0)("TipoCanal").GetType.Name = "DBNull", 0, dt.Rows(0)("TipoCanal"))
                    .PREClave = IIf(dt.Rows(0)("PREClave").GetType.Name = "DBNull", "", dt.Rows(0)("PREClave"))
