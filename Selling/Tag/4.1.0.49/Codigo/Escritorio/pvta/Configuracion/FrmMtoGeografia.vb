...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.GrpColonias.Location = New System.Drawing.Point(7, 336)
        Me.GrpColonias.Name = "GrpColonias"
        Me.GrpColonias.Size = New System.Drawing.Size(649, 171)
        ...
        Me.GridColonias.FilterRowButtonStyle = Janus.Windows.GridEX.FilterRowButtonStyle.ConditionOperatorDropDown
        ...
        Me.GridColonias.Size = New System.Drawing.Size(540, 148)
        ...
        Me.btnImportar.Location = New System.Drawing.Point(496, 7)
        Me.btnImportar.Name = "btnImportar"
        Me.btnImportar.Size = New System.Drawing.Size(154, 37)
        Me.btnImportar.TabIndex = 159
        Me.btnImportar.Text = "Importar XML SEPOMEX"
        Me.btnImportar.ToolTipText = "Importar catalogo de SEPOMEX"
        ...
        Me.GrpEstado.Location = New System.Drawing.Point(7, 45)
        ...
        Me.GridEstados.FilterRowButtonStyle = Janus.Windows.GridEX.FilterRowButtonStyle.ConditionOperatorDropDown
        ...
        Me.GrpMnpios.Location = New System.Drawing.Point(7, 189)
        ...
        Me.GridMnpios.FilterRowButtonStyle = Janus.Windows.GridEX.FilterRowButtonStyle.ConditionOperatorDropDown
        ...
        'cmbPais
        '
        Me.cmbPais.Location = New System.Drawing.Point(52, 18)
        ...
        'LblPais
        '
        Me.LblPais.Location = New System.Drawing.Point(10, 21)
    ...
    Private Sub btnImportar_Click(sender As Object, e As EventArgs) Handles btnImportar.Click
        Try
            ...
            If (openDlg.ShowDialog() = DialogResult.OK) Then
                ...
                Dim xmlSR As System.IO.StringReader = New System.IO.StringReader(stringXML)
                ds2.ReadXml(xmlSR)
                Dim dt2 As DataTable = ds2.Tables(0)

                Dim dtEntidad As DataTable = ModPOS.Recupera_Tabla("st_recupera_asentamiento", "@Tipo", 1, "@Pais", cmbPais.SelectedValue)
                Dim dtMnpio As DataTable = ModPOS.Recupera_Tabla("st_recupera_asentamiento", "@Tipo", 2, "@Pais", cmbPais.SelectedValue)
                Dim dtColonia As DataTable = ModPOS.Recupera_Tabla("st_recupera_asentamiento", "@Tipo", 3, "@Pais", cmbPais.SelectedValue)
                ...
                For i = 0 To dt2.Rows.Count - 1
                    frmStatusMessage.Show("Procesando " & CStr(i + 1) & " de " & CStr(dt2.Rows.Count) & " registros")

                    foundRows = dtEntidad.Select("c_estado = '" & dt2.Rows(i)("c_estado") & "'")
                    If foundRows.GetLength(0) = 0 Then
                        'Agrega Entidad

                        ModPOS.Ejecuta("sp_inserta_geografia", _
                             "@Tipo", 1, _
                             "@Clave", dt2.Rows(i)("c_estado"), _
                             "@Pais", cmbPais.SelectedValue, _
                             "@Estado", dt2.Rows(i)("d_estado"), _
                             "@Mnpio", "", _
                             "@Colonia", "", _
                             "@CP", "", _
                             "@Asentamiento", 0, _
                        ...
                        row1 = dtEntidad.NewRow()
                        row1.Item("c_estado") = dt2.Rows(i)("c_estado")
                        dtEntidad.Rows.Add(row1)


                    End If

                    foundRows = dtMnpio.Select("c_estado = '" & dt2.Rows(i)("c_estado") & "' and c_mnpio = '" & dt2.Rows(i)("c_mnpio") & "' ")
                    If foundRows.GetLength(0) = 0 Then
                        'Agrega Mnpio

                        ModPOS.Ejecuta("sp_inserta_geografia", _
                               "@Tipo", 2, _
                               "@Clave", dt2.Rows(i)("c_mnpio"), _
                               "@Pais", cmbPais.SelectedValue, _
                               "@Estado", dt2.Rows(i)("c_estado"), _
                               "@Mnpio", dt2.Rows(i)("d_mnpio"), _
                               "@Colonia", "", _
                               "@CP", "", _
                               "@Asentamiento", 0, _
                               "@Usuario", ModPOS.UsuarioActual)
                        ...
                        row1 = dtMnpio.NewRow()
                        row1.Item("c_estado") = dt2.Rows(i)("c_estado")
                        row1.Item("c_mnpio") = dt2.Rows(i)("c_mnpio")
                        dtMnpio.Rows.Add(row1)



                    End If

                    foundRows = dtColonia.Select("c_estado = '" & dt2.Rows(i)("c_estado") & "' and c_mnpio = '" & dt2.Rows(i)("c_mnpio") & "' and codigo_postal = '" & dt2.Rows(i)("d_codigo") & "' and d_asentamiento = '" & CStr(dt2.Rows(i)("d_asenta")).ToUpper.Trim & "'")
                    If foundRows.GetLength(0) = 0 Then
                        'Agrega Colonia
                        ModPOS.Ejecuta("sp_inserta_geografia", _
                                "@Tipo", 3, _
                                "@Clave", obtenerLlave, _
                                "@Pais", cmbPais.SelectedValue, _
                                "@Estado", dt2.Rows(i)("c_estado"), _
                                "@Mnpio", dt2.Rows(i)("c_mnpio"), _
                                "@Colonia", CStr(dt2.Rows(i)("d_asenta")).ToUpper.Trim, _
                                "@CP", dt2.Rows(i)("d_codigo"), _
                                "@Asentamiento", CInt(dt2.Rows(i)("c_tipo_asenta")), _
                                "@Usuario", ModPOS.UsuarioActual)

                    
                        row1 = dtColonia.NewRow()
                        row1.Item("c_estado") = dt2.Rows(i)("c_estado")
                        row1.Item("c_mnpio") = dt2.Rows(i)("c_mnpio")
                        row1.Item("codigo_postal") = dt2.Rows(i)("d_codigo")
                        row1.Item("d_asentamiento") = CStr(dt2.Rows(i)("d_asenta")).ToUpper.Trim
                        dtColonia.Rows.Add(row1)
