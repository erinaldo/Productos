...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.btnAdjuntar.Location = New System.Drawing.Point(208, 430)
        ...
        Me.BtnRefresh.Location = New System.Drawing.Point(453, 14)
        ...
        Me.BtnSalir.Location = New System.Drawing.Point(112, 430)
        ...
        Me.CmbSucursal.Size = New System.Drawing.Size(359, 24)
        ...
        Me.GridCompras.FilterRowButtonStyle = Janus.Windows.GridEX.FilterRowButtonStyle.ConditionOperatorDropDown
...
#End Region
    ...
    Private Sub btnAdjuntar_Click(sender As Object, e As EventArgs) Handles btnAdjuntar.Click
        If sCompraSelected <> "" Then
            ...
            a.TipoDocumento = "Compra"
            a.COMClave = sCompraSelected
            a.Text = GridCompras.GetValue("Factura")
            a.ShowDialog()
            a.Dispose()
        Else
            MessageBox.Show("¡No se ha seleccionado una Compra", "Error", MessageBoxButtons.OK, MessageBoxIcon.Stop)
