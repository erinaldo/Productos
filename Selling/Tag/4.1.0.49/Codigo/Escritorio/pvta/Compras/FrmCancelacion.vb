...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.GrpPagos.Controls.Add(Me.btnAbono)
        ...
        Me.btnAbono.Location = New System.Drawing.Point(413, 11)
        Me.btnAbono.Name = "btnAbono"
        Me.btnAbono.Size = New System.Drawing.Size(62, 30)
        Me.btnAbono.TabIndex = 53
        Me.btnAbono.ToolTipText = "Modifica Pago"
...
#End Region
    ...
    Private Sub btnAbono_Click(sender As Object, e As EventArgs) Handles btnAbono.Click
        ...
        If foundRows.GetLength(0) = 1 Then
            Dim a As New FrmEditPago
            a.PAGClave = foundRows(0)("ID")
            If a.ShowDialog() = System.Windows.Forms.DialogResult.OK Then
                foundRows(0)("Tipo") = a.sMetodoPago
                foundRows(0)("Banco") = a.sBanco
                foundRows(0)("Fecha") = a.FechaPago
                foundRows(0)("Referencia") = a.Referencia
            End If
            a.Dispose()


        Else
            MessageBox.Show("Debe marcar un registro", "Información", MessageBoxButtons.OK, MessageBoxIcon.Information)
        End If
    End Sub
End Class
