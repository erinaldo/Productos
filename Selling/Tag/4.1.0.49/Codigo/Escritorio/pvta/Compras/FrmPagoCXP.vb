...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.dtPicker.Location = New System.Drawing.Point(171, 21)
        Me.dtPicker.Name = "dtPicker"
        Me.dtPicker.ShowUpDown = True
        Me.dtPicker.Size = New System.Drawing.Size(184, 22)
        Me.dtPicker.TabIndex = 142
        '
        'chkPagados
        '
        Me.chkPagados.Location = New System.Drawing.Point(375, 24)
        Me.chkPagados.Name = "chkPagados"
        Me.chkPagados.Size = New System.Drawing.Size(136, 19)
        ...
        Me.Almacen.Size = New System.Drawing.Size(64, 19)
        Me.Almacen.TabIndex = 107
        Me.Almacen.Text = "Periodo"
        '
        'ChkMarcaTodos
        '
...
#End Region
    ...
    Private Sub RecuperaFolios()
        ...
        dtCxP = ModPOS.Recupera_Tabla("sp_recupera_cxp", "@Periodo", Periodo, "@Mes", Mes, "@COMClave", ModPOS.CompanyActual, "@Pagado", iPagado)
    ...
    Private Sub muestraPagos(ByVal sID As String, ByVal sTipo As String)
        Dim a As New FrmConsultaGen
        a.Text = "Detalle de Pagos aplicados"
        ModPOS.ActualizaGrid(False, a.GridConsultaGen, "st_abn_aplicado_cxp", "@DOCClave", sID, "@Tipo", sTipo)
        a.GridConsultaGen.GroupByBoxVisible = False
        a.ShowDialog()
        a.Dispose()
    End Sub

    Private Sub GridCxC_DoubleClick(sender As Object, e As EventArgs) Handles GridCxC.DoubleClick
        If Not GridCxC.GetValue(0) Is Nothing Then
            If CDbl(GridCxC.GetValue("Saldo")) < CDbl(GridCxC.GetValue("Total")) Then
                Dim sID As String = GridCxC.GetValue("ID")
                Dim sTipo As String = GridCxC.GetValue("Tipo")
                muestraPagos(sID, sTipo)
            End If
        End If
    End Sub
    ...
    Private Sub cmbPlazo_SelectedIndexChanged(sender As Object, e As EventArgs)
        If BLoad = True Then
            RecuperaFolios()
        End If
    End Sub
