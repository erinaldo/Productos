...
#End Region
    ...
    Private Picking, SurtidoRF, ticketPicking As Boolean
    ...
    Private Sub FrmDevCompra_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Else
            ...
            If sUBCClave <> "" Then
                dt = ModPOS.Recupera_Tabla("sp_recupera_ubicacion", "@UBCClave", sUBCClave)
        ...
        If validaForm() Then
            ...
            If EstadoActual = 1 Then
                ...
                If EstadoActual = 2 Then 'Cerrado
                    ModPOS.GeneraMovInv(2, 2, 10, DEVClave, ALMClave, Folio, Autoriza, Picking)
            ...
            If EstadoActual <> 1 Then
                If Picking = True Then
                    Select Case MessageBox.Show("¿Desea Reimprimir la Hoja de Recolección?", "Pregunta", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
                        Case DialogResult.Yes
                            ModPOS.ImprimirSurtido(10, DEVClave, True, True, SUCClave, TIKClave, ticketPicking, TallaColor)
                    End Select
