...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'lblFecha
        '
        Me.lblFecha.Location = New System.Drawing.Point(75, 83)
        ...
        Me.cmbFechaPago.Location = New System.Drawing.Point(150, 81)
...
#End Region
    ...
    Private Function ObtenerFolio() As String
        ...
        dt = ModPOS.SiExisteRecupera("sp_recupera_folio", "@Tipo", 11, "@PDVClave", ModPOS.CompanyActual)
        If dt Is Nothing Then
            ModPOS.Ejecuta("sp_crea_folio", "@Tipo", 11, "@PDVClave", ModPOS.CompanyActual)
            Folio = 1
            Periodo = Today.Year
            Mes = Today.Month
        Else
            ...
            Mes = dt.Rows(0)("Mes")
            ModPOS.Ejecuta("sp_act_folio", "@Tipo", 11, "@PDVClave", ModPOS.CompanyActual, "@Incremento", 1)

            dt.Dispose()
        End If

        Clave = "PG" & Microsoft.VisualBasic.Right(CStr(Periodo), 2) & Microsoft.VisualBasic.Right("0" & CStr(Mes), 2) & "-" & CStr(Folio)
    ...
    Private Sub BtnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnOK.Click
        If validaForm() Then
            ...
            Dim FolioPago As String = ObtenerFolio()
            ...
            If cmbMetodoPago.SelectedValue = 1 Then
                ...
                ModPOS.Ejecuta("sp_inserta_pago", _
                                  ...
                                  "@fechaPago", cmbFechaPago.Value, _
