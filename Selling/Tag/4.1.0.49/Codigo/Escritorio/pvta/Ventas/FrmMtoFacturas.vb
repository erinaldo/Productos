...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.GridFacturas.FilterRowButtonStyle = Janus.Windows.GridEX.FilterRowButtonStyle.ConditionOperatorDropDown
                ...
                Case DialogResult.Yes
                    ...
                    If a.DialogResult = DialogResult.OK Then
                        If a.Autorizado Then
                            ...
                            If Stage <> "" Then
                                ModPOS.GeneraMovInv(1, 5, 2, foundRows(0)("FACClave"), ALMClave, foundRows(0)("Folio"), Autoriza, False, 1, Stage)
                            Else
                                ModPOS.GeneraMovInv(1, 5, 2, foundRows(0)("FACClave"), ALMClave, foundRows(0)("Folio"), Autoriza, False)
                            End If
