Public Class FrmCancelaProducto
    ...
    Public SucursalPadre As String = ""
...
#End Region
    ...
    Private Sub BtnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnOK.Click
        ...
        foundRows = dtDetalle.Select("Eliminar > 0 and Cantidad >= Eliminar and IdKIT <> '' ")
        If foundRows.GetLength(0) > 0 Then
            ...
            For i = 0 To foundRows.GetUpperBound(0)
                ...
                If sIdKIT <> foundRows(i)("IdKIT") Then
                    ...
                    foundRows2 = dtDetalle.Select("Eliminar = 0 and IdKIT = '" & foundRows(i)("IdKIT") & "' ")
            ...
            For i = 0 To foundRows.GetUpperBound(0)
                ...
                Select Case CantidadEliminar
                    ...
                    Case Is < CantidadOrigen
                        ...
                        If centroSuministro <> "" Then
                            ModPOS.Ejecuta("stpr_remueveTraslado", "@SUCClave", centroSuministro, "@Destino", SUCClave, "@VENClave", VENClave, "@PROClave", foundRows(i)("PROClave"), "@Cantidad", CantidadEliminar)
                        Else
    ...
    Private Sub GridProductos_CellEdited(sender As Object, e As Janus.Windows.GridEX.ColumnActionEventArgs) Handles GridProductos.CellEdited
        If GridProductos.CurrentColumn.Caption = "Eliminar" Then
            If IsNumeric(GridProductos.GetValue("Eliminar")) Then
                GridProductos.SetValue("Eliminar", ModPOS.Redondear(GridProductos.GetValue("Eliminar"), GridProductos.GetValue("Num_Decimales")))
    ...
    Private Sub FrmCancelaProducto_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        GridProductos.RootTable.Columns("centroSuministro").Visible = False
        GridProductos.RootTable.Columns("BackOrder").Visible = False
        GridProductos.RootTable.Columns("IdKIT").Visible = False
        ...
        GridProductos.RootTable.Columns("Num_Decimales").Visible = False
