Public Class FrmCambios
    ...
    Private MonRefBase, Moneda, MonedaCambio As String
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.LblNombreCte.Size = New System.Drawing.Size(594, 30)
        ...
        Me.BtnOK.Location = New System.Drawing.Point(561, 346)
        Me.BtnOK.Name = "BtnOK"
        ...
        Me.BtnSalir.Location = New System.Drawing.Point(465, 346)
        ...
        Me.ClientSize = New System.Drawing.Size(659, 390)
    ...
    Private Sub BtnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnOK.Click
        If validaForm() Then
            ...
            If PrecioCambio > PrecioRecibe Then
                ...
                Dim sFolio As String = "CM" & Referencia & Microsoft.VisualBasic.Right(CStr(Periodo), 2) & Microsoft.VisualBasic.Right("0" & CStr(Mes), 2) & "-" & CStr(Folio)
                ...
                Do
                    ...
                    If a.DialogResult = DialogResult.OK Then
                        ...
                        For i = 0 To a.detallePago.Rows.Count - 1
                            ModPOS.Aplica_Pagos(dtVenta, Cliente, a.detallePago.Rows(i)("ABNClave"), a.detallePago.Rows(i)("TipoPago"), a.detallePago.Rows(i)("SaldoBase"), CAJClave, 1, a.detallePago.Rows(i)("FechaPago"), idEvento)
                        Next
            ...
            ElseIf PrecioCambio < PrecioRecibe Then
                ...
                Dim msg As New FrmMeMsg
                msg.TxtTiulo = "Su Cambio es:"
                msg.TxtMsg = MonRefBase & " " & Format(CStr(Math.Round(Importe, 2)), "Currency")
                msg.TxtMsg2 = Letras(CStr(Math.Round(Importe, 2))).ToUpper & " " & MonRefBase
                msg.StartPosition = FormStartPosition.CenterScreen
                msg.BringToFront()
                msg.ShowDialog()
                msg.Dispose()
            ...
            dtValor = Recupera_Tabla("sp_obtener_valorref", "@Tabla", "Cambio", "@Campo", "Motivo", "@Valor", CmbMotivo.SelectedValue)
        ...
        Select Case e.KeyCode
            ...
            Case Is = Keys.Enter
                ...
                If Not TxtCodigo1.Text = vbNullString Then
                    ...
                    dtCliente = ModPOS.Recupera_Tabla("sp_venta_lista", "@Sucursal", SUCClave, "@Cliente", Cliente, "@TipoCanal", 0)
