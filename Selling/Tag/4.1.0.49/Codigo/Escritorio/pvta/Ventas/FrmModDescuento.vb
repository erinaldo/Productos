...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.grpMaterial.Controls.Add(Me.btnImportar)
        ...
        Me.btnBuscaMaterial.Location = New System.Drawing.Point(191, 13)
        Me.btnBuscaMaterial.Name = "btnBuscaMaterial"
        Me.btnBuscaMaterial.Size = New System.Drawing.Size(48, 27)
        ...
        Me.txtNombreMaterial.Anchor = CType(((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Left) _
            Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        Me.txtNombreMaterial.Location = New System.Drawing.Point(299, 19)
        Me.txtNombreMaterial.Name = "txtNombreMaterial"
        Me.txtNombreMaterial.ReadOnly = True
        Me.txtNombreMaterial.Size = New System.Drawing.Size(396, 20)
        ...
        Me.btnBuscaCliente.Location = New System.Drawing.Point(191, 13)
        Me.btnBuscaCliente.Name = "btnBuscaCliente"
        Me.btnBuscaCliente.Size = New System.Drawing.Size(48, 27)
        ...
        Me.btnImportar.Location = New System.Drawing.Point(245, 13)
        Me.btnImportar.Name = "btnImportar"
        Me.btnImportar.Size = New System.Drawing.Size(48, 27)
        Me.btnImportar.TabIndex = 181
...
#End Region
    ...
    Private Sub recuperaCliente(ByVal sClave As String)
        Dim dtCliente As DataTable = ModPOS.SiExisteRecupera("sp_recupera_clavecte", "@Clave", sClave, "@COMClave", ModPOS.CompanyActual, "@SUCClave")
    ...
    Private Function validaForm(ByVal bImportar As Boolean) As Boolean
        Dim i As Integer = 0
        ...
        Select Case Nivel
            ...
            Case 3, 10 'Material
                ...
                If bImportar = False Then
                    If Me.Producto = "" AndAlso (dtTemporal Is Nothing OrElse dtTemporal.Rows.Count = 0) Then
                        i += 1
                        reloj = New parpadea(Me.alerta(1))
                        reloj.Enabled = True
                        reloj.Start()
            ...
            Case Is = 4 ' Descuento\Material
                ...
                If bImportar = False Then
                    If ChkTodos.Checked = False AndAlso Me.Producto = "" AndAlso (dtTemporal Is Nothing OrElse dtTemporal.Rows.Count = 0) Then
                        i += 1
                        reloj = New parpadea(Me.alerta(1))
                        reloj.Enabled = True
                        reloj.Start()
    ...
    Private Function ImportarProductos() As Boolean
        ...
        Try
            ...
            If (openDlg.ShowDialog() = DialogResult.OK) Then
                ...
                dtTemporal = ReadCSV(curFileName, 1)
                        ...
                        If dtTemporal.Rows(i)("GTIN").GetType.FullName <> "System.DBNull" Then
                            ...
                            If dt.Rows.Count > 0 Then
                                ...
                                If Padre = "Nuevo" Then
                                    Select Case Nivel
                                        Case 1, 9 ' Cliente\Material
                                            ModPOS.DesCte.addVigencia(Tipo, Nivel, Clave, PROClave, txtClaveCliente.Text, CTEClave, "", 0, "", 0, "", 0, CDbl(txtInicio.Text), CDbl(txtFin.Text), CDbl(TxtImporte.Text), dtInicio.Value, dtFin.Value)
                                        Case 3, 10 'Material
                                            ModPOS.DesCte.addVigencia(Tipo, Nivel, Clave, PROClave, "", "", "", 0, "", 0, "", 0, CDbl(txtInicio.Text), CDbl(txtFin.Text), CDbl(TxtImporte.Text), dtInicio.Value, dtFin.Value)
                                        Case Is = 4 ' Descuento\Material
                                            ModPOS.DesCte.addVigencia(Tipo, Nivel, Clave, PROClave, "", "", "", 0, cmbDirecto.SelectedItem(1), cmbDirecto.SelectedValue, "", 0, CDbl(txtInicio.Text), CDbl(txtFin.Text), CDbl(TxtImporte.Text), dtInicio.Value, dtFin.Value)
                                    End Select
                                End If
