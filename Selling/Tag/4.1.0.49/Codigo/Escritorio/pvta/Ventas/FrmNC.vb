...
#End Region
    ...
    Private oCFD As CFD
    Private formaPagoFactura As String
    ...
    Public Sub CargaDatosFactura(ByVal Folio As String, ByVal esClave As Integer)
        ...
        If Not dtFactura Is Nothing AndAlso dtFactura.Rows.Count > 0 Then
            ...
            If TipoCF_fac = 2 AndAlso Estado_fac = 2 Then
                MessageBox.Show("No es posible realizar la NC de una factura que aun no ha sido certificada por el PAC (Timbrada)", "Información", MessageBoxButtons.OK, MessageBoxIcon.Information)
                Exit Sub
            End If
    ...
    Private Sub BtnGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnGuardar.Click
        ...
        If Not dtDetalle Is Nothing Then
            ...
            If foundRows.GetLength(0) > 0 Then
                ...
                a.Sucursal = SUCClave
                a.MontodeAutorizacion = CDbl(TotalNC * TipoCambio)
                ...
                Select Case MessageBox.Show("¿Desea imprimir la nota de crédito?", "Pregunta", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
                    ...
                    Case DialogResult.Yes
                        ...
                        imprimirNC(oCFD.TipoCF, FormatNC, NCClave, TotalNC, SUCClave, TipoCambio, MonedaDesc, MonedaRef, sImpresora, 1, oCFD.VersionCF, Logo)
