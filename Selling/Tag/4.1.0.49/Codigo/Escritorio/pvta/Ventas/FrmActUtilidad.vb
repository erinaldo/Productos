...
#End Region
    ...
    Private Sub FrmActUtilidad(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
        ModPOS.ActUtilidad.Dispose()
        ModPOS.ActUtilidad = Nothing
    End Sub
    ...
    Private Sub BtnGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnGuardar.Click
        If validaForm() Then
            ...
            If foundRows.GetLength(0) > 0 Then
                ...
                Beep()
                Select Case MessageBox.Show("Se va a " & CmbModificar.SelectedItem.ToString & " la Utilidad en un " & lblPorc.Text & TxtPorcentaje.Text & " de todos los registros marcados, esta deacuerdo?", "Pregunta", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
                    Case DialogResult.Yes
                        dUtilidad = CDbl(TxtPorcentaje.Text)

                        For i = 0 To foundRows.GetUpperBound(0)
                            sPROClave = foundRows(i)("ID")
                            ModPOS.Ejecuta("st_actualiza_utilidad", _
