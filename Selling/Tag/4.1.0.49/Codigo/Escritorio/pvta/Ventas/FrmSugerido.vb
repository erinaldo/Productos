        ...
        If Not dtProductos Is Nothing AndAlso dtProductos.Rows.Count > 0 Then
            ...
            If foundRows.GetLength(0) > 0 Then
                ...
                For i = 0 To foundRows.GetUpperBound(0)
                    ...
                    If Padre = "Touch" Then
                        ModPOS.TouchCK.AgregaGTIN(False, foundRows(i)("Clave"), False, False, foundRows(i)("Cant"))

                    ElseIf Padre = "Venta" Then
                        ModPOS.Mostradores(Me.numMostrador).AgregaGTIN(foundRows(i)("Clave"), True, False, False, foundRows(i)("Cant"), #1/1/1900#, #1/1/1900#, True, True)

                    ElseIf Padre = "Preventa" Then
                        ModPOS.PreVenta.AgregaGTIN(foundRows(i)("Clave"), True, False, False, foundRows(i)("Cant"), #1/1/1900#, #1/1/1900#, True, True)
