...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.GridNC.FilterRowButtonStyle = Janus.Windows.GridEX.FilterRowButtonStyle.ConditionOperatorDropDown
...
#End Region
    ...
    Public Sub refrescaGrid()
        ...
        GridNC.RootTable.Columns("Stage").Visible = False
    ...
    Private Sub BtnCancelar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnCancelar.Click
        ...
        If foundRows.GetLength(0) = 1 Then
            ...
            If foundRows(0)("Tipo") = "Devolución" Then
                If VerificaExistencia(4, foundRows(0)("NCClave"), foundRows(0)("ALMClave")) = False Then
                    Exit Sub
                End If
            End If
                ...
                Case DialogResult.Yes
                    ...
                    If a.DialogResult = DialogResult.OK Then
                        If a.Autorizado Then
                            ...
                            If foundRows(0)("Tipo") = "Devolución" Then
                                ReubicaStage(4, foundRows(0)("NCClave"), foundRows(0)("ALMClave"), foundRows(0)("Stage"), Autoriza)
                                ModPOS.GeneraMovInv(2, 5, 4, foundRows(0)("NCClave"), foundRows(0)("ALMClave"), foundRows(0)("Folio"), Autoriza, False, 1, foundRows(0)("Stage"))
                            End If
