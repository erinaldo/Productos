...
#End Region
    ...
    Private TipoCambio, TipoCambiario As Decimal
        ...
        If GridDetalle.GetValue("Fase") = 0 Then
            ...
            If Moneda <> MonedaCambio Then
                If TotalVenta > 0 Then
                    LblTipoCambio.Text = MonedaRef.ToUpper.Trim & " " & Format(CStr(ModPOS.Redondear(TotalVenta / TipoCambiario, 2)), "Currency")
                Else
    ...
    Private Function AgregaPartida(ByVal dtProducto As DataTable, ByVal sAbreviatura As String) As Boolean
        ...
        If Not dtProducto Is Nothing Then
            ...
            Dim bPreventa As Boolean = dtProducto.Rows(0)("Preventa")
            ...
            If bVtaPaquete = True Then
                MessageBox.Show("El producto " & sClave & ", su venta es exclusiva en Paquete ", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                Return False
            End If
    ...
    Private Sub BtnCerrar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnCerrar.Click
        ...
        If TotalArticulos > 0 Then
            ...
            If ComandaCerrada = False Then
                ...
                Dim dtPromocion As DataTable = ModPOS.SiExisteRecupera("sp_promocion_vigente_comanda", "CTEClave", CTEClaveActual, "@SUCCLave", SUCClave, "@CMDClave", CMDClave)
                ...
                If GeneraMovSalida Then
                    ModPOS.GeneraMovInv(2, 1, 1, CMDClave, ALMClave, LblFolio.Text, Nothing, False)
            ...
            If ComandaCerrada = True Then
                ModPOS.Ejecuta("sp_actualiza_venta_cerrada", "@VENClave", CMDClave, "@Estado", 2, "@ActSaldo", 0)
            End If
            ...
            If ComandaCerrada AndAlso Caja AndAlso TotalRecibido > 0 AndAlso MaxEfectivo > 0 Then
