...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.GridPerfiles.FilterRowButtonStyle = Janus.Windows.GridEX.FilterRowButtonStyle.ConditionOperatorDropDown
...
#End Region
    ...
    Public Sub actualiza_Grid()
        ...
        GridPerfiles.RootTable.Columns("AjustaExistencia").Visible = False
    ...
    Private Sub Modificar()
        If Not (Me.GridPerfiles.GetValue(0) Is Nothing OrElse Me.sPerfilSelected = "" OrElse (Me.GridPerfiles.GetValue(0) = "SUPER" And ModPOS.UsuarioActual <> "SU")) Then
            If ModPOS.Perfil Is Nothing Then
                ...
                End If
                ModPOS.Perfil.Ajusta = IIf(GridPerfiles.GetValue("AjustaExistencia").GetType.Name = "DBNull", 0, GridPerfiles.GetValue("AjustaExistencia"))
