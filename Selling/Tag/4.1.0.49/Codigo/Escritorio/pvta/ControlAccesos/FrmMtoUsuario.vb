...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.GridUsuarios.FilterRowButtonStyle = Janus.Windows.GridEX.FilterRowButtonStyle.ConditionOperatorDropDown
        ...
        If Me.sUsuarioSelected <> "" Then
            If ModPOS.Usuarios Is Nothing Then
                ...
                With ModPOS.Usuarios
                    ...
                    .PorcMaxDesc = IIf(dt.Rows(0)("PorcMaxDesc").GetType.FullName <> "System.DBNull", dt.Rows(0)("PorcMaxDesc"), 0)
                    .CambiaPrecio = IIf(dt.Rows(0)("CambiaPrecio").GetType.FullName <> "System.DBNull", dt.Rows(0)("CambiaPrecio"), 0)
                    .PERClave = dt.Rows(0)("PERClave")
                    .Login = IIf(dt.Rows(0)("Login").GetType.FullName <> "System.DBNull", dt.Rows(0)("Login"), "")
                    .Password = IIf(dt.Rows(0)("Password").GetType.FullName <> "System.DBNull", dt.Rows(0)("Password"), "")
                    .Estado = IIf(dt.Rows(0)("Estado").GetType.FullName <> "System.DBNull", dt.Rows(0)("Estado"), 1)
                    .SUCClave = IIf(dt.Rows(0)("SUCClave").GetType.FullName <> "System.DBNull", dt.Rows(0)("SUCClave"), "")
                    ...
                    .Tipo = IIf(dt.Rows(0)("Tipo").GetType.FullName = "System.DBNull", 0, dt.Rows(0)("Tipo"))
                    .Dias = IIf(dt.Rows(0)("Renovacion").GetType.FullName = "System.DBNull", 0, dt.Rows(0)("Renovacion"))
                End With
                dt.Dispose()
            End If
            ModPOS.Usuarios.StartPosition = FormStartPosition.CenterScreen
