Public Class MeFiltroAlmUbc
    ...
    Public ReadOnly Property UBCOrigen() As String
        Get
            UBCOrigen = UOrigen
        End Get
    End Property

    Public ReadOnly Property UBCDestino() As String
        Get
            UBCDestino = UDestino
        End Get
    End Property
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(MeFiltroAlmUbc))
        ...
        resources.ApplyResources(Me.lblCombo, "lblCombo")
        ...
        'Combo
        '
        resources.ApplyResources(Me.Combo, "Combo")
...
#End Region
    ...
    Private Sub BtnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnOK.Click
        If validaForm() Then
            ...
            UOrigen = TxtOrigen.Text
            UDestino = TxtDestino.Text
            bError = False
        Else
            bError = True
            Beep()
