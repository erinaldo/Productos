Public Class MeSearchSimple
    ...
    Public numColDescripcion2 As Integer = -1
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.GroupBox1.Size = New System.Drawing.Size(776, 512)
        ...
        Me.GridSearch.Size = New System.Drawing.Size(769, 499)
        ...
        Me.BtnCancel.Location = New System.Drawing.Point(592, 522)
        ...
        Me.BtnOK.Location = New System.Drawing.Point(688, 522)
        Me.BtnOK.Name = "BtnOK"
    ...
    Private Sub BtnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnOK.Click
        If Not GridSearch.DataSource Is Nothing Then
            If Not GridSearch.GetValue(numColValor) Is Nothing Then
                ...
                If numColDescripcion2 <> -1 Then
                    Descripcion2 = GridSearch.GetValue(numColDescripcion2)
                End If
            End If
            bError = False
            Me.Close()
