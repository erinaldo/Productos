...
#End Region
    ...
    Private Sub FrmMenu_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If dt.Columns.Contains("GrupoTipo") Then
            GrupoTipo = IIf(dt.Rows(0)("GrupoTipo").GetType.Name = "DBNull", 0, dt.Rows(0)("GrupoTipo"))
        End If
    ...
    Private Sub BtnBarMain_ItemClick(ByVal sender As System.Object, ByVal e As Janus.Windows.ButtonBar.ItemEventArgs) Handles BtnBarMain.ItemClick
        Select Case e.Item.Key
            ...
            Case "307"
                If ModPOS.MtoPaqueteria Is Nothing Then
                    ModPOS.MtoPaqueteria = New FrmMtoPaqueteria
                    ModPOS.MtoPaqueteria.MdiParent = MPrincipal

                End If
                ModPOS.MtoPaqueteria.StartPosition = FormStartPosition.CenterScreen
                ModPOS.MtoPaqueteria.Show()
                ModPOS.MtoPaqueteria.BringToFront()

                'Reportes
            Case "321"
                Dim a As New MeFiltroCteSuc
                ...
                If a.DialogResult = System.Windows.Forms.DialogResult.OK Then
                    ...
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_rep_VentasCK", "@SUCClave", a.Sucursal, "@FechaInicial", CDate(a.FechaInicio), "@FechaFinal", CDate(a.FechaFinal), "@CTEClave", a.Cliente, "@Canceladas", a.Cancelados))
                    OpenReport.PrintPreview("Reporte de Ventas CKlass", "CRVentasCK.rpt", pvtaDataSet, "")
                End If
            Case "322"
                ...
                If a.DialogResult = System.Windows.Forms.DialogResult.OK Then
                    ...
                    Dim pvtaDataSet As New DataSet
                    pvtaDataSet.DataSetName = "reportDataSet"
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_rep_PagosCredito", "@CTEClave", a.Cliente, "@FechaInicial", CDate(a.FechaInicio), "@FechaFinal", CDate(a.FechaFinal)))
                    OpenReport.PrintPreview("Reporte de pagos a créditos", "CRPagosCreditoCK.rpt", pvtaDataSet, "")
                End If
            Case "323"
                Dim a As New MeFiltroDevCK
                a.Titulo = "Reporte de Devoluciones"
                a.ShowDialog()
                If a.DialogResult = System.Windows.Forms.DialogResult.OK Then
                    Dim OpenReport As New Report
                    Dim pvtaDataSet As New DataSet
                    pvtaDataSet.DataSetName = "reportDataSet"
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_rep_devolucionCK", "@SUCClave", a.Sucursal, "@Inicio", CDate(a.FechaInicial), "@Fin", CDate(a.FechaFinal), "@Modelo", a.ClaveProducto, "@CTEClave", a.Cliente, "@Motivo", a.Motivo))
                    Dim fechas As String = " DEL " & CDate(a.FechaInicial).ToShortDateString() & " AL " & CDate(a.FechaFinal).ToShortDateString()
                    OpenReport.PrintPreview("Reporte de Devoluciones", "CRDevolucionCK.rpt", pvtaDataSet, fechas)
                End If
                a.Dispose()
            Case "324"
                Dim a As New MeFiltroDiaria
                a.Titulo = "Reporte de Pedidos Vencidos"
                a.textolbl = "Sucursal"
                a.StoreProcedure = "sp_filtra_sucursal"
                a.ChkDetallado.Visible = False
                a.ChkVtas.Visible = False
                a.ShowDialog()
                If a.DialogResult = System.Windows.Forms.DialogResult.OK Then
                    Dim OpenReport As New Report
                    Dim pvtaDataSet As New DataSet
                    pvtaDataSet.DataSetName = "reportDataSet"
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_rep_PedidosVencidos", "@SUCClave", a.Origen, "@FechaInicial", CDate(a.FechaInicio), "@FechaFinal", CDate(a.FechaFinal)))
                    OpenReport.PrintPreview("Reporte de Pedidos Vencidos", "CRPedidoVencido.rpt", pvtaDataSet, "")
                End If
                a.Dispose()
            Case "325"
                Dim a As New MeFiltroDiaria
                a.Titulo = "Reporte de Entregas Pendientes"
                a.textolbl = "Sucursal"
                a.StoreProcedure = "sp_filtra_sucursal"
                a.ChkDetallado.Visible = False
                a.ChkVtas.Visible = False
                ...
                If a.DialogResult = System.Windows.Forms.DialogResult.OK Then
                    ...
                    Dim pvtaDataSet As New DataSet
                    pvtaDataSet.DataSetName = "reportDataSet"
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_rep_EntregasPendientes", "@SUCClave", a.Origen, "@FechaInicial", CDate(a.FechaInicio), "@FechaFinal", CDate(a.FechaFinal)))
                    OpenReport.PrintPreview("Reporte de Entregas Pendientes", "CREntregasPendientes.rpt", pvtaDataSet, "")
                End If
                a.Dispose()
            Case "326"
                Dim a As New MeFiltroDiaria
                a.Titulo = "Reporte de Catálogos Vendidos"
                a.textolbl = "Sucursal"
                a.StoreProcedure = "sp_filtra_sucursal"
                a.ChkDetallado.Visible = False
                a.ChkVtas.Visible = False
                ...
                If a.DialogResult = System.Windows.Forms.DialogResult.OK Then
                    ...
                    Dim pvtaDataSet As New DataSet
                    pvtaDataSet.DataSetName = "reportDataSet"
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_rep_CatalogosVendidos", "@SUCClave", a.Origen, "@FechaInicio", CDate(a.FechaInicio), "@FechaFinal", CDate(a.FechaFinal)))
                    OpenReport.PrintPreview("Reporte de Catálogos Vendidos", "CRCatalogosVendidos.rpt", pvtaDataSet, "")
                End If
                a.Dispose()
            Case "327"

                Dim a As New MeFiltroCorte
                a.Titulo = "Reporte de Corte de Devoluciones"
                a.ChkTicket.Text = "Imprimir en PDF"
                a.ChkTicket.Visible = True
                a.ShowDialog()
                If a.DialogResult = System.Windows.Forms.DialogResult.OK Then
                    ...
                    If B.DialogResult = DialogResult.OK Then
                        If B.IdCorte <> "" Then
                            If a.ChkTicket.Checked Then
                                Dim OpenReport As New Report
                                Dim pvtaDataSet As New DataSet
                                pvtaDataSet.DataSetName = "reportDataSet"

                                'If TallaColor = 1 Then
                                pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_encabezado_corte", "@SUCClave", a.SucursalOrigen))
                                pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_corte_devoluciones", "@IdCorte", B.IdCorte))
                                pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_recupera_corte", "@ID", B.IdCorte))
                                OpenReport.PrintPreview("Reporte de Corte de Devolución", "crCorteDevCarta.rpt", pvtaDataSet, "")
                                'End If
                            Else
                                Dim sImpresora As String
                                Dim iCopias As Integer = 1
                                Dim PrintDialog1 As System.Windows.Forms.PrintDialog
                                ...
                                Dim dt As DataTable = ModPOS.Recupera_Tabla("sp_recupera_caja", "@Caja", a.CajaOrigen)
                                Dim TICDevolucion As String = dt.Rows(0)("TICDevolucion")
                                dt.Dispose()
                                imprimeTicketCierreDev(B.IdCorte, sImpresora, TICDevolucion, a.SucursalOrigen, True)
                            End If
            ...
            Case "328"
                ...
                Dim a As New MeFiltroRuta
                a.Titulo = "Ventas por Kilo"
                a.ShowDialog()
                If a.DialogResult = System.Windows.Forms.DialogResult.OK Then
                    Dim OpenReport As New Report
                    Dim pvtaDataSet As New DataSet
                    ...
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_rep_costeo", "@SUCClave", a.Origen, "@Inicio", CDate(a.FechaInicio), "@Fin", CDate(a.FechaFinal), "@Todos", a.ChkTodos.Checked, "@Rutas", a.Ruta))
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_rep_costeo_clas", "@SUCClave", a.Origen, "@Inicio", CDate(a.FechaInicio), "@Fin", CDate(a.FechaFinal), "@Todos", a.ChkTodos.Checked, "@Rutas", a.Ruta))
                    frmstatusmessage.Close()
                    OpenReport.PrintPreview("Venta por Kilos", "CRVentaKilos.rpt", pvtaDataSet, "")
                End If
                a.Dispose()
                        ...
                        If TallaColor = 1 Then
                            ...
                            If B.DialogResult = DialogResult.OK Then
                                If B.IdCorte <> "" Then
                                    ...
                                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_corte_cklass_det", "@IdCorte", B.IdCorte))
                                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_corte_cklass", "@IdCorte", B.IdCorte))
                        ...
                        If B.DialogResult = DialogResult.OK Then
                            If B.IdCorte <> "" Then
                                ...
                                If TallaColor = 1 Then
                                    ...
                                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_corte_cklass_det", "@IdCorte", B.IdCorte))
                                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_corte_cklass", "@IdCorte", B.IdCorte))
                                    OpenReport.PrintPreview("Reporte de Corte de Caja", "crCorteCarta.rpt", pvtaDataSet, "")
                                Else
                                    ...
                                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_rep_tarjetaAmiga_det", "@IdCorte", B.IdCorte))
            ...
            Case "398"
                ...
                a.Dispose()
            Case "399"
                Dim a As New MeFiltroSucursal
                a.Titulo = "Reporte de Existencias por Catalogo"
                a.ShowDialog()
                If a.DialogResult = System.Windows.Forms.DialogResult.OK Then
                    Dim OpenReport As New Report
                    Dim pvtaDataSet As New DataSet
                    pvtaDataSet.DataSetName = "reportDataSet"
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_rep_existenciaCatalogo", "@ALMClave", a.AlmacenOrigen))
                    OpenReport.PrintPreview("Reporte de Existencia por Catalogo", "CRExistCatalogos.rpt", pvtaDataSet, a.AlmacenNombre + " - " + a.AlmacenClave)
                End If
                a.Dispose()
            ...
            Case "417"
                ...
                If ModPOS.SplashVenta Is Nothing Then
                    ModPOS.SplashVenta = New FrmSplashVenta
                    ModPOS.SplashVenta.FrmPadre = "Devolucion"
                    ModPOS.SplashVenta.Label5.Text = "Abrir caja Devolución"
                    ModPOS.SplashVenta.GrpVenta.Text = "Caja"
                    ModPOS.SplashVenta.MdiParent = MPrincipal
                End If
                ModPOS.SplashVenta.StartPosition = FormStartPosition.CenterScreen
            ...
            Case "418"
                ...
                If ModPOS.Cierre Is Nothing Then
                    ModPOS.Cierre = New FrmCierre

                    ModPOS.Cierre.MdiParent = MPrincipal
                End If
                ModPOS.Cierre.StartPosition = FormStartPosition.CenterScreen
                ModPOS.Cierre.Show()
                ModPOS.Cierre.BringToFront()
            Case "419"
                If ModPOS.CancelarPedidos Is Nothing Then
                    ModPOS.CancelarPedidos = New FrmCancelarPedidos
                End If
                ModPOS.CancelarPedidos.StartPosition = FormStartPosition.CenterScreen
                ModPOS.CancelarPedidos.Show()
                ModPOS.CancelarPedidos.BringToFront()
            Case "500"
            ...
            Case "613"
                Dim a As New FrmSolicitaPacking
                If a.ShowDialog() = System.Windows.Forms.DialogResult.OK Then

                    If ModPOS.Surtido Is Nothing Then
                        ModPOS.Surtido = New FrmSurtido
                        ModPOS.Surtido.filtroEmpacador = a.AtiendeClave
                        ModPOS.Surtido.filtroUbicacion = a.UBCClave
                        ModPOS.Surtido.MdiParent = MPrincipal
                    End If
                    ModPOS.Surtido.StartPosition = FormStartPosition.CenterScreen
                    ModPOS.Surtido.Show()
            ...
            Case "714"
                If ModPOS.DevolucionMasiva Is Nothing Then
                    ModPOS.DevolucionMasiva = New FrmDevolucionMasiva
                    ModPOS.DevolucionMasiva.MdiParent = MPrincipal
                End If
                ModPOS.DevolucionMasiva.StartPosition = FormStartPosition.CenterScreen
                ModPOS.DevolucionMasiva.Show()
                ModPOS.DevolucionMasiva.BringToFront()
