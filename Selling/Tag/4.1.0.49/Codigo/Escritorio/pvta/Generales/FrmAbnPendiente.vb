...
#End Region
    ...
    Private Sub BtnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnOK.Click
        ...
        If Not GridAbonos.DataSource Is Nothing Then
            ...
            foundRows = dtAbonos.Select("Marca ='True'", "SaldoBase ASC")
    ...
    Private Sub GridAbonos_CellValueChanged(ByVal sender As Object, ByVal e As Janus.Windows.GridEX.ColumnActionEventArgs) Handles GridAbonos.CellValueChanged
        ...
        GridAbonos.Refresh()
        dSaldo = IIf(dtAbonos.Compute("Sum(SaldoBase)", "Marca = True") Is System.DBNull.Value, 0, dtAbonos.Compute("Sum(SaldoBase)", "Marca = True"))
