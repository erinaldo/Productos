...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.btnImprimir.Location = New System.Drawing.Point(508, 518)
        Me.btnImprimir.Name = "btnImprimir"
        Me.btnImprimir.Size = New System.Drawing.Size(90, 37)
        Me.btnImprimir.TabIndex = 135
        Me.btnImprimir.Text = "Pedido"
        Me.btnImprimir.ToolTipText = "Imprimir pedido seleccionado"
...
#End Region
    ...
    Private Sub loadPage()
        ...
        If ChkFolio.Checked = True Then
            If TxtFolio.Text <> "" Then
                ...
                dt = ModPOS.Recupera_Tabla("st_search_ticket_auditoria", "@Campo", CmbCampo.SelectedValue, "@Busqueda", TxtSearch.Text.ToUpper.Trim.Replace("'", "''"), "@COMClave", ModPOS.CompanyActual, "@FechaIni", FechaIni, "@FechaFin", FechaFin, "@Max", CInt(TxtMaxHits.Text), "@Folio", TxtFolio.Text.ToUpper.Trim.Replace("'", "''"))
    ...
    Private Sub ImprimirPedido(ByVal Venta As String, ByVal Total As Decimal, Optional ByVal bImprimir As Boolean = False, Optional ByVal sImpresora As String = "", Optional ByVal iCopias As Integer = 0, Optional ByVal bReimpresion As Boolean = False)
        previewPedido(FormatoPedido, Venta, Total, SUCClave, sImpresora, bImprimir, iCopias, bReimpresion, False, IIf(TallaColor = 1, "0", ""), IIf(TallaColor = 1, "0", ""), IIf(TallaColor = 1, True, False))
    End Sub
        ...
        If Not GridSearch.DataSource Is Nothing Then
            If Not GridSearch.GetValue("ID") Is Nothing Then
                ...
                If PrintDialog1.ShowDialog() = DialogResult.OK Then
                    ...
                    ImprimirPedido(valor, GridSearch.GetValue("Total"), True, sImpresora, PrintDialog1.PrinterSettings.Copies, True)
                End If
            End If
            bError = True
        Else
