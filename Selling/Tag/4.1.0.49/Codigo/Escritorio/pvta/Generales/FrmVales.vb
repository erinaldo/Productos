Public Class FrmVales
    ...
    Public MonRef As String = ""
    Public SaldoDocumento As Double = 0
    Public drVales() As DataRow
    ...
    Public WriteOnly Property Vales() As DataTable
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.GroupBox1.Size = New System.Drawing.Size(709, 292)
        ...
        Me.LblPagar.Location = New System.Drawing.Point(489, 10)
        ...
        Me.LblTotal.Location = New System.Drawing.Point(492, 268)
        ...
        Me.LblSaldo.Location = New System.Drawing.Point(551, 266)
        ...
        Me.GridAbonos.Size = New System.Drawing.Size(703, 231)
        ...
        Me.BtnOK.Location = New System.Drawing.Point(621, 295)
        Me.BtnOK.Name = "BtnOK"
        Me.BtnOK.Size = New System.Drawing.Size(90, 30)
        Me.BtnOK.TabIndex = 3
        Me.BtnOK.Text = "Imprimir"
        Me.BtnOK.ToolTipText = "Imprimir Vale seleccionado"
        ...
        Me.BtnCancel.Location = New System.Drawing.Point(525, 295)
...
#End Region
    ...
    Private Sub BtnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnOK.Click
        ...
        If Not GridAbonos.DataSource Is Nothing Then
            ...
            foundRows = dtVales.Select("Marca ='True'", "SaldoBase ASC")
            ...
            If foundRows.GetLength(0) > 0 Then
                ...
                For i = 0 To foundRows.GetUpperBound(0)
                    ...
                    If foundRows(i)("Importe") > foundRows(i)("Saldo") Then
                        bAplicado = True
                    End If

                    ImprimeVale(foundRows(i)("ID"), Impresora, Ticket, bAplicado, foundRows(i)("Tipo"), True, Generic)
                Next
    ...
    Private Sub MeSearch_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        GridAbonos.CurrentTable.Columns("MON").Selectable = False
        GridAbonos.CurrentTable.Columns("Saldo").Selectable = False
        GridAbonos.CurrentTable.Columns("SaldoBase").Visible = False

        LblPagar.Text = "Total a Pagar: " & MonRef & " " & Format(CStr(ModPOS.TruncateToDecimal(SaldoDocumento, 2)), "Currency")
    End Sub
    ...
    Private Sub GridAbonos_CellValueChanged(ByVal sender As Object, ByVal e As Janus.Windows.GridEX.ColumnActionEventArgs) Handles GridAbonos.CellValueChanged
        dtVales.AcceptChanges()
        GridAbonos.Refresh()
        dSaldo = IIf(dtVales.Compute("Sum(SaldoBase)", "Marca = True") Is System.DBNull.Value, 0, dtVales.Compute("Sum(SaldoBase)", "Marca = True"))
        Me.LblSaldo.Text = MonRef & " " & Format(CStr(ModPOS.TruncateToDecimal(dSaldo, 2)), "Currency")
    End Sub
