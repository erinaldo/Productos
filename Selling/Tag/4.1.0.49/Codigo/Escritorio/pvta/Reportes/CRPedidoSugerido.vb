...
Public Class CRPedidoSugerido
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRPedidoSugerido.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRPedidoSugerido
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRPedidoSugerido = New CRPedidoSugerido()
        rpt.Site = Me.Site
        Return rpt
    End Function
