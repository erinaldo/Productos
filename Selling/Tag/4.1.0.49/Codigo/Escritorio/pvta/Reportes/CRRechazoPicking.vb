...
Public Class CRRechazoPicking
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRRechazoPicking.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRRechazoPicking
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRRechazoPicking = New CRRechazoPicking()
        rpt.Site = Me.Site
        Return rpt
    End Function
