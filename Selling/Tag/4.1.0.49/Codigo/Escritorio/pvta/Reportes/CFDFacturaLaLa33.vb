...
Public Class CFDFacturaLaLa33
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CFDFacturaLaLa33.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCFDFacturaLaLa33
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CFDFacturaLaLa33 = New CFDFacturaLaLa33()
        rpt.Site = Me.Site
        Return rpt
    End Function
