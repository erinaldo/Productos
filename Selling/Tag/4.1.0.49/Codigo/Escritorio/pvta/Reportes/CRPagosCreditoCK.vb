...
Public Class CRPagosCreditoCK
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRPagosCreditoCK.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRPagosCreditoCK
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRPagosCreditoCK = New CRPagosCreditoCK()
        rpt.Site = Me.Site
        Return rpt
    End Function
