...
Public Class CRExistCatalogos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRExistCatalogos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRExistCatalogos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRExistCatalogos = New CRExistCatalogos()
        rpt.Site = Me.Site
        Return rpt
    End Function
