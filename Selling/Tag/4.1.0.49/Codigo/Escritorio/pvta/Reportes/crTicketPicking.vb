...
Public Class crTicketPicking
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.crTicketPicking.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrTicketPicking
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crTicketPicking = New crTicketPicking()
        rpt.Site = Me.Site
        Return rpt
    End Function
