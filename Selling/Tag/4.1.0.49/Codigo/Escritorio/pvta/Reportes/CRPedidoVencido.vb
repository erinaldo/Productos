...
Public Class CRPedidoVencido
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRPedidoVencido.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRPedidoVencido
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRPedidoVencido = New CRPedidoVencido()
        rpt.Site = Me.Site
        Return rpt
    End Function
