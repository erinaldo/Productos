...
Public Class CRIngresoNCFDI
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRIngresoNCFDI.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRIngresoNCFDI
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRIngresoNCFDI = New CRIngresoNCFDI()
        rpt.Site = Me.Site
        Return rpt
    End Function
