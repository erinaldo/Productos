...
Public Class CRMovimientosGral
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRMovimientosGral.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRMovimientosGral
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRMovimientosGral = New CRMovimientosGral()
        rpt.Site = Me.Site
        Return rpt
    End Function
