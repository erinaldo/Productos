...
Public Class CRRegistroValores
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRRegistroValores.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRRegistroValores
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRRegistroValores = New CRRegistroValores()
        rpt.Site = Me.Site
        Return rpt
    End Function
