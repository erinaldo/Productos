...
Public Class crCorteDevCarta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.crCorteDevCarta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrCorteDevCarta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crCorteDevCarta = New crCorteDevCarta()
        rpt.Site = Me.Site
        Return rpt
    End Function
