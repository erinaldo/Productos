...
Public Class CRDevolucionCK
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRDevolucionCK.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRDevolucionCK
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRDevolucionCK = New CRDevolucionCK()
        rpt.Site = Me.Site
        Return rpt
    End Function
