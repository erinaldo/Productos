...
Public Class crCorteTicket
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.crCorteTicket.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrCorteTicket
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crCorteTicket = New crCorteTicket()
        rpt.Site = Me.Site
        Return rpt
    End Function
