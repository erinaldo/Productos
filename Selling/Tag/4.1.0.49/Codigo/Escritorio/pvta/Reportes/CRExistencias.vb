...
Public Class CRExistencias
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRExistencias.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRExistencias
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRExistencias = New CRExistencias()
        rpt.Site = Me.Site
        Return rpt
    End Function
