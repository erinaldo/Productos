...
Public Class CRTarjetaAmiga
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRTarjetaAmiga.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRTarjetaAmiga
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRTarjetaAmiga = New CRTarjetaAmiga()
        rpt.Site = Me.Site
        Return rpt
    End Function
