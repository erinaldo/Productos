...
Public Class CRReciboTicket
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRReciboTicket.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRReciboTicket
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRReciboTicket = New CRReciboTicket()
        rpt.Site = Me.Site
        Return rpt
    End Function
