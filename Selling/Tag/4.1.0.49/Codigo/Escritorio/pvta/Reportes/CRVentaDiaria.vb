...
Public Class CRVentaDiaria
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRVentaDiaria.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRVentaDiaria
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRVentaDiaria = New CRVentaDiaria()
        rpt.Site = Me.Site
        Return rpt
    End Function
