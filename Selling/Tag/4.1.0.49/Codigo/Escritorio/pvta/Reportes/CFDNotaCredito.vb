...
Public Class CFDNotaCredito
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CFDNotaCredito.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCFDNotaCredito
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CFDNotaCredito = New CFDNotaCredito()
        rpt.Site = Me.Site
        Return rpt
    End Function
