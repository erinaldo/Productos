...
Public Class CRRechazoTraspaso
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRRechazoTraspaso.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRRechazoTraspaso
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRRechazoTraspaso = New CRRechazoTraspaso()
        rpt.Site = Me.Site
        Return rpt
    End Function
