...
Public Class crTicketCargo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.crTicketCargo.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_ProximoNivel() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedcrTicketCargo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crTicketCargo = New crTicketCargo()
        rpt.Site = Me.Site
        Return rpt
    End Function
