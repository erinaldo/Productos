...
Public Class CRPrecioSucursal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRPrecioSucursal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRPrecioSucursal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRPrecioSucursal = New CRPrecioSucursal()
        rpt.Site = Me.Site
        Return rpt
    End Function
