...
Public Class CRFacturaResumenPicking
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRFacturaResumenPicking.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRFacturaResumenPicking.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRFacturaResumenPicking
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRFacturaResumenPicking = New CRFacturaResumenPicking()
        rpt.Site = Me.Site
        Return rpt
    End Function
