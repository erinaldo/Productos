...
Public Class CRContrarecibos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRContrarecibos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRContrarecibos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRContrarecibos = New CRContrarecibos()
        rpt.Site = Me.Site
        Return rpt
    End Function
