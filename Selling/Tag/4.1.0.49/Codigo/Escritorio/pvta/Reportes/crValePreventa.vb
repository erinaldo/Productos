...
Public Class crValePreventa
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.crValePreventa.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrValePreventa
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crValePreventa = New crValePreventa()
        rpt.Site = Me.Site
        Return rpt
    End Function
