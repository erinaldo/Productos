...
Public Class CFDNotaCreditoCK
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CFDNotaCreditoCK.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCFDNotaCreditoCK
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CFDNotaCreditoCK = New CFDNotaCreditoCK()
        rpt.Site = Me.Site
        Return rpt
    End Function
