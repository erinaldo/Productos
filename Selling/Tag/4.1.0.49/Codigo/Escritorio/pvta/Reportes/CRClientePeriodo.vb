...
Public Class CRClientePeriodo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRClientePeriodo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRClientePeriodo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRClientePeriodo = New CRClientePeriodo()
        rpt.Site = Me.Site
        Return rpt
    End Function
