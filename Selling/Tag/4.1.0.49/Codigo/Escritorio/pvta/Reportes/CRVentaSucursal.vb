...
Public Class CRVentaSucursal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRVentaSucursal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRVentaSucursal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRVentaSucursal = New CRVentaSucursal()
        rpt.Site = Me.Site
        Return rpt
    End Function
