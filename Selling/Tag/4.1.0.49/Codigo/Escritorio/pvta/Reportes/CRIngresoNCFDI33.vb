...
Public Class CRIngresoNCFDI33
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRIngresoNCFDI33.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRIngresoNCFDI33
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRIngresoNCFDI33 = New CRIngresoNCFDI33()
        rpt.Site = Me.Site
        Return rpt
    End Function
