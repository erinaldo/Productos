...
Public Class CRNotasCredito
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRNotasCredito.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRNotasCredito
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRNotasCredito = New CRNotasCredito()
        rpt.Site = Me.Site
        Return rpt
    End Function
