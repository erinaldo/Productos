    ...
    Private Sub FrmCanvas_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.DoubleClick
        If ModPOS.CrearAlm Is Nothing Then
            ...
            With ModPOS.CrearAlm
                ...
                .TxtClave.Text = Me.Referencia
                .TxtClave.ReadOnly = True
                .sCpyNombre = Me.Nombre
                .TxtNombre.Text = Me.Nombre

                .iCpyEstado = Me.Estado
                .cmbTipoEstado.SelectedValue = Me.Estado

                .sCpySucursal = Me.SUCClave
                .CmbSucursal.SelectedValue = Me.SUCClave

                .dCpyAlto = Me.Alto
                .TxtAlto.Text = Me.Alto
                .dCpyLargo = Me.Largo
                .TxtLargo.Text = Me.Largo
                .dCpyAncho = Me.Ancho
                .TxtAncho.Text = Me.Ancho
                .iCpyEscala = Me.Escala
    ...
    Public Sub Control_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If ModPOS.Estructuras Is Nothing Then
            ...
            With ModPOS.Estructuras
                ...
                .sTESTClave = CStr(CType(sender, Estructura).TSTClave)
