        ...
        Select Case e.KeyCode
            ...
            Case Is = Keys.Enter
                ...
                If Not TxtCodigo1.Text = vbNullString Then
                    ...
                    Dim dtProducto As DataTable = ModPOS.SiExisteRecupera("sp_venta_producto", "@Tipo", 1, "@Busca", TxtCodigo1.Text.Trim.ToUpper.Replace("'", "''"), "@SUCClave", SUCClave, "@PREClave", ListaPrecio, "@CTEClave", Cliente, "@Cantidad", 1)
        ...
        Select Case e.KeyCode
            Case Is = Keys.Enter
                If Not TxtCodigo2.Text = vbNullString Then
                    ...
                    'Busca y recupera los datos del producto
                    Dim dtProducto As DataTable = ModPOS.SiExisteRecupera("sp_venta_producto", "@Tipo", 1, "@Busca", TxtCodigo2.Text.Trim.ToUpper.Replace("'", "''"), "@SUCClave", SUCClave, "@PREClave", ListaPrecio, "@CTEClave", Cliente, "@Cantidad", 1)
                    If Not dtProducto Is Nothing Then
