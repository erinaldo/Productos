...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.GrpProductos.Size = New System.Drawing.Size(771, 556)
        ...
        Me.TxtAlmacen.Size = New System.Drawing.Size(297, 22)
        ...
        Me.TxtUltimaVta.Location = New System.Drawing.Point(459, 87)
        ...
        Me.TxtPrecio.Location = New System.Drawing.Point(608, 86)
        ...
        Me.Label4.Location = New System.Drawing.Point(555, 90)
        ...
        Me.btnAplicacion.Location = New System.Drawing.Point(502, 44)
        ...
        Me.Label1.Location = New System.Drawing.Point(577, 19)
        ...
        Me.TxtMaxHits.Location = New System.Drawing.Point(709, 15)
        ...
        Me.GrpClas.Size = New System.Drawing.Size(220, 436)
        ...
        Me.TreeViewClass.Size = New System.Drawing.Size(207, 385)
        ...
        Me.btnPromocion.Location = New System.Drawing.Point(431, 44)
        ...
        Me.btnTransito.Location = New System.Drawing.Point(361, 44)
        ...
        Me.BtnCancelar.Location = New System.Drawing.Point(628, 44)
        ...
        Me.BtnStock.Location = New System.Drawing.Point(291, 44)
        ...
        Me.BtnAgregar.Location = New System.Drawing.Point(699, 44)
        ...
        Me.BtnEquivalente.Location = New System.Drawing.Point(221, 44)
        ...
        Me.BtnUbicacion.Location = New System.Drawing.Point(151, 44)
        ...
        Me.TxtBuscar.Anchor = CType(((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Left) _
                    Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        Me.TxtBuscar.Location = New System.Drawing.Point(178, 15)
        Me.TxtBuscar.Name = "TxtBuscar"
        Me.TxtBuscar.Size = New System.Drawing.Size(343, 22)
        ...
        Me.GridProductos.Size = New System.Drawing.Size(757, 438)
        ...
        Me.BtnImagen.Location = New System.Drawing.Point(79, 44)
        ...
        Me.picKeyboard.Location = New System.Drawing.Point(741, 532)
...
#End Region
    ...
    Private Sub actGrid(ByVal MaxHits As Integer, ByVal Tag As Integer, ByVal iCampo As Integer, ByVal sBusqueda As String, ByVal sAlmacen As String, ByVal sPrecio As String, ByVal iTipoImpuesto As Integer)

        bLoad = False

        If Tag = 0 Then
            ModPOS.ActualizaGrid(False, Me.GridProductos, "sp_busca_VentaProductos", "@Max", MaxHits, "@Campo", iCampo, "@Busqueda", sBusqueda, "@ALMClave", sAlmacen, "@COMClave", ModPOS.CompanyActual)
        Else
            ModPOS.ActualizaGrid(False, Me.GridProductos, "sp_busca_VentaClasProd", "@Class", Tag, "@ALMClave", sAlmacen, "@COMClave", ModPOS.CompanyActual)
        End If
    ...
    Private Sub actGridAplicacion(ByVal MaxHits As Integer, ByVal sAlmacen As String, ByVal sPrecio As String, ByVal iTipoImpuesto As Integer, ByVal sMarca As String, ByVal sModelo As String, ByVal iAño As Integer)

        bLoad = False

        ModPOS.ActualizaGrid(False, Me.GridProductos, "sp_busca_aplicacion", "@Max", MaxHits, "@Marca", sMarca, "@Modelo", sModelo, "@Año", iAño, "@ALMClave", sAlmacen, "@COMClave", ModPOS.CompanyActual)
    ...
    Private Sub Controls_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp, BtnAgregar.KeyUp, BtnCancelar.KeyUp, BtnEquivalente.KeyUp, BtnImagen.KeyUp, BtnUbicacion.KeyUp, CmbCampo.KeyUp, GridProductos.KeyUp, BtnStock.KeyUp, btnTransito.KeyUp, btnPromocion.KeyUp, btnAplicacion.KeyUp, cmbGrupo.KeyUp, TreeViewClass.KeyUp, TxtMaxHits.KeyUp
    ...
    Private Sub FrmBuscaProducto_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If BusquedaInicial Then
            ...
            If TxtBuscar.Text <> "" Then
                Me.actGrid(CInt(TxtMaxHits.Text), 0, CmbCampo.SelectedValue, TxtBuscar.Text, ALMClave, ListaPrecio, TImpuesto)
    ...
    Private Sub BtnAgregar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnAgregar.Click
                ...
                If Tipo = 1 Then
                    Select Case MessageBox.Show("La venta actual se encuentra cerrada ¿Desea crear un nuevo Ticket?", "Pregunta", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
                        Case DialogResult.Yes
                            ModPOS.Venta.btnVentaPerformClick(sClave)
                    End Select
                End If
            Else
        ...
        Else
            If bVentaConvencional = False Then
                If Tipo = 1 Then
                    ModPOS.Venta.AgregaGTIN(sClave)
                End If
            Else
                ModPOS.PreVenta.AgregaClave(sClave)
            End If
        End If
        Me.Close()
    End Sub
    ...
    Private Sub TreeViewClass_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles TreeViewClass.KeyUp
        If e.KeyCode = Keys.Enter AndAlso Not TreeViewClass.SelectedNode.Tag Is Nothing Then
            actGrid(CInt(TxtMaxHits.Text), TreeViewClass.SelectedNode.Tag, CmbCampo.SelectedValue, TxtBuscar.Text, ALMClave, ListaPrecio, TImpuesto)
        End If
    End Sub
    ...
    Private Sub TreeViewClass_NodeMouseClick(ByVal sender As Object, ByVal e As System.Windows.Forms.TreeNodeMouseClickEventArgs) Handles TreeViewClass.NodeMouseClick
        If Not e.Node.Tag Is Nothing Then
            actGrid(CInt(TxtMaxHits.Text), e.Node.Tag, CmbCampo.SelectedValue, TxtBuscar.Text, ALMClave, ListaPrecio, TImpuesto)
        End If
    End Sub
    ...
    Private Sub btnAplicacion_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAplicacion.Click
        ...
        If a.DialogResult = DialogResult.OK Then
            Me.actGridAplicacion(CInt(TxtMaxHits.Text), ALMClave, ListaPrecio, TImpuesto, a.Marca, a.Modelo, a.Año)
        End If
        a.Dispose()
    End Sub
    ...
    Private Sub btnClasificacion_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnClasificacion.Click
        ...
        Else
            ...
            If bClasLoad = False Then
                actualizaTree(IIf(cmbGrupo.SelectedValue Is Nothing, 0, cmbGrupo.SelectedValue))
                Me.actGrid(CInt(TxtMaxHits.Text), TreeViewClass.TopNode.Tag, CmbCampo.SelectedValue, TxtBuscar.Text, ALMClave, ListaPrecio, TImpuesto)
                bClasLoad = True
            End If
        End If
    End Sub
