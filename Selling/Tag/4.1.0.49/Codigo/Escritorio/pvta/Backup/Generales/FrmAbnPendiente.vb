...
#End Region
    ...
    Private Sub BtnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnOK.Click
        ...
        If Not GridAbonos.DataSource Is Nothing Then
            ...
            foundRows = dtAbonos.Select("Marca ='True'")

            If foundRows.GetLength(0) > 0 Then

                If dSaldo <= SaldoDocumento Then
                    drAbonos = foundRows
                    bError = False
                Else
                    MessageBox.Show("El la suma de los abonos seleccionados no debe ser mayor al total por pagar", "Información", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    bError = True
                End If
                'ABNClave = GridAbonos.GetValue(0)
                'Saldo = GridAbonos.GetValue("Saldo")
                'TPago = GridAbonos.GetValue("TipoPago")
            Else
    ...
    Private Sub MeSearch_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        dtAbonos = ModPOS.Recupera_Tabla("sp_aplicar_abn", "@CTEClave", CTEClave)
        ...
        LblPagar.Text = "Total a Pagar: " & Format(CStr(ModPOS.Redondear(SaldoDocumento, 2)), "Currency")
    End Sub
        ...
        If dtAbonos.Rows.Count > 0 Then
            ...
            If ChkMarcaTodos.Checked Then
                ...
                For i = 0 To dtAbonos.Rows.Count - 1
                    dtAbonos.Rows(i)("Marca") = True
                Next
            Else
                For i = 0 To dtAbonos.Rows.Count - 1
                    dtAbonos.Rows(i)("Marca") = False
                Next
            End If
