...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.GrpPagos.Location = New System.Drawing.Point(7, 68)
        Me.GrpPagos.Name = "GrpPagos"
        Me.GrpPagos.Size = New System.Drawing.Size(378, 353)
        ...
        Me.GridPagos.Size = New System.Drawing.Size(366, 304)
        ...
        Me.PictureBox2.Location = New System.Drawing.Point(593, 16)
        ...
        Me.CmbMes.Location = New System.Drawing.Point(634, 11)
        ...
        Me.CmbPeriodo.Location = New System.Drawing.Point(490, 11)
        ...
        Me.PictureBox3.Location = New System.Drawing.Point(772, 15)
        ...
        Me.Label2.Location = New System.Drawing.Point(442, 15)
        ...
        Me.BtnSalir.Location = New System.Drawing.Point(595, 428)
        ...
        Me.BtnCancelar.Location = New System.Drawing.Point(692, 429)
        ...
        Me.GrpCompras.Location = New System.Drawing.Point(390, 68)
        Me.GrpCompras.Name = "GrpCompras"
        Me.GrpCompras.Size = New System.Drawing.Size(392, 353)
        ...
        Me.GrdCompras.Size = New System.Drawing.Size(381, 304)
        ...
        Me.CmbAlmacen.Location = New System.Drawing.Point(73, 47)
        Me.CmbAlmacen.Name = "CmbAlmacen"
        Me.CmbAlmacen.Size = New System.Drawing.Size(307, 21)
        Me.CmbAlmacen.TabIndex = 108
        '
        'Almacen
        '
        ...
        Me.Almacen.Location = New System.Drawing.Point(11, 50)
        Me.Almacen.Name = "Almacen"
        Me.Almacen.Size = New System.Drawing.Size(56, 15)
        Me.Almacen.TabIndex = 109
        Me.Almacen.Text = "Almacén"
        '
        'PictureBox4
        '
        Me.PictureBox4.Image = CType(resources.GetObject("PictureBox4.Image"), System.Drawing.Image)
        Me.PictureBox4.Location = New System.Drawing.Point(384, 50)
...
#End Region
    ...
    Private Sub AgregarFolio(ByVal Folio As Boolean, ByVal FirsTime As Boolean)
        If validaForm(Folio) Then
            ...
            If Folio Then
                dtPagos = ModPOS.Recupera_Tabla("sp_busca_pagos", "@ALMClave", CmbAlmacen.SelectedValue, "@Folio", TxtFolio.Text.ToUpper.Trim.Replace("'", "''"))
            Else
                dtPagos = ModPOS.Recupera_Tabla("sp_recupera_pagos", "@ALMClave", CmbAlmacen.SelectedValue, "@Periodo", CmbPeriodo.SelectedValue, "@Mes", CmbMes.SelectedValue)
            End If
        ...
        If dtPagos.Rows.Count > 0 Then
            ...
            If ChkMarcaTodos.Checked Then
                For i = 0 To dtPagos.Rows.Count - 1
                    dtPagos.Rows(i)("Marca") = True
                Next
            Else
                For i = 0 To dtPagos.Rows.Count - 1
                    dtPagos.Rows(i)("Marca") = False
                Next
            End If
        End If
    End Sub
    ...
    Private Sub BtnCancelaTicket_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnCancelar.Click
        If Not dtPagos Is Nothing AndAlso Not CmbAlmacen.SelectedValue Is Nothing Then
            Dim i As Integer
                ...
                For i = 0 To foundRows.GetUpperBound(0)
                    ...
                    Select Case MessageBox.Show("¿Esta seguro de Cancelar el Pago en " & foundRows(i)(4) & " de " & Format(CStr(foundRows(i)(3)), "Currency") & " ?", "Pregunta", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
                        Case DialogResult.Yes
                            ...
                            a.Sucursal = SUCClave
                            a.MontodeAutorizacion = foundRows(i)(3)
