...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmMtoContenedor))
        ...
        Me.GridCaja.Size = New System.Drawing.Size(666, 314)
...
#End Region
    ...
    Private Sub FrmMtoContenedor_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'ModPOS.CambiarEstiloXP.CambiarEstilo(Me)
        Cursor.Current = Cursors.WaitCursor
        ModPOS.ActualizaGrid(True, Me.GridCaja, "sp_muestra_contenedores", "@COMClave", ModPOS.CompanyActual)
        Me.GridCaja.RootTable.Columns("CONClave").Visible = False
    ...
    Private Sub GridCaja_SelectionChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles GridCaja.SelectionChanged
        If Not GridCaja.GetValue("CONClave") Is Nothing Then
            Me.BtnModificar.Enabled = True
            Me.BtnEliminar.Enabled = True
            Me.sCAJASelected = GridCaja.GetValue("CONClave")
    ...
    Private Sub BtnAgregar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnAgregar.Click
        If ModPOS.Contenedor Is Nothing Then
            ModPOS.Contenedor = New FrmContenedor
            With ModPOS.Contenedor
                .Text = "Agregar Caja"
            ...
            End With
        End If
        ModPOS.Contenedor.StartPosition = FormStartPosition.CenterScreen
        ModPOS.Contenedor.Show()
        ModPOS.Contenedor.BringToFront()
    End Sub
        ...
        If sCAJASelected <> "" Then
            ...
            If ModPOS.Contenedor Is Nothing Then
                ...
                With ModPOS.Contenedor
                    ...
                    Dim dt As DataTable
                    dt = ModPOS.Recupera_Tabla("sp_recupera_contenedor", "@CONClave", Me.sCAJASelected)
    ...
    Private Sub GridCaja_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles GridCaja.DoubleClick
        modificarCaja()
    End Sub
        ...
        If sCAJASelected <> "" Then
            ...
            Select Case MessageBox.Show("Se eliminara la Caja :" & sNombre, "Advertencia", MessageBoxButtons.YesNo, MessageBoxIcon.Warning)
                Case DialogResult.Yes
                    ...
                    ModPOS.Ejecuta("sp_elimina_contenedor", "@CONClave", sCAJASelected, "@Usuario", ModPOS.UsuarioActual)
    ...
    Private Sub FrmMtoContenedor_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
        ModPOS.MtoContenedor.Dispose()
        ModPOS.MtoContenedor = Nothing
    End Sub
End Class
