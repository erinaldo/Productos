...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.TxtAlto.Location = New System.Drawing.Point(94, 16)
        ...
        'cmbTipoEstado
        '
        Me.cmbTipoEstado.Location = New System.Drawing.Point(94, 89)
        Me.cmbTipoEstado.Name = "cmbTipoEstado"
        Me.cmbTipoEstado.Size = New System.Drawing.Size(155, 21)
        ...
        'NumericUpDown1
        '
        Me.NumericUpDown1.Location = New System.Drawing.Point(94, 51)
        ...
        Me.PictureBox3.Location = New System.Drawing.Point(255, 94)
        ...
        Me.PictureBox2.Location = New System.Drawing.Point(217, 55)
...
#End Region
    ...
    Private Sub BtnAceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnAceptar.Click
        If CDbl(Me.TxtAlto.Text) <> dAlto OrElse Me.cmbTipoEstado.SelectedValue <> iEstado Then
            If validaForm() Then
                If Not (dAlto = CDbl(TxtAlto.Text) AndAlso _
                      iEstado = CInt(cmbTipoEstado.SelectedValue) AndAlso _
                      iPorc = CInt(NumericUpDown1.Value)) Then

                    Dim actEdo As Boolean

                    If iEstado <> CInt(cmbTipoEstado.SelectedValue) Then
                        actEdo = True
                    Else
                        actEdo = False
                    End If
                    ...
                    If actEdo Then
                        Ejecuta("sp_cambio_edo_hueco", "@ESTClave", Me.sEstructura, "@HUEClave", Me.sHueco, "@Estado", cmbTipoEstado.SelectedValue, "@Usuario", ModPOS.UsuarioActual)

                        ModPOS.Estructuras.cargaUbicaciones(sHueco & "-" & sNivel, sEstructura)




                        Dim dt As DataTable = Recupera_Tabla("st_recupera_ubc_hueco", "@HUEClave", sHueco, "@ESTClave", Me.sEstructura, "@Estado", cmbTipoEstado.SelectedValue)
                        If dt.Rows.Count > 0 Then
                            ...
                            For i = 0 To dt.Rows.Count - 1
                                ...
                                msg = ModPOS.Ejecuta("sp_bloqueo_ubc", "@ALMClave", sAlmacen, "@UBCClave", dt.Rows(i)("UBCClave"), "@PROClave", dt.Rows(i)("PROClave"), "@Estado", cmbTipoEstado.SelectedValue, "@Usuario", ModPOS.UsuarioActual)



                                If cmbTipoEstado.SelectedValue = 0 Then
                                    cantCambioEdo = dt.Rows(i)("Cantidad")
                                Else
                                    cantCambioEdo = dt.Rows(i)("Bloqueado")
                                End If


                                msg = ModPOS.Ejecuta("st_cambio_estado", _
                                               "@SUCClave", sSucursal, _
                                               "@ALMClave", sAlmacen, _
                                               "@UBCClave", dt.Rows(i)("UBCClave"), _
                                               "@PROClave", dt.Rows(i)("PROClave"), _
                                               "@Cantidad", cantCambioEdo, _
                                               "@Estado", cmbTipoEstado.SelectedValue, _
                            ...
                            If Not ModPOS.Estructuras Is Nothing Then

                                ModPOS.Estructuras.cargaContenido()
                            End If
    ...
    Private Function validaForm() As Boolean
        ...
        If cmbTipoEstado.SelectedValue Is Nothing Then
            i += 1
