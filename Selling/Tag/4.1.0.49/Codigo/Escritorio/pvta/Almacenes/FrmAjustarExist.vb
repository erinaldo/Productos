...
#End Region
    ...
    Private Sub actprd(ByVal sPROClave As String, ByVal sClave As String, ByVal sDesc As String, ByVal dCantidad As Double)
        ...
        If foundRows.Length = 0 Then
            ...
            row1.Item("Marca") = IIf(dCantidad = 0, True, False)
        ...
        Else
            ...
            foundRows(0)("Marca") = IIf(dCantidad = 0, True, False)
        End If
                    ...
                    If dtTemporal.Rows.Count > 0 Then
                        ...
                        For i = 0 To dtTemporal.Rows.Count - 1
                            ...
                            If dtTemporal.Rows(i)("GTIN").GetType.FullName <> "System.DBNull" Then
                                dt = Recupera_Tabla("sp_compra_producto", "@COMClave", ModPOS.CompanyActual, "@Clave", dtTemporal.Rows(i)("GTIN").ToString.Replace("'", "''").Trim, "@Char", cReplace, "@TallaColor", TallaColor)
                                If dt.Rows.Count > 0 Then
