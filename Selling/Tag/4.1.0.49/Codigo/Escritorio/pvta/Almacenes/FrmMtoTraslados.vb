...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.GridTraslados.FilterRowButtonStyle = Janus.Windows.GridEX.FilterRowButtonStyle.ConditionOperatorDropDown
                    ...
                    If a.DialogResult = DialogResult.OK Then
                        If a.Autorizado Then
                            ...
                            For i = 0 To foundRows.GetUpperBound(0)
                                ...
                                Dim SUCClave As String, ALMClave As String, Folio As String
                                ...
                                Dim dtCargo As DataTable = ModPOS.SiExisteRecupera("st_verificarCargoProveedor", "@TRSClave", foundRows(i)("TRSClave"))
                                If Not dtCargo Is Nothing Then
                                    If dtCargo.Rows(0)("Cantidad") > 0 Then
                                        MessageBox.Show("No es posible cancelar el Traslado: " & CStr(foundRows(i)("Folio")) & " ya que cuenta con cargos a proveedor asociados", "Información", MessageBoxButtons.OK)
                                        valido = False
                                    End If
                                End If
                                ...
                                If valido Then
                                    If iEstado = 1 Then
                                        ...
                                        refrescaGrid()
                                    ElseIf iEstado = 2 AndAlso SUCClave = Me.CmbSucursal.SelectedValue Then
                                        ...
                                        If Picking Then
                                            ModPOS.Ejecuta("st_cancela_traslado_cerrado", "@ALMClave", ALMClave, "@TRSClave", foundRows(i)("TRSClave"), "@Referencia", Folio, "@USRClave", ModPOS.UsuarioActual)
                                        Else
    ...
    Private Sub BtnReimpresion_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnReimpresion.Click
        ...
        If foundRows.GetLength(0) > 0 Then
            ...
            If cmbFormato.SelectedValue = 1 Then
                ...
                For i = 0 To foundRows.GetUpperBound(0)
                    ModPOS.imprimirTicketTraslado(sTIKClave, True, foundRows(i)("TRSClave"), TallaColor)
                Next
