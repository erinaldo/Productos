...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents btnTalla As Janus.Windows.EditControls.UIButton
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.btnTalla = New Janus.Windows.EditControls.UIButton()
        ...
        Me.GrpProductos.Controls.Add(Me.chkSinExistencia)
        ...
        'chkSinExistencia
        '
        Me.chkSinExistencia.Anchor = CType((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        Me.chkSinExistencia.CheckAlign = System.Drawing.ContentAlignment.MiddleRight
        Me.chkSinExistencia.Location = New System.Drawing.Point(440, 92)
        Me.chkSinExistencia.Name = "chkSinExistencia"
        Me.chkSinExistencia.Size = New System.Drawing.Size(103, 19)
        Me.chkSinExistencia.TabIndex = 142
        Me.chkSinExistencia.Text = "Sin Existencia"
        '
        'cmbSucursalO
        '
        ...
        Me.GroupBox1.Anchor = CType(((System.Windows.Forms.AnchorStyles.Bottom Or System.Windows.Forms.AnchorStyles.Left) _
            Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        Me.GroupBox1.Controls.Add(Me.btnTalla)
        ...
        'btnTalla
        '
        Me.btnTalla.Anchor = CType((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        Me.btnTalla.Image = Global.Selling.My.Resources.Resources.iconfinder_format_text_size_3671766
        Me.btnTalla.ImageSize = New System.Drawing.Size(20, 20)
        Me.btnTalla.Location = New System.Drawing.Point(106, 12)
        Me.btnTalla.Name = "btnTalla"
        Me.btnTalla.Size = New System.Drawing.Size(105, 30)
        Me.btnTalla.TabIndex = 22
        Me.btnTalla.Text = "Cambio"
        Me.btnTalla.ToolTipText = "Cambio de Talla"
        Me.btnTalla.VisualStyle = Janus.Windows.UI.VisualStyle.Office2007
        '
        'BtnStock
        '
        ...
        Me.BtnStock.Location = New System.Drawing.Point(328, 12)
        Me.BtnStock.Name = "BtnStock"
        Me.BtnStock.Size = New System.Drawing.Size(105, 30)
        ...
        Me.BtnImp.Location = New System.Drawing.Point(439, 12)
        Me.BtnImp.Name = "BtnImp"
        Me.BtnImp.Size = New System.Drawing.Size(105, 30)
        ...
        Me.BtnAjustar.Location = New System.Drawing.Point(217, 12)
        Me.BtnAjustar.Name = "BtnAjustar"
        Me.BtnAjustar.Size = New System.Drawing.Size(105, 30)
        Me.BtnAjustar.TabIndex = 7
        Me.BtnAjustar.Text = "&Mov. Almacén"
        ...
        Me.BtnCancelar.Location = New System.Drawing.Point(691, 519)
...
#End Region
    ...
    Private Sub FrmMtoExistencia_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim dtParam As DataTable = ModPOS.Recupera_Tabla("sp_recupera_comparam", "@PARClave", "TallaColor", "@COMClave", ModPOS.CompanyActual)
        ...
        If TallaColor = 1 Then
            btnTalla.Visible = True
        Else
            btnTalla.Visible = False
        End If
    ...
    Private Sub GridProductos_DoubleClick(sender As Object, e As EventArgs) Handles GridProductos.DoubleClick
        If sProdSelected <> "" Then
            If sProdSelected <> "" Then
                ...
                a.Text = "Detalle de Apartados"
                ModPOS.ActualizaGrid(False, a.GridConsultaGen, "st_consulta_apartados", "@PROClave", sProdSelected, "@ALMClave", CmbAlmacen.SelectedValue)
    ...
    Public Sub AjustarExistencia()
        If sProdSelected <> "" Or TallaColor = 1 Then
    ...
    Public Sub recuperaExistencia(ByVal iTipo As Integer, ByVal sT As String)
        ...
        Select Case iTipo
            Case Is = 1
                dtExistencia = ModPOS.Recupera_Tabla("sp_muestra_existencias", "@Tipo", iTipo, "@ALMClave", CmbAlmacen.SelectedValue, "@Campo", CmbCampo.SelectedValue, "@Busca", TxtBuscar.Text.ToUpper.Trim, "@Char", cReplace, "@SinExist", chkSinExistencia.Checked, "@TallaColor", TallaColor)
            Case Is = 2
                If TreeViewClass.SelectedNode Is Nothing Then
                    dtExistencia = ModPOS.Recupera_Tabla("sp_muestra_existencias", "@Tipo", iTipo, "@ALMClave", CmbAlmacen.SelectedValue, "@Class", TreeViewClass.TopNode.Tag, "@Char", cReplace, "@SinExist", chkSinExistencia.Checked, "@TallaColor", TallaColor)
                    sTag = TreeViewClass.TopNode.Tag
                Else
                    dtExistencia = ModPOS.Recupera_Tabla("sp_muestra_existencias", "@Tipo", iTipo, "@ALMClave", CmbAlmacen.SelectedValue, "@Class", TreeViewClass.SelectedNode.Tag, "@Char", cReplace, "@SinExist", chkSinExistencia.Checked, "@TallaColor", TallaColor)
                    sTag = TreeViewClass.SelectedNode.Tag
                End If
            Case Is = 3
                dtExistencia = ModPOS.Recupera_Tabla("sp_muestra_existencias", "@Tipo", iTipo, "@ALMClave", CmbAlmacen.SelectedValue, "@Class", sT, "@Char", cReplace, "@SinExist", chkSinExistencia.Checked, "@TallaColor", TallaColor)
                sTag = sT
            Case Is = 4
                dtExistencia = ModPOS.Recupera_Tabla("sp_muestra_existencias", "@Tipo", iTipo, "@ALMClave", CmbAlmacen.SelectedValue, "@UBCClave", TxtUbicacion.Text.ToUpper.Trim, "@Char", cReplace, "@SinExist", chkSinExistencia.Checked, "@TallaColor", TallaColor)
        End Select
        ...
        GridProductos.RootTable.Columns("Exist").TextAlignment = Janus.Windows.GridEX.TextAlignment.Far
        GridProductos.RootTable.Columns("Apart").TextAlignment = Janus.Windows.GridEX.TextAlignment.Far
        GridProductos.RootTable.Columns("Bloq").TextAlignment = Janus.Windows.GridEX.TextAlignment.Far


        If TallaColor = 1 Then
            GridProductos.RootTable.Columns("Clave").Visible = False
            GridProductos.RootTable.Columns("Nombre").Visible = False
            Me.GridProductos.RootTable.Columns("Modelo").Width = 70
            Me.GridProductos.RootTable.Columns("C.BARRAS").Width = 70
            Me.GridProductos.RootTable.Columns("Color").Width = 200
            Me.GridProductos.RootTable.Columns("Talla").Width = 70
        Else
    ...
    Private Sub BtnImp_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnImp.Click
        If sUBCClave <> "" AndAlso Not CmbAlmacen.SelectedValue Is Nothing Then
            ...
            Select Case TipoConsulta
                Case Is = 1
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_muestra_existencias", "@Tipo", TipoConsulta, "@ALMClave", CmbAlmacen.SelectedValue, "@Campo", CmbCampo.SelectedValue, "@Busca", TxtBuscar.Text.ToUpper.Trim, "@Char", cReplace, "@SinExist", chkSinExistencia.Checked, "@TallaColor", TallaColor))
                Case Is = 2
                    If TreeViewClass.SelectedNode Is Nothing Then
                        pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_muestra_existencias", "@Tipo", TipoConsulta, "@ALMClave", CmbAlmacen.SelectedValue, "@Class", sTag, "@Char", cReplace, "@SinExist", chkSinExistencia.Checked, "@TallaColor", TallaColor))
                    Else
                        pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_muestra_existencias", "@Tipo", TipoConsulta, "@ALMClave", CmbAlmacen.SelectedValue, "@Class", sTag, "@Char", cReplace, "@SinExist", chkSinExistencia.Checked, "@TallaColor", TallaColor))
                    End If
                Case Is = 3
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_muestra_existencias", "@Tipo", TipoConsulta, "@ALMClave", CmbAlmacen.SelectedValue, "@Class", sTag, "@Char", cReplace, "@SinExist", chkSinExistencia.Checked, "@TallaColor", TallaColor))
                Case Is = 4
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_muestra_existencias", "@Tipo", TipoConsulta, "@ALMClave", CmbAlmacen.SelectedValue, "@UBCClave", TxtUbicacion.Text.ToUpper.Trim, "@Char", cReplace, "@SinExist", chkSinExistencia.Checked, "@TallaColor", TallaColor))
            End Select

            If TallaColor = 1 Then
                OpenReport.PrintPreview("Existencia por Ubicación", "CRExistUbaCK.rpt", pvtaDataSet, "")
            Else
    ...
    Private Sub btnTalla_Click(sender As Object, e As EventArgs) Handles btnTalla.Click
        If sProdSelected <> "" AndAlso Not CmbAlmacen.SelectedValue Is Nothing Then
            Dim a As New FrmCambiaTalla
            ...
            a.Dispose()
        Else
            MessageBox.Show("¡Debe selecionar Producto y Almacén!", "Error", MessageBoxButtons.OK, MessageBoxIcon.Stop)
        End If
    End Sub

    Private Sub chkSinExistencia_CheckedChanged(sender As Object, e As EventArgs) Handles chkSinExistencia.CheckedChanged
        If TxtBuscar.Text = "" Then
            TxtBuscar.Text = "%"
        End If
        recuperaExistencia(1, "")
