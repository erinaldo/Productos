...
#End Region
    ...
    Private Sub recalculaPartidaPedido(ByVal dtDetalle As DataTable, ByVal DOCClave As String, ByVal DETClave As String, ByVal dCantidadOriginal As Decimal, ByVal dFaltante As Decimal)
        ...
        If foundRows.GetLength(0) > 0 Then
            ...
            For i = 0 To foundRows.GetUpperBound(0)
                ...
                Dim dImporteNegado As Decimal = Math.Round(dPrecioUnitario * dFaltante, 2)
                Dim dGeneralNegado As Decimal = Math.Round(dImporteNegado * (dDescGeneralPorc / 100), 2)
                ...
                Dim dImpuestoNegado As Decimal = Math.Round((dImporteNegado - dGeneralNegado - dVolumenNegado - dDescuentoNegado) * dPorcImp, 2)

                dDescuentoNegado += dGeneralNegado + dVolumenNegado

                ModPOS.Ejecuta("sp_registra_negado", "@SUCClave", SUCClave, "@CTEClave", foundRows(i)("Cliente"), "@VENClave", DOCClave, "@PROClave", foundRows(i)("PROClave"), "@TProducto", foundRows(i)("TProducto"), _
                                   "@Costo", foundRows(i)("Costo"), "@Precio", dPrecioUnitario, "@Importe", dImporteNegado, "@Descuento", dDescuentoNegado, "Impuesto", dImpuestoNegado, "@Cantidad", dFaltante, _
                                   "@Existencia", foundRows(i)("e"), "@Disponible", foundRows(i)("e") - foundRows(i)("a") - foundRows(i)("b"), "@Apartado", foundRows(i)("a"), "@Bloqueado", foundRows(i)("b"), _
                                   "@Motivo", 3, "@Solicitar", False, "@Usuario", ModPOS.UsuarioActual)
    ...
    Private Sub FrmRecorte_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        GridDetalle.RootTable.Columns("e").Visible = False
        GridDetalle.RootTable.Columns("a").Visible = False
        GridDetalle.RootTable.Columns("b").Visible = False
        ...
        If dSurtido <= 0 Then
            Select Case MessageBox.Show("El pedido será cancelado al no tener producto. ¿Desea continuar con la cancelación?", "Pregunta", MessageBoxButtons.YesNo, MessageBoxIcon.Warning)
                ...
                Case Else
                    ...
                    ModPOS.Ejecuta("sp_cancela_venta", "@VENClave", VENClave, "@TipoDoc", 1, "@Motivo", motCancelacion, "@Autoriza", ModPOS.UsuarioActual, "@AlmacenNegado", ALMClave)
                    bCerrar = True
                    Me.Close()
