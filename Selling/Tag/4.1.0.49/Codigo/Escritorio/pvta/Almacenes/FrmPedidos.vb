...
#End Region
    ...
    Public Sub AgregarFolio()
        If validaForm() Then
            ...
            GridPicking.RootTable.Columns("TipoCambio").Visible = False
    ...
    Private Sub surtirPedido()
        ...
        If foundRows.GetLength(0) > 0 Then
            ...
            Dim dtSurtido As DataTable = ModPOS.CrearTabla("Picking", _
                ...
                If dt.Rows.Count > 0 Then
                    ...
                    If valExist = True Then
                        ...
                        If TipoDocumento = 3 Then
                            ...
                            recuperaCliente(foundRows(i)("CTEClave"))

                            Dim iValidaCredito As Integer

                            iValidaCredito = ModPOS.ValidaCredido(CtaMaestra, LimiteCredito, DiasCredito, foundRows(i)("Total"), foundRows(i)("TipoCambio"))
                            ...
                            ElseIf iValidaCredito = -1 Then
                                ...
                                If CreditoDisponible < (foundRows(i)("Total") * foundRows(i)("TipoCambio")) Then
                                    MessageBox.Show("El limite de crédito disponible para el cliente: " & foundRows(i)("Clave") & ", es de " & Format(CStr(ModPOS.Redondear(CreditoDisponible, 2)), "Currency") & ", la venta actual lo sobrepasa por " & Format(CStr(ModPOS.Redondear((foundRows(i)("Total") * foundRows(i)("TipoCambio")) - CreditoDisponible, 2)), "Currency"), "Información", MessageBoxButtons.OK)
                                    Exit For
                                End If
                            End If
                        End If
                    ...
                    If Picking = True Then
                      ...
                      "@Usuario", ModPOS.UsuarioActual)
                        ...
                        ' ModPOS.ImprimirSurtido(1, foundRows(i)("VENClave"), False)
                            ...
                            row1 = dtSurtido.NewRow()
                        row1.Item("VENClave") = foundRows(i)("VENClave")
                            dtSurtido.Rows.Add(row1)

                    Else
                        ModPOS.Ejecuta("sp_act_saldo_cte", "@Tipo", 1, "@Cliente", foundRows(i)("CTEClave"), "@Importe", foundRows(i)("Total"))

                            ModPOS.GeneraMovInv(2, 1, 1, foundRows(i)("VENClave"), ALMClave, foundRows(i)("Folio"), Nothing, Picking)
                    End If
            ...
            If dtSurtido.Rows.Count > 0 Then
                If MessageBox.Show("¿Desea imprimir?", "Pregunta", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
                    ...
                    For i = 0 To dtSurtido.Rows.Count - 1

                        ' Create label objects... 

                        Dim lblPickingLabel As New PickingPrinting.PickingSheet()

                        lblPickingLabel.AddPicking(dtSurtido.Rows(i)("VENClave"))
