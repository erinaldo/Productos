...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.BtnRefresh.Location = New System.Drawing.Point(450, 18)
        ...
        Me.ChkTodos.Size = New System.Drawing.Size(152, 20)
        ...
        Me.GridTransferencia.FilterRowButtonStyle = Janus.Windows.GridEX.FilterRowButtonStyle.ConditionOperatorDropDown
    ...
    Private Sub BtnTransferencia_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnTransferencia.Click
        If validaForm() Then
            If ModPOS.Transferencia Is Nothing Then
                ...
                ModPOS.Transferencia.SUCClave = Me.CmbSucursal.SelectedValue
            End If
    ...
    Private Sub ChkTodos_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ChkTodos.CheckedChanged
        If dtTraspaso.Rows.Count > 0 Then
            ...
            If ChkTodos.Checked Then
                For i = 0 To GridTransferencia.GetDataRows.Length - 1
                    GridTransferencia.GetDataRows(i).DataRow("Marca") = True
                Next
            Else
                For i = 0 To GridTransferencia.GetDataRows.Length - 1
                    GridTransferencia.GetDataRows(i).DataRow("Marca") = False
                Next
            End If
