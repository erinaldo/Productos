...
#End Region
    ...
    Private Transito, Picking, SurtidoRF, ticketPicking As Boolean
    ...
    Private Sub recuperaProducto(ByVal sClave As String)
        Dim dtProducto As DataTable = ModPOS.SiExisteRecupera("sp_compra_producto", "@COMClave", ModPOS.CompanyActual, "@Clave", sClave.Replace("'", "''"), "@Char", cReplace, "@TallaColor", TallaColor, "@SUCClave", SUCClave)
        If Not dtProducto Is Nothing AndAlso dtProducto.Rows.Count > 0 Then
            ...
            Costo = dtProducto.Rows(0)("CostoVigente")
            ...
            If Picking = True Then
                Select Case MessageBox.Show("¿Desea Reimprimir la Hoja de Recolección?", "Pregunta", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
                    Case DialogResult.Yes
                        ModPOS.ImprimirSurtido(6, MVAClave, True, True, SUCClave, TIKClave, ticketPicking, TallaColor)
                End Select
