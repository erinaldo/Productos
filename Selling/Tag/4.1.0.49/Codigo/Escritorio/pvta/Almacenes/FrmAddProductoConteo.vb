...
#End Region
    ...
    Private Sub BtnAgregar_Click(sender As Object, e As EventArgs) Handles BtnAgregar.Click
        If Not dtProducto Is Nothing Then
            ...
            If foundRows.GetLength(0) > 0 Then
                ...
                Dim fin As String = CStr(foundRows.GetUpperBound(0) + 1)

                For z = 0 To foundRows.GetUpperBound(0)
                    frmstatusmessage.Show("Estamos haciendo magia..." & CStr(z + 1) & "/" & fin)
    ...
    Private Sub ChkTodos_CheckedChanged(sender As Object, e As EventArgs) Handles ChkTodos.CheckedChanged
        If dtProducto.Rows.Count > 0 Then
            ...
            Dim fin As String = CStr(GridProductos.GetDataRows.Length)

            Dim i As Integer
            If ChkTodos.Checked Then
                For i = 0 To GridProductos.GetDataRows.Length - 1
                    frmstatusmessage.Show("Estamos haciendo magia..." & CStr(i + 1) & "/" & fin)
