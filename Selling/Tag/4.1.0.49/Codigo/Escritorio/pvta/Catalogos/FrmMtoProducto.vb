        ...
        If sProdSelected <> "" Then
            ...
            If ModPOS.Producto Is Nothing Then
                ...
                With ModPOS.Producto
                    ...
                    .Preventa = IIf(dt.Rows(0)("Preventa").GetType.FullName = "System.DBNull", False, dt.Rows(0)("Preventa"))
                    .vtaPaquete = IIf(dt.Rows(0)("vtaPaquete").GetType.FullName = "System.DBNull", False, dt.Rows(0)("vtaPaquete"))
                    dt.Dispose()
                    ...
                    If dExistencia <= 0 Then
                        ...
                        If Not TreeViewClass.SelectedNode Is Nothing Then
                            If Not TreeViewClass.SelectedNode.Tag Is Nothing Then
                                ...
                                ultimo_tag = TreeViewClass.SelectedNode.Tag

                                ModPOS.ActualizaGrid(True, Me.GridProductos, "sp_muestra_productos", "@Class", ultimo_tag, "@COMClave", ModPOS.CompanyActual)
                                Me.GridProductos.RootTable.Columns("ID").Visible = False
    ...
    Private Sub Clock_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Clock.Tick
        ...
        If Not CmbCampo.SelectedValue Is Nothing Then
            If TxtBuscar.Text <> "" Then
                ModPOS.ActualizaGrid(True, Me.GridProductos, "sp_busca_productos", "@Campo", CmbCampo.SelectedValue, "@Busca", TxtBuscar.Text.ToUpper.Trim.Replace("'", "''"), "@COMClave", ModPOS.CompanyActual, "@Char", cReplace)
                Me.GridProductos.RootTable.Columns("ID").Visible = False
