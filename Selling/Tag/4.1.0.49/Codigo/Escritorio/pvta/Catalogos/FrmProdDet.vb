        ...
        If validaForm() Then
            Select Case Me.Padre
                Case "Agregar"
                    ...
                    ModPOS.Producto.AddMultiproducto(PROClave, TxtClave.Text, TxtNombre.Text, "", -1, "", TxtUnidad.Text, CantidadUnidades, Estado, IIf(Estado = 1, "Activo", "Inactivo"), TProducto, 0)
