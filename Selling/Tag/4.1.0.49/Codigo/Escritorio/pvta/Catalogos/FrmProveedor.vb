...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.grpProducto.Controls.Add(Me.cmbAlmacen)
        Me.grpProducto.Controls.Add(Me.LblOrigen)
        Me.grpProducto.Controls.Add(Me.CmbSucursal)
        Me.grpProducto.Controls.Add(Me.Label18)
        ...
        Me.CmbSucursal.Location = New System.Drawing.Point(115, 55)
        ...
        'Label18
        '
        Me.Label18.Location = New System.Drawing.Point(7, 59)
        Me.Label18.Name = "Label18"
        Me.Label18.Size = New System.Drawing.Size(123, 17)
        Me.Label18.TabIndex = 135
        Me.Label18.Text = "Sucursal de Entrega"
        '
        'btnProducto
        '
        ...
        Me.btnProducto.Location = New System.Drawing.Point(274, 22)
        ...
        'txtProducto
        '
        Me.txtProducto.Location = New System.Drawing.Point(114, 29)
        ...
        Me.btnDelProd.Location = New System.Drawing.Point(311, 22)
        ...
        Me.gridProductos.Location = New System.Drawing.Point(10, 83)
        Me.gridProductos.Name = "gridProductos"
        Me.gridProductos.RecordNavigator = True
        Me.gridProductos.Size = New System.Drawing.Size(618, 411)
        ...
        Me.cmbAlmacen.Location = New System.Drawing.Point(441, 55)
        Me.cmbAlmacen.Name = "cmbAlmacen"
        Me.cmbAlmacen.Size = New System.Drawing.Size(187, 21)
        Me.cmbAlmacen.TabIndex = 137
        '
        'LblOrigen
        '
        Me.LblOrigen.Location = New System.Drawing.Point(379, 59)
        Me.LblOrigen.Name = "LblOrigen"
        Me.LblOrigen.Size = New System.Drawing.Size(56, 16)
        Me.LblOrigen.TabIndex = 136
...
#Region "Variables Privadas"
    ...
    Private dtClasificaciones, dtProductos, dtSucursal, dtAlmacen As DataTable
    ...
    Private Sub cargaProductos()
        ...
        Else
            ...
            dtProductos = ModPOS.CrearTabla("PrvProd", _
               ...
               "Sucursal", "System.String", _
               "Almacen", "System.String", _
        ...
        gridProductos.CurrentTable.Columns("Sucursal").EditType = Janus.Windows.GridEX.EditType.Combo
        gridProductos.CurrentTable.Columns("Sucursal").HasValueList = True

        Dim AircraftTypeValueListItemCollectionCl As Janus.Windows.GridEX.GridEXValueListItemCollection
        AircraftTypeValueListItemCollectionCl = gridProductos.Tables(0).Columns("Sucursal").ValueList
        ...
        gridProductos.CurrentTable.Columns("Almacen").EditType = Janus.Windows.GridEX.EditType.Combo
        gridProductos.CurrentTable.Columns("Almacen").HasValueList = True

        Dim AircraftTypeValueListItemCollectionC2 As Janus.Windows.GridEX.GridEXValueListItemCollection
        AircraftTypeValueListItemCollectionC2 = gridProductos.Tables(0).Columns("Almacen").ValueList
        With AircraftTypeValueListItemCollectionC2

            dtAlmacen = ModPOS.Recupera_Tabla("st_muestra_almacenes", "@COMClave", ModPOS.CompanyActual)

            Dim i As Integer
            For i = 0 To dtAlmacen.Rows.Count - 1
                .Add(dtAlmacen.Rows(i)("ALMClave"), dtAlmacen.Rows(i)("Clave"))
            Next
            ...
            Select Case Me.Padre
                Case "Agregar"
                    ...
                    If foundRows.Length <> 0 Then
                        'inserta prvprod
                        For z = 0 To foundRows.GetUpperBound(0)
                            ModPOS.Ejecuta("sp_inserta_prvprod", "@PRVClave", PRVClave, "@PROClave", foundRows(z)("PROClave"), "@SUCClave", foundRows(z)("Sucursal"), "@ALMClave", foundRows(z)("Almacen"), "@Descuento", foundRows(z)("Desc"), "@Estado", foundRows(z)("Activo"), "@Usuario", ModPOS.UsuarioActual)
                        Next
                    End If
...
#End Region
    ...
    Private Sub addProductos(ByVal PROClave As String, ByVal Clave As String, ByVal Nombre As String, ByVal SUCClave As String, ByVal ALMClave As String)
        ...
        If foundRows.Length = 0 Then
            ...
            row1.Item("Update") = 1
            row1.Item("Baja") = 0
            row1.Item("Sucursal") = SUCClave
            row1.Item("Almacen") = ALMClave
    ...
    Public Sub recuperaProducto(ByVal sClave As String)
        ...
        If SUCClave = "" Then
            MessageBox.Show("Debe seleccionar una sucursal de entrega", "Error", MessageBoxButtons.OK, MessageBoxIcon.Stop)
            Exit Sub
        End If

        If ALMClave = "" Then
            MessageBox.Show("Debe seleccionar un Almacén de entrega", "Error", MessageBoxButtons.OK, MessageBoxIcon.Stop)
            Exit Sub
        End If
    ...
    Private Sub gridProductos_CurrentCellChanged(sender As Object, e As EventArgs) Handles gridProductos.CurrentCellChanged
        If Not gridProductos.CurrentColumn Is Nothing Then
            If gridProductos.CurrentColumn.Caption = "Desc" OrElse gridProductos.CurrentColumn.Caption = "Sucursal" OrElse gridProductos.CurrentColumn.Caption = "Activo" Then
