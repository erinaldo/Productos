...
#End Region
        ...
        If sCteSelected <> "" Then
            If ModPOS.Cliente Is Nothing Then
                ...
                With ModPOS.Cliente
                    ...
                    .TImpuesto = IIf(dt.Rows(0)("TImpuesto").GetType.Name = "DBNull", "", dt.Rows(0)("TImpuesto"))
                ...
                Select Case MessageBox.Show("Se eliminara el Cliente :" & sNombre, "Advertencia", MessageBoxButtons.YesNo, MessageBoxIcon.Warning)
                    Case DialogResult.Yes
                        ...
                        If Not TreeViewClass.SelectedNode.Tag Is Nothing Then
                            ...
                            ModPOS.ActualizaGrid(True, Me.GridClientes, "sp_muestra_clientes", "@Class", ultimo_tag, "@Responsable", iResponsable, "@COMClave", ModPOS.CompanyActual)
                            Me.GridClientes.RootTable.Columns("ID").Visible = False
    ...
    Private Sub BtnListado_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnListado.Click
        ...
        If a.DialogResult = DialogResult.OK Then
            ...
            pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_rep_listadocliente", "@Zona", a.Zona, "@Responsable", a.SucursalOrigen, "@Vendedor", a.Vendedor, "@Inicio", a.FechaIni, "@Fin", a.FechaFin))
