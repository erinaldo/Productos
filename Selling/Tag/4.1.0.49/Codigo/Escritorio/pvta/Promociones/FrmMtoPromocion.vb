...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.GridPromociones.FilterRowButtonStyle = Janus.Windows.GridEX.FilterRowButtonStyle.ConditionOperatorDropDown
        ...
        If sPromocionSelected <> "" Then
            If ModPOS.Promocion Is Nothing Then
                ...
                With ModPOS.Promocion
                    ...
                    .LimitaPago = IIf(dt.Rows(0)("LimitaPago").GetType.Name = "DBNull", 0, dt.Rows(0)("LimitaPago"))
                    .Iguales = IIf(dt.Rows(0)("Iguales").GetType.Name = "DBNull", 1, dt.Rows(0)("Iguales"))
                    .TodosClientes = IIf(dt.Rows(0)("TodosClientes").GetType.Name = "DBNull", 1, dt.Rows(0)("TodosClientes"))
                    .TodasSucursales = IIf(dt.Rows(0)("TodasSucursales").GetType.Name = "DBNull", 1, dt.Rows(0)("TodasSucursales"))
                    .TodosProductos = IIf(dt.Rows(0)("TodosProductos").GetType.Name = "DBNull", 0, dt.Rows(0)("TodosProductos"))
                    .VtaPaquete = IIf(dt.Rows(0)("vtaPaquete").GetType.Name = "DBNull", 0, dt.Rows(0)("vtaPaquete"))
                    .CompraHist = IIf(dt.Rows(0)("CompraHist").GetType.Name = "DBNull", 0, dt.Rows(0)("CompraHist"))
                    .FechaInicioHist = IIf(dt.Rows(0)("IniciaCompra").GetType.Name = "DBNull", Today.Date, dt.Rows(0)("IniciaCompra"))
                    .FechaFinHist = IIf(dt.Rows(0)("FinCompra").GetType.Name = "DBNull", Today.Date, dt.Rows(0)("FinCompra"))
                    dt.Dispose()
                End With
            End If
            ModPOS.Promocion.StartPosition = FormStartPosition.CenterScreen
