...
namespace SellingWS.Models
{
    ...
    public partial class Cliente
    {
        ...
        public Nullable<bool> ImprimirFac { get; set; }
        public string UsoCFDI { get; set; }
        public string CtaMaestra { get; set; }
        public Nullable<bool> facturable { get; set; }
        public string Password { get; set; }
        public Nullable<bool> AccesoWeb { get; set; }
        public Nullable<System.DateTime> fechaNacimiento { get; set; }
        public Nullable<int> Genero { get; set; }
        public Nullable<int> tipoTel1 { get; set; }
        public Nullable<int> tipoTel2 { get; set; }
