...
public class MetodosEstaticos {
    ...
    public static int obtenerTallaColor(Context context){
        return context.getSharedPreferences(ValoresEstaticos.PREFERENCES_NAME,Context.MODE_PRIVATE).getInt(ValoresEstaticos.PREFERENCES_TALLACOLOR, 0);
    }
    public static void limpiarSesion(Context context){
        ...
        context.getSharedPreferences(ValoresEstaticos.PREFERENCES_NAME,Context.MODE_PRIVATE).edit().remove(ValoresEstaticos.PREFERENCES_TALLACOLOR).commit();
    ...
    public static void guardarFijarUbicacion(Context context, boolean fijar){
        context
                .getSharedPreferences(ValoresEstaticos.PREFERENCES_NAME,Context.MODE_PRIVATE)
                .edit()
                .putBoolean(ValoresEstaticos.PREFERENCES_FIJARUBI, fijar)
                .commit();
    }

    public static boolean obtenerFijarUbicacion(Context context){
        return context.getSharedPreferences(ValoresEstaticos.PREFERENCES_NAME,Context.MODE_PRIVATE)
                .getBoolean(ValoresEstaticos.PREFERENCES_FIJARUBI, false);
    }
    ...
    public static void guardarConteoNormal(Context context, boolean conteo){
        context
                .getSharedPreferences(ValoresEstaticos.PREFERENCES_CONTEO, Context.MODE_PRIVATE)
                .edit()
                .putBoolean(ValoresEstaticos.PREFERENCES_CONTEO, conteo)
                .commit();
    }

    public static boolean obtenerConteoNormal(Context context){
        return context
                .getSharedPreferences(ValoresEstaticos.PREFERENCES_CONTEO, Context.MODE_PRIVATE)
                .getBoolean(ValoresEstaticos.PREFERENCES_CONTEO,true);
    }
