...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (MetodosEstaticos.obtenerTallaColor(context) == 0){
            Button btn = (Button) this.findViewById(R.id.BtnDefecto);
            btn.setVisibility(View.GONE);
            btn = (Button)this.findViewById(R.id.BtnExtra);
            btn.setVisibility(View.GONE);
        }
    }
    ...
    public void almacenaje(View v){
        ...
        showOptionsDialog(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                tipoAlmacenaje = opciones.get(position);
                dialog.dismiss();
                if(MetodosEstaticos.obtenerFijarUbicacion(context))
                {
                    Intent almacenajeIntent = new Intent(context, AlmacenajeActivity.class);
                    almacenajeIntent.putExtra("tipoAlmacenaje", tipoAlmacenaje);
                    almacenajeIntent.putExtra("tipoUbicacion", ValoresEstaticos.OPCION_UBICACION_FIJA);
                    startActivity(almacenajeIntent);
                }
                else
                    ubicacionOrigen(view);
            }
        },ValoresEstaticos.DIALOG_OPTION_ALMACENAJE);
    }

    public void ubicacionOrigen(View v){
        ...
        showOptionsDialog(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent almacenajeIntent = new Intent(context, AlmacenajeActivity.class);
                almacenajeIntent.putExtra("tipoAlmacenaje", tipoAlmacenaje);
                almacenajeIntent.putExtra("tipoUbicacion", position);
                startActivity(almacenajeIntent);
                dialog.dismiss();
            }
        },ValoresEstaticos.DIALOG_OPTION_UBICACION_ORIGEN);
    }
    ...
    public void conteo(View v){
       // Toast.makeText(context,context.getString(R.string.mensaje_modulo_proceso_lbl),Toast.LENGTH_SHORT).show();
        Intent conteoIntent = new Intent(context,ConteoActivity.class);
        startActivity(conteoIntent);
    }
    ...
    public void defectos(View v){
        Intent defectosIntent = new Intent(getApplicationContext(),DefectoActivity.class);
        startActivity(defectosIntent);
    }
    ...
    private void showOptionsDialog(AdapterView.OnItemClickListener listener, int opcion){
        ...
        switch (opcion){
            ...
            break;
            case ValoresEstaticos.DIALOG_OPTION_UBICACION_ORIGEN:
                opciones.add(getString(R.string.fijar_ubicacion_origen_lbl));
                opciones.add(getString(R.string.multiples_ubicaciones_origen_lbl));
                break;
        }
