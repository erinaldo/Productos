...
Public Class CRSurtidoDetalle
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRSurtidoDetalle.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRSurtidoDetalle
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRSurtidoDetalle = New CRSurtidoDetalle
        rpt.Site = Me.Site
        Return rpt
    End Function
