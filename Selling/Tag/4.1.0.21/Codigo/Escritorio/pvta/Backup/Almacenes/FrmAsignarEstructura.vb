...
#End Region
    ...
    Private Sub BtnOk_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnOk.Click
        ...
        ModPOS.ActualizaGrid(True, MtoArea.GridEstructuras, "sp_muestra_estructuras", "@almacen", "Todos", "@area", Me.AREClave)
        ModPOS.MtoArea.GridEstructuras.RootTable.Columns("ESTClave").Visible = False
