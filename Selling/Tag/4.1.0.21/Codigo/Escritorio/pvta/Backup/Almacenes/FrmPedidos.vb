...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.BtnConsultar.Location = New System.Drawing.Point(606, 521)
        ...
        Me.btnRecortar.Location = New System.Drawing.Point(414, 521)
        ...
        Me.BtnSalir.Location = New System.Drawing.Point(318, 521)
        ...
        Me.BtnCancelar.Location = New System.Drawing.Point(510, 521)
        ...
        Me.BtnSurtir.Location = New System.Drawing.Point(702, 521)
        ...
        'CmbAlmacen
        '
        Me.CmbAlmacen.Location = New System.Drawing.Point(81, 17)
        ...
        Me.Label1.Location = New System.Drawing.Point(546, 24)
        ...
        Me.dtPicker.Location = New System.Drawing.Point(608, 19)
        ...
        Me.BtnRefresh.Location = New System.Drawing.Point(297, 17)
        ...
        Me.GridPicking.Size = New System.Drawing.Size(786, 449)
    ...
    Private Sub BtnConsultar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnConsultar.Click
        ...
        If foundRows.GetLength(0) > 0 Then
            ...
            For i = 0 To foundRows.GetUpperBound(0)
                ...
                pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_encabezado_ped", "@VENClave", foundRows(i)("VENClave")))
                pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_detalle_ped", "@VENClave", foundRows(i)("VENClave")))
                    ...
                    If validaExistencia(foundRows(i)("VENClave"), foundRows(i)("Folio")) = True Then
                        ...
                        End If
                         ...
                         If Picking = True Then
                            If ModPOS.ValidaEnvio(Picking, foundRows(i)("VENClave"), foundRows(i)("CTEClave"), True, ALMClave) = False Then
                                Exit For
                            End If
                        End If
                        ...
                        If Picking = True Then
                            ...
                            ModPOS.calculaRecoleccion(1, foundRows(i)("VENClave"), ALMClave)
                        Else
                            ModPOS.GeneraMovInv(2, 1, 1, foundRows(i)("VENClave"), ALMClave, foundRows(i)("Folio"), Nothing)
                            ModPOS.ActualizaExistAlm(2, 1, foundRows(i)("VENClave"), ALMClave)
                            ModPOS.ActualizaExistUbc(2, 1, foundRows(i)("VENClave"), ALMClave)
                        End If
                    Else
                        Exit For
                    End If
                    ...
                    If a.DialogResult = DialogResult.OK Then
                        If a.Autorizado Then
                            ...
                            For i = 0 To foundRows.GetUpperBound(0)
                                ...
                                ModPOS.Ejecuta("sp_cancela_venta", "@VENClave", foundRows(i)("VENClave"), "@TipoDoc", 1)
