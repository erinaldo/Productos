        ...
        If validaForm() Then
            ...
            If Me.GridMetodos.RecordCount > 0 Then
                ...
                If foundRows.Length <> 1 Then
                    Beep()
                    MessageBox.Show("Debe detener un Metodo de Pago marcado como Preferido. Verifique no tener más de uno seleccionado", "Error", MessageBoxButtons.OK, MessageBoxIcon.Stop)
                    Exit Sub
                End If
            End If
...
#Region "Domicilio"
    ...
    Private Sub GridDomicilios_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles GridDomicilios.DoubleClick
        ...
        If DCTEClave <> "" Then
            ...
            Pais = GridDomicilios.GetValue("País")
