...
#End Region
    ...
    Public Sub AddMetodoPago(ByVal iMetodoPago As Integer, ByVal sTipo As String, ByVal sBancoClave As String, ByVal sBancoNombre As String, ByVal sRef As String)
        ...
        If Me.GridMetodos.RecordCount > 0 Then
            ...
            If foundRows.Length >= 1 Then
                ...
                Else
                    ...
                    Dim Referencia, Banco, Tipo As String
