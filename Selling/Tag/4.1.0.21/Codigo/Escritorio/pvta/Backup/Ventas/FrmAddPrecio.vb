                ...
                Select Case MessageBox.Show("Se va a " & CmbModificar.SelectedItem.ToString & " el Precio en un " & lblPorc.Text & TxtPorcentaje.Text & " de todos los registros marcados, esta deacuerdo?", "Pregunta", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
                    Case DialogResult.Yes
                        ...
                        For i = 0 To foundRows.GetUpperBound(0)
                            ...
                            "@Cantidad", Math.Abs(dUtilidad / 100), _
    ...
    Private Sub Clock_Tick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Clock.Tick
        ...
        ElseIf TxtSearch.Text <> "" Then
            If Not dtProductos Is Nothing Then
                dtProductos.Dispose()
            End If
            dtProductos = ModPOS.Recupera_Tabla("sp_filtra_ConPrecio", "@PREClave", PREClave, "@Campo", Me.CmbCampo.SelectedValue, "@Busca", Me.TxtSearch.Text.Replace("'", "''"))
