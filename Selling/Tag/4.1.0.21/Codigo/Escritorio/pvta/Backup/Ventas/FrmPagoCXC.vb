    ...
    Private Sub BtnPago_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnPago.Click
        If Not dtCxC Is Nothing Then
            ...
            If foundRows.GetLength(0) > 0 Then
                ...
                If ModPOS.SiExite(ModPOS.BDConexion, "sp_aplicar_abn", "@CTEClave", sCTEClave) > 0 Then
                    ...
                    If b.DialogResult = DialogResult.OK Then
                        If Not b.drAbonos Is Nothing AndAlso b.drAbonos.Length > 0 Then
                            ...
                            For i = 0 To b.drAbonos.Length - 1
                                Aplica_Pagos(foundRows, sCTEClave, b.drAbonos(i)("ID"), b.drAbonos(i)("TipoPago"), b.drAbonos(i)("Saldo"), dSaldo, IIf(b.drAbonos(i)("Saldo") > dSaldo, b.drAbonos(i)("Saldo") - dSaldo, 0), False)
                            Next
                            dtCxC.Dispose()
                            ActualizaGridCxC()
                            Exit Sub
                ...
                If a.DialogResult = DialogResult.OK Then
                    Aplica_Pagos(foundRows, sCTEClave, a.AbonoClave, a.TPago, a.TotalAbono, a.SaldoVenta, a.TotalCambio, True)
                    dtCxC.Dispose()
                    ActualizaGridCxC()
                    'RetiroProgramado()
                End If
