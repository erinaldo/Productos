        ...
        Try
            ...
            If Not CnxExitosa Then
                ...
                If a.DialogResult = DialogResult.OK Then
                    Con = "data source=" & a.BDServidor & ";initial catalog=" & a.BDCatalogo & "; user id=" & a.BDUsuario & "; password=" & a.BDContraseña & "; TimeOut=30;"
                Else
                    Exit Sub
                End If
                a.Dispose()
        ...
        If Not dtUsuario Is Nothing Then
            ...
            If EW.Encrypt.HashPass.ValidatePassword(TxtPassword.Text.Trim, dtUsuario.Rows(0)("Password")) Then
                ...
                If dt.Rows.Count = 1 Then
                    ...
                    ModPOS.TituloMain = "Selling - " & dt.Rows(0)("Nombre")
                ...
                Else
                    ...
                    If a.DialogResult = System.Windows.Forms.DialogResult.OK Then
                        ...
                        ModPOS.TituloMain = "Selling - " & a.Texto
