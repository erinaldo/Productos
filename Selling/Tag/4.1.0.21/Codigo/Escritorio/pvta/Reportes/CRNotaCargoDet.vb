...
Public Class CRNotaCargoDet
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRNotaCargoDet.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRNotaCargoDet
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRNotaCargoDet = New CRNotaCargoDet()
        rpt.Site = Me.Site
        Return rpt
    End Function
