...
Public Class CRFacturacionConsec
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRFacturacionConsec.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRFacturacionConsec.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRFacturacionConsec
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRFacturacionConsec = New CRFacturacionConsec()
        rpt.Site = Me.Site
        Return rpt
    End Function
