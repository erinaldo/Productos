...
Public Class CRSurtidoAsignado
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRSurtidoAsignado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRSurtidoAsignado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRSurtidoAsignado = New CRSurtidoAsignado()
        rpt.Site = Me.Site
        Return rpt
    End Function
