...
Public Class CRIngresoCFDI
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRIngresoCFDI.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRIngresoCFDI
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRIngresoCFDI = New CRIngresoCFDI()
        rpt.Site = Me.Site
        Return rpt
    End Function
