...
Public Class CRProductoTransito
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRProductoTransito.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRProductoTransito
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRProductoTransito = New CRProductoTransito()
        rpt.Site = Me.Site
        Return rpt
    End Function
