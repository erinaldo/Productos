...
Public Class CRClienteSinVta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRClienteSinVta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRClienteSinVta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRClienteSinVta = New CRClienteSinVta()
        rpt.Site = Me.Site
        Return rpt
    End Function
