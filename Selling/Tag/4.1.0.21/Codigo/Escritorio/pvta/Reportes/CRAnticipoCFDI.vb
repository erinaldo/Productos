...
Public Class CRAnticipoCFDI
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRAnticipoCFDI.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRAnticipoCFDI
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRAnticipoCFDI = New CRAnticipoCFDI()
        rpt.Site = Me.Site
        Return rpt
    End Function
