...
Public Class CRTrasladoCFDI
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRTrasladoCFDI.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRTrasladoCFDI
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRTrasladoCFDI = New CRTrasladoCFDI()
        rpt.Site = Me.Site
        Return rpt
    End Function
