...
Public Class CRFacturaResumen
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRFacturaResumen.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRFacturaResumen
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRFacturaResumen = New CRFacturaResumen()
        rpt.Site = Me.Site
        Return rpt
    End Function
