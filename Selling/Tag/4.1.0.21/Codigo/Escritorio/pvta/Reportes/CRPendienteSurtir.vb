...
Public Class CRPendienteSurtir
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRPendienteSurtir.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRPendienteSurtir
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRPendienteSurtir = New CRPendienteSurtir()
        rpt.Site = Me.Site
        Return rpt
    End Function
