...
Public Class CFDNotaCredito33
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CFDNotaCredito33.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCFDNotaCredito33
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CFDNotaCredito33 = New CFDNotaCredito33()
        rpt.Site = Me.Site
        Return rpt
    End Function
