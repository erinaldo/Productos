...
Public Class CRPendientesFacturar
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRPendientesFacturar.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRPendientesFacturar.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRPendientesFacturar
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRPendientesFacturar = New CRPendientesFacturar()
        rpt.Site = Me.Site
        Return rpt
    End Function
