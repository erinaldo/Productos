...
Public Class CRProductoNegado
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRProductoNegado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRProductoNegado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRProductoNegado = New CRProductoNegado()
        rpt.Site = Me.Site
        Return rpt
    End Function
