...
Public Class CRPedidoPagare2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Selling.CRPedidoPagare2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRPedidoPagare2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRPedidoPagare2 = New CRPedidoPagare2()
        rpt.Site = Me.Site
        Return rpt
    End Function
