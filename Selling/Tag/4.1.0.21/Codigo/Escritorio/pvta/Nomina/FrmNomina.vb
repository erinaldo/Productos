                        ...
                        If a.DialogResult = DialogResult.OK Then
                            If a.Autorizado Then
                                ...
                                ElseIf foundRows(0)("Estado") = "Activo" Then 'Timbrado
                                    ...
                                    If ModPOS.cancelarXML(dtPAC, foundRows(0)("Folio"), foundRows(0)("uuid"), eRFC, foundRows(0)("VersionCF"), 7, foundRows(0)("RENClave")) = False Then
                                        Exit Sub
                                    End If
                                ...
                                ElseIf foundRows(0)("Estado") = "Espera" Then
                                    ...
                                    If ModPOS.ObtenerEspera(dtPAC, foundRows(0)("RFC"), 7, foundRows(0)("RENClave"), foundRows(0)("uuid")) = True Then
                                        ModPOS.Ejecuta("sp_cancela_reciboNomina", "@RENClave", foundRows(0)("RENClave"), "@Usuario", ModPOS.UsuarioActual)
