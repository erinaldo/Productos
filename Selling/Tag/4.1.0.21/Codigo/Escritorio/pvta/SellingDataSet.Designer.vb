...
Partial Public Class SellingDataSet
    ...
    Partial Public Class sp_detalle_openDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
        Public Overloads Function Addsp_detalle_openRow(ByVal DVEClave As String, ByVal PROClave As String, ByVal Baja As Integer, ByVal Clave As String, ByVal Nombre As String, ByVal Cantidad As Double, ByVal Precio As Decimal, ByVal Importe As Decimal, ByVal ___Desc As Double, ByVal Desc As Decimal, ByVal Impts As Decimal, ByVal Total As Decimal, ByVal GrupoMaterial As Integer, ByVal Sector As Integer, ByVal Partida As Integer) As sp_detalle_openRow
            Dim rowsp_detalle_openRow As sp_detalle_openRow = CType(Me.NewRow, sp_detalle_openRow)
            Dim columnValuesArray() As Object = New Object() {DVEClave, PROClave, Baja, Clave, Nombre, Cantidad, Precio, Importe, ___Desc, Desc, Impts, Total, GrupoMaterial, Sector, Partida}
