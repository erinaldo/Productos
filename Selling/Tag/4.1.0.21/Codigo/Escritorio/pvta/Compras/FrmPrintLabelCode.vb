    ...
    Private Sub FrmPrintLabel_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If dtCode.Rows.Count > 0 Then
            ...
            If iTipoDOc = 3 Then
                ...
                GridDetalle.RootTable.Columns("Columna").Selectable = False
                GridDetalle.RootTable.Columns("Nivel").Selectable = False
            Else
            ...
            If foundRows.GetLength(0) > 0 Then
                ...
                For i = 0 To foundRows.GetUpperBound(0)
                    ...
                    If iTipoDOc = 3 Then
                        ...
                        ' lblAddressLabel.AddTexto(foundRows(i)("Ubicación"))
