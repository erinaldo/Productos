...
#End Region
    ...
    Private Sub FrmAddMetodoPago_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If CmbMetodoPago.SelectedValue = 0 OrElse CmbMetodoPago.SelectedValue = 1 OrElse CmbMetodoPago.SelectedValue >= 7 Then
    ...
    Private Function validaForm() As Boolean
        ...
        If ValidaCtaPago = 1 Then

            If Not CmbMetodoPago.SelectedValue Is Nothing AndAlso Not (CmbMetodoPago.SelectedValue = 0 OrElse CmbMetodoPago.SelectedValue = 1 OrElse CmbMetodoPago.SelectedValue >= 7) AndAlso Me.cmbBanco.SelectedValue Is Nothing Then
                i += 1
            ...
            If Not CmbMetodoPago.SelectedValue Is Nothing AndAlso Not (CmbMetodoPago.SelectedValue = 0 OrElse CmbMetodoPago.SelectedValue = 1 OrElse CmbMetodoPago.SelectedValue >= 7) AndAlso TxtReferencia.Text = "" Then
                i += 1
    ...
    Private Sub BtnAgregar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnAgregar.Click
        If Me.validaForm Then
            ...
            If Not (CmbMetodoPago.SelectedValue = 0 OrElse CmbMetodoPago.SelectedValue = 1 OrElse CmbMetodoPago.SelectedValue >= 7) Then
            ...
            If cmbBanco.SelectedValue Is Nothing OrElse (CmbMetodoPago.SelectedValue = 0 OrElse CmbMetodoPago.SelectedValue = 1 OrElse CmbMetodoPago.SelectedValue >= 7) Then
                Banco = ""
                BancoClave = ""
            Else
            ...
            Else
                ...
                sSAT = IIf(dt.Rows(0)("ClaveSAT").GetType.Name <> "DBNull", dt.Rows(0)("ClaveSAT"), "99")
                dt.Dispose()

                ModPOS.MetodoPago.AddMetodoPago(CmbMetodoPago.SelectedValue, CmbMetodoPago.SelectedItem(1), BancoClave, Banco, TxtReferencia.Text.Trim.ToUpper, sSAT)
                Me.Close()
            End If
    ...
    Private Sub CmbMetodoPago_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CmbMetodoPago.SelectedIndexChanged
        If bload = True AndAlso (CmbMetodoPago.SelectedValue = 0 OrElse CmbMetodoPago.SelectedValue = 1 OrElse CmbMetodoPago.SelectedValue >= 7) Then
            cmbBanco.Visible = False
            TxtReferencia.Visible = False
            TxtReferencia.Text = ""
        Else
