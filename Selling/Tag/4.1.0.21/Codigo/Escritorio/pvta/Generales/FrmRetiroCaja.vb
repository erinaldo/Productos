...
#End Region
    ...
    Private dtMonto, dtRetiro As DataTable
    ...
    Private Function imprimeTicketRetiro(ByVal Folio As String, ByVal Efectivo As Double, ByVal Impresora As String, ByVal Generic As Boolean, ByVal Ticket As String, ByVal MON As String) As Boolean
        ...
        If bError = False And Total > 0 Then
            ...
            For i = 0 To dtRetiro.Rows.Count - 1
                ...
                If bimprimir = True Then
                    imprimeTicketRetiro(Folio, dtRetiro.Rows(i)("Importe"), Impresora, Generic, Ticket, dtRetiro.Rows(i)("MON"))
                End If
            Next
    ...
    Private Sub btnAgregar_Click(sender As Object, e As EventArgs) Handles btnAgregar.Click
        ...
        Else
            ...
            Dim dEfectivo, dSaldoBase, dTipoCambio As Decimal
            ...
            If dEfectivo >= Efectivo Then
                ...
                dTipoCambio = dSaldoBase / dEfectivo
                ...
                If foundRows.Length = 0 Then
                    ...
                    row1.Item("SaldoBase") = Efectivo * dTipoCambio
