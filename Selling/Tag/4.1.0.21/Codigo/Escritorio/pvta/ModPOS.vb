...
#Region "Variables de Ventanas"
    ...
    Public VersionSelling As String = "4.1.0.21"
    ...
    Public MtoRegValores As FrmMtoRegValores
    Public RegValores As FrmRegValores

    Public Rechazos As FrmRechazos
...
#End Region
    ...
    Public Sub ImprimeVale(ByVal VALClave As String, ByVal ImpresoraTicket As String, ByVal Ticket As String)

        Dim Total As Decimal
        Dim Caja, NomComercial, Nombre, oDomicilio, oDomicilio2, rfc, Regimen, sClave, sNombre, sDomicilio, sDomicilio2, Cajero, Folio, Hora, Fecha, Cliente, RazonSocial As String

        Dim dt As DataTable = ModPOS.Recupera_Tabla("st_encabezado_vale", "@VALClave", VALClave)

        NomComercial = dt.Rows(0)("NomComercial")
        Nombre = dt.Rows(0)("Nombre")
        oDomicilio = dt.Rows(0)("oDomicilio")
        oDomicilio2 = dt.Rows(0)("oDomicilio2")
        rfc = dt.Rows(0)("Id_Fiscal")
        Regimen = dt.Rows(0)("RegimenFiscal")
        Caja = dt.Rows(0)("Caja")
        sClave = dt.Rows(0)("sClave")
        sNombre = dt.Rows(0)("sNombre")
        sDomicilio = dt.Rows(0)("sDomicilio")
        sDomicilio2 = dt.Rows(0)("sDomicilio2")
        Cajero = dt.Rows(0)("Cajero")
        Folio = dt.Rows(0)("Folio")
        Fecha = CDate(dt.Rows(0)("Fecha")).ToShortDateString()
        Hora = CDate(dt.Rows(0)("Fecha")).ToShortTimeString()
        ...
        ' IMPRIME ENCABEZADO DE DEVOLUCION 
        Tickets.AddHeaderLine(NomComercial, Imprimir.FontEstilo.Negrita, Imprimir.Alinear.Centrado)
        Tickets.AddHeaderLine(" ", Imprimir.FontEstilo.Regular, Imprimir.Alinear.Izquierda)
        Tickets.AddHeaderLine(Nombre, Imprimir.FontEstilo.Regular, Imprimir.Alinear.Izquierda)
        Tickets.AddHeaderLine(oDomicilio, Imprimir.FontEstilo.Regular, Imprimir.Alinear.Izquierda)
        Tickets.AddHeaderLine(oDomicilio2, Imprimir.FontEstilo.Regular, Imprimir.Alinear.Izquierda)
        Tickets.AddHeaderLine(rfc, Imprimir.FontEstilo.Regular, Imprimir.Alinear.Izquierda)
        Tickets.AddHeaderLine(Regimen, Imprimir.FontEstilo.Regular, Imprimir.Alinear.Izquierda)
        Tickets.AddHeaderLine(" ", Imprimir.FontEstilo.Regular, Imprimir.Alinear.Izquierda)
        Tickets.AddHeaderLine("SUCURSAL " & sClave, Imprimir.FontEstilo.Regular, Imprimir.Alinear.Izquierda)
        Tickets.AddHeaderLine(sNombre, Imprimir.FontEstilo.Regular, Imprimir.Alinear.Izquierda)
        Tickets.AddHeaderLine(sDomicilio, Imprimir.FontEstilo.Regular, Imprimir.Alinear.Izquierda)
        Tickets.AddHeaderLine(sDomicilio2, Imprimir.FontEstilo.Regular, Imprimir.Alinear.Izquierda)
        Tickets.AddHeaderLine(" ", Imprimir.FontEstilo.Regular, Imprimir.Alinear.Izquierda)
        Tickets.AddHeaderLine("Fecha: " & Fecha, Imprimir.FontEstilo.Negrita, Imprimir.Alinear.Izquierda)
        Tickets.AddHeaderLine("CAJA: " & Caja, Imprimir.FontEstilo.Negrita, Imprimir.Alinear.Izquierda)
        Tickets.AddHeaderLine("LE ATENDIO: " & Cajero, Imprimir.FontEstilo.Regular, Imprimir.Alinear.Izquierda)
        Tickets.AddHeaderLine(" ", Imprimir.FontEstilo.Regular, Imprimir.Alinear.Izquierda)
        Tickets.AddHeaderLine("*** DETALLE DE DEVOLUCIONES ***", Imprimir.FontEstilo.Negrita, Imprimir.Alinear.Centrado)

        'El metodo AddItem requeire 3 parametros, el primero es cantidad, el segundo es la descripcion 
        'del producto y el tercero es el precio 
        Dim dtDetalle As DataTable
        dtDetalle = ModPOS.SiExisteRecupera("st_detalle_vale", "@VALClave", VALClave)

        Dim sFolio, sModelo, sTalla, sColor, sCantidad As String
        Dim dAcumulado As Double = 0
        Dim dTotal As Double = 0
        Dim sCatalogo As String = ""

        Tickets.AddItemVale("FOLIO", "", "MODELO", "TALLA", "COLOR", "CANT")
        Tickets.AddItemVale("------------------------------", "", "", "", "", "----------")
        ...
        If Not dtDetalle Is Nothing Then
            ...
            For i = 0 To dtDetalle.Rows.Count - 1
                ...
                If sCatalogo <> dtDetalle.Rows(i)("Catalogo") Then
                    If sCatalogo <> "" Then
                        Tickets.AddItemVale("------------------------------", "", "", "", "", "----------")
                        Tickets.AddItemVale("TOTAL " & sCatalogo, "", "", "", "", TruncateToDecimal(dAcumulado, 2).ToString)
                    End If
                    sCatalogo = CStr(dtDetalle.Rows(i)("Catalogo")).ToUpper
                    Tickets.AddItemVale(sCatalogo, "", "", "", "", "")
                    dAcumulado = 0
                End If

                sFolio = dtDetalle.Rows(i)("Folio")
                sClave = dtDetalle.Rows(i)("Clave")
                sModelo = dtDetalle.Rows(i)("Modelo")
                sTalla = dtDetalle.Rows(i)("Talla")
                sColor = dtDetalle.Rows(i)("Color")
                sCantidad = TruncateToDecimal(dtDetalle.Rows(i)("Cantidad"), 2).ToString
                dAcumulado += dtDetalle.Rows(i)("Cantidad")
                dTotal += dtDetalle.Rows(i)("Cantidad")
                Tickets.AddItemVale(sFolio, sClave, sModelo, sTalla, sColor, sCantidad)
            Next
            dtDetalle.Dispose()
        End If
        Tickets.AddItemVale("------------------------------", "", "", "", "", "----------")
        Tickets.AddItemVale("TOTAL DEVOLUCIONES ", "", "", "", "", TruncateToDecimal(dTotal, 2).ToString)

        Tickets.AddFooterLine("FECHA DE IMPRESION " & DateTime.Now.ToShortDateString() & " " & DateTime.Now.ToShortTimeString(), 0, 3)
        Tickets.PrintTicket(ImpresoraTicket, 70, 0)

        'INICIA IMPRESION DE VALE

        Tickets = New Imprimir '.PrintTicket.Ticket
        If Not dtTicket Is Nothing Then
            Tickets.MaxCharLine = dtTicket.Rows(0)("MaxChar")
            Tickets.LetraSize = dtTicket.Rows(0)("FontSize")
            Tickets.LetraName = dtTicket.Rows(0)("FontName")
        ...
        Tickets.AddHeaderLine(Nombre, Imprimir.FontEstilo.Negrita, Imprimir.Alinear.Centrado)
        Tickets.AddHeaderLine("SUCURSAL " & sClave & " " & sNombre, Imprimir.FontEstilo.Regular, Imprimir.Alinear.Izquierda)
        Tickets.AddHeaderLine("VALE: " & Folio, Imprimir.FontEstilo.Negrita, Imprimir.Alinear.Izquierda)
        Tickets.AddHeaderLine("FECHA " & Fecha & " " & Hora, Imprimir.FontEstilo.Regular, Imprimir.Alinear.Izquierda)
        Tickets.AddHeaderLine(" ", Imprimir.FontEstilo.Regular, Imprimir.Alinear.Izquierda)
        Tickets.AddHeaderLine("CLIENTE " & Cliente, Imprimir.FontEstilo.Regular, Imprimir.Alinear.Izquierda)
        Tickets.AddHeaderLine(RazonSocial, Imprimir.FontEstilo.Regular, Imprimir.Alinear.Izquierda)
        Tickets.AddHeaderLine(" ", Imprimir.FontEstilo.Regular, Imprimir.Alinear.Izquierda)
        Tickets.AddHeaderLine("*** DOCUMENTOS RELACIONADOS ***", Imprimir.FontEstilo.Regular, Imprimir.Alinear.Izquierda)

        dtDetalle = ModPOS.SiExisteRecupera("st_documentos_vale", "@VALClave", VALClave)
        If Not dtDetalle Is Nothing Then
            Dim i As Integer = 0
            For i = 0 To dtDetalle.Rows.Count - 1
                Tickets.AddItemVale(dtDetalle.Rows(i)("Folio"), "", "", "", "", Strings.Format(TruncateToDecimal(dtDetalle.Rows(i)("Total"), 2).ToString, "Currency"))
            Next
            dtDetalle.Dispose()
            Tickets.AddItemVale("------------------------------", "", "", "", "", "----------")
            Tickets.AddItemVale("MONTO", "", "", "", "", Strings.Format(TruncateToDecimal(Total, 2).ToString, "Currency"))
        ...
        Tickets.AddFooterLine(" ", Imprimir.FontEstilo.Regular, Imprimir.Alinear.Centrado)
        Tickets.AddFooterLine("----------------------------", Imprimir.FontEstilo.Regular, Imprimir.Alinear.Centrado)
        Tickets.AddFooterLine("*** CAJERO *** ", Imprimir.FontEstilo.Regular, Imprimir.Alinear.Centrado)
        Tickets.PrintTicket(ImpresoraTicket, 70, 0)
    ...
    Public Function imprimeDevolucion(ByVal DEVClave As String, ByVal ImpresoraTicket As String, ByVal Ticket As String, ByVal reciboTicket As Integer, ByVal ImpresoraFac As String, ByVal MonDesc As String, ByVal MonRef As String, ByVal Copias As Integer, ByVal Print As Boolean) As Boolean


        If Print = True AndAlso reciboTicket = 1 AndAlso Ticket <> "" Then

            Dim dTotalVenta, dArticulos, Total As Double
            Dim Cte, Folio, FolioVta, Atiende As String

            Dim dt As DataTable = ModPOS.Recupera_Tabla("sp_encabezado_dev", "@DEVClave", DEVClave)
            Cte = dt.Rows(0)("RazonSocial")
            FolioVta = dt.Rows(0)("VENClave")
            Atiende = dt.Rows(0)("Vendedor")
            Folio = dt.Rows(0)("Folio")
            Total = dt.Rows(0)("Total")
            dt.Dispose()
            ...
            Tickets.AddSubHeaderLine("Folio # " & CStr(Folio), 1, 3)
            Tickets.AddSubHeaderLine("REFERENCIA: " & FolioVta, 1, 3)
            Tickets.AddSubHeaderLine("CTE: " & Cte, 0, 3)
            Tickets.AddSubHeaderLine("LE ATENDIO: " & Atiende, 0, 3)
            ...
            If Not dtVentaDetalle Is Nothing Then
                ...
                For i = 0 To dArticulos - 1
                    ...
                    'dDescPorc = (dDescuentoImp / dSubtotal) * 100

                    ' AGREGAR PRODUCTO A LISTA
                    Tickets.AddItem(sDVEClave, sGTIN, sNombre, dCantidad, dTotal / dCantidad, 0)
            ...
            Tickets.AddTotalDevolucion(dTotalVenta, Total, 1)
        ...
        Else
            ...
            pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_devolucion_det", "@DEVClave", DEVClave))
            ...
            If Print = True Then
                OpenReport.Print(Copias, "CRDevolucion.rpt", pvtaDataSet, ModPOS.Letras(ModPOS.TruncateToDecimal(Total, 2)).ToUpper, ImpresoraFac)
            Else
                OpenReport.PrintPreview("Devolución", "CRDevolucion.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonDesc, MonRef).ToUpper)
            End If
    ...
    Public Function ObtenerFolioRetiro(ByVal CAJClave As String, ByVal Referencia As String) As String
        Dim Folio, Periodo, Mes As Integer
        Dim Clave As String
        Dim dt As DataTable

        dt = ModPOS.SiExisteRecupera("sp_recupera_folio", "@Tipo", 10, "@PDVClave", CAJClave)
        ...
        Else
            ...
            Mes = dt.Rows(0)("Mes")
            ModPOS.Ejecuta("sp_act_folio", "@Tipo", 10, "@PDVClave", CAJClave, "@Incremento", 1)

            dt.Dispose()
        End If

        Clave = "RC" & Referencia & "-" & CStr(Folio) & "-" & CStr(Periodo) & CStr(Mes)
    ...
    Public Sub previewNC(ByVal iTipoCF As Integer, ByVal sFormato As String, ByVal NCClave As String, ByVal Total As Decimal, ByVal SUCClave As String, ByVal TipoCambio As Decimal, ByVal MonDesc As String, ByVal MonRef As String, ByVal VersionCF As String, ByVal Logo As Integer)
        ...
        Select Case sFormato
            Case Is = "Clasico"
                If VersionCF = "3.3" Then
                    ...
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_encabezado_nc", "@NCClave", NCClave, "@Logo", Logo))
                    ...
                    OpenReport.PrintPreview("Nota de Crédito", "CREgresoCFDI33.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonDesc, MonRef).ToUpper)
                ...
                Else
                    ...
                    If iTipoCF = 1 Then
                        OpenReport.PrintPreview("Nota de Crédito", "CREgresoCFD.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonDesc, MonRef).ToUpper)
                    ElseIf iTipoCF = 2 Then
                        OpenReport.PrintPreview("Nota de Crédito", "CREgresoCFDI.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonDesc, MonRef).ToUpper)

                    ElseIf iTipoCF = 3 Then
                        OpenReport.PrintPreview("Nota de Crédito", "CREgresoCBB.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonDesc, MonRef).ToUpper)
            ...
            Case Is = "Radec"
                If VersionCF = "3.3" Then
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_rep_relacionado", "@DOCClave", NCClave, "@Tipo", "E"))
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_encabezado_nc_radec", "@NCClave", NCClave, "@Logo", Logo))
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_detalle_nc_radec", "@NCClave", NCClave))
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_sello_nc", "@NCClave", NCClave))

                    OpenReport.PrintPreview("Nota de Crédito", "CFDNotaCredito33.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonDesc, MonRef).ToUpper)
                ...
                Else
                    ...
                    OpenReport.PrintPreview("Nota de Crédito", "CFDNotaCredito.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonDesc, MonRef).ToUpper)
                End If
        End Select

    End Sub

    Public Sub previewCargo(ByVal FormatCargo As String, ByVal sCARClave As String, ByVal dTotal As Decimal, ByVal TipoCambio As Decimal, ByVal MonDesc As String, ByVal MonRef As String, ByVal VersionCF As String, ByVal Logo As Integer)
        Dim OpenReport As New Report
        Dim pvtaDataSet As New DataSet
        pvtaDataSet.DataSetName = "pvtaDataSet"
        ...
        Select Case FormatCargo
            Case Is = "Clasico"
                If VersionCF = "3.3" Then
                    ...
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_encabezado_cargo", "@CARClave", sCARClave, "@Logo", Logo))
                    ...
                    OpenReport.PrintPreview("Nota de Cargo", "CRNotaCargo33.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.Redondear(dTotal, 2), MonDesc, MonRef).ToUpper)
                ...
                Else
                    ...
                    OpenReport.PrintPreview("Nota de Cargo", "CRNotaCargo.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.Redondear(dTotal, 2), MonDesc, MonRef).ToUpper)
                End If
            Case Is = "Radec"
                If VersionCF = "3.3" Then
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_rep_relacionado", "@DOCClave", sCARClave, "@Tipo", "I"))
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_encabezado_cargo_radec", "@CARClave", sCARClave, "@Logo", Logo))
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_detalle_cargo_radec", "@CARClave", sCARClave))
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_sello_cargo", "@CARClave", sCARClave))

                    OpenReport.PrintPreview("Nota de Cargo", "CFDNotaCargo33.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.Redondear(dTotal, 2), MonDesc, MonRef).ToUpper)
                ...
                Else
                    ...
                    OpenReport.PrintPreview("Nota de Cargo", "CFDNotaCargo.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.Redondear(dTotal, 2), MonDesc, MonRef).ToUpper)
                End If
        End Select
    End Sub

    Public Sub previewPedido(ByVal sFormato As String, ByVal VENClave As String, ByVal Total As Decimal, ByVal SUCClave As String, Optional ByVal sImpresora As String = "", Optional ByVal Print As Boolean = False, Optional ByVal iCopias As Integer = 0)

        Dim OpenReport As New Report
        Dim pvtaDataSet As New DataSet


        Dim dt As DataTable = ModPOS.Recupera_Tabla("st_obtener_pedido", "@VENClave", VENClave)
        Dim Estado As Integer = dt.Rows(0)("Estado")
        Dim Tipo As Double = dt.Rows(0)("Tipo")
        dt.Dispose()
        ...
        If sFormato = "Radec" Then

            pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_encabezado_ped_radec", "@VENClave", VENClave))
            pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_detalle_ped_radec", "@VENClave", VENClave))
            pvtaDataSet.DataSetName = "pvtaDataSet"

            If Print = False Then
                OpenReport.PrintPreview("Pedido", "CRPedidoRadec.rpt", pvtaDataSet, ModPOS.Letras(ModPOS.TruncateToDecimal(Total, 2)).ToUpper)
            Else
                OpenReport.Print(iCopias, "CRPedidoRadec.rpt", pvtaDataSet, ModPOS.Letras(ModPOS.TruncateToDecimal(Total, 2)).ToUpper, sImpresora)
            End If

        ElseIf sFormato = "Pagare" Then

            pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_encabezado_pedido", "@VENClave", VENClave, "@Estado", Estado))
            pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_detalle_pedido", "@VENClave", VENClave, "@Estado", Estado))
            pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_datos_compania", "@COMClave", ModPOS.CompanyActual))
            pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_datos_cuentasbaco", "@SUCClave", SUCClave))
            pvtaDataSet.DataSetName = "pvtaDataSet"

            If Print = False Then
                OpenReport.PrintPreview("Pedido", "CRPedidoTPV.rpt", pvtaDataSet, ModPOS.Letras(ModPOS.TruncateToDecimal(Total, 2)).ToUpper)
            Else
                OpenReport.Print(iCopias, "CRPedidoTPV.rpt", pvtaDataSet, ModPOS.Letras(ModPOS.TruncateToDecimal(Total, 2)).ToUpper, sImpresora)
            End If

        ElseIf sFormato = "Clasico" Then
            ...
            Else
                OpenReport.Print(iCopias, "CRPedido.rpt", pvtaDataSet, ModPOS.Letras(ModPOS.TruncateToDecimal(Total, 2)).ToUpper, sImpresora)
            End If


        ElseIf sFormato = "Pagare2" Then
            ...
            If Print = False Then
                OpenReport.PrintPreview("Pedido", "CRPedidoPagare2.rpt", pvtaDataSet, ModPOS.Letras(ModPOS.Redondear(Total, 2)).ToUpper)
            Else
                OpenReport.Print(iCopias, "CRPedidoPagare2.rpt", pvtaDataSet, ModPOS.Letras(ModPOS.TruncateToDecimal(Total, 2)).ToUpper, sImpresora)
            End If
    ...
    Public Sub previewFactura(ByVal iTipoCF As Integer, ByVal sFormato As String, ByVal FACClave As String, ByVal Total As Decimal, ByVal SUCClave As String, ByVal TipoCambio As Decimal, ByVal MonedaDesc As String, ByVal MonedaRef As String, ByVal VersionCF As String, ByVal Logo As Integer)
        ...
        Select Case sFormato
            ...
            Case Is = "Global"
                If VersionCF = "3.3" Then
                    ...
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_rep_impdet_global", "@FACClave", FACClave))
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_sello_fac", "@FACClave", FACClave))

                    OpenReport.PrintPreview("Factura", "CRGlobalCFDI.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper)
                Else
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_logo_compania", "@COMClave", ModPOS.CompanyActual))
                    ...
                    OpenReport.PrintPreview("Factura", "CRGlobal.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper)
                End If
            ...
            Case Is = "Clasico"
                If VersionCF = "3.3" Then
                    ...
                    OpenReport.PrintPreview("Factura", "CRIngresoCFDI33.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper)
                ...
                Else
                    ...
                    Select Case iTipoCF
                        Case Is = 1
                            ...
                            OpenReport.PrintPreview("Factura", "CRIngresoCFD.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper)



                        Case Is = 2
                            OpenReport.PrintPreview("Factura", "CRIngresoCFDI.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper)



                        Case Is = 3
                            pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_metodopago_fac", "@FACClave", FACClave))
                            OpenReport.PrintPreview("Factura", "CRIngresoCBB.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper)
            ...
            Case Is = "Con Notas"
                If VersionCF = "3.3" Then
                    ...
                    OpenReport.PrintPreview("Factura", "CRIngresoNCFDI33.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper)
                ...
                Else
                    ...
                    Select Case iTipoCF
                        Case Is = 1
                            pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_metodopago_fac", "@FACClave", FACClave))
                            OpenReport.PrintPreview("Factura", "CRIngresoNCFD.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper)



                        Case Is = 2
                            OpenReport.PrintPreview("Factura", "CRIngresoNCFDI.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper)
            ...
            Case Is = "Pagare"
                If VersionCF = "3.3" Then
                    ...
                    OpenReport.PrintPreview("Factura", "CFDIPagare33.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper)
                ...
                Else
                    ...
                    OpenReport.PrintPreview("Factura", "CFDIPagare.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper)
            ...
            Case Is = "Pagare2"
                If VersionCF = "3.3" Then
                    ...
                    OpenReport.PrintPreview("Factura", "CFDIPagare2.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper)
                End If
            Case Is = "Radec"
                If VersionCF = "3.3" Then
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_rep_relacionado", "@DOCClave", FACClave, "@Tipo", "F"))
                    ...
                    OpenReport.PrintPreview("Factura", "CFDFactura33.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper)
                ...
                Else
                    ...
                    OpenReport.PrintPreview("Factura", "CFDFactura.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper)
            ...
            Case Is = "AutoZone"
                If VersionCF = "3.3" Then
                    ...
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_venta_fac_radec", "@FACClave", FACClave))
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_sello_fac", "@FACClave", FACClave))
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_complemento_autozone", "@DOCClave", FACClave, "@Tipo", 1))
                    OpenReport.PrintPreview("Factura", "CFDAutoZone.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper)
            ...
            Case Is = "LaLa"
                If VersionCF = "3.3" Then
                    ...
                    OpenReport.PrintPreview("Factura", "CFDFacturaLaLa33.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper)
                ...
                Else
                    ...
                    OpenReport.PrintPreview("Factura", "CFDFacturaLaLa.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper)
            ...
            Case Is = "Aseguradora"
                If VersionCF = "3.3" Then
                    ...
                    OpenReport.PrintPreview("Factura", "CFDFacturaAseg33.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper)
                ...
                Else
                    ...
                    OpenReport.PrintPreview("Factura", "CFDFacturaAseg.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper)
    ...
    Public Sub imprimirFacturas(ByVal iTipoCF As Integer, ByVal idFactura As String, ByVal SUCClave As String, ByVal TipoCambio As Decimal, ByVal MonedaDesc As String, ByVal MonedaRef As String, ByVal PrinterInvoice As String, ByVal NumCopias As Integer, ByVal VersionCF As String)
        ...
        For fila = 0 To dtFactura.Rows.Count - 1
            ...
            iLogo = dtFactura.Rows(fila)("Logo")
            Try
                ModPOS.imprimirFactura(iTipoCF, sFormato, dtFactura.Rows(fila)("FACClave"), dtFactura.Rows(fila)("Total"), SUCClave, TipoCambio, MonedaDesc, MonedaRef, PrinterInvoice, NumCopias, VersionCF, iLogo)
            Catch
            End Try
    ...
    Public Sub imprimirCargo(ByVal FormatCargo As String, ByVal CARClave As String, ByVal Total As Decimal, ByVal TipoCambio As Decimal, ByVal MonDesc As String, ByVal MonRef As String, ByVal sImpresora As String, ByVal iCopias As Integer, ByVal VersionCF As String, ByVal Logo As Integer)
        Dim OpenReport As New Report
        Dim pvtaDataSet As New DataSet
        pvtaDataSet.DataSetName = "pvtaDataSet"
        ...
        Select Case FormatCargo
            Case Is = "Clasico"
                ...
                If VersionCF = "3.3" Then
                    ...
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_encabezado_cargo", "@CARClave", CARClave, "@Logo", Logo))
                    ...
                    OpenReport.Print(iCopias, "CRNotaCargo33.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonDesc, MonRef).ToUpper, sImpresora)
                ...
                Else
                    ...
                    OpenReport.Print(iCopias, "CRNotaCargo.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonDesc, MonRef).ToUpper, sImpresora)
                End If
            Case Is = "Radec"
                If VersionCF = "3.3" Then
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_rep_relacionado", "@DOCClave", CARClave, "@Tipo", "I"))
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_encabezado_cargo_radec", "@CARClave", CARClave, "@Logo", Logo))
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_detalle_cargo_radec", "@CARClave", CARClave))
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_sello_cargo", "@CARClave", CARClave))

                    OpenReport.Print(iCopias, "CFDNotaCargo33.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonDesc, MonRef).ToUpper, sImpresora)
                ...
                Else
                    ...
                    OpenReport.Print(iCopias, "CFDNotaCargo.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonDesc, MonRef).ToUpper, sImpresora)
    ...
    Public Sub imprimirNC(ByVal iTipoCF As Integer, ByVal sFormato As String, ByVal NCClave As String, ByVal Total As Decimal, ByVal SUCClave As String, ByVal TipoCambio As Decimal, ByVal MonedaDesc As String, ByVal MonedaRef As String, ByVal sImpresora As String, ByVal NumCopias As Integer, ByVal VersionCF As String, ByVal Logo As Integer)
        ...
        Select Case sFormato
            Case Is = "Clasico"
                ...
                If VersionCF = "3.3" Then
                    ...
                    OpenReport.Print(NumCopias, "CREgresoCFDI33.rpt", pvtaDataSet, ModPOS.LetrasM(TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, sImpresora)
                ...
                Else
                    ...
                    If iTipoCF = 1 Then
                        OpenReport.Print(NumCopias, "CREgresoCFD.rpt", pvtaDataSet, ModPOS.LetrasM(TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, sImpresora)
                    ElseIf iTipoCF = 2 Then
                        OpenReport.Print(NumCopias, "CREgresoCFDI.rpt", pvtaDataSet, ModPOS.LetrasM(TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, sImpresora)
                    ElseIf iTipoCF = 3 Then
                        OpenReport.Print(NumCopias, "CREgresoCBB.rpt", pvtaDataSet, ModPOS.LetrasM(TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, sImpresora)
                    End If
                End If
            ...
            Case Is = "Radec"
                ...
                If VersionCF = "3.3" Then
                    ...
                    OpenReport.Print(NumCopias, "CFDNotaCredito33.rpt", pvtaDataSet, ModPOS.LetrasM(TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, sImpresora)
                ...
                Else
                    ...
                    OpenReport.Print(NumCopias, "CFDNotaCredito.rpt", pvtaDataSet, ModPOS.LetrasM(TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, sImpresora)
                End If
        End Select
    ...
    Public Sub imprimirFactura(ByVal iTipoCF As Integer, ByVal sFormato As String, ByVal FACClave As String, ByVal Total As Decimal, ByVal SUCClave As String, ByVal TipoCambio As Decimal, ByVal MonedaDesc As String, ByVal MonedaRef As String, ByVal PrinterInvoice As String, ByVal NumCopias As Integer, ByVal VersionCF As String, ByVal Logo As Integer)
        ...
        Select Case sFormato
            Case Is = "Global"
                If VersionCF = "3.3" Then
                    ...
                    OpenReport.Print(NumCopias, "CRGlobalCFDI.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, PrinterInvoice)
                Else
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_logo_compania", "@COMClave", ModPOS.CompanyActual))
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_encabezado_fac", "@FACClave", FACClave))
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_detalle_fac", "@FACClave", FACClave))
                    ...
                    OpenReport.Print(NumCopias, "CRGlobal.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, PrinterInvoice)
            ...
            Case Is = "Clasico"
                If VersionCF = "3.3" Then
                    ...
                    OpenReport.Print(NumCopias, "CRIngresoCFDI33.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, PrinterInvoice)
                ...
                Else
                    ...
                    Select Case iTipoCF
                        Case Is = 1
                            pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_metodopago_fac", "@FACClave", FACClave))
                            OpenReport.Print(NumCopias, "CRIngresoCFD.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, PrinterInvoice)

                        Case Is = 2
                            OpenReport.Print(NumCopias, "CRIngresoCFDI.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, PrinterInvoice)


                        Case Is = 3
                            pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_metodopago_fac", "@FACClave", FACClave))
                            OpenReport.Print(NumCopias, "CRIngresoCBB.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, PrinterInvoice)
            ...
            Case Is = "Con Notas"
                If VersionCF = "3.3" Then
                    ...
                    OpenReport.Print(NumCopias, "CRIngresoNCFDI33.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, PrinterInvoice)
                ...
                Else
                    ...
                    Select Case iTipoCF
                        Case Is = 1
                            pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_metodopago_fac", "@FACClave", FACClave))
                            OpenReport.Print(NumCopias, "CRIngresoNCFD.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, PrinterInvoice)


                        Case Is = 2
                            OpenReport.Print(NumCopias, "CRIngresoNCFDI.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, PrinterInvoice)
            ...
            Case Is = "Pagare"
                If VersionCF = "3.3" Then
                    ...
                    OpenReport.Print(NumCopias, "CFDIPagare33.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, PrinterInvoice)
                ...
                Else
                    ...
                    OpenReport.Print(NumCopias, "CFDIPagare.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, PrinterInvoice)
                End If
            Case Is = "Pagare2"
                If VersionCF = "3.3" Then
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_rep_relacionado", "@DOCClave", FACClave, "@Tipo", "F"))
                    ...
                    OpenReport.Print(NumCopias, "CFDIPagare2.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, PrinterInvoice)
                End If
            ...
            Case Is = "Radec"
                If VersionCF = "3.3" Then
                    ...
                    OpenReport.Print(NumCopias, "CFDFactura33.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, PrinterInvoice)
                ...
                Else
                    ...
                    OpenReport.Print(NumCopias, "CFDFactura.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, PrinterInvoice)
            ...
            Case Is = "AutoZone"
                If VersionCF = "3.3" Then
                    ...
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_sello_fac", "@FACClave", FACClave))
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_complemento_autozone", "@DOCClave", FACClave, "@Tipo", 1))
                    OpenReport.Print(NumCopias, "CFDAutoZone.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, PrinterInvoice)
                End If
            Case Is = "LaLa"
                If VersionCF = "3.3" Then
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_rep_relacionado", "@DOCClave", FACClave, "@Tipo", "F"))
                    ...
                    OpenReport.Print(NumCopias, "CFDFacturaLaLa33.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, PrinterInvoice)
                ...
                Else
                    ...
                    OpenReport.Print(NumCopias, "CFDFacturaLaLa.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, PrinterInvoice)
            ...
            Case Is = "Aseguradora"
                If VersionCF = "3.3" Then
                    ...
                    OpenReport.Print(NumCopias, "CFDFacturaAseg33.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, PrinterInvoice)
                ...
                Else
                    ...
                    OpenReport.Print(NumCopias, "CFDFacturaAseg.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, PrinterInvoice)
    ...
    Public Function SendMailNC(ByVal VersionCF As String, ByVal email As String, ByVal TipoCF As Integer, ByVal sFormato As String, ByVal Fecha As Date, ByVal Folio As String, ByVal NCClave As String, ByVal Total As Decimal, ByVal MailAdress As String, ByVal MailUser As String, MailPassword As String, ByVal HostSMTP As String, ByVal MailPort As Integer, ByVal MailSSL As Boolean, ByVal DisplayName As String, ByVal PathXML As String, ByVal SUCClave As String, ByVal TipoCambio As Decimal, ByVal MonedaDesc As String, ByVal MonedaRef As String, ByVal Logo As Integer, Optional ByVal ShowMsg As Boolean = True) As String
        ...
        Select Case sFormato
            Case Is = "Clasico"
                If VersionCF = "3.3" Then
                    ...
                    OpenReport.PrintPDF("CREgresoCFDI33.rpt", pvtaDataSet, ModPOS.LetrasM(TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, PathPDF)
                Else
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_recupera_publicidad", "@SUCClave", SUCClave))
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_encabezado_nc", "@NCClave", NCClave, "@Logo", Logo))
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_nc_detalle", "@NCClave", NCClave))
                    ...
                    If TipoCF = 1 Then
                        OpenReport.PrintPDF("CREgresoCFD.rpt", pvtaDataSet, ModPOS.LetrasM(TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, PathPDF)
                    ElseIf TipoCF = 2 Then
                        OpenReport.PrintPDF("CREgresoCFDI.rpt", pvtaDataSet, ModPOS.LetrasM(TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, PathPDF)
                    ElseIf TipoCF = 3 Then
                        OpenReport.PrintPDF("CREgresoCBB.rpt", pvtaDataSet, ModPOS.LetrasM(TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, PathPDF)
                    End If
                End If
            ...
            Case Is = "Radec"
                If VersionCF = "3.3" Then
                    ...
                    OpenReport.PrintPDF("CFDNotaCredito33.rpt", pvtaDataSet, ModPOS.LetrasM(TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, PathPDF)

                Else
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_encabezado_nc_radec", "@NCClave", NCClave))
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_detalle_nc_radec", "@NCClave", NCClave, "@Logo", Logo))
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_sello_nc", "@NCClave", NCClave))

                    OpenReport.PrintPDF("CFDNotaCredito.rpt", pvtaDataSet, ModPOS.LetrasM(TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, PathPDF)
                End If
        End Select
    ...
    End Function
    Public Function SendMailCargo(ByVal VersionCF As String, ByVal email As String, ByVal FormatCargo As String, ByVal Fecha As Date, ByVal Folio As String, ByVal CARClave As String, ByVal Total As Decimal, ByVal MailAdress As String, ByVal MailUser As String, MailPassword As String, ByVal HostSMTP As String, ByVal MailPort As Integer, ByVal MailSSL As Boolean, ByVal DisplayName As String, ByVal PathXML As String, ByVal TipoCambio As Decimal, ByVal MonDesc As String, ByVal MonRef As String, ByVal Logo As Integer, Optional ByVal ShowMsg As Boolean = True) As String
        ...
        Select Case FormatCargo
            Case Is = "Clasico"
                If VersionCF = "3.3" Then
                    ...
                    OpenReport.PrintPDF("CRNotaCargo33.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonDesc, MonRef).ToUpper, PathPDF)
                ...
                Else
                    ...
                    OpenReport.PrintPDF("CRNotaCargo.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonDesc, MonRef).ToUpper, PathPDF)
                End If
            Case Is = "Radec"
                If VersionCF = "3.3" Then
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_rep_relacionado", "@DOCClave", CARClave, "@Tipo", "I"))
                    ...
                    OpenReport.PrintPDF("CFDNotaCargo33.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonDesc, MonRef).ToUpper, PathPDF)
                ...
                Else
                    ...
                    OpenReport.PrintPDF("CFDNotaCargo.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonDesc, MonRef).ToUpper, PathPDF)
                End If
        End Select
    ...
    Public Function SendMail(ByVal VersionCF As String, ByVal email As String, ByVal TipoCF As Integer, ByVal sFormato As String, ByVal Fecha As Date, ByVal Folio As String, ByVal FACClave As String, ByVal Total As Decimal, ByVal MailAdress As String, ByVal MailUser As String, MailPassword As String, ByVal HostSMTP As String, ByVal MailPort As Integer, ByVal MailSSL As Boolean, ByVal DisplayName As String, ByVal PathXML As String, ByVal SUCClave As String, ByVal TipoCambio As Decimal, ByVal MonedaDesc As String, ByVal MonedaRef As String, ByVal Logo As Integer, Optional ByVal ShowMsg As Boolean = True) As String
        ...
        Select Case sFormato
            ...
            Case Is = "Global"
                If VersionCF = "3.3" Then
                    ...
                    OpenReport.PrintPDF("CRGlobalCFDI.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, PathPDF)
                ...
                Else
                    ...
                    OpenReport.PrintPDF("CRGlobal.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, PathPDF)
                End If
            Case Is = "Clasico"
                ...
                If VersionCF = "3.3" Then
                    ...
                    OpenReport.PrintPDF("CRIngresoCFDI33.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, PathPDF)
                ...
                Else
                    ...
                    Select Case TipoCF
                        Case Is = 1
                            pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_metodopago_fac", "@FACClave", FACClave))
                            OpenReport.PrintPDF("CRIngresoCFD.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, PathPDF)
                        Case Is = 2
                            OpenReport.PrintPDF("CRIngresoCFDI.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, PathPDF)
                        Case Is = 3
                            pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_metodopago_fac", "@FACClave", FACClave))
                            OpenReport.PrintPDF("CRIngresoCBB.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, PathPDF)
            ...
            Case Is = "Con Notas"
                If VersionCF = "3.3" Then
                    ...
                    OpenReport.PrintPDF("CRIngresoNCFDI33.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, PathPDF)
                ...
                Else
                    ...
                    Select Case TipoCF
                        Case Is = 1
                            ...
                            OpenReport.PrintPDF("CRIngresoNCFD.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, PathPDF)
                        Case Is = 2
                            OpenReport.PrintPDF("CRIngresoNCFDI.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, PathPDF)
                        Case Is = 3
                            pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_metodopago_fac", "@FACClave", FACClave))
            ...
            Case Is = "Pagare"
                If VersionCF = "3.3" Then
                    ...
                    OpenReport.PrintPDF("CFDIPagare33.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, PathPDF)
                ...
                Else
                    ...
                    OpenReport.PrintPDF("CFDIPagare.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, PathPDF)
                End If
            ...
            Case Is = "Pagare2"
                If VersionCF = "3.3" Then
                    ...
                    OpenReport.PrintPDF("CFDIPagare2.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, PathPDF)
                End If
            Case Is = "Radec"
                If VersionCF = "3.3" Then
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_rep_relacionado", "@DOCClave", FACClave, "@Tipo", "F"))
                    ...
                    OpenReport.PrintPDF("CFDFactura33.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, PathPDF)
                ...
                Else
                    ...
                    OpenReport.PrintPDF("CFDFactura.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, PathPDF)
                End If
            Case Is = "AutoZone"
                If VersionCF = "3.3" Then
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_rep_relacionado", "@DOCClave", FACClave, "@Tipo", "F"))
                    ...
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("sp_sello_fac", "@FACClave", FACClave))
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_complemento_autozone", "@DOCClave", FACClave, "@Tipo", 1))
                    OpenReport.PrintPDF("CFDAutoZone.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, PathPDF)
                End If
            ...
            Case Is = "LaLa"
                If VersionCF = "3.3" Then
                    ...
                    OpenReport.PrintPDF("CFDFacturaLaLa33.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, PathPDF)
                ...
                Else
                    ...
                    OpenReport.PrintPDF("CFDFacturaLaLa.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, PathPDF)
                End If
            Case Is = "Aseguradora"
                If VersionCF = "3.3" Then
                    pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_rep_relacionado", "@DOCClave", FACClave, "@Tipo", "F"))
                    ...
                    OpenReport.PrintPDF("CFDFacturaAseg33.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, PathPDF)
                ...
                Else
                    ...
                    OpenReport.PrintPDF("CFDFacturaAseg.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonedaDesc, MonedaRef).ToUpper, PathPDF)
                End If
    ...
    Public Sub Aplica_Pagos(ByRef dtDoctos As DataTable, ByVal CTEClave As String, ByVal AbonoClave As String, ByVal TPago As Integer, ByRef TotalAbono As Decimal, ByVal CAJClave As String, ByVal TipoPago As Integer)
        ...
        If dtDoctos.Rows.Count = 1 Then
            If dtDoctos.Rows(0)("SaldoBase") > 0 Then

                dSaldoVenta = CDec(dtDoctos.Rows(0)("SaldoBase"))
                ...
                Select Case TotalAbono
                    Case Is >= Math.Round(dSaldoVenta, 2)
                        ...
                        TotalAbono -= dtDoctos.Rows(0)("SaldoBase")
                        dtDoctos.Rows(0)("SaldoBase") = 0
                    ...
                    Case Is < dSaldoVenta
                        ...
                        ModPOS.Ejecuta("sp_actualiza_saldo", _
                                       ...
                                       "@Documento", dtDoctos.Rows(0)("ID"), _
                                       "@Tipo", TPago, _
                                       "@SaldoRemanente", Math.Round((dtDoctos.Rows(0)("SaldoBase") - TotalAbono) / dtDoctos.Rows(0)("TipoCambio"), 2), _
                                       "@Usuario", ModPOS.UsuarioActual)

                        dtDoctos.Rows(0)("SaldoBase") -= TotalAbono
        ...
        Else
            ...
            For i = 0 To dtDoctos.Rows.Count - 1
                If dtDoctos.Rows(i)("SaldoBase") > 0 Then
                    Select Case SaldoDisponible
                        Case Is >= Math.Round(CDec(dtDoctos.Rows(i)("SaldoBase")), 2)
                            ModPOS.Ejecuta("sp_paga_documento", _
                                           "@CAJClave", CAJClave, _
                                                          "@ABNClave", AbonoClave, _
                                                          "@TipoDoc", dtDoctos.Rows(i)("TipoDocumento"), _
                                                          "@Documento", dtDoctos.Rows(i)("ID"), _
                                                          "@Pago", dtDoctos.Rows(i)("SaldoBase"), _
                                                          "@AcumulaPuntos", AcumulaPuntos, _
                                                          "@Tipo", TPago, _
                                                          "@Usuario", ModPOS.UsuarioActual)

                            SaldoDisponible -= dtDoctos.Rows(i)("SaldoBase")

                            If TipoPago = 2 AndAlso (dtDoctos.Rows(0)("TipoDocumento") = 2 OrElse dtDoctos.Rows(0)("TipoDocumento") = 6) Then
                                'Aplica Anticipo
                                AplicaAnticipo(AbonoClave, dtDoctos.Rows(0)("ID"), dtDoctos.Rows(0)("TipoDocumento"), dtDoctos.Rows(i)("SaldoBase"), CAJClave)
                            End If
                            dtDoctos.Rows(i)("SaldoBase") = 0

                        Case Is < CDec(dtDoctos.Rows(i)("SaldoBase"))
                            ModPOS.Ejecuta("sp_actualiza_saldo", _
                                            "@CAJClave", CAJClave, _
                                           "@ABNClave", AbonoClave, _
                                           ...
                                           "@Documento", dtDoctos.Rows(i)("ID"), _
                                           "@Tipo", TPago, _
                                           "@SaldoRemanente", Math.Round((dtDoctos.Rows(i)("SaldoBase") - SaldoDisponible) / dtDoctos.Rows(i)("TipoCambio"), 2), _
                                           "@Usuario", ModPOS.UsuarioActual)


                            dtDoctos.Rows(i)("SaldoBase") -= SaldoDisponible
    ...
    Public Function ValidaCredido(ByVal CTEClave As String, ByVal dLimiteCredito As Decimal, ByVal iDiasCredito As Integer, ByVal dValorPedido As Decimal, ByVal dTipoCambio As Decimal) As Integer
            ...
            Else
                ...
                If dtRiesgo.Rows.Count > 0 Then
                    ...
                    If iResult <> 0 AndAlso CDbl(dtRiesgo.Rows(0)("ValorPedido")) >= 0 Then
                        If (dValorPedido * dTipoCambio) > CDbl(dtRiesgo.Rows(0)("ValorPedido")) Then
                    ...
                    If iResult <> 0 AndAlso CBool(dtRiesgo.Rows(0)("ValidaLimite")) = True Then
                        ...
                        Comprometido = CDbl(dt.Rows(0)("TotalComprometido")) + (dValorPedido * dTipoCambio)
    ...
    Public Function obtenerDescuentoVolumen(ByVal CTEClave As String, ByVal iGrupoMaterial As Integer, ByVal iSector As Integer, ByVal VENClave As String, ByVal PROClave As String, ByVal Subtotal As Double, Optional ByVal bCerrado As Boolean = False) As DescVol
        ...
        dt = Recupera_Tabla("st_venta_grupo", "@Grupo", iGrupoMaterial, "@VENClave", VENClave, "@PROClave", PROClave, "@Cerrado", bCerrado) 'Sector
        If dt.Rows.Count > 0 Then
        ...
        dt = Recupera_Tabla("st_venta_sector", "@Sector", iSector, "@VENClave", VENClave, "@PROClave", PROClave, "@Cerrado", bCerrado) 'Sector
        If dt.Rows.Count > 0 Then
    ...
    Public Function imprimeTicketCierre(ByVal IDCorte As String, ByVal Impresora As String, ByVal Generic As Boolean, ByVal Ticket As String, ByVal FormatoCorte As String, ByVal SUCClave As String) As Boolean
        Dim dtObjetos As DataTable
        ...
        If Not dtObjetos Is Nothing Then
            If dtObjetos.Rows.Count > 0 Then
                ...
                dDiferencia = dtObjetos.Rows(0)("Diferencia")
                sAutoriza = dtObjetos.Rows(0)("Autoriza")
                sMotivo = dtObjetos.Rows(0)("Motivo")
            End If
            dtObjetos.Dispose()
        End If
        ...
        If FormatoCorte = "Resumen" Then
            ...
            Tickets.AddHeaderLine("*** RETIROS DE CAJA ***", Imprimir.FontEstilo.Negrita, Imprimir.Alinear.Centrado)

            dtObjetos = ModPOS.SiExisteRecupera("st_recupera_retiro", "@CAJClave", sCAJClave, "@Inicial", dApertura, "@Final", dCierre)

            Dim dTotalRetiro As Double = 0
                ...
                If dtObjetos.Rows.Count > 0 Then
                    ...
                    If foundRows.GetLength(0) > 0 Then
                        ...
                        Next
                             ...
                             Tickets.AddHeaderLineDetalle("TOTAL", dTotalRetiro, Imprimir.FontEstilo.Negrita, Imprimir.Alinear.Izquierda)
                            Tickets.AddHeaderDotLine(Imprimir.FontEstilo.Regular, Imprimir.Alinear.Centrado)
            ...
            If dt.Rows.Count > 0 Then
                dTotalEfectivoCaja = CDec(dt.Rows(0)("Efectivo"))
            End If
            dt.Dispose()
            ...
            Tickets.AddHeaderLineDetalle("RETIROS DE CAJA", dTotalRetiro, Imprimir.FontEstilo.Negrita, Imprimir.Alinear.Izquierda)

            Tickets.AddHeaderLineDetalle("T.EFECTIVO EN CAJA", dTotalEfectivoCaja, Imprimir.FontEstilo.Negrita, Imprimir.Alinear.Izquierda)
            Tickets.AddHeaderLineDetalle("EFECTIVO REGISTRADO", dSaldoCierre, Imprimir.FontEstilo.Regular, Imprimir.Alinear.Izquierda)
            Tickets.AddHeaderLineDetalle("FALTANTE EFECTIVO", dDiferencia, Imprimir.FontEstilo.Negrita, Imprimir.Alinear.Izquierda)

            If dDiferencia > 0 Then
                Tickets.AddFooterLine(sMotivo, Imprimir.FontEstilo.Regular, Imprimir.Alinear.Izquierda)
                Tickets.AddFooterLine(sAutoriza, Imprimir.FontEstilo.Regular, Imprimir.Alinear.Izquierda)
            End If
        ...
        Else
            ...
            dt = ModPOS.Recupera_Tabla("st_encabezado_corte", "@SUCClave", SUCClave)

            Tickets.AddHeaderLine(dt.Rows(0)("Compania"), Imprimir.FontEstilo.Regular, Imprimir.Alinear.Izquierda)
            Tickets.AddHeaderLine(dt.Rows(0)("eCalle"), Imprimir.FontEstilo.Regular, Imprimir.Alinear.Izquierda)
            Tickets.AddHeaderLine(dt.Rows(0)("eDomicilio1"), Imprimir.FontEstilo.Regular, Imprimir.Alinear.Izquierda)
            Tickets.AddHeaderLine(dt.Rows(0)("eDomicilio2"), Imprimir.FontEstilo.Regular, Imprimir.Alinear.Izquierda)
            Tickets.AddHeaderLine(dt.Rows(0)("cRFC"), Imprimir.FontEstilo.Regular, Imprimir.Alinear.Izquierda)
            Tickets.AddHeaderLine(dt.Rows(0)("RegimenFiscal"), Imprimir.FontEstilo.Regular, Imprimir.Alinear.Izquierda)
            ' Sucursal
            Tickets.AddHeaderLine(" ", Imprimir.FontEstilo.Regular, Imprimir.Alinear.Izquierda)

            Tickets.AddHeaderLine("Sucursal:" & CStr(dt.Rows(0)("Clave")), Imprimir.FontEstilo.Regular, Imprimir.Alinear.Izquierda)
            Tickets.AddHeaderLine(dt.Rows(0)("Sucursal"), Imprimir.FontEstilo.Regular, Imprimir.Alinear.Izquierda)
            Tickets.AddHeaderLine(dt.Rows(0)("sCalle"), Imprimir.FontEstilo.Regular, Imprimir.Alinear.Izquierda)
            Tickets.AddHeaderLine(dt.Rows(0)("sDomicilio1"), Imprimir.FontEstilo.Regular, Imprimir.Alinear.Izquierda)
            ...
            Tickets.AddHeaderLine("RESUMEN POR FORMA DE PAGO", Imprimir.FontEstilo.Regular, Imprimir.Alinear.Izquierda)
            Tickets.AddHeaderDotLine(Imprimir.FontEstilo.Regular, Imprimir.Alinear.Izquierda)

            dtObjetos = ModPOS.SiExisteRecupera("st_formapago_corte", "@CAJClave", sCAJClave, "@Inicial", dApertura, "@Final", dCierre)

            Dim dFormaPago As Double = 0
            Dim sConcepto As String
            Dim dImporte As Decimal
            ...
            If Not dtObjetos Is Nothing Then
                If dtObjetos.Rows.Count > 0 Then
                    For fila = 0 To dtObjetos.Rows.Count - 1
                        sConcepto = CStr(dtObjetos.Rows(fila)("Concepto"))
                        iCantidad = CInt(dtObjetos.Rows(fila)("Cantidad"))
                        dImporte = CDbl(dtObjetos.Rows(fila)("Importe"))
                        dFormaPago += dImporte
                        Tickets.AddHeaderLineDetalle(sConcepto, iCantidad, dImporte, Imprimir.FontEstilo.Regular, Imprimir.Alinear.Izquierda)
                    Next
            ...
            End If
            Tickets.AddHeaderDotLine(Imprimir.FontEstilo.Regular, Imprimir.Alinear.Izquierda)
            Tickets.AddHeaderLineDetalle("TOTAL", dFormaPago, Imprimir.FontEstilo.Regular, Imprimir.Alinear.Izquierda)

            Tickets.AddHeaderLine(" ", Imprimir.FontEstilo.Regular, Imprimir.Alinear.Izquierda)

            '***** VENTAS POR FORMA DE PAGO 

            Tickets.AddHeaderLine("VENTAS POR FORMA DE PAGO", Imprimir.FontEstilo.Regular, Imprimir.Alinear.Izquierda)
            Tickets.AddHeaderDotLine(Imprimir.FontEstilo.Regular, Imprimir.Alinear.Izquierda)

            Tickets.AddHeaderLineDetalle("FOLIO", "FP", "FORMA PAGO", "IMPORTE", Imprimir.FontEstilo.Regular, Imprimir.Alinear.Izquierda)


            dtObjetos = ModPOS.SiExisteRecupera("st_vta_corte", "@CAJClave", sCAJClave, "@Inicial", dApertura, "@Final", dCierre)
            ...
            If Not dtObjetos Is Nothing Then
                If dtObjetos.Rows.Count > 0 Then
                    For fila = 0 To dtObjetos.Rows.Count - 1
                        sConcepto = CStr(dtObjetos.Rows(fila)("Concepto"))
                        sDesc = CStr(dtObjetos.Rows(fila)("Desc"))
                        sDescripcion = CStr(dtObjetos.Rows(fila)("Descripcion"))
                        dImporte = CDbl(dtObjetos.Rows(fila)("Importe"))
                        dGrupo += dImporte
                        Tickets.AddHeaderLineDetalle(sConcepto, sDesc, sDescripcion, dImporte, Imprimir.FontEstilo.Regular, Imprimir.Alinear.Izquierda)
                    Next
            ...
            End If
            Tickets.AddHeaderDotLine(Imprimir.FontEstilo.Regular, Imprimir.Alinear.Izquierda)
            Tickets.AddHeaderLineDetalle("TOTAL", dGrupo, Imprimir.FontEstilo.Regular, Imprimir.Alinear.Izquierda)
    ...
    Public Function ObtenerEspera(ByVal dtPAC As DataTable, ByVal rRFC As String, ByVal Tipo As Integer, ByVal DOCClave As String, ByVal uuid As String) As Boolean
        Dim resultado As Boolean
        Dim frmStatusMessage As New frmStatus
        frmStatusMessage.Show("Solicitado Cancelación...")
        Dim j As Integer
        For j = 0 To dtPAC.Rows.Count - 1
            If dtPAC.Rows(j)("TipoPAC") = 3 Then ' DigitalInvoice

                Dim result As DigitalInvoiceCancelacionWS33.AcusePeticionesPendientes
                ...
                If CStr(dtPAC.Rows(j)("ServerCancel")).Length > 1 Then
                    client.Endpoint.Address = New System.ServiceModel.EndpointAddress(dtPAC.Rows(j)("ServerCancel").ToString)
                End If
                ...
                Try
                    ...
                    result = client.ObtenerPeticionesPendientes(rRFC)
                    ...
                    Else
                        ...
                        If (Not result.codEstatusField Is Nothing) Then

                            estatus = result.codEstatusField
                        End If

                        If estatus = "PRUEBA" Then
                            resultado = True
                            Exit For
                        Else
                            resultado = False
    ...
    Public Function cancelarXML(ByVal dtPAC As DataTable, ByVal sFolio As String, ByVal UUID As String, ByVal eRFC As String, ByVal VersionCF As String, ByVal Tipo As Integer, ByVal DOCClave As String) As Boolean
        Dim dt As DataTable
                            ...
                            ElseIf j = dtPAC.Rows.Count - 1 Then
                                Select Case estatus
                                    ...
                                    Case Is = "ResultadoNoIdentificado"
                                        ...
                                        resultado = False
                                    Case Is = "300"
                                        MsgBox("Requiere Aprobación del receptor, el comprobante quedara en Espera")
                                        ModPOS.Ejecuta("st_actualiza_edo_comprobante", "@Tipo", Tipo, "@DOCClave", DOCClave, "@Estado", 3)
                                        resultado = False
                                    Case Is = "301"
                                        MsgBox("El comprobante no cumple con el estandar XML")
                                        resultado = False
                                    Case Is = "302"
                                        MsgBox("El sello del emisor no es valido")
                                        resultado = False
                                    Case Is = "303"
                                        MsgBox("El CSD del emisor no corresponde al RFC")
                                        resultado = False
                                    Case Is = "304"
                                        MsgBox("El CSD del emisor ha sido revocado")
                                        resultado = False
                                    Case Is = "305"
                                        MsgBox("Fecha de emision no esta dentro de la vigencia del CSD")
                                        resultado = False
                                    Case Is = "306"
                                        MsgBox("La llave utilizada corresponde a FIEL (no a un CSD)")
                                        resultado = False
                                    Case Is = "307"
                                        MsgBox("Contiene un timbre previo")

                                        resultado = False
                                    Case Is = "308"
                                        MsgBox("El CSD del emisor no ha sido firmado por un certificado de autoridad del SAT")
                                        resultado = False
                                    Case Is = "401"
                                        MsgBox("La fecha de generacion es mayor a 72 hrs de la emision del timbre")
                                        resultado = False
                                    Case Is = "402"
                                        MsgBox("El RFC no existe en la Lista de validacion de regimen")

                                        resultado = False
                                    Case Is = "403"
                                        MsgBox("La fecha de emsion es anterior al 1 de enero de 2011")
                                        resultado = False
                                End Select
                            End If
                        End If
            ...
            ElseIf dtPAC.Rows(j)("TipoPAC") = 4 Then 'Detecno
                ...
                If VersionCF = "3.3" Then
                    ...
                    If generaXmlCancelarCfdi(eRFC, UUID, CertificadoFile, LlaveFile, ContrasenaClave, xmlstring, sError) = True Then
                        ...
                        Else
                            If dtPAC.Rows(j)("ServerCancel") = "" Then
        ...
        If oCFD.VersionCF <> "3.3" Then
            ...
            If VersionNomina = 1 Then
                ...
                If oCFD.descuento > 0 Then
                    ...
                    textWriter.WriteAttributeString("TipoCambio", QuitarCeros(TruncateToDecimal(oCFD.TipoCambio, 2), 2))
                End If
            ...
            If VersionNomina = 1 Then
                ...
                If foundRows.GetLength(0) > 0 Then
                    For i = 0 To foundRows.GetUpperBound(0)
                        ...
                        textWriter.WriteAttributeString("valorUnitario", QuitarCeros(foundRows(i)("P.U.")))
                        textWriter.WriteAttributeString("importe", QuitarCeros(foundRows(i)("Cantidad") * (foundRows(i)("P.U."))))
                        textWriter.WriteEndElement()
                ...
                Else
                    ...
                    If foundRows.GetLength(0) > 0 Then
                        ...
                        For i = 0 To foundRows.GetUpperBound(0)
                            ...
                            textWriter.WriteAttributeString("importe", QuitarCeros(foundRows(i)("Importe")))
                            textWriter.WriteEndElement()
                        Next
                    End If
        ...
        Else '3.3
            ...
            For i = 0 To dtPAC.Rows.Count - 1
                ...
                ElseIf dtPAC.Rows(i)("TipoPAC") = 3 Then 'DigitalInvoice
                    ...
                    If CStr(dtPAC.Rows(i)("ServerTimbre")).Length > 1 Then
    ...
    Public Function crearXMLGlobal(ByVal TipoAccion As Integer, ByVal dtPAC As DataTable, ByVal PathXML As String, ByVal sFolio As String, ByVal sDOCClave As String, ByVal dtConcepto As DataTable, ByVal dtImpuesto As DataTable, ByVal dtImpuestoDet As DataTable, Optional ByVal oCFD As CFD = Nothing, Optional ByVal sInterfazSalida As String = "") As Integer
        ...
        If TipoAccion = 1 OrElse TipoAccion = 3 OrElse TipoAccion = 4 Then 'Crea por primera vez el XML o regenerar xml
            ...
            textWriter.WriteAttributeString("NoCertificado", oCFD.noCertificado)
            textWriter.WriteAttributeString("Certificado", oCFD.Certificado64)
            textWriter.WriteAttributeString("SubTotal", QuitarCeros(TruncateToDecimal(oCFD.subtotal, 2), 2))
            If oCFD.descuento > 0 Then
                textWriter.WriteAttributeString("Descuento", QuitarCeros(TruncateToDecimal(oCFD.descuento, 2), 2))
            End If
            ...
            If oCFD.TipoCambio <> 1 Then
                textWriter.WriteAttributeString("TipoCambio", QuitarCeros(TruncateToDecimal(oCFD.TipoCambio, 2), 2))
            End If
            textWriter.WriteAttributeString("Total", QuitarCeros(TruncateToDecimal(oCFD.total, 2), 2))
            ...
            If foundRows.GetLength(0) > 0 Then
                For i = 0 To foundRows.GetUpperBound(0)
                    ...
                    textWriter.WriteAttributeString("ValorUnitario", QuitarCeros(TruncateToDecimal(foundRows(i)("Subtotal"), 2), 2))
                    textWriter.WriteAttributeString("Importe", QuitarCeros(TruncateToDecimal((foundRows(i)("Subtotal")), 2), 2))

                    'Campo opcional cuando se tenga descuentos
                    If foundRows(i)("Descuento") > 0 Then
                        textWriter.WriteAttributeString("Descuento", QuitarCeros(TruncateToDecimal(foundRows(i)("Descuento"), 2), 2))
                    End If
                    textWriter.WriteStartElement(sPre & "Impuestos")
                    textWriter.WriteStartElement(sPre & "Traslados")
                    For z = 0 To foundDet.GetUpperBound(0)
                        textWriter.WriteStartElement(sPre & "Traslado")
                        textWriter.WriteAttributeString("Base", QuitarCeros(TruncateToDecimal(foundDet(z)("Base"), 2), 2))
                        ...
                        textWriter.WriteAttributeString("Importe", QuitarCeros(TruncateToDecimal(foundDet(z)("Importe"), 2), 2))
                        textWriter.WriteEndElement()
                    Next
            ...
            ' Write one more element
            textWriter.WriteStartElement(sPre & "Impuestos")
            textWriter.WriteAttributeString("TotalImpuestosTrasladados", QuitarCeros(TruncateToDecimal(oCFD.impuestos, 2), 2))
            textWriter.WriteStartElement(sPre & "Traslados")
            ...
            If foundRows.GetLength(0) > 0 Then
                ...
                For i = 0 To foundRows.GetUpperBound(0)
                    ...
                    textWriter.WriteAttributeString("Importe", QuitarCeros(TruncateToDecimal(foundRows(i)("Importe"), 2), 2))
                    textWriter.WriteEndElement()
                Next
    ...
    Public Function crearXMLPago(ByVal TipoAccion As Integer, ByVal dtPAC As DataTable, ByVal PathXML As String, ByVal sFolio As String, ByVal sDOCClave As String, ByVal iTipo As Integer, ByVal TipoComprobante As String, ByVal DOCClave As String, Optional ByVal oCFD As CFD = Nothing, Optional ByVal sInterfazSalida As String = "", Optional ByVal bShowMsg As Boolean = True) As Integer
        ...
        If TipoAccion = 1 OrElse TipoAccion = 3 OrElse TipoAccion = 4 Then 'Crea por primera vez el XML o regenerar xml
            ...
            If iTipo = 2 Then
                ...
                textWriter.WriteAttributeString("NoCertificado", oCFD.noCertificado)
                textWriter.WriteAttributeString("Certificado", oCFD.Certificado64)
                textWriter.WriteAttributeString("SubTotal", QuitarCeros(TruncateToDecimal(Base, 2), 2))
                textWriter.WriteAttributeString("Moneda", oCFD.Moneda)

                If oCFD.TipoCambio <> 1 Then
                    textWriter.WriteAttributeString("TipoCambio", QuitarCeros(TruncateToDecimal(oCFD.TipoCambio, 2), 2))
                End If
                textWriter.WriteAttributeString("Total", QuitarCeros(TruncateToDecimal(Base + IVA, 2), 2))
                ...
                textWriter.WriteAttributeString("ValorUnitario", QuitarCeros(TruncateToDecimal(Base, 2), 2))
                textWriter.WriteAttributeString("Importe", QuitarCeros(TruncateToDecimal(Base, 2), 2))

                textWriter.WriteStartElement(sPre & "Impuestos")

                textWriter.WriteStartElement(sPre & "Traslados")
                textWriter.WriteStartElement(sPre & "Traslado")
                textWriter.WriteAttributeString("Base", QuitarCeros(TruncateToDecimal(Base, 2), 2))
                ...
                textWriter.WriteAttributeString("Importe", QuitarCeros(TruncateToDecimal(IVA, 2), 2))
                textWriter.WriteEndElement()
                'cierre traslados
                textWriter.WriteEndElement()
                'cierre impuestos
                ...
                textWriter.WriteStartElement(sPre & "Impuestos")
                textWriter.WriteAttributeString("TotalImpuestosTrasladados", QuitarCeros(TruncateToDecimal(IVA, 2), 2))
                textWriter.WriteStartElement(sPre & "Traslados")
                textWriter.WriteStartElement(sPre & "Traslado")
                textWriter.WriteAttributeString("Impuesto", "002")
                textWriter.WriteAttributeString("TipoFactor", "Tasa")
            ...
            Else
                ...
                textWriter.WriteAttributeString("FechaPago", oCFD.FechaPago)
                textWriter.WriteAttributeString("FormaDePagoP", oCFD.metodoDePago)
                textWriter.WriteAttributeString("MonedaP", oCFD.Moneda)
                If oCFD.TipoCambio <> 1 Then
                    textWriter.WriteAttributeString("TipoCambioP", QuitarCeros(TruncateToDecimal(oCFD.TipoCambio, 2), 2))
                End If

                textWriter.WriteAttributeString("Monto", QuitarCeros(TruncateToDecimal(oCFD.total, 2), 2))
                ...
                For i = 0 To dt.Rows.Count - 1
                    ...
                    If dt.Rows(i)("TipoCambioDR") <> oCFD.TipoCambio Then
                        ...
                        Else
                            textWriter.WriteAttributeString("TipoCambioDR", QuitarCeros(TruncateToDecimal(dt.Rows(i)("TipoCambioDR"), 2), 6))
                        End If
                    End If
                    ...
                    If MetodoPagoDR = "PPD" Then
                        ...
                        textWriter.WriteAttributeString("ImpSaldoAnt", QuitarCeros(TruncateToDecimal(dt.Rows(i)("ImpSaldoAnt"), 2), 2))
                        textWriter.WriteAttributeString("ImpPagado", QuitarCeros(TruncateToDecimal(dt.Rows(i)("ImpPagado"), 2), 2))
                        textWriter.WriteAttributeString("ImpSaldoInsoluto", QuitarCeros(TruncateToDecimal(dt.Rows(i)("ImpSaldoInsoluto"), 2), 2))
                    Else
                        If dt.Rows.Count > 1 Then
                            textWriter.WriteAttributeString("ImpPagado", QuitarCeros(TruncateToDecimal(dt.Rows(i)("ImpPagado"), 2), 2))
                        End If
        ...
        If TipoAccion <> 3 Then
            If TipoAccion = 2 OrElse oCFD.TipoCF = 2 Then ' Inicia timbrado
                ...
                Else
                    ...
                    Dim childComplemento As XmlNode

                    If iTipo = 2 Then

                        newElem = oXml.CreateElement("cfdi", "Complemento", "http://www.sat.gob.mx/cfd/3")
                    Else

                        nsManager = New XmlNamespaceManager(oXml.NameTable)
                        nsManager.AddNamespace("cfdi", "http://www.sat.gob.mx/cfd/3")
                        childComplemento = oXml.SelectSingleNode("//cfdi:Complemento", nsManager)
                    ...
                    If iTipo = 2 Then
                        ...
                        oXml.DocumentElement.AppendChild(newElem)
                    Else
                        If childComplemento IsNot Nothing Then
                            childComplemento.AppendChild(newEle1)
                        End If
                    End If
                    oXml.Save(FileXML)
    ...
    Public Function crearXML(ByVal TipoAccion As Integer, ByVal dtPAC As DataTable, ByVal PathXML As String, ByVal sFolio As String, ByVal sDOCClave As String, ByVal sTipoComprobante As String, Optional ByVal oCFD As CFD = Nothing, Optional ByVal dtConcepto As DataTable = Nothing, Optional ByVal dtImpuesto As DataTable = Nothing, Optional ByVal iTipoComprobante As Integer = 0, Optional ByVal sInterfazSalida As String = "", Optional ByVal dtImpuestoDet As DataTable = Nothing, Optional ByVal dtRetencionDet As DataTable = Nothing, Optional ByVal dtRetencion As DataTable = Nothing, Optional ByVal bShowError As Boolean = True) As Integer
        ...
        If TipoAccion = 1 OrElse TipoAccion = 3 OrElse TipoAccion = 4 Then 'Crea por primera vez el XML o regenerar xml
            ...
            If oCFD.total = 0 Then
                ...
                oCFD.total = Math.Round(oCFD.subtotal - oCFD.descuento + Math.Round(oCFD.impuestos, 2) - Math.Round(oCFD.Retenciones, 2), 2)
            End If
            ...
            If oCFD.VersionCF <> "3.3" Then
                ...
                textWriter.WriteAttributeString("subTotal", QuitarCeros(oCFD.subtotal))
                textWriter.WriteAttributeString("descuento", QuitarCeros(oCFD.descuento))
                ...
                textWriter.WriteAttributeString("total", QuitarCeros(oCFD.total))
            ...
            Else 'VersionCF 3.3
                ...
                textWriter.WriteAttributeString("NoCertificado", oCFD.noCertificado)
                textWriter.WriteAttributeString("Certificado", oCFD.Certificado64)
                If oCFD.CondicionesDePago <> "" AndAlso oCFD.tipoDeComprobante <> "E" Then
                    'Contado, 3 meses etc.
            ...
            If foundRows.GetLength(0) > 0 Then
                For i = 0 To foundRows.GetUpperBound(0)
                    If oCFD.VersionCF = "3.3" Then
                        ...
                        If oCFD.tieneAddenda = True AndAlso iTipoComprobante = 1 AndAlso (oCFD.Tipo = 2 OrElse oCFD.Tipo = 5) Then
                            If oCFD.Tipo = 2 Then
                                descripcion = spaceFormat(foundDetCliente(0)("Clave")) & " " & spaceFormat(CStr(foundRows(i)("Descripción")))
                            ElseIf oCFD.Tipo = 5 Then
                                descripcion = "(" & spaceFormat(foundRows(i)("Clave")) & ") " & spaceFormat(foundDetCliente(0)("Clave")) & " " & spaceFormat(CStr(foundRows(i)("Descripción")))
                            End If
                        Else
                            descripcion = spaceFormat(CStr(foundRows(i)("Descripción")))
                        End If


                        textWriter.WriteAttributeString("Descripcion", descripcion.Trim)


                        textWriter.WriteAttributeString("ValorUnitario", QuitarCeros(TruncateToDecimal(foundRows(i)("P.U."), 2), 2))
                        textWriter.WriteAttributeString("Importe", QuitarCeros(TruncateToDecimal((foundRows(i)("SubTotalPartida")), 2), 2))
                        ...
                        For z = 0 To foundDet.GetUpperBound(0)
                            ...
                            textWriter.WriteAttributeString("TipoFactor", foundDet(z)("TipoFactor"))
                            textWriter.WriteAttributeString("TasaOCuota", QuitarCeros(foundDet(z)("Tasa"), 6))
                            textWriter.WriteAttributeString("Importe", QuitarCeros(Math.Round(foundDet(z)("Importe"), 2), 2))
                            textWriter.WriteEndElement()
                        Next
                        'cierre traslados
                        textWriter.WriteEndElement()
                        ...
                        If Not dtRetencionDet Is Nothing Then
                            If foundRet.Length > 0 Then
                                ...
                                For z = 0 To foundRet.GetUpperBound(0)
                                    textWriter.WriteStartElement(sPre & "Retencion")
                                    textWriter.WriteAttributeString("Base", QuitarCeros(TruncateToDecimal(foundRet(z)("Base"), 2), 2))
                                    ...
                                    textWriter.WriteAttributeString("Importe", QuitarCeros(Math.Round(foundRet(z)("Importe"), 2), 2))
                                    textWriter.WriteEndElement()
                                Next
                    ...
                    Else
                        ...
                        textWriter.WriteAttributeString("descripcion", spaceFormat(CStr(foundRows(i)("Descripción")).Trim))
                        textWriter.WriteAttributeString("valorUnitario", QuitarCeros(foundRows(i)("P.U.")))
                        textWriter.WriteAttributeString("importe", QuitarCeros((foundRows(i)("SubTotalPartida"))))
                        textWriter.WriteEndElement()
                    End If
            ...
            If oCFD.VersionCF = "3.3" Then
                If oCFD.Retenciones > 0 Then
                    textWriter.WriteAttributeString("TotalImpuestosRetenidos", QuitarCeros(Math.Round(oCFD.Retenciones, 2), 2))
                End If
                textWriter.WriteAttributeString("TotalImpuestosTrasladados", QuitarCeros(Math.Round(oCFD.impuestos, 2), 2))
            Else
                ...
                If foundRet.GetLength(0) > 0 Then
                    For i = 0 To foundRet.GetUpperBound(0)
                        If oCFD.VersionCF = "3.3" Then
                            ...
                            textWriter.WriteAttributeString("Importe", QuitarCeros(Math.Round(foundRet(i)("Importe"), 2), 2))
                            textWriter.WriteEndElement()
                        End If
                    Next
                End If
            ...
            If foundRows.GetLength(0) > 0 Then
                ...
                For i = 0 To foundRows.GetUpperBound(0)
                    If oCFD.VersionCF = "3.3" Then
                        ...
                        textWriter.WriteAttributeString("Importe", QuitarCeros(Math.Round(foundRows(i)("Importe"), 2), 2))
                        textWriter.WriteEndElement()
                    Else
                        textWriter.WriteStartElement(sPre & "Traslado")
                        textWriter.WriteAttributeString("impuesto", foundRows(i)("Impuesto"))
                    ...
                    If oCFD.tieneAddenda = True Then
                        If foundRows(i)("Impuesto") = "IVA" Then
                            dIVA = +foundRows(i)("Importe")
                        ElseIf foundRows(i)("Impuesto") = "IEPS" Then
                            dIEPS = +foundRows(i)("Importe")
                        Else
                            dOtros = +foundRows(i)("Importe")
                        End If
                    End If
    ...
    Public Function generarCadenaOriginal(ByVal oCFD As CFD, ByVal dtConcepto As DataTable, ByVal dtImpuesto As DataTable) As String
        ...
        If foundRows.GetLength(0) > 0 Then
            ...
            For i = 0 To foundRows.GetUpperBound(0)
                sNodoConcepto = sNodoConcepto & QuitarCeros(foundRows(i)("Cantidad")) & "|" & spaceFormat(foundRows(i)("Unidad")) & "|" & spaceFormat(foundRows(i)("Clave")) & "|" & spaceFormat(CStr(foundRows(i)("Descripción")).Trim) & "|" & QuitarCeros(foundRows(i)("P.U.")) & "|" & QuitarCeros((foundRows(i)("SubTotalPartida"))) & "|"
                dSubtotal += (foundRows(i)("SubTotalPartida"))
        ...
        If foundRows.GetLength(0) > 0 Then
            ...
            For i = 0 To foundRows.GetUpperBound(0)
                ...
                sNodoImpuestosTrasladado = sNodoImpuestosTrasladado & "|" & QuitarCeros(foundRows(i)("Importe")) & "|"
    ...
    Public Function generarCadenaOriginalGlobal(ByVal oCFD As CFD, ByVal dtConcepto As DataTable, ByVal dtImpuesto As DataTable, ByVal dtImpuestoDet As DataTable) As String
        ...
        If foundRows.GetLength(0) > 0 Then
            ...
            For i = 0 To foundRows.GetUpperBound(0)
                ...
                sNodoConcepto &= "01010101|" & spaceFormat(foundRows(i)("Folio")) & "|1|ACT|Venta|" & QuitarCeros(TruncateToDecimal(foundRows(i)("Subtotal"), 2), 2) & "|" & QuitarCeros(TruncateToDecimal((foundRows(i)("Subtotal")), 2), 2) & "|" & IIf(foundRows(i)("Descuento") > 0, QuitarCeros(TruncateToDecimal(foundRows(i)("Descuento"), 2), 2) & "|", "")
                sNodoConceptoImpuestos = ""
                For z = 0 To foundDet.GetUpperBound(0)
                    sNodoConceptoImpuestos &= QuitarCeros(TruncateToDecimal(foundDet(z)("Base"), 2), 2) & "|"
                    ...
                    sNodoConceptoImpuestos &= QuitarCeros(TruncateToDecimal(foundDet(z)("Importe"), 2), 2) & "|"
                Next
        ...
        If foundRows.GetLength(0) > 0 Then
            ...
            For i = 0 To foundRows.GetUpperBound(0)
                ...
                sNodoImpuestosTrasladado &= "|" & QuitarCeros(TruncateToDecimal(foundRows(i)("Importe"), 2), 2) & "|"
            Next
        End If

        sNodoImpuestosTrasladado &= QuitarCeros(TruncateToDecimal(oCFD.impuestos, 2), 2) & "||"
        sNodoEncabezado = "||" & oCFD.VersionCF & IIf(oCFD.Serie <> "", "|" & spaceFormat(oCFD.Serie), "") & "|" & oCFD.Folio & "|" & oCFD.Fecha & "|" & oCFD.metodoDePago & "|" & oCFD.noCertificado & "|" & QuitarCeros(TruncateToDecimal(oCFD.subtotal, 2), 2) & "|" & IIf(oCFD.descuento > 0, QuitarCeros(TruncateToDecimal(oCFD.descuento, 2), 2) & "|", "") & oCFD.Moneda & "|" & IIf(oCFD.TipoCambio <> 1, QuitarCeros(TruncateToDecimal(oCFD.TipoCambio, 2), 2) & "|", "") & QuitarCeros(TruncateToDecimal(oCFD.total, 2), 2) & "|I|PUE|" & spaceFormat(oCFD.sCodigoPostal)
        sNodoEncabezado &= "|"
        sNodoEmisor = spaceFormat(oCFD.eRFC) & "|" & spaceFormat(oCFD.eRazonSocial) & "|" & spaceFormat(oCFD.regimenFiscal) & "|"
    ...
    Public Function generarCadenaOriginalPago(ByVal oCFD As CFD, ByVal iTipo As Integer, ByVal TipoComprobante As String) As String
        ...
        If iTipo = 2 Then
            ...
            sNodoEncabezado = "||" & oCFD.VersionCF & "|" & oCFD.Folio & "|" & oCFD.Fecha & "|" & IIf(TipoComprobante = "I", spaceFormat(oCFD.metodoDePago), "30") & "|" & oCFD.noCertificado & "|" & QuitarCeros(TruncateToDecimal(Base, 2), 2) & "|" & oCFD.Moneda & IIf(oCFD.TipoCambio <> 1, "|" & QuitarCeros(TruncateToDecimal(oCFD.TipoCambio, 2), 2), "") & "|" & QuitarCeros(TruncateToDecimal((Base + IVA), 2), 2) & "|" & TipoComprobante & "|PUE|" & spaceFormat(oCFD.sCodigoPostal)
            ...
            sNodoConcepto = "84111506|1|ACT|" & IIf(TipoComprobante = "I", "Anticipo del bien o servicio", "Aplicación de anticipo") & "|" & QuitarCeros(TruncateToDecimal(Base, 2), 2) & "|" & QuitarCeros(TruncateToDecimal(Base, 2), 2) & "|"
            sNodoConceptoImpuestos &= QuitarCeros(TruncateToDecimal(Base, 2), 2) & "|"
            sNodoConceptoImpuestos &= "002|"
            sNodoConceptoImpuestos &= "Tasa|"
            sNodoConceptoImpuestos &= "0.160000|"
            sNodoConceptoImpuestos &= QuitarCeros(TruncateToDecimal(IVA, 2), 2) & "|"
        ...
        Else
            ...
            sNodoPago = "1.0|" & oCFD.FechaPago & "|" & oCFD.metodoDePago & "|" & oCFD.Moneda & "|" & IIf(oCFD.TipoCambio <> 1, QuitarCeros(TruncateToDecimal(oCFD.TipoCambio, 2), 2) & "|", "") & QuitarCeros(TruncateToDecimal(oCFD.total, 2), 2) & "|"
            ...
            For i = 0 To dt.Rows.Count - 1
                ...
                If dt.Rows(i)("TipoCambioDR") <> oCFD.TipoCambio Then
                    If dt.Rows(i)("MonedaDR") = "MXN" Then
                        sCFDI &= "1|"
                    Else
                        sCFDI &= QuitarCeros(TruncateToDecimal(dt.Rows(i)("TipoCambioDR"), 2), 6) & "|"
                    End If
                End If
                ...
                sCFDI &= MetodoPagoDR & "|"
                If MetodoPagoDR = "PPD" Then
                    sCFDI &= dt.Rows(i)("NumParcialidad") & "|" & QuitarCeros(TruncateToDecimal(dt.Rows(i)("ImpSaldoAnt"), 2), 2) & "|" & QuitarCeros(TruncateToDecimal(dt.Rows(i)("ImpPagado"), 2), 2) & "|" & QuitarCeros(TruncateToDecimal(dt.Rows(i)("ImpSaldoInsoluto"), 2), 2) & "|"
                Else
                    If dt.Rows.Count > 1 Then
                        sCFDI &= QuitarCeros(TruncateToDecimal(dt.Rows(i)("ImpPagado"), 2), 2) & "|"
                    End If
                End If
            Next
    ...
    Public Function generarCadenaOriginalCFDI(ByVal oCFD As CFD, ByVal dtConcepto As DataTable, ByVal dtImpuesto As DataTable, ByVal TipoComprobante As Integer, ByVal dtImpuestoDet As DataTable, Optional ByVal dtRetencionDet As DataTable = Nothing, Optional ByVal dtRetencion As DataTable = Nothing) As String
        ...
        If foundRows.GetLength(0) > 0 Then
            ...
            For i = 0 To foundRows.GetUpperBound(0)
                If oCFD.VersionCF = "3.3" Then
                    ...
                    sNodoConcepto &= ClaveProdServ & "|" & noIdentificacion & "|" & QuitarCeros(foundRows(i)("Cantidad")) & "|" & ClaveUnidad & "|" & spaceFormat(foundRows(i)("Unidad")) & "|" & Descripcion & "|" & QuitarCeros(TruncateToDecimal(foundRows(i)("P.U."), 2), 2) & "|" & QuitarCeros(TruncateToDecimal((foundRows(i)("SubTotalPartida")), 2), 2) & "|" & IIf(foundRows(i)("Descuento") > 0, QuitarCeros(TruncateToDecimal(foundRows(i)("Descuento"), 2), 2) & "|", "")
                    sNodoConceptoImpuestos = ""
                    For z = 0 To foundDet.GetUpperBound(0)
                        sNodoConceptoImpuestos &= QuitarCeros(TruncateToDecimal(foundDet(z)("Base"), 2), 2) & "|"
                        sNodoConceptoImpuestos &= spaceFormat(foundDet(z)("ClaveSAT")) & "|"
                        sNodoConceptoImpuestos &= foundDet(z)("TipoFactor") & "|"
                        sNodoConceptoImpuestos &= QuitarCeros(foundDet(z)("Tasa"), 6) & "|"
                        sNodoConceptoImpuestos &= QuitarCeros(Math.Round(foundDet(z)("Importe"), 2), 2) & "|"
                    Next

                    If Not dtRetencionDet Is Nothing Then
                        If foundRet.Length > 0 Then
                            For z = 0 To foundRet.GetUpperBound(0)
                                sNodoConceptoImpuestos &= QuitarCeros(TruncateToDecimal(foundRet(z)("Base"), 2), 2) & "|"
                                ...
                                sNodoConceptoImpuestos &= QuitarCeros(Math.Round(foundRet(z)("Importe"), 2), 2) & "|"
                            Next
                        End If
                    End If
                ...
                Else
                    If foundRows(i)("Clave") = "NotaCargo" Then
                        sNodoConcepto &= QuitarCeros(foundRows(i)("Cantidad")) & "|" & spaceFormat(foundRows(i)("Unidad")) & "|" & spaceFormat(CStr(foundRows(i)("Descripción")).Trim) & "|" & QuitarCeros(foundRows(i)("P.U.")) & "|" & QuitarCeros((foundRows(i)("SubTotalPartida"))) & "|"
                    Else
                        sNodoConcepto &= QuitarCeros(foundRows(i)("Cantidad")) & "|" & spaceFormat(foundRows(i)("Unidad")) & "|" & spaceFormat(foundRows(i)("Clave")) & "|" & spaceFormat(CStr(foundRows(i)("Descripción")).Trim) & "|" & QuitarCeros(foundRows(i)("P.U.")) & "|" & QuitarCeros((foundRows(i)("SubTotalPartida"))) & "|"
                    End If
                End If
                dSubtotal += (foundRows(i)("SubTotalPartida"))
        ...
        If oCFD.Retenciones > 0 Then
            For i = 0 To foundRet.GetUpperBound(0)
                If oCFD.VersionCF = "3.3" Then
                    ...
                    sNodoImpuestosRetenidos &= "|" & QuitarCeros(Math.Round(foundRet(i)("Importe"), 2), 2) & "|"
                End If
            Next
            sNodoImpuestosRetenidos &= QuitarCeros(Math.Round(oCFD.Retenciones, 2), 2) & "|"
        End If
        ...
        If foundRows.GetLength(0) > 0 Then
            ...
            For i = 0 To foundRows.GetUpperBound(0)
                If oCFD.VersionCF = "3.3" Then
                    ...
                    sNodoImpuestosTrasladado &= "|" & QuitarCeros(Math.Round(foundRows(i)("Importe"), 2), 2) & "|"
                Else
                    sNodoImpuestosTrasladado &= foundRows(i)("Impuesto")
                    sNodoImpuestosTrasladado &= "|" & CStr(QuitarCeros(foundRows(i)("Tasa")))
                    sNodoImpuestosTrasladado &= "|" & QuitarCeros(foundRows(i)("Importe")) & "|"
        ...
        If oCFD.total = 0 Then
            oCFD.total = (oCFD.subtotal - oCFD.descuento + Math.Round(oCFD.impuestos, 2) - Math.Round(oCFD.Retenciones))
        End If

        If oCFD.VersionCF = "3.3" Then
            sNodoImpuestosTrasladado &= QuitarCeros(Math.Round(oCFD.impuestos, 2), 2) & "||"
            sNodoEncabezado = "||" & oCFD.VersionCF & IIf(oCFD.Serie <> "", "|" & spaceFormat(oCFD.Serie), "") & "|" & oCFD.Folio & "|" & oCFD.Fecha & "|" & oCFD.metodoDePago & "|" & oCFD.noCertificado & "|" & IIf(oCFD.CondicionesDePago <> "" AndAlso oCFD.tipoDeComprobante <> "E", oCFD.CondicionesDePago & "|", "") & QuitarCeros(TruncateToDecimal(oCFD.subtotal, 2), 2) & "|" & IIf(oCFD.descuento > 0, CStr(QuitarCeros(TruncateToDecimal(oCFD.descuento, 2), 2)) & "|", "") & oCFD.Moneda & "|" & IIf(oCFD.TipoCambio <> 1, QuitarCeros(TruncateToDecimal(oCFD.TipoCambio, 2), 2) & "|", "") & QuitarCeros(TruncateToDecimal(oCFD.total, 2), 2) & "|" & oCFD.tipoDeComprobante & "|" & spaceFormat(oCFD.formaDePago) & "|" & spaceFormat(oCFD.sCodigoPostal)
        ...
        Else
            ...
            sNodoEncabezado = "||" & oCFD.VersionCF & "|" & oCFD.Fecha & "|" & oCFD.tipoDeComprobante & "|" & oCFD.formaDePago & "|" & QuitarCeros(oCFD.subtotal) & "|" & CStr(QuitarCeros(oCFD.descuento)) & "|" & IIf(oCFD.TipoCF = 2, QuitarCeros(oCFD.TipoCambio) & "|" & oCFD.Moneda & "|", "") & QuitarCeros(oCFD.total) & "|"
    ...
    Public Function generaCadenaOriginalComplemento(ByVal oCFD As eCFD, ByVal dtConcepto As DataTable, ByVal dtImpuesto As DataTable) As String
        ...
        If foundRows.GetLength(0) > 0 Then
            ...
            For i = 0 To foundRows.GetUpperBound(0)
                ...
                sCadenaOriginal &= QuitarCeros(foundRows(i)("ImporteGravado")) & "|"
                sCadenaOriginal &= QuitarCeros(foundRows(i)("ImporteExento")) & "|"
    ...
    Public Function generarCadenaOriginalNomina(ByVal oCFD As eCFD, ByVal dtConcepto As DataTable, ByVal dtImpuesto As DataTable, ByVal VersionNomina As Integer) As String
        ...
        If foundRows.GetLength(0) > 0 Then
            If VersionNomina = 1 Then
                Dim dSubtotal As Double = 0
                For i = 0 To foundRows.GetUpperBound(0)
                    sNodoConcepto = sNodoConcepto & QuitarCeros(foundRows(i)("Cantidad"), numDec) & "|" & spaceFormat(foundRows(i)("Unidad")) & "|" & spaceFormat(foundRows(i)("Clave")) & "|" & spaceFormat(CStr(foundRows(i)("Descripción")).Trim) & "|" & QuitarCeros(foundRows(i)("P.U."), numDec) & "|" & QuitarCeros(foundRows(i)("Cantidad") * (foundRows(i)("P.U.")), numDec) & "|"
                    dSubtotal += foundRows(i)("Cantidad") * (foundRows(i)("P.U."))
                    dTotal += foundRows(i)("Cantidad") * (foundRows(i)("SubTotalPartida"))
                Next
        ...
        If foundRows.GetLength(0) > 0 Then
            ...
            For i = 0 To foundRows.GetUpperBound(0)
                ...
                sNodoImpuestosRetenidos = sNodoImpuestosRetenidos & "|" & QuitarCeros(foundRows(i)("Importe"), numDec) & "|"
                oCFD.impuestos += foundRows(i)("Importe")
            Next
        Else
        ...
        If VersionNomina = 1 Then
            sNodoEncabezado = "||" & oCFD.VersionCF & "|" & String.Format("{0:yyyy-MM-ddTHH:mm:ss}", oCFD.Fecha) & "|" & "egreso" & "|" & oCFD.formaDePago & "|" & oCFD.subtotal & "|" & CStr(QuitarCeros(oCFD.descuento)) & "|" & IIf(oCFD.TipoCF = 2, QuitarCeros(TruncateToDecimal(oCFD.TipoCambio, 2), 2) & "|" & oCFD.Moneda & "|", "") & QuitarCeros(oCFD.total, numDec) & "|"
        ElseIf VersionNomina = 2 Then
            If oCFD.VersionCF = "3.3" Then
    ...
    Public Sub InsertaImpuesto(ByVal PartidaId As String, ByVal sPROClave As String, ByVal dPrecio As Double, ByVal iTImpuesto As Integer, ByVal sSUCClave As String, Optional ByVal iCerrado As Integer = 0)
        Dim PrecioImp As Double = dPrecio
        Dim ImpImporte As Double = 0
        Dim dtImpuesto As DataTable
        Dim Base As Double
        ...
        If Not dtImpuesto Is Nothing AndAlso Not dtImpuesto.Rows(0)("Valor") Is DBNull.Value Then
            For i = 0 To dtImpuesto.Rows.Count() - 1
                ...
                Else
                    ...
                    Base = dPrecio
                End If
                ModPOS.Ejecuta("sp_inserta_detalle_impuesto", "@DVEClave", PartidaId, "@IMPClave", dtImpuesto.Rows(i)("IMPClave"), "@Base", Base, "@PorcImp", dtImpuesto.Rows(i)("Valor"), "@Importe", Math.Round(ImpImporte, 2), "@Usuario", ModPOS.UsuarioActual, "@Cerrado", iCerrado)
    ...
    Public Sub RecalculaImpuesto(ByVal dtDetalle As DataTable, ByVal iTImpuesto As Integer, ByVal sSUCClave As String, ByVal iCerrado As Integer)
        Dim x As Integer
        For x = 0 To dtDetalle.Rows.Count() - 1
            ...
            If Not dtImpuesto Is Nothing AndAlso Not dtImpuesto.Rows(0)("Valor") Is DBNull.Value Then
                For i = 0 To dtImpuesto.Rows.Count() - 1
                    ...
                    End If
                    ModPOS.Ejecuta("sp_actualiza_detalle_impuesto", "@DVEClave", dtDetalle.Rows(x)("DVEClave"), "@IMPClave", dtImpuesto.Rows(i)("IMPClave"), "@Importe", Math.Round(ImpImporte, 2), "@Base", Base, "@Cerrado", iCerrado)
                    PrecioImp += Math.Round(ImpImporte, 2)
                Next
                dtImpuesto.Dispose()
            End If
...
#Region "Procedimientos y Funciones Generales"
    ...
    Public Sub previewCfdiPago(ByVal ABNClave As String, ByVal sTipo As String)
        ...
        If sTipo = "Anticipo" OrElse sTipo = "2" Then
            ...
            OpenReport.PrintPreview("Anticipo", "CRAnticipoCFDI.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal((Base + IVA), 2), MonDesc, MonRef).ToUpper)
        ...
        ElseIf sTipo = "Pago" OrElse sTipo = "1" Then
            ...
            OpenReport.PrintPreview("Pago", "CRPagoCFDI.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonDesc, MonRef).ToUpper)
        Else
            ...
            Dim Base As Decimal = Math.Round(Total / 1.16, 2)
            Dim IVA As Decimal = Math.Round(Base * 0.16, 2)
            OpenReport.PrintPreview("Egreso", "CRAplicacionCFDI.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal((Base + IVA), 2), MonDesc, MonRef).ToUpper)
    ...
    Public Sub imprimirCfdiPago(ByVal ABNClave As String, ByVal sTipo As String, ByVal iCopias As Integer, ByVal sPrinter As String)
        ...
        If sTipo = "Anticipo" OrElse sTipo = "2" Then
            ...
            OpenReport.Print(iCopias, "CRAnticipoCFDI.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal((Base + IVA), 2), MonDesc, MonRef).ToUpper, sPrinter)

        ElseIf sTipo = "Pago" OrElse sTipo = "1" Then
            'Pago
            pvtaDataSet.Tables.Add(ModPOS.Recupera_Tabla("st_recupera_relacionado", "@DOCClave", ABNClave, "@Tipo", "P"))
            OpenReport.Print(iCopias, "CRPagoCFDI.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal(Total, 2), MonDesc, MonRef).ToUpper, sPrinter)
        Else
            ...
            Dim Base As Decimal = Math.Round(Total / 1.16, 2)
            Dim IVA As Decimal = Math.Round(Base * 0.16, 2)
            OpenReport.Print(iCopias, "CRAplicacionCFDI.rpt", pvtaDataSet, ModPOS.LetrasM(ModPOS.TruncateToDecimal((Base + IVA), 2), MonDesc, MonRef).ToUpper, sPrinter)
    ...
    Public Sub calculaRecoleccion(ByVal TipoDocumento As Integer, ByVal DOCClave As String, ByVal ALMClave As String, ByVal Stage As String, ByVal RF As Integer)
        If TipoDocumento = 1 Then
            If Stage = "" Then
                Dim dt As DataTable = ModPOS.Recupera_Tabla("st_recupera_envio", "@VENClave", DOCClave)
                Stage = dt.Rows(0)("UBCClave")
                dt.Dispose()
            End If
        End If

        ModPOS.Ejecuta("st_calcula_recoleccion", "@ALMClave", ALMClave, "@TipoDoc", TipoDocumento, "@DOCClave", DOCClave, "@Stage", Stage, "@Usuario", ModPOS.UsuarioActual)
    ...
    '                If TipoDoc = 7 OrElse TipoDoc = 9 Then
    ...
    '                    ModPOS.Ejecuta("sp_actualiza_existuba", "Tipo", TipoMov, "@ALMClave", Almacen, "@PROClave", sProducto, "@Ubicacion", Ubicacion, "@Cantidad", dCantidad)
    ...
    Public Sub GeneraMovInv(ByVal TipoMov As Integer, ByVal Motivo As Integer, ByVal TipoDoc As Integer, ByVal Documento As String, ByVal Almacen As String, ByVal Referencia As String, ByVal Autorizo As String, Optional ByVal AfectaInv As Integer = 1, Optional ByVal Ubicacion As String = Nothing)

        If Ubicacion Is Nothing Then
            Dim foundRows() As DataRow
            Dim dt As DataTable = ModPOS.Recupera_Tabla("st_recupera_ubicaciones", "@ALMClave", Almacen)

            foundRows = dt.Select("TESTClave = 2 and Estado = 1")
            If foundRows.GetLength(0) > 0 Then
                Ubicacion = foundRows(0)("UBCClave")
            Else
                foundRows = dt.Select("TESTClave = 1 and Estado= 1")
                If foundRows.GetLength(0) > 0 Then
                    Ubicacion = foundRows(0)("UBCClave")
                End If
            End If
        ...
        ModPOS.Ejecuta("st_genera_movimiento", "@TipoMov", TipoMov, "@Motivo", Motivo, "@ALMClave", Almacen, "@TipoDoc", TipoDoc, "@Documento", Documento, "@Referencia", Referencia, "@Autorizo", Autorizo, "@Usuario", ModPOS.UsuarioActual, "@AfectaInv", AfectaInv, "@Ubicacion", Ubicacion)
    End Sub
    ...
    Public Function ValidaIP(ByVal sIP As String) As Boolean
        Try
                    ...
                    For i = 0 To Parametros.Length - 1 Step 2
                        If Not Parametros(i + 1) Is Nothing Then
                            Select Case Parametros(i + 1).GetType.Name
                                ...
                                Case "Xml"
                                    MyComand.Parameters.Add(Parametros(i), SqlDbType.Xml).Value = Parametros(i + 1)
                            End Select
                        Else
