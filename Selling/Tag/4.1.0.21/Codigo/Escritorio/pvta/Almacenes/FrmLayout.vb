...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents Volumen1 As Janus.Windows.UI.CommandBars.UICommand
    Friend WithEvents Volumen As Janus.Windows.UI.CommandBars.UICommand
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Volumen1 = New Janus.Windows.UI.CommandBars.UICommand("Volumen")
        ...
        Me.Volumen = New Janus.Windows.UI.CommandBars.UICommand("Volumen")
        ...
        'StatusBar1
        '
        Me.StatusBar1.Location = New System.Drawing.Point(0, 680)
        ...
        Me.StatusBar1.Size = New System.Drawing.Size(1012, 22)
        ...
        Me.UiCommandManager1.Commands.AddRange(New Janus.Windows.UI.CommandBars.UICommand() {Me.Archivo, Me.Zoom, Me.Edicion, Me.Estructura, Me.Abrir, Me.Cerrar, Me.Salir, Me.Almacen, Me.Area, Me.EstructuraOpen, Me.Pasillo, Me.Copiar, Me.CopiarN, Me.Pegar, Me.Rotar, Me.Eliminar, Me.Nuevo, Me.Insertar, Me.EliminarEst, Me.Fila, Me.Columna, Me.EliminarFila, Me.EliminarColumna, Me.Largo, Me.Buscar, Me.Volumen})
        ...
        Me.UiCommandManager1.VisualStyle = Janus.Windows.UI.VisualStyle.Office2007
        '
        'BottomRebar1
        '
        ...
        Me.jcbMenu.Size = New System.Drawing.Size(1012, 26)
        ...
        'Estructura
        '
        Me.Estructura.Commands.AddRange(New Janus.Windows.UI.CommandBars.UICommand() {Me.Nuevo1, Me.Separator4, Me.Insertar1, Me.EliminarEst1, Me.Command1, Me.Volumen1})
        ...
        'Volumen1
        '
        Me.Volumen1.Key = "Volumen"
        Me.Volumen1.Name = "Volumen1"
        '
        'Abrir
        '
        ...
        'Volumen
        '
        Me.Volumen.Key = "Volumen"
        Me.Volumen.Name = "Volumen"
        Me.Volumen.Text = "Volumen"
        '
        'LeftRebar1
        '
        ...
        Me.TopRebar1.Size = New System.Drawing.Size(1012, 26)
        '
        'FrmLayout
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.BackColor = System.Drawing.Color.LightSteelBlue
        Me.ClientSize = New System.Drawing.Size(1012, 702)
    ...
    Private Sub UiCommandManager1_CommandClick(ByVal sender As System.Object, ByVal e As Janus.Windows.UI.CommandBars.CommandEventArgs) Handles UiCommandManager1.CommandClick
        Select Case e.Command.Key
                ...
                Try
                    ...
                    If (openDlg.ShowDialog() = DialogResult.OK) Then
                        ...
                        If dtTemporal.Rows.Count > 0 Then
                            ...
                            Dim i As Integer
                            Dim UBCClave, Ubicacion As String
                            ...
                            For i = 0 To dtTemporal.Rows.Count - 1
                                ...
                                If dtTemporal.Rows(i)("GTIN").GetType.FullName <> "System.DBNull" Then
                                    dt = Recupera_Tabla("sp_recupera_ubicaciones", "@ALMClave", Almacen_Activo, "@Ubicacion", dtTemporal.Rows(i)("GTIN").ToString.Trim)
                                    If dt.Rows.Count > 0 Then
                                        ...
                                        If dtTemporal.Rows(i)("Cantidad").GetType.FullName <> "System.DBNull" Then
                                            If IsNumeric(dtTemporal.Rows(i)("Cantidad")) AndAlso CDbl(dtTemporal.Rows(i)("Cantidad")) > 0 Then
                                                ...
                                                ModPOS.Ejecuta("sp_act_ubicacion", "@UBCClave", UBCClave, "@Ubicacion", Ubicacion, "@Volumen", Cantidad, "@Usuario", ModPOS.UsuarioActual)
                                            Else
                                                If MessageBox.Show("La fila " & CStr(i + 1) & " no cuenta con un Volumen valido" & dtTemporal.Rows(i)("Cantidad").ToString & ". ¿Desea continuar procesando el resto del archivo?", "Error", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.No Then
                                                    Exit For
                                                End If
                                            End If
                                        Else
                                            If MessageBox.Show("El Volumen de fila " & CStr(i + 1) & " se encuentra vacio. ¿Desea continuar procesando el resto del archivo?", "Error", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.No Then
                                                Exit For
                                            End If
                                        End If
                                    Else
                                        dt.Dispose()
                                        If MessageBox.Show("La fila " & CStr(i + 1) & " tiene una ubicación que no existe o no pertenece al almacén actual" & dtTemporal.Rows(i)("GTIN").ToString & ". ¿Desea continuar procesando el resto del archivo?", "Error", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.No Then
                                            Exit For
                                        End If
                                    End If
                                Else
                                    If MessageBox.Show("La Ubicación de la fila " & CStr(i + 1) & " se encuentra vacia. ¿Desea continuar procesando el resto del archivo?", "Error", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.No Then
                                        Exit For
                                    End If
                                End If
                            Next
                        ...
                        Else
                            MessageBox.Show("El archivo no cuenta con el formato: Ubicación,Volumen o se encuentra vacio", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                        End If
                    End If
            ...
            Case "Cerrar"
                ...
                Me.Volumen.Enabled = Janus.Windows.UI.InheritableBoolean.False
