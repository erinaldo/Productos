...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.cmbMotivo.Location = New System.Drawing.Point(404, 35)
        ...
        Me.GridDoctos.Size = New System.Drawing.Size(170, 287)
        ...
        If bSurtido = False Then
            ...
            Else
                ...
                For i = 0 To dtDetalle.Rows.Count - 1
                    ...
                    If dtDetalle.Rows(i)("KgLt") = 1 Then
                        ...
                        For j = 0 To dtVentaDetalle.Rows.Count - 1
                            ...
                            If dtVentaDetalle.Rows(j)("Cantidad") > CantidadSurtida Then
                                ...
                                ModPOS.Ejecuta("st_act_detalle_doctos", _
                    ...
                    ModPOS.Ejecuta("st_act_surtido_detalle", _
                ...
                If dtDoctos.Rows.Count > 0 Then
                    ...
                    For i = 0 To dtDoctos.Rows.Count - 1
                        ...
                        If dtDoctos.Rows(i)("Tipo") = 1 Then 'Venta
                            ModPOS.Ejecuta("sp_actualiza_venta_cerrada", "@VENClave", dtDoctos.Rows(i)("DOCClave"), "@Estado", 2, "@ActSaldo", 1)

                            dtVenta = ModPOS.Recupera_Tabla("sp_recupera_venta_closed", "@VENClave", dtDoctos.Rows(i)("DOCClave"))
                            If dtVenta.Rows.Count > 0 Then
                                ModPOS.Ejecuta("sp_act_saldo_cte", "@Tipo", 1, "@Cliente", dtVenta.Rows(0)("Cliente"), "@Importe", dtVenta.Rows(0)("Total") * dtVenta.Rows(0)("TipoCambio"))
                            End If
                            dtVenta.Dispose()

                            ModPOS.GeneraMovInv(2, 1, iTipoDoc, dtDoctos.Rows(i)("DOCClave"), ALMClave, dtDoctos.Rows(i)("Folio"), ModPOS.UsuarioActual, 1, dtDoctos.Rows(i)("Stage"))

                        ElseIf dtDoctos.Rows(i)("Tipo") = 8 Then ' Traslado
                            ModPOS.GeneraMovInv(2, 8, iTipoDoc, dtDoctos.Rows(i)("DOCClave"), ALMClave, dtDoctos.Rows(i)("Folio"), ModPOS.UsuarioActual, 1, dtDoctos.Rows(i)("Stage"))
                        ...
                        ElseIf dtDoctos.Rows(i)("Tipo") = 10 Then 'Devolucion Compra
                            ModPOS.GeneraMovInv(2, 2, iTipoDoc, dtDoctos.Rows(i)("DOCClave"), ALMClave, dtDoctos.Rows(i)("Folio"), ModPOS.UsuarioActual, 1, dtDoctos.Rows(i)("Stage"))
            ...
            If dtDoctos.Rows.Count > 0 Then
                For i = 0 To dtDoctos.Rows.Count - 1
                    If dtDoctos.Rows(i)("Tipo") = 1 Then
                        ...
                        previewPedido(FormatoPedido, dtDoctos.Rows(i)("DOCClave"), dtDoctos.Rows(i)("Total"), SUCClave, sImpresora, True, iCopias)
    ...
    Private Sub GridDetalle_CellEdited(ByVal sender As Object, ByVal e As Janus.Windows.GridEX.ColumnActionEventArgs) Handles GridDetalle.CellEdited
        If GridDetalle.CurrentColumn.Caption = "Surtido" Then
            If IsNumeric(GridDetalle.GetValue("Surtido")) Then
                ...
                ElseIf CDbl(GridDetalle.GetValue("Surtido")) > CDbl(GridDetalle.GetValue("SurtidoStage")) Then
                    If CInt(GridDetalle.GetValue("RF")) = 1 Then
                        Beep()
