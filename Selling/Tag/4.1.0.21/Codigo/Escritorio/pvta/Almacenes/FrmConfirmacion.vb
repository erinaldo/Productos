        ...
        If Estado < 2 Then
            If validaForm() Then
                ...
                If dRecibido > 0 OrElse Movilidad = True Then
                    ...
                    For i = 0 To foundRows.GetUpperBound(0)
                        ModPOS.Ejecuta("sp_act_reciboAlmacenD", "@IdRecibo", IdRecibo, "@DOCClave", foundRows(i)("DOCClave"), "@Tipo", foundRows(i)("Tipo"), "@DETClave", foundRows(i)("DETClave"), "@Recibido", foundRows(i)("Recibido"), "@TipoRechazo", foundRows(i)("TipoRechazo"), "@Usuario", ModPOS.UsuarioActual, "@UBCClave", foundRows(i)("UBCClave"))
                    Next
        ...
        If Estado = 1 Then
            ...
            If au.DialogResult = DialogResult.OK Then
                If au.Autorizado Then
                    ...
                    Else
                        ModPOS.GeneraMovInv(1, 9, 9, IdRecibo, ALMClave, Folio, au.Autoriza, 0)
                    End If
