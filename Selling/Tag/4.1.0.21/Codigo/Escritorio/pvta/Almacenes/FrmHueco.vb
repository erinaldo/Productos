                ...
                If Not (dAlto = CDbl(TxtAlto.Text) AndAlso _
                    ...
                    If actEdo Then
                        ...
                        If InterfazSalida <> "" Then
                            ...
                            Dim dt As DataTable = Recupera_Tabla("st_recupera_ubc_hueco", "@HUEClave", sHueco, "@ESTClave", Me.sEstructura)
                            If dt.Rows.Count > 0 Then
                                ...
                                For i = 0 To dt.Rows.Count - 1
                                    ...
                                    ModPOS.Ejecuta("sp_bloqueo_ubc", "@ALMClave", sAlmacen, "@UBCClave", dt.Rows(i)("UBCClave"), "@PROClave", dt.Rows(i)("PROClave"), "@Estado", cmbTipoEstado.SelectedValue, "@Usuario", ModPOS.UsuarioActual)
