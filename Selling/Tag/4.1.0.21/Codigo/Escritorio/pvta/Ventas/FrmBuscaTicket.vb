    ...
    Private Sub ChkMarcaTodos_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ChkMarcaTodos.CheckedChanged
        If dt.Rows.Count > 0 Then
            ...
            If ChkMarcaTodos.Checked Then
                For i = 0 To GridTickets.GetDataRows.Length - 1
                    GridTickets.GetDataRows(i).DataRow("Marca") = True
                Next
            Else
                For i = 0 To GridTickets.GetDataRows.Length - 1
                    GridTickets.GetDataRows(i).DataRow("Marca") = False
                Next
            End If
            ...
            If foundRows.GetLength(0) > 0 Then
                ...
                If TipoBusqueda = "Factura" Then
                    For i = 0 To foundRows.GetUpperBound(0)
                        ModPOS.Factura.CargaDatosTicket(CmbFecha.Value.Year, CmbFecha.Value.Month, foundRows(i)(2), False)
                    Next
                    ModPOS.Factura.CargaTickets()
