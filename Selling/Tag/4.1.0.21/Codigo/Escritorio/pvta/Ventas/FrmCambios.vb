    ...
    Private Sub BtnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnOK.Click
        If validaForm() Then
            ...
            If PrecioCambio > PrecioRecibe Then
                ...
                Dim sFolio As String = "CM-" & Referencia & "-" & CStr(Periodo) & CStr(Mes) & "-" & CStr(Folio)
                ...
                Do
                    ...
                    If a.DialogResult = DialogResult.OK Then
                        ...
                        For i = 0 To a.detallePago.Rows.Count - 1
                            ModPOS.Aplica_Pagos(dtVenta, Cliente, a.detallePago.Rows(i)("ABNClave"), a.detallePago.Rows(i)("TipoPago"), a.detallePago.Rows(i)("SaldoBase"), CAJClave, 1)
                        Next
