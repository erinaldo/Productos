                        ...
                        If Not b.drAbonos Is Nothing AndAlso b.drAbonos.Length > 0 Then
                            For i = 0 To b.drAbonos.Length - 1
                                ...
                                If b.drAbonos(i)("Tipo") = 2 AndAlso DateDiff(DateInterval.Day, CDate(b.drAbonos(i)("Fecha")), CDate(dtCargos.Rows(0)("fecha"))) = 0 Then
                                    ...
                                    Else
                                        ModPOS.Aplica_Pagos(dtCargo, oCFD.CTEClave, b.drAbonos(i)("ID"), b.drAbonos(i)("TipoPago"), b.drAbonos(i)("SaldoBase"), CAJClave, b.drAbonos(i)("Tipo"))
                                    End If
                                Else
                                    ModPOS.Aplica_Pagos(dtCargo, oCFD.CTEClave, b.drAbonos(i)("ID"), b.drAbonos(i)("TipoPago"), b.drAbonos(i)("SaldoBase"), CAJClave, b.drAbonos(i)("Tipo"))
                                End If
                        ...
                        If a.DialogResult = DialogResult.OK Then
                            If a.detallePago.Rows.Count > 0 Then
                                ...
                                For i = 0 To a.detallePago.Rows.Count - 1
                                    ModPOS.Aplica_Pagos(dtCargo, oCFD.CTEClave, a.detallePago.Rows(i)("ABNClave"), a.detallePago.Rows(i)("TipoPago"), a.detallePago.Rows(i)("SaldoBase"), CAJClave, 1)
                                Next
