...
#End Region
    ...
    Private Sub BtnGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnGuardar.Click
        ...
        ElseIf bPedidoCredito = False Then
            ...
            iValidaCredito = ModPOS.ValidaCredido(oCFD.CTEClave, oCFD.LCredito, oCFD.DiasCredito, dTotal, TipoCambio)
                        ...
                        If Not b.drAbonos Is Nothing AndAlso b.drAbonos.Length > 0 Then
                            For i = 0 To b.drAbonos.Length - 1
                                ...
                                If b.drAbonos(i)("Tipo") = 2 AndAlso DateDiff(DateInterval.Day, CDate(b.drAbonos(i)("Fecha")), CDate(dtFacturas.Rows(0)("fechaFactura"))) = 0 Then
                                    ...
                                    Else
                                        ModPOS.Aplica_Pagos(dtFacturas, oCFD.CTEClave, b.drAbonos(i)("ID"), b.drAbonos(i)("TipoPago"), b.drAbonos(i)("SaldoBase"), CAJClave, b.drAbonos(i)("Tipo"))
                        ...
                        If a.DialogResult = DialogResult.OK Then
                            If a.detallePago.Rows.Count > 0 Then
                                ...
                                For i = 0 To a.detallePago.Rows.Count - 1
                                    ModPOS.Aplica_Pagos(dtFacturas, oCFD.CTEClave, a.detallePago.Rows(i)("ABNClave"), a.detallePago.Rows(i)("TipoPago"), a.detallePago.Rows(i)("SaldoBase"), CAJClave, 1)
                                Next
