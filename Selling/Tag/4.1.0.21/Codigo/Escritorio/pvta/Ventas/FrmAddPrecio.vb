...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmAddPrecio))
        ...
        Me.Name = "FrmAddPrecio"
        Me.Text = "Agregar Productos a Lista de Precios"
...
#End Region
    ...
    Private Sub FrmAddPrecio_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
        ModPOS.AddPrecio.Dispose()
        ModPOS.AddPrecio = Nothing
    End Sub
    ...
    Private Sub BtnGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnGuardar.Click
        If validaForm() Then
            ...
            If foundRows.GetLength(0) > 0 Then
                ...
                Beep()
                Select Case MessageBox.Show("Se va a " & CmbModificar.SelectedItem.ToString & " el Precio en un " & lblPorc.Text & TxtPorcentaje.Text & " de todos los registros marcados, esta deacuerdo?", "Pregunta", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
                    Case DialogResult.Yes
                        ...
                        Select Case incrementar
                            Case Is = 1 '"Incrementar"
                                dUtilidad = Math.Abs(dUtilidad / 100)
                            Case Is = 0 '"Disminuir"
                                dUtilidad = Math.Abs(dUtilidad / 100)
                        End Select
                        ...
                        For i = 0 To foundRows.GetUpperBound(0)
                            ...
                            ModPOS.Ejecuta("sp_actualiza_precio", _
                            "@Funcion", incrementar, _
                            "@PREClave", PREClave, _
                            "@PROClave", sPROClave, _
                            "@Cantidad", dUtilidad, _
    ...
    Private Sub Clock_Tick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Clock.Tick
        ...
        ElseIf TxtSearch.Text <> "" Then
            If Not dtProductos Is Nothing Then
                dtProductos.Dispose()
            End If
            dtProductos = ModPOS.Recupera_Tabla("sp_filtra_ConPrecio", "@PREClave", PREClave, "@Campo", Me.CmbCampo.SelectedValue, "@Busca", Me.TxtSearch.Text.Replace("'", "''"), "@Char", cReplace)
            ...
            GridProductos.RootTable.Columns("Precio").Width = 40
            GridProductos.RootTable.Columns("Fin").Width = 40
            ...
            GridProductos.CurrentTable.Columns("Precio").Selectable = False
            GridProductos.CurrentTable.Columns("Fin").Selectable = False
    ...
    Private Sub CmbModificar_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CmbModificar.SelectedIndexChanged
        Select Case CmbModificar.SelectedItem.ToString
            Case Is = "Reemplazar"
                lblPorc.Text = "$"
            Case Else
