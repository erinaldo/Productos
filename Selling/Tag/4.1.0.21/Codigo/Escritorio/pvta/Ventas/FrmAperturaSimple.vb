...
#End Region
    ...
    Private Sub BtnOk_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnOk.Click
        ...
        Else
            ...
            If dt.Rows.Count > 0 Then
                ...
                If TotalRegistrado < Redondear(MontoEfectivo, 2) AndAlso Redondear(Math.Abs(TotalRegistrado - MontoEfectivo), 2) >= 0.5 Then
    ...
    Private Function TotalRegistrado() As Decimal
