...
#End Region
    ...
    Private Sub cargaRendimiento()
        ...
        GridDetalle.RootTable.Columns("Litros").FormatString = "0.00"
        GridDetalle.RootTable.Columns("Odometro(Km)").FormatString = "0.00"
        GridDetalle.RootTable.Columns("Rendimiento").FormatString = "0.00"
        GridDetalle.RootTable.Columns("Recorrido(Km)").FormatString = "0.00"
        bCombustible = True
