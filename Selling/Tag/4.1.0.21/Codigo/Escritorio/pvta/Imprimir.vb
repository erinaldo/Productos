...
Public Class Imprimir
    ...
    Public Sub AddItemVale(ByVal Folio As String, ByVal Clave As String, ByVal Modelo As String, ByVal Talla As String, ByVal Color As String, ByVal Cantidad As String)
        '40 Caracteres
        ...
        Dim str4, str5, str10, str7, str14, str30 As String

        str4 = Me.FormateaCadena(Alinear.Derecha, Cantidad, 4)
        str5 = Me.FormateaCadena(Alinear.Centrado, Talla, 5)
        str10 = Me.FormateaCadena(Alinear.Izquierda, Color, 10)
        str7 = Me.FormateaCadena(Alinear.Izquierda, Modelo, 7)
        str14 = Me.FormateaCadena(Alinear.Izquierda, Folio, 14 - iEspacio)

        If Clave = "" AndAlso Modelo = "" Then
            str30 = Me.FormateaCadena(Alinear.Izquierda, Folio, 30 - iEspacio)
            str10 = Me.FormateaCadena(Alinear.Derecha, Cantidad, 10)
            Me.items.Add(String.Concat(New String() {str30, str10}))
        Else
            Me.items.Add(String.Concat(New String() {str14, str7, str10, str5, str4}))
        End If
    End Sub
