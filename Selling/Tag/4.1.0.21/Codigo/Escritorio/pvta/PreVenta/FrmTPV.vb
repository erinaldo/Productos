...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Panel1.Location = New System.Drawing.Point(974, 419)
        ...
        Me.Panel3.Location = New System.Drawing.Point(974, 493)
        ...
        Me.picKeyboard.Location = New System.Drawing.Point(3, 198)
        ...
        Me.Panel4.Location = New System.Drawing.Point(974, 455)
        ...
        Me.TxtCliente.Location = New System.Drawing.Point(1014, 119)
        ...
        Me.TxtProducto.Location = New System.Drawing.Point(1046, 329)
        ...
        Me.Label11.Location = New System.Drawing.Point(972, 308)
        ...
        Me.Label12.Location = New System.Drawing.Point(1047, 308)
        ...
        Me.Label13.Location = New System.Drawing.Point(1025, 329)
        ...
        Me.TxtCantidad.Location = New System.Drawing.Point(976, 328)
        ...
        Me.Panel6.Location = New System.Drawing.Point(974, 372)
        ...
        Me.Label14.Location = New System.Drawing.Point(977, 355)
        ...
        Me.BtnBusquedaProducto.Location = New System.Drawing.Point(1169, 319)
        ...
        Me.txtLimite.Location = New System.Drawing.Point(137, 160)
        ...
        Me.txtDias.Location = New System.Drawing.Point(137, 187)
        ...
        Me.txtSaldo.Location = New System.Drawing.Point(137, 214)
        ...
        Me.Panel8.Size = New System.Drawing.Size(241, 243)
        ...
        Me.lblCteClave.Location = New System.Drawing.Point(4, 86)
        ...
        Me.btnCliente.Location = New System.Drawing.Point(186, 51)
        ...
        Me.Label10.Location = New System.Drawing.Point(1, 58)
        ...
        Me.lblSaldo.Location = New System.Drawing.Point(4, 214)
        ...
        Me.Label17.Location = New System.Drawing.Point(4, 187)
        ...
        Me.LblCliente.Location = New System.Drawing.Point(4, 115)
        ...
        Me.btnBuscaCte.Location = New System.Drawing.Point(1113, 113)
        ...
        Me.btnCortar.Location = New System.Drawing.Point(856, 582)
        ...
        Me.btnPegar.Location = New System.Drawing.Point(901, 582)
...
#End Region
                                ...
                                If item.Length = 2 Then
                                    If Not IsDBNull(item(0)) AndAlso Not IsDBNull(item(1)) Then
                                        If IsNumeric(item(1)) Then
                                            ...
                                            leeCodigoBarras(CStr(item(0)).Trim, True, False, True, True, False, False, 0)
        ...
        ElseIf e.Control AndAlso e.KeyCode = Keys.Oemplus Then
            If VentaCerrada = False Then
                If GridDetalle.GetValue("Baja") = 0 Then
                    TxtCantidad.Text = 1
                    leeCodigoBarras(GridDetalle.GetValue("Clave"), True, False, False, True, True, True, 0)
                End If
            End If
        ElseIf e.Control AndAlso e.KeyCode = Keys.OemMinus Then
            If VentaCerrada = False Then
                If GridDetalle.GetValue("Baja") = 0 AndAlso GridDetalle.GetValue("Cantidad") > 1 Then
                    ...
                    leeCodigoBarras(GridDetalle.GetValue("Clave"), False, False, False, True, True, True, 0)
                End If
            End If
        End If
    End Sub
    ...
    Private Function leeCodigoBarras(ByVal Codigo As String, ByVal Suma As Boolean, ByVal Busca As Boolean, ByVal bCopy As Boolean, ByVal bRecalcular As Boolean, ByVal bValidaOpen As Boolean, ByVal bShortCut As Boolean, ByVal dDescuento As Double) As Boolean
        If VentaCerrada = False Then
            Dim dt As DataTable
            ...
            If Not Codigo = vbNullString Then
                ...
                If dt Is Nothing Then
                    ...
                    Return False
                Else
                    BacktoSearh = AgregaPartida(dt, Suma, Busca, bCopy, bRecalcular, bShortCut, dDescuento)
                    'Sugerido
                    If dt.Rows.Count > 0 Then
    ...
    Private Sub TxtProducto_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TxtProducto.KeyPress
        If Asc(e.KeyChar) = 13 Then
            leeCodigoBarras(TxtProducto.Text.Trim.ToUpper.Replace("'", "''"), True, False, False, True, True, False, 0)
        End If
    End Sub
    ...
    Public Function AgregaGTIN(ByVal sGTIN As String, ByVal Busca As Boolean, ByVal bValidaOpen As Boolean) As Boolean
        ...
        backToSearch = leeCodigoBarras(sGTIN, True, Busca, False, True, bValidaOpen, False, 0)
        Return backToSearch
    End Function
    ...
    Public Function AgregaPartida(ByVal dtProducto As DataTable, ByVal Suma As Boolean, ByVal Busca As Boolean, ByVal bCopy As Boolean, ByVal bRecalculaInventario As Boolean, ByVal bShortCut As Boolean, ByVal dDescuento As Double) As Boolean
        Dim dt As DataTable
        ...
        If Not dtProducto Is Nothing Then
            ...
            Dim dDescPorc As Decimal = dDescuento
    ...
    Private Sub BtnWait_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnWait.Click
        If Not VentaCerrada Then
            If TotalArticulos > 0 Then
                ...
                ModPOS.Ejecuta("sp_actualiza_venta", "@VENClave", VENClave, "@Estado", 6, "@ALMClave", ALMClave, "@MONClave", MonedaActual, "@TipoCambio", TipoCambio)
    ...
    Private Sub GridDetalle_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles GridDetalle.DoubleClick
        If GridDetalle.GetValue("Baja") = 0 Then
            ...
            leeCodigoBarras(GridDetalle.GetValue("Clave"), False, False, False, True, True, False, 0)
        End If
    End Sub
        ...
        Select Case MessageBox.Show("Esta apunto de crear una venta a partir de la cotización. ¿Esta usted de acuerdo?", "Pregunta", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
            Case DialogResult.Yes
                ...
                If Not dtventadetalle Is Nothing Then
                    ...
                    For i = 0 To dtventadetalle.Rows.Count - 1
                        TxtCantidad.Text = dtventadetalle.Rows(i)("Cantidad")
                        leeCodigoBarras(dtventadetalle.Rows(i)("Clave"), True, False, True, True, False, False, 0)
                    Next
                    dtventadetalle.Dispose()
        ...
        If Not VentaCerrada Then
            If dtPortaPapeles.Rows.Count > 0 Then
                ...
                For i = 0 To dtPortaPapeles.Rows.Count - 1
                    TxtCantidad.Text = dtPortaPapeles.Rows(i)("Cantidad")
                    leeCodigoBarras(dtPortaPapeles.Rows(i)("Clave"), True, False, True, True, False, False, dtPortaPapeles.Rows(i)("Descuento"))
