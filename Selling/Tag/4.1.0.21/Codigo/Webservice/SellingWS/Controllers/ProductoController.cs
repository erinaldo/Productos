...
namespace SellingWS.Controllers
{
    ...
    public class ProductoController : ApiController
    {
        ...
        /// <returns>ApiProductoInventario</returns>
        [HttpGet]
        public HttpResponseMessage VerificaReubicacion(string ALMClave, string UBCClave, string PROClave)
        {
            ApiProductoInventario producto = (
                from p in db.Producto
                where p.Baja==false &&
        ...
        public decimal? MoverProductoReubicacion([FromBody]ApiProductoMoverRequest requestData)
        {
            ...
            if (estructuraDestino.TESTClave == 3 || estructuraDestino.TESTClave == 0)
                throw new HttpResponseException(Request.CreateErrorResponse(HttpStatusCode.NotFound, Mensajes.Reubicacion_UbicacionDestino_NoContent));
            ...
            var cantidadMovida = disponibleOrigen - requestData.cantidad >= 0 ?
            ...
            if (estructuraDestino.TESTClave == 1)
            {
                ...
                if (volumenUbicacion != null && volumenUbicacion.Volumen - volumenUbicacion.VolumenOcupado < volumenOcupar)
                    throw new HttpResponseException(Request.CreateErrorResponse(HttpStatusCode.NotFound, Mensajes.Reubicacion_UbicacionDestino_NoContent4));
                ...
                if (ubicacionDestino.prd_exist_uba.Count(u => u.Existencia > 0) > 0 &&
                    !ubicacionDestino.prd_exist_uba.Any(u => 
                            ...
                            u.Producto.ClasProd.Any(cp => 
                                cp.CLAClave == peuOrigen.Producto.ClasProd.First(cp1 => 
                    ...
                    throw new HttpResponseException(Request.CreateErrorResponse(HttpStatusCode.NotFound, Mensajes.Reubicacion_UbicacionDestino_NoContent2));
                }
/*
