...
class DescuentoControllerSpec extends Specification {
    ...
    void "Test the index action returns the correct model"() {
        ...
        then:"The model is correct"
            !model.descuentoInstanceList
            model.descuentoInstanceCount == 0
    }
    ...
    void "Test the save action correctly persists an instance"() {
        ...
        then:"A redirect is issued to the show action"
            response.redirectedUrl == '/descuento/show/1'
    ...
    void "Test that the show action returns the correct model"() {
        ...
        when:"A domain instance is passed to the show action"
            ...
            controller.show(descuento)

        then:"A model is populated containing the domain instance"
            model.descuentoInstance == descuento
    }
    ...
    void "Test the update action performs an update on a valid domain instance"() {
        ...
        then:"A 404 error is returned"
            response.redirectedUrl == '/descuento/index'
            flash.message != null
        ...
        then:"A redirect is issues to the show action"
            response.redirectedUrl == "/descuento/show/$descuento.id"
            flash.message != null
    }
