...
public class ServicesCentral
{
	...
	public static TipoLicencia WSTipo_Licencia() throws Exception
	{
		...
		String message = "<soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\" " +
				...
				"<pvDeviceID>" + config.get(CampoConfiguracion.NUMERO_SERIE) + "</pvDeviceID><pvDeviceName>" + Dispositivo.obtenerNombre() + "</pvDeviceName>" +
				"</WSTipo_Licencia>" +
				"</soap:Body>" +
				"</soap:Envelope>";
	...
	public static void WSEliminarArchivoBases(String nombreArchivo) throws Exception
	{
	...
	public static boolean WSActualizarCaptura(String vendedorID, String dataSet, Date fechaInicial, Date fechaPrimerDia, Boolean reintentar) throws Exception
	{
		boolean res = false;
		...
		String message = "<soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\" " +
				"xmlns:tem=\"http://tempuri.org/services/MobileClient\">" +
				"<soap:Body>" +
				"<WSActualizarCaptura xmlns=\"http://tempuri.org/services/MobileClient\">" +
		...
		hc.setRequestProperty("SOAPAction", "http://tempuri.org/services/MobileClient/WSActualizarCaptura");
		hc.setRequestProperty("User-Agent", "Profile/MIDP-1.0 Configuration/CLDC-1.0");
		hc.setRequestProperty("Content-Type", "text/xml;charset=utf-8");
		hc.setRequestProperty("Content-Length", Integer.toString(message.length()));
		hc.setRequestProperty("Connection", "close");
	...
	// se duplico el metodo WSActualizarCapturaSQLite para enviar el zip al server ldelatorre
	@SuppressWarnings("resource")
	public static boolean WSImagenEcuestaEnviarSQLite(String pathImagenes) throws Exception
	{
	...
	//metodo para mandar zip ldelatorre*/
