...
public class CancelarPedido extends Presentador
{
	...
	public int cancelarPedido(TransProd pedido)
	{
		...
		try
		{
			...
			//String diaActual = ((Dia) Sesion.get(Campo.DiaActual)).DiaClave;
			//String visita = ((TransProd) Sesion.get(Campo.TransProd)).VisitaClave;
			//String dia = ((TransProd) Sesion.get(Campo.TransProd)).DiaClave;
