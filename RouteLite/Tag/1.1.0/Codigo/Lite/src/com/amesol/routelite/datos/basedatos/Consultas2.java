...
public final class Consultas2
{
	...
	public static class ConsultasInventario{
		...
		public static ISetDatos obtenerInventarioParaReporte() throws Exception{
			...
			query.append("from Inventario INV inner join (select ProductoClave, PRUTipoUnidad, min(Factor) as Factor from ProductoDetalle group by productoclave, PRUTipoUnidad) as PD on PD.ProductoClave = INV.ProductoClave inner join Producto p on ");
			query.append("INV.ProductoClave = p.ProductoClave order by INV.ProductoClave limit 2");
