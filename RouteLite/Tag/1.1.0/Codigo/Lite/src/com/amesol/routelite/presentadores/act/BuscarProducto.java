...
public class BuscarProducto extends Presentador {
	...
	public boolean validarCantMax(float cantidad, int tipoTransProd){
		...
		if(Integer.parseInt(oMot.get("CantidadMaxProd").toString()) > 0 && (tipoTransProd == TiposTransProd.PEDIDO || tipoTransProd == TiposTransProd.MOV_SIN_INV_EV)){ //solo se valida para los pedidos
