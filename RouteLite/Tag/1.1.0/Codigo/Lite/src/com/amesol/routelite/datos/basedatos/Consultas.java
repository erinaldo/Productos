...
*/
	...
	/*	public static ISetDatos obtenerUnidadesRestantesProducto(String productoClave, String transProdsId) throws Exception
		...
		public static Cursor obtenerProductosExistencia(String filtro, String PrecioClave, boolean filtrarProductos, String transProdIds, int tipoTransProd, boolean validarExistencia, int tipoMovimiento, String esquemasModulo) throws Exception
		{
...
//				sConsulta.append("AND Visita.DiaClave='" + diaClave + "'");
	...
	public static final class ConsultasInventario
	{
		...
		public static ISetDatos obtenerInventarioDescarga() throws Exception
		{
			...
			consulta.append("HAVING (INV.Disponible-INV.Apartado-INV.NoDisponible-INV.Contenido)>0 ");
			return BDVend.consultar(consulta.toString());
		}
		...
		public static ISetDatos obtenerInventarioParaReporte() throws Exception{
			...
			query.append("and PD.ProductoClave = TPD.ProductoClave where INV.ProductoClave = TPD.ProductoClave and TRP.Tipo = 9 and TRP.TipoFase = 1 and TipoMovimiento = 1) as IM,");
			
			query.append("(select ifnull(sum(TPD.Cantidad*PD.Factor),0) from transprod TRP ");
			query.append("inner join transproddetalle TPD on TRP.TransProdId = TPD.TransProdid and TPD.TipoMotivo = 211 ");
			query.append("and PD.ProductoClave = TPD.ProductoClave where INV.ProductoClave = TPD.ProductoClave and TRP.Tipo = 9 and TRP.TipoFase = 1 and TipoMovimiento = 1) as IF,");
