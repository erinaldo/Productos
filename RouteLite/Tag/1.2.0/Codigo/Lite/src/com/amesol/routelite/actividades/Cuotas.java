...
public class Cuotas {
	...
	public static void VerificarCuotas(String vendedorID, int tipo, float cantidad, String ProductoClave) throws Exception{
		...
		while(cuotas.moveToNext()){
			...
			//obtenerCuotasCliente(cuota, clienteClave, tipo);
			//obtenerCuotasEsquema(cuota);
			//obtenerCuotasProducto(cuota);
			//obtenerCuotasVendedor(cuota);
