...
public class Recibos
{
	...
	private static String generarArchivoReporte(int reporte, String directorioArchivo, Recibo recibo, boolean imprimeLogo, String[] byRefMsgError) throws Exception
	{
		...
		try
		{
			...
			Document document = reporte != 5 ? new Document() : new Document(new Rectangle(1495, 595));
			...
			//resumen movimientos costeña
				...
				case 4:
					...
					break;
				case 5:
					generarReportePedidosPreventa(reporte, cadenaRecibo, document, pdfWriter);
					break;
			}
...
//		reportePDF.add(vacio);
	...
	private static void generarReportePedidosPreventa(int reporte, StringBuilder cadenaRecibo, Document document, PdfWriter pdfWriter) throws Exception
	{
		String cadena = "";
		String texto = "";
		int columna = 10;
