...
//		cadenaRecibo.append("\r\n");
	...
	private static void generarReportePedidosPreventa(int reporte, StringBuilder cadenaRecibo) throws Exception
	{
		...
		cadena+= completaHasta(texto, 35, TipoAlineacion.IZQUIERDA, false);
		...
		while(pedidos.moveToNext())
		{
			...
			cadena+= completaHasta(pedidos.getString("Domicilio"), 35, TipoAlineacion.IZQUIERDA, false);
		...
		cadena = completaHasta(Generales.getFormatoDecimal(volumen, 2), 124, TipoAlineacion.DERECHA, false);
		cadena+= completaHasta("$ ".concat(Generales.getFormatoDecimal(monto, "#,###,##0.00")), 10, TipoAlineacion.IZQUIERDA, true);
