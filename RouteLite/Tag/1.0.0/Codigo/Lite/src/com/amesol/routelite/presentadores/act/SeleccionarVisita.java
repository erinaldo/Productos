...
public class SeleccionarVisita extends Presentador {
	...
	public boolean validarMostrarAutorizacion(boolean[] array){
		...
		if(!aseguramiento.EdoContraFija || aseguramiento.TipoAseguramiento == 0){
			...
			if(((aseguramiento.TipoAseguramiento == 1 || aseguramiento.TipoAseguramiento == 3 )) && !(Boolean)oParametros.get("CodigoLeido")){
				
					if (aseguramiento.TipoContrasena == 2)
						return true;
					else if (aseguramiento.EdoContraFija && aseguramiento.TipoContrasena == 1){
				...
				if(aseguramiento.TipoAseguramiento != 2 && aseguramiento.TipoAseguramiento != 3 && aseguramiento.TipoContrasena == 2 && !(Boolean)oParametros.get("CodigoLeido"))
					return true;
				else 
					array[1] =true;
					return false;
	...
	public void mostrarResumen(Cursor visita){
		try{
			...
			mVista.iniciarActividadConResultado(IResumenMovVisita.class, 0, "", oParametros);
		}catch(Exception ex){
