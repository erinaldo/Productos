	...
	public static class Pedidos
	{
		...
		public static void CalcularTotalesDetallePedido(TransProdDetalle transProdDetalle) throws Exception
		{
			...
			if (transProdDetalle.Precio >= 0)
			{
				...
				transProdDetalle.Impuesto = Impuestos.Calcular(listaImpuestos, transProdDetalle.getSubTotal(), transProdDetalle.Precio);
		...
		public static TransProdDetalle GenerarDetallePedido(String TransProdId, String ProductoClave, int TipoUnidad, float Cantidad, int Motivo) throws Exception
		{
				...
				{*/
					...
					if (nPrecio >= 0)
					{
						...
						else
						{
							...
							oTPD.Impuesto = Impuestos.Calcular(oImpuestos, oTPD.getSubTotal(), oTPD.Precio);
