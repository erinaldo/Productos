...
public class Transacciones
{
	...
	public static class Pedidos
	{
		...
		public static TransProd ActualizarGenerarPedido(String TransProdID, ModuloMovDetalle moduloMovDetalle, final StringBuilder byRefMensaje, int Motivo) throws ControlError, Exception
		{
