...
public class ServidorComunicaciones extends Vista implements IServidorComunicaciones
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		if (getIntent().getExtras() != null)
		{
			...
			{
				if (hm.containsKey("Recargas") && (Boolean.parseBoolean(hm.get("Recargas").toString()))){
					presenta = new ServirComunicaciones(this, accion, hm.get("Tablas").toString(), true);					
				}else{
					presenta = new ServirComunicaciones(this, accion, hm.get("Tablas").toString(),false);				
				}
			}
