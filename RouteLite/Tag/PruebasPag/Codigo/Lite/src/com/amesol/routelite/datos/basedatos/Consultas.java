...
public final class Consultas
{
	...
	public static final class ConsultasEsquema
	{
		...
		public static SortedMap<String,Esquema> obtenerEsquemasJerarquia(ServicesCentral.TiposEsquemas Tipo) throws Exception
		{
				...
				consulta.append("order by indice ");
				...
				{
					hm.put(datos.getString("EsquemaId"), datos.getString("indice"));
					...
					if (datos.getInt("Nivel") == 1){
						tm.put(datos.getString("indice"), esq);
					}else{
						if (hm.containsKey(datos.getString("EsquemaIdPadre"))){
							tm.put(hm.get(datos.getString("EsquemaIdPadre")) + "." + datos.getString("indice"), esq);
							hm.put(datos.getString("EsquemaId"), hm.get(datos.getString("EsquemaIdPadre")) + "." + datos.getString("indice"));
						}
					}
				}
				datos.close();
...
//				sConsulta.append("AND Visita.DiaClave='" + diaClave + "'");
	...
	public static final class ConsultasInventario
	{
		...
		public static ISetDatos obtenerInventarioParaReporte() throws Exception{
			...
			query.append("where INV.ProductoClave = TPD.ProductoClave and TRP.Tipo = 2 and TRP.TipoFase = 1) as II,");
...
//	}
	...
	public static final class ConsultasValidacionPreliquidacion{
		...
		public static int getTransProdCFVTipo(String visitaClave, String diaClave) throws Exception
		{
			int valor = 0;
		...
		public static int getTransProdClientePago(String visitaClave, String diaClave) throws Exception
		{
			int valor = 0;
			ISetDatos CFVTipo = BDVend.consultar("SELECT * from TransProd where VisitaClave = '"+visitaClave+"' and DiaClave = '"+diaClave+"'");
			...
			if(CFVTipo.moveToNext())
			{
				valor = CFVTipo.getInt("ClientePagoId");
			}
			CFVTipo.close();
			return valor;
		}
		
		public static boolean validarTotal (String visitaClave, String diaClave) throws Exception
		{
			boolean confirmado = false;
			
			ISetDatos Transprod = BDVend.consultar("SELECT * from TransProd where VisitaClave = '"+visitaClave+"' and DiaClave = '"+diaClave+"'");
