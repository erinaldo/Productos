	...
	public void onCreate(Bundle savedInstanceState)
	{
		try
		{
			...
			if (((Vendedor)Sesion.get(Campo.VendedorActual)).MostrarEsquema){
				iniciarActividadConResultado(ISeleccionEsquemaProducto.class, Enumeradores.Solicitudes.SOLICITUD_SELECCIONAR_ESQUEMAS_PRODUCTO, Enumeradores.Acciones.ACCION_SELECCIONAR_ESQUEMAS_PRODUCTO);
			}else{
