...
public class SeleccionarFacturacion extends Presentador
{
	...
	public void validarInicioFacturacion() throws ControlError
	{
		try
		{
			...
			ISetDatos pagos = Consultas.ConsultasClientePago.obtenerFormaPago(cliente.ClienteClave);
	...
	private TransProd crearTransProdFactura() throws Exception
	{
		...
		tp.Subtotal = Transacciones.Factura.obtenerSubtotal(pedidosIds);
		tp.Impuesto = Transacciones.Factura.obtenerImpuesto(pedidosIds);
	...
	public void cancelarFactura()
	{
		...
		}catch(Exception ex)
		{
			...
			try{
				...
				Log.e("CANCELAR_FACTURA_ROLLBACK", e.getMessage());
			}
			mVista.mostrarError(ex.getMessage());
		}
	}
