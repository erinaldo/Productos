...
public final class Consultas
{
	...
	public static final class ConsultasTransProd
	{
		...
		public static ISetDatos obtenerTotalPedidosCostena() throws Exception{
			StringBuilder consulta = new StringBuilder();
			...
			consulta.append("where TRP.TransProdID is null or (TRP.Tipo = 1 and TRP.TipoFase = 1) ");
		...
		public static ISetDatos obtenerPedidosCancelados() throws Exception{
			...
			consulta.append("from TransProd TRP ");
			consulta.append("where TRP.Tipo = 1 and TRP.TipoFase = 0 ");
			consulta.append("group by TRP.Tipo ");
			return BDVend.consultar(consulta.toString());
		}
		...
		public static ISetDatos obtenerPedidosDelDia() throws Exception{
			...
			consulta.append("inner join Visita VIS on TRP.VisitaClave = VIS.VisitaClave or TRP.VisitaClave1 = VIS.VisitaClave ");
			consulta.append("inner join Cliente CLI on VIS.ClienteClave = CLI.ClienteClave ");
			consulta.append("where TRP.Tipo = 1 and TRP.TipoFase = 1 and CLI.Clave not like 'MX%' and VIS.FueraFrecuencia = 0 ");
			consulta.append("group by TRP.Tipo ");
			return BDVend.consultar(consulta.toString());
		}
		...
		public static ISetDatos obtenerPedidosOp() throws Exception{
			...
			consulta.append("inner join Visita VIS on TRP.VisitaClave = VIS.VisitaClave or TRP.VisitaClave1 = VIS.VisitaClave ");
			consulta.append("inner join Cliente CLI on VIS.ClienteClave = CLI.ClienteClave ");
			consulta.append("where TRP.Tipo = 1 and TRP.TipoFase = 1 and CLI.Clave like 'MX%' ");
			consulta.append("group by TRP.Tipo ");
			return BDVend.consultar(consulta.toString());
		}
		...
		public static ISetDatos obtenerPedidosFueraFrecuencia() throws Exception{
			...
			consulta.append("from TransProd TRP ");
			consulta.append("inner join Visita VIS on TRP.VisitaClave = VIS.VisitaClave or TRP.VisitaClave1 = VIS.VisitaClave ");
			consulta.append("where TRP.Tipo = 1 and TRP.TipoFase = 1 and VIS.FueraFrecuencia = 1 ");
			consulta.append("group by TRP.Tipo ");
			return BDVend.consultar(consulta.toString());
		}
		...
		public static ISetDatos obtenerPedidosContado() throws Exception{
			...
			consulta.append("select SUM(TRP.Total) as Total, COUNT(*) as TotalPedidos ");
			consulta.append("from TransProd TRP ");
			consulta.append("where TRP.Tipo = 1 and TRP.TipoFase = 1 and TRP.CFVTipo = 1 ");
			consulta.append("group by TRP.Tipo ");
			return BDVend.consultar(consulta.toString());
		}
		...
		public static ISetDatos obtenerPedidosCredito() throws Exception{
			...
			consulta.append("select SUM(TRP.Total) as Total, COUNT(*) as TotalPedidos ");
			consulta.append("from TransProd TRP ");
			consulta.append("where TRP.Tipo = 1 and TRP.TipoFase = 1 and TRP.CFVTipo = 2 ");
			consulta.append("group by TRP.Tipo ");
			return BDVend.consultar(consulta.toString());
		}
	...
	public static final class ConsultasTransProdDetalle
	{
		...
		{
			StringBuilder consulta = new StringBuilder();
			consulta.append("SELECT TPD.TransProdDetalleID, PRO.Nombre, PRO.ProductoClave, TPD.Cantidad, TPD.Precio, TPD.Total, PRO.DecimalProducto, TPD.TipoUnidad ");
			consulta.append("FROM Producto as PRO inner join TransProdDetalle as TPD on TPD.ProductoClave = PRO.ProductoClave ");
	...
	public static final class ConsultasAbono
	{
		...
		public static float obtenerSaldoAbonos(Cliente cliente, boolean in, int...formasPago) throws Exception{
			float saldoAbono = 0f;
			StringBuilder consulta = new StringBuilder();
			consulta.append("SELECT case when sum(Abn.Saldo) is null then 0 else sum(Abono.Saldo) end FROM Abono as Abn inner join Visita as v on v.VisitaClave = Abn.VisitaClave ");
	...
	public static final class ConsultasModuloMovDetalle{
		...
		public static ModuloMovDetalle obtenerModuloMovDetallePorIndice(int indice) throws Exception{
			ISetDatos movDetalleSet = BDVend.consultar("SELECT ModuloMovDetalleClave, TipoTransProd, TipoPedido FROM ModuloMovDetalle WHERE TipoIndice = " + indice);
	...
	public static final class ConsultasTrpTpd{
		...
		public static List<TrpTpd> obtenerTransProdDevolucionDeConsignacion(String transProdId) throws Exception{
			ISetDatos trptpdSet = BDVend.consultar("SELECT * FROM TprTpd where TrpTpd.TransProdID1 ='" + transProdId + "'");
		...
		{
			BDVend.ejecutarComando("DELETE FROM TprTpd where TransProdID1 = '" + transProdID + "'");
		}
	}
