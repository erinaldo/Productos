...
public class ListaPrecio {
	...
	public static float BuscarPrecio(String ProductoClave, short TipoUnidad, String listasPrecios)
	{				
		return ConsultasPrecioProductoVig.obtenerPrecioProducto(ProductoClave, TipoUnidad, listasPrecios);
	}
