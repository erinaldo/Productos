...
public class TextBoxScanner extends LinearLayout
{
    ...
    public void setTipoCodigo(int tipocodigo){tipoCodigo = tipocodigo;}
    ...
    public void mostrarCamera(){
        //btnScanner.setVisibility(GONE);
        btnScanner.setImageResource(R.drawable.camera);
        bCamera = true;
    }

    public void mostrarScaner(){
        //btnScanner.setVisibility(VISIBLE);
        btnScanner.setImageResource(R.drawable.codigo_barras);
        bCamera = false;
    }
}
