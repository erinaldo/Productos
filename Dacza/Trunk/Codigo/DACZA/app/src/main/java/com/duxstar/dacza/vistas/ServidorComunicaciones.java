...
import com.duxstar.dacza.presentadores.act.ServirComunicaciones;
...
public class ServidorComunicaciones extends Vista implements IServidorComunicaciones
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        if (getIntent().getExtras() != null) {
            ...
            if (hm.containsKey("TipoEnvioInfo")) {
                int tipoEnvioInfo = Integer.parseInt(hm.get("TipoEnvioInfo").toString());
                if (hm.containsKey("IdDocumento")) {
                    String idDocumento = hm.get("IdDocumento").toString();
                    presenta = new ServirComunicaciones(this, accion, tipoEnvioInfo, idDocumento);
                }
                else {
