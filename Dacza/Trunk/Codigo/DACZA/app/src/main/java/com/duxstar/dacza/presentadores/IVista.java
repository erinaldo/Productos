...
//import com.duxstar.dacza.actividades.btPrintFile;
...
public interface IVista {	
	...
	//void mostrarPromocionProducto(String promocionClave, String promocionReglaID, int CantidadGrupoApp, String SubEmpresaId, int cantidad);
