Public Class clsFuncionamiento
    Inherits clsName
...
#Region "Metodos"
    ...
    Public Function EditarRegistro() As Boolean Implements iNuevoEditable.EditarRegistro
        Try
            With DB
                ...
                .ExecuteCmd("EditaFuncionalidad", CommandType.StoredProcedure)
            End With
    ...
    Public Function EliminarRegistro() As Boolean Implements iNuevoEditable.EliminarRegistro
        Try
            With DB
                .AddParameter("@ID", SqlDbType.Int, ID)
                .ExecuteCmd("EliminaFuncionalidad", CommandType.StoredProcedure)
            End With
            Return True
        Catch ex As Exception
            Throw ex
    ...
    Public Function NuevoRegistro() As Boolean Implements iNuevoEditable.NuevoRegistro
        Try
            With DB
                .AddParameter("@Nombre", SqlDbType.VarChar, Nombre.Trim)
                .AddParameter("@Descripcion", SqlDbType.VarChar, Descripcion.Trim)
                .ExecuteCmd("InsertaFuncionalidad", CommandType.StoredProcedure)
            End With
            Return True
        Catch ex As Exception
            Throw ex
    ...
    Public Function ObtenerDatos() As DataTable
        Try
            Dim dt As DataTable
            With DB
                dt = .ToDatatable("obtenDatosFuncionalidad", CommandType.StoredProcedure)
            End With
            Return dt
        Catch ex As Exception
            Throw ex
