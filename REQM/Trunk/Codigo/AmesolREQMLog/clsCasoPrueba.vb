...
#Region "Metodos"
    ...
    Public Function EditarRegistro() As Boolean Implements iNuevoEditable.EditarRegistro
        Try
            With DB
                ...
                .ExecuteCmd("EditaCasoPrueba", CommandType.StoredProcedure)
            End With
            Return True
    ...
    Public Function EliminarRegistro() As Boolean Implements iNuevoEditable.EliminarRegistro
        Try
            With DB
                .AddParameter("@ID", SqlDbType.Int, ID)
                .ExecuteCmd("EliminaCasoPrueba", CommandType.StoredProcedure)
            End With
            Return True
        Catch ex As Exception
            Throw ex
    ...
    Public Function NuevoRegistro() As Boolean Implements iNuevoEditable.NuevoRegistro
        Try
            With DB
                .AddParameter("@Nombre", SqlDbType.VarChar, Nombre.Trim)
                .ExecuteCmd("InsertaCasoPrueba", CommandType.StoredProcedure)
            End With
            Return True
        Catch ex As Exception
            Throw ex
    ...
    Public Function ObtenerDatos() As DataTable
        Try
            Dim dt As DataTable
            With DB
                dt = .ToDatatable("obtenDatosCasoPrueba", CommandType.StoredProcedure)
            End With
            Return dt
        Catch ex As Exception
            Throw ex
