<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/incidMaster.Master" CodeBehind="catStatus.aspx.vb" Inherits="appIncidencias.catStatus" %>
...
<table width="80%">
        <tr>
            <td>
                <asp:Label CssClass="Title" ID="lblTitle" runat="server" Text="Status"></asp:Label>
            </td>
        </tr>
        <tr>
            <td align="center">
                <asp:GridView ID="gvStatus" runat="server" AutoGenerateColumns="False" 
                    DataKeyNames="iStausID" ShowFooter="True">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="ID" InsertVisible="False" 
                            ...
                            <EditItemTemplate>
                                <asp:Label ID="lblID" runat="server" Text='<%# Eval("iStausID") %>'></asp:Label>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="lblID" runat="server" Text='<%# Bind("iStausID") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
