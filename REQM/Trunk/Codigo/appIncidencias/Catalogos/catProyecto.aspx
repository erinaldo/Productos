<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/incidMaster.Master" CodeBehind="catProyecto.aspx.vb" Inherits="appIncidencias.catProyecto" %>
...
<table width="80%">
        <tr>
            <td>
                <asp:Label CssClass="Title" ID="lblTitle" runat="server" Text="Proyectos"></asp:Label>
            </td>
        </tr>
        <tr>
            <td align="center">
                <asp:GridView ID="gvProyecto" runat="server" AutoGenerateColumns="False" 
                    DataKeyNames="iProyectoID" ShowFooter="True">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="ID" InsertVisible="False" 
                            SortExpression="iProyectoID">
                            <EditItemTemplate>
                                <asp:Label ID="lblID" runat="server" Text='<%# Eval("iProyectoID") %>'></asp:Label>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="lblID" runat="server" Text='<%# Bind("iProyectoID") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
