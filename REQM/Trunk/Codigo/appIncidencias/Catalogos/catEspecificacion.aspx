<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/incidMaster.Master" CodeBehind="catEspecificacion.aspx.vb" Inherits="appIncidencias.catEspecificacion" %>
        ...
        <tr>
            <td>
                <asp:Label CssClass="Title" ID="lblTitle" runat="server" 
                    Text="Especificaciones"></asp:Label>
            </td>
        </tr>
        <tr>
            <td align="center">
                <asp:GridView ID="gvEspecificacion" runat="server" AutoGenerateColumns="False" 
                    DataKeyNames="iEspecificacionID" ShowFooter="True">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="ID" InsertVisible="False" 
                            ...
                            <EditItemTemplate>
                                <asp:Label ID="lblID" runat="server" Text='<%# Eval("iEspecificacionID") %>'></asp:Label>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="lblID" runat="server" Text='<%# Bind("iEspecificacionID") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
