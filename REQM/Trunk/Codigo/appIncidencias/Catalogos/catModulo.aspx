<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/incidMaster.Master" CodeBehind="catModulo.aspx.vb" Inherits="appIncidencias.catModulo" %>
...
<table width="80%">
        <tr>
            <td>
                <asp:Label CssClass="Title" ID="lblTitle" runat="server" Text="Modulos"></asp:Label>
            </td>
        </tr>
        <tr>
            <td align="center">
                <asp:GridView ID="gvModulo" runat="server" AutoGenerateColumns="False" 
                    DataKeyNames="iModuloID" ShowFooter="True">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="ID" InsertVisible="False" 
                            SortExpression="iModuloID">
                            <EditItemTemplate>
                                <asp:Label ID="lblID" runat="server" Text='<%# Eval("iModuloID") %>'></asp:Label>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="lblID" runat="server" Text='<%# Bind("iModuloID") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                ...
                <a href="catModulo.aspx">catModulo.aspx</a></td>
        </tr>
    </table>
     </ContentTemplate>
    </asp:UpdatePanel>
