<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/incidMaster.Master" CodeBehind="catFuncionalidad.aspx.vb" Inherits="appIncidencias.catFuncionalidad" %>
...
<table width="80%">
        <tr>
            <td>
                <asp:Label CssClass="Title" ID="lblTitle" runat="server" Text="Funcionalidades"></asp:Label>
            </td>
        </tr>
        <tr>
            <td align="center">
                <asp:GridView ID="gvFuncionalidad" runat="server" AutoGenerateColumns="False" 
                    DataKeyNames="iFuncionalidadID" ShowFooter="True">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="ID" InsertVisible="False" 
                            SortExpression="iFuncionalidadID">
                            <EditItemTemplate>
                                <asp:Label ID="lblID" runat="server" Text='<%# Eval("iFuncionalidadID") %>'></asp:Label>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="lblID" runat="server" Text='<%# Bind("iFuncionalidadID") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Descripcion" SortExpression="vchDescripcion">
                            <EditItemTemplate>
                                <asp:TextBox ID="txtDescripcion" runat="server" 
                                    Text='<%# Bind("vchDescription") %>' ValidationGroup="Edit"></asp:TextBox>
                            ...
                            <ItemTemplate>
                                <asp:Label ID="lblDescripcion" runat="server" 
                                    Text='<%# Bind("vchDescription") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
