<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/incidMaster.Master"
    CodeBehind="catCasoUso.aspx.vb" Inherits="appIncidencias.catCasoUso" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table width="80%">
                <tr>
                    <td>
                        <asp:Label CssClass="Title" ID="lblTitle" runat="server" Text="Casos de Uso"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td align="center">
                        <asp:GridView ID="gvCasoUso" runat="server" AutoGenerateColumns="False" DataKeyNames="iCasoUsoID"
                            ShowFooter="True">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="ID" InsertVisible="False" SortExpression="iStausID">
                                    <EditItemTemplate>
                                        <asp:Label ID="lblID" runat="server" Text='<%# Eval("iCasoUsoID") %>'></asp:Label>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="lblID" runat="server" Text='<%# Bind("iCasoUsoID") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Nombre" SortExpression="vchNombre">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtNombre" runat="server" Text='<%# Bind("vchNombre") %>' ValidationGroup="Edit"></asp:TextBox>
                                    ...
                                    <FooterTemplate>
                                        <asp:TextBox ID="txtNombre" runat="server" Text='<%# Bind("vchNombre") %>' ValidationGroup="Footer"></asp:TextBox>
