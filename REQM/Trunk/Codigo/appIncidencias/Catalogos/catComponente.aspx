<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/incidMaster.Master" CodeBehind="catComponente.aspx.vb" Inherits="appIncidencias.catComponente" %>
...
<table width="80%">
        <tr>
            <td>
                <asp:Label CssClass="Title" ID="lblTitle" runat="server" Text="Componentes"></asp:Label>
            </td>
        </tr>
        <tr>
            <td align="center">
                <asp:GridView ID="gvComponente" runat="server" AutoGenerateColumns="False" 
                    DataKeyNames="iComponenteID" ShowFooter="True">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="ID" InsertVisible="False" 
                            ...
                            <EditItemTemplate>
                                <asp:Label ID="lblID" runat="server" Text='<%# Eval("iComponenteID") %>'></asp:Label>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="lblID" runat="server" Text='<%# Bind("iComponenteID") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
