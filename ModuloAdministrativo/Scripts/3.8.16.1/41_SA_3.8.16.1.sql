...
/****** Object:  StoredProcedure [dbo].[sp_tg_ExportManagement]    Script Date: 08/01/2011 17:24:33 ******/
...
BEGIN
	...
	VALUES('SA', GETDATE(), '3.8.16.1', 41, (SELECT  cast(SERVERPROPERTY('productversion') as varchar(50))))
END
ELSE
BEGIN 
	Update VersionBD  set MaximoConsecutivo = 41 where  Tipo = 'SA' and Version ='3.8.16.1'
END
GO