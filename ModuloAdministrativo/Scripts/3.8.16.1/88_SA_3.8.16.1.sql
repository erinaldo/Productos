...
/****** Object:  StoredProcedure [dbo].[up_ComisionesHistorico]    Script Date: 08/30/2011 12:25:55 ******/
...
BEGIN
	...
	VALUES('SA', GETDATE(), '3.8.16.1', 88, (SELECT  cast(SERVERPROPERTY('productversion') as varchar(50))))
END
ELSE
BEGIN 
	Update VersionBD  set MaximoConsecutivo = 88 where  Tipo = 'SA' and Version ='3.8.16.1'
END
