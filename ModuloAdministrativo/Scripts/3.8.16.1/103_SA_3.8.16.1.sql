...
/****** Object:  StoredProcedure [dbo].[sel_SurtidosDetalle]    Script Date: 09/13/2011 16:29:11 ******/
...
begin
        ...
        (select sum(Total) from (
			...
			inner join Route.dbo.Dia on VIS.DiaClave = Route.dbo.Dia.DiaClave 
			where TransProdID in (select TransProdId from ConsignasTransProd )
			and convert(datetime, convert(varchar(20), Route.dbo.Dia.FechaCaptura, 103), 103) = @Fecha
