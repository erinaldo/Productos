...
/****** Object:  StoredProcedure [dbo].[Gsp_NivelReporte]    Script Date: 08/26/2011 11:47:03 ******/
...
begin
	...
	begin
		...
		GROUP BY VEN.IdVendedor, TPVEN.TipoVendedor, VEN.ApPaterno, VEN.ApMaterno, VEN.Nombre, VEN.Nomina
		UNION 
		SELECT VEN.IdVendedor AS Número, TPVEN.TipoVendedor AS Tipo, VEN.ApPaterno + ' ' + VEN.ApMaterno + ' ' + VEN.Nombre AS [Nombre del Vendedor], 
		VEN.Nomina from 
		Ventas VTA 
...
BEGIN
	...
	VALUES('SA', GETDATE(), '3.8.16.1', 69, (SELECT  cast(SERVERPROPERTY('productversion') as varchar(50))))
END
ELSE
BEGIN 
	Update VersionBD  set MaximoConsecutivo = 69 where  Tipo = 'SA' and Version ='3.8.16.1'
END
GO
