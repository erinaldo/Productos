...
/****** Object:  StoredProcedure [dbo].[sel_ComisionesCalculo]    Script Date: 09/01/2011 12:02:36 ******/
...
BEGIN
	...
	VALUES('SA', GETDATE(), '3.8.16.1', 96, (SELECT  cast(SERVERPROPERTY('productversion') as varchar(50))))
END
ELSE
BEGIN 
	Update VersionBD  set MaximoConsecutivo = 96 where  Tipo = 'SA' and Version ='3.8.16.1'
END
