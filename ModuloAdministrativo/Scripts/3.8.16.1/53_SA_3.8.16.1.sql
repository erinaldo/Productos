...
/****** Object:  StoredProcedure [dbo].[up_Surtidos]    Script Date: 08/08/2011 15:43:51 ******/
...
BEGIN
	...
	VALUES('SA', GETDATE(), '3.8.16.1', 53, (SELECT  cast(SERVERPROPERTY('productversion') as varchar(50))))
END
ELSE
BEGIN 
	Update VersionBD  set MaximoConsecutivo = 53 where  Tipo = 'SA' and Version ='3.8.16.1'
END
GO
