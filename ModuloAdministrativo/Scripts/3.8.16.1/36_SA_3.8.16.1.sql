...
/****** Object:  StoredProcedure [dbo].[up_VentasDetalle]    Script Date: 07/30/2011 17:55:41 ******/
...
BEGIN
	...
	VALUES('SA', GETDATE(), '3.8.16.1', 36, (SELECT  cast(SERVERPROPERTY('productversion') as varchar(50))))
END
ELSE
BEGIN 
	Update VersionBD  set MaximoConsecutivo = 36 where  Tipo = 'SA' and Version ='3.8.16.1'
END
GO
