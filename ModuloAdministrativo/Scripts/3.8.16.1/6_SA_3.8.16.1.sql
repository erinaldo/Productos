...
/****** Object:  StoredProcedure [dbo].[Gsp_NivelReporte]    Script Date: 07/24/2011 18:24:41 ******/
...
BEGIN
	...
	VALUES('SA', GETDATE(), '3.8.16.1', 6, (SELECT  cast(SERVERPROPERTY('productversion') as varchar(50))))
END
ELSE
BEGIN 
	Update VersionBD  set MaximoConsecutivo = 6 where  Tipo = 'SA' and Version ='3.8.16.1'
END
GO