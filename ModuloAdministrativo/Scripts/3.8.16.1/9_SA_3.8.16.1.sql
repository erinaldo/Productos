...
/****** Object:  StoredProcedure [dbo].[sel_StatusRutas]    Script Date: 07/26/2011 14:21:47 ******/
...
BEGIN
	...
	VALUES('SA', GETDATE(), '3.8.16.1', 9, (SELECT  cast(SERVERPROPERTY('productversion') as varchar(50))))
END
ELSE
BEGIN 
	Update VersionBD  set MaximoConsecutivo = 9 where  Tipo = 'SA' and Version ='3.8.16.1'
END
GO