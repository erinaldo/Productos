...
/****** Object:  StoredProcedure [dbo].[up_Ventas]    Script Date: 07/30/2011 17:43:45 ******/
...
BEGIN
	...
	VALUES('SA', GETDATE(), '3.8.16.1', 35, (SELECT  cast(SERVERPROPERTY('productversion') as varchar(50))))
END
ELSE
BEGIN 
	Update VersionBD  set MaximoConsecutivo = 35 where  Tipo = 'SA' and Version ='3.8.16.1'
END
GO