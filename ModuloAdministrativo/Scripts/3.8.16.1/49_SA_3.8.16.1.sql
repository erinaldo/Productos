...
/****** Object:  StoredProcedure [dbo].[sel_ValidaDesc]    Script Date: 08/02/2011 18:06:01 ******/
...
BEGIN
	...
	VALUES('SA', GETDATE(), '3.8.16.1', 49, (SELECT  cast(SERVERPROPERTY('productversion') as varchar(50))))
END
ELSE
BEGIN 
	Update VersionBD  set MaximoConsecutivo = 49 where  Tipo = 'SA' and Version ='3.8.16.1'
END
GO