...
/****** Object:  StoredProcedure [dbo].[up_SurtidosDetalle]    Script Date: 07/25/2011 15:36:51 ******/
...
BEGIN
	...
	VALUES('SA', GETDATE(), '3.8.16.1', 11, (SELECT  cast(SERVERPROPERTY('productversion') as varchar(50))))
END
ELSE
BEGIN 
	Update VersionBD  set MaximoConsecutivo = 11 where  Tipo = 'SA' and Version ='3.8.16.1'
END
GO