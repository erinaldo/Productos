...
/****** Object:  StoredProcedure [dbo].[sp_tg_ExportManagement]    Script Date: 07/29/2011 12:48:31 ******/
...
BEGIN
	...
	VALUES('SA', GETDATE(), '3.8.16.1', 31,(SELECT  cast(SERVERPROPERTY('productversion') as varchar(50))))
END
ELSE
BEGIN 
	Update VersionBD  set MaximoConsecutivo = 31 where  Tipo = 'SA' and Version ='3.8.16.1'
END
GO
