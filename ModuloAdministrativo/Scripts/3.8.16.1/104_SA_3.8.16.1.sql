...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[CedisVirtuales]') AND type in (N'U'))
DROP TABLE [dbo].[CedisVirtuales]

CREATE TABLE [dbo].[CedisVirtuales](
	[IdCedis] [bigint] NOT NULL,
	[TipoRuta] [varchar](20) NOT NULL,
	[IdCedisVirtual] [varchar](10) NOT NULL,
...
BEGIN
	...
	VALUES('SA', GETDATE(), '3.8.16.1', 104, (SELECT  cast(SERVERPROPERTY('productversion') as varchar(50))))
END
ELSE
BEGIN 
	Update VersionBD  set MaximoConsecutivo = 104 where  Tipo = 'SA' and Version ='3.8.16.1'
END
GO