USE [Route]
GO
/****** Object:  StoredProcedure [dbo].[sp_tg_ExportManagement]    Script Date: 09/01/2011 10:52:36 ******/
...
BEGIN
	...
	VALUES('SA', GETDATE(), '3.8.16.1', 97, (SELECT  cast(SERVERPROPERTY('productversion') as varchar(50))))
END
ELSE
BEGIN 
	Update VersionBD  set MaximoConsecutivo = 97 where  Tipo = 'SA' and Version ='3.8.16.1'
END
