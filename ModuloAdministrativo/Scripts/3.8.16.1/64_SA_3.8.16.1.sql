...
/****** Object:  StoredProcedure [dbo].[up_VentasDevoluciones]    Script Date: 08/17/2011 23:02:02 ******/
...
BEGIN
	...
	VALUES('SA', GETDATE(), '3.8.16.1', 64, (SELECT  cast(SERVERPROPERTY('productversion') as varchar(50))))
END
ELSE
BEGIN 
	Update VersionBD  set MaximoConsecutivo = 64 where  Tipo = 'SA' and Version ='3.8.16.1'
END
GO