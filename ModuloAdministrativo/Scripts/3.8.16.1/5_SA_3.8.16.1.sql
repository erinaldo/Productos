...
/****** Object:  StoredProcedure [dbo].[sel_SurtidosDetalle]    Script Date: 07/24/2011 12:18:57 ******/
...
BEGIN
	...
	VALUES('SA', GETDATE(), '3.8.16.1', 5, (SELECT  cast(SERVERPROPERTY('productversion') as varchar(50))))
END
ELSE
BEGIN 
	Update VersionBD  set MaximoConsecutivo =5 where  Tipo = 'SA' and Version ='3.8.16.1'
END
GO