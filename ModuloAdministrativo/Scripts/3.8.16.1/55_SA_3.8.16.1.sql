...
/****** Object:  StoredProcedure [dbo].[sel_StatusRutas]    Script Date: 08/10/2011 14:41:03 ******/
...
BEGIN
	...
	VALUES('SA', GETDATE(), '3.8.16.1', 55, (SELECT  cast(SERVERPROPERTY('productversion') as varchar(50))))
END
ELSE
BEGIN 
	Update VersionBD  set MaximoConsecutivo = 55 where  Tipo = 'SA' and Version ='3.8.16.1'
END
GO
