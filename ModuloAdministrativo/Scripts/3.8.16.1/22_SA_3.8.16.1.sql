...
/****** Object:  StoredProcedure [dbo].[sel_SurtidosDetalle]    Script Date: 07/27/2011 13:54:37 ******/
...
begin
        ...
        (VentaCredito + VentaContado) as 'Venta', Consignacion as 'Consignación', Recuperacion as 'Recuperación',
        ...
        select Rejas.IdCedis, Rejas.IdProducto as 'Cve. Producto', Producto as 'Producto', Surtido as 'Carga', 0 as 'Venta', 0 as 'Consignación', 0 as 'Recuperación',
...
begin
        ...
        if @IdFamiliaRejas <> 0  -- producto reja
                ...
                0 as 'Venta', 0 as 'Consignación', 0 as 'Recuperación',
...
begin
        ...
        SELECT     SURDET.IdCedis, SURDET.IdProducto AS 'Cve. Prod.', PROD.Producto AS Producto, SURDET.Surtido AS Carga, 
                              ...
                              SURDET.Recuperacion as 'Recuperacion', SURDET.DevBuena AS 'Dev. Buena', SURDET.DevMala AS 'Dev. Mala', 
        ...
        SELECT     SURDET.IdCedis, SURDET.IdProducto AS 'Cve. Prod.', PROD.Producto AS Producto, SURDET.Surtido AS Carga, 
                              0 AS Venta, 0 as 'Consignacion', 0 as 'Recuperacion', SURDET.Devolucion AS 'Dev. Buena', 0 AS 'Dev. Mala', 
...
if @Opc = 7
	...
	isnull(sum(ventacontado + ventacredito), 0) as Venta, ISNULL(sum(consignacion),0) as Consignacion, ISNULL(sum(recuperacion),0) as Recuperacion,
...
BEGIN
	...
	VALUES('SA', GETDATE(), '3.8.16.1', 22, (SELECT  cast(SERVERPROPERTY('productversion') as varchar(50))))
END
ELSE
BEGIN 
	Update VersionBD  set MaximoConsecutivo = 22 where  Tipo = 'SA' and Version ='3.8.16.1'
END
GO