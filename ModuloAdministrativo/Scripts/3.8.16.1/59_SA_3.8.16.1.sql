...
/****** Object:  StoredProcedure [dbo].[sp_tg_ExportManagement]    Script Date: 08/17/2011 22:02:49 ******/
...
BEGIN
	...
	VALUES('SA', GETDATE(), '3.8.16.1', 59, (SELECT  cast(SERVERPROPERTY('productversion') as varchar(50))))
END
ELSE
BEGIN 
	Update VersionBD  set MaximoConsecutivo = 59 where  Tipo = 'SA' and Version ='3.8.16.1'
END
GO
