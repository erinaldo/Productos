...
/****** Object:  StoredProcedure [dbo].[sp_importVentasADM]    Script Date: 08/01/2011 17:06:57 ******/
	...
	BEGIN	
		...
		BEGIN
			...
			BEGIN
				...
				SET TipoFase = @TipoFase, FechaCancelacion = @FechaCancelacion, MUsuarioID = @USUId, MFechaHora = GETDATE()
...
BEGIN
	...
	VALUES('SA', GETDATE(), '3.8.16.1', 40,(SELECT  cast(SERVERPROPERTY('productversion') as varchar(50))))
END
ELSE
BEGIN 
	Update VersionBD  set MaximoConsecutivo = 40 where  Tipo = 'SA' and Version ='3.8.16.1'
END
GO