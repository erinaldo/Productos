...
/****** Object:  StoredProcedure [dbo].[up_Surtidos]    Script Date: 08/01/2011 16:41:30 ******/
...
BEGIN
	...
	VALUES('SA', GETDATE(), '3.8.16.1', 39, (SELECT  cast(SERVERPROPERTY('productversion') as varchar(50))))
END
ELSE
BEGIN 
	Update VersionBD  set MaximoConsecutivo = 39 where  Tipo = 'SA' and Version ='3.8.16.1'
END
GO