...
/****** Object:  StoredProcedure [dbo].[up_Ventas]    Script Date: 08/02/2011 09:50:47 ******/
...
BEGIN
	...
	VALUES('SA', GETDATE(), '3.8.16.1', 44, (SELECT  cast(SERVERPROPERTY('productversion') as varchar(50))))
END
ELSE
BEGIN 
	Update VersionBD  set MaximoConsecutivo = 44 where  Tipo = 'SA' and Version ='3.8.16.1'
END
GO
