...
/****** Object:  StoredProcedure [dbo].[up_ActualizaKardex]    Script Date: 07/25/2011 10:10:09 ******/
...
BEGIN
	...
	VALUES('SA', GETDATE(), '3.8.16.1', 7, (SELECT  cast(SERVERPROPERTY('productversion') as varchar(50))))
END
ELSE
BEGIN 
	Update VersionBD  set MaximoConsecutivo = 7 where  Tipo = 'SA' and Version ='3.8.16.1'
END
GO