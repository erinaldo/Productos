...
/****** Object:  StoredProcedure [dbo].[sp_tg_ExportManagement]    Script Date: 08/03/2011 16:11:20 ******/
...
BEGIN
	...
	VALUES('SA', GETDATE(), '3.8.16.1', 51, (SELECT  cast(SERVERPROPERTY('productversion') as varchar(50))))
END
ELSE
BEGIN 
	Update VersionBD  set MaximoConsecutivo = 51 where  Tipo = 'SA' and Version ='3.8.16.1'
END
GO