...
/****** Object:  StoredProcedure [dbo].[Gsp_NivelReporte]    Script Date: 08/29/2011 13:45:06 ******/
...
BEGIN
	...
	VALUES('SA', GETDATE(), '3.8.16.1', 90, (SELECT  cast(SERVERPROPERTY('productversion') as varchar(50))))
END
ELSE
BEGIN 
	Update VersionBD  set MaximoConsecutivo = 90 where  Tipo = 'SA' and Version ='3.8.16.1'
END
