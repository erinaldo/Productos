...
/****** Object:  StoredProcedure [dbo].[up_Pedidos]    Script Date: 08/17/2011 22:40:22 ******/
...
begin
	...
	values (@IdCedis, @IdSurtido, @IdTipoVenta, @Folio, @Serie, @FechaEntrega, @IdCliente, 0, 0, @IdSucursal, 0, @DiasCredito)	
...
BEGIN
	...
	VALUES('SA', GETDATE(), '3.8.16.1', 60, (SELECT  cast(SERVERPROPERTY('productversion') as varchar(50))))
END
ELSE
BEGIN 
	Update VersionBD  set MaximoConsecutivo = 60 where  Tipo = 'SA' and Version ='3.8.16.1'
END
GO
