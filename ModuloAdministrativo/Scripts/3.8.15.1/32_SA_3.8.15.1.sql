...
/****** Object:  StoredProcedure [dbo].[sel_Ventas]    Script Date: 08/08/2011 16:02:05 ******/
...
if @Opc = 1
	...
	Ventas.Subtotal as 'Subtotal', Ventas.DctoImp as 'Dcto.', Ventas.Iva as 'Impuestos', Ventas.Total as 'Total', isnull( ClienteSucursal.CodigoBarras, ' - ') as 'Código de Barras', isnull(ClienteSucursal.NombreSucursal, 0) as NombreSucursal, isnull(ClienteSucursal.IdSucursal, 0) as IdSucursal,
	...
	left outer join VentasDevolucion on VentasDevolucion.IdCedisD = Ventas.IdCedis and VentasDevolucion.IdSurtidoD = Ventas.IdSurtido 
