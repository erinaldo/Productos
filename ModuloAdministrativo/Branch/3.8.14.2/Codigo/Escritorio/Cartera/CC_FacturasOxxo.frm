...
Dim IdDocumento, IdTipoDocumento, CargoAbono, IdMovimiento, FechaMovimiento
    ...
    If MsgBox("¿ Deseas dar de Aplicar la Factura Global " & Trim(LstFacturasOxxo.SelectedItem) & " - " & CLng(LstFacturasOxxo.SelectedItem.ListSubItems(1)) & " del " & LstFacturasOxxo.SelectedItem.ListSubItems(2) & " ?", vbQuestion + vbYesNo, App.Title) = vbNo Then
        Exit Sub
    Else
    ...
    While Not Rs.EOF
        ...
        Rs.MoveNext
    Wend
    StrCmd = "execute up_FacturaOxxo " & CLng(LstDFacturasOxxo(0, LstFacturasOxxo.SelectedItem.Index - 1)) & ", " & LstDFacturasOxxo(11, LstFacturasOxxo.SelectedItem.Index - 1) & ", '" & Trim(LstFacturasOxxo.SelectedItem) & "', " & CLng(LstFacturasOxxo.SelectedItem.ListSubItems(1)) & ", '01/01/1900', 0, 0, '" & Usuario & "', 4"
    If Rs.State Then Rs.Close
    Rs.Open StrCmd, Cnn
...
Private Sub btnEliminar_Click()
    ...
    MousePointer = 11
    StrCmd = "execute up_FacturaOxxo " & CLng(LstDFacturasOxxo(0, LstFacturasOxxo.SelectedItem.Index - 1)) & ", " & LstDFacturasOxxo(11, LstFacturasOxxo.SelectedItem.Index - 1) & ", '" & Trim(LstFacturasOxxo.SelectedItem) & "', " & CLng(LstFacturasOxxo.SelectedItem.ListSubItems(1)) & ", '01/01/1900', 0, 0, '" & Usuario & "', 3"
    If Rs.State Then Rs.Close
    Rs.Open StrCmd, Cnn
    MuestraFacturas
    MousePointer = 0
...
On Error Resume Next
    ...
    If RsC.State Then RsC.Close
    RsC.Open StrCmd, Cnn
    RptFacturaOxxo.LblFolios.Caption = "ESTA FACTURA SUSTITUYE A LAS SIGUIENTES FACTURAS: " & Chr(13) & Chr(10)
    FoliosCount = 0
    While Not RsC.EOF
...
On Error Resume Next
    ...
    With CC_FacturasOxxoAlta
        ...
        If Month(DTPPeriodo.Value) = 12 Then
            .DTPFecha.MaxDate = CDate("31/" & Month(DTPPeriodo.Value) & "/" & Year(DTPPeriodo.Value))
        Else
...
On Error Resume Next
    ...
    LstDFacturasOxxo = GetDataLVL(Rs, LstFacturasOxxo, 1, 8, "0|0|0|9|9|9|9|0")
...
Dim j
    ...
    With CC_FacturasOxxoDetalle
        ...
        If Rs.State Then Rs.Close
        Rs.Open StrCmd, Cnn
        LstDFacturas = GetDataLVL(Rs, .LstFacturas, 1, 9, "0|0|0|9|9|9|9|9|3")
