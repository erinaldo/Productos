   ...
   Begin VB.Frame FrmOpt 
      ...
      Begin VB.Frame FrmDatos 
         ...
         Begin VB.CommandButton btnFacturas 
            ...
            Height          =   495
            Left            =   9720
            Picture         =   "CC_Movimientos.frx":2C05
            Style           =   1  'Graphical
            TabIndex        =   9
            Top             =   840
            Width           =   495
...
On Error Resume Next
    ...
    If MsgBox("¿ Está seguro que desea Importar la Cobranza de Vendedores ?" & Chr(13) & Chr(10) & "La validación puede tardar unos segundos, por favor espere...", vbQuestion + vbYesNo) = vbNo Then Exit Sub
...
On Error Resume Next
    If CmbDocumento.ListIndex > 0 Then
        ...
        TxtReferencia.Enabled = True 'IIf(Mid(LstDDocumento(0, CmbDocumento.ListIndex - 1), 1, 1) = "P", True, False)
        TxtReferenciaBancos.Enabled = True 'IIf(Mid(LstDDocumento(0, CmbDocumento.ListIndex - 1), 1, 1) = "P", True, False)
        ...
        If Rs.State Then Rs.Close
        Rs.Open StrCmd, Cnn
        LstDMovimientos = GetDataLVL(Rs, LstMovimientos, 1, 7, "0|0|0|0|0|9|0")
    Else
