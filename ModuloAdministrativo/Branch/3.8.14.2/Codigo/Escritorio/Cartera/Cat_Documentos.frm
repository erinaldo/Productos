...
Begin VB.Form Cat_Documentos 
   ...
   Begin VB.CommandButton btnActualizar 
      ...
      Height          =   855
      Left            =   1680
      Picture         =   "Cat_Documentos.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   46
      Top             =   7080
      Width           =   1215
   ...
   Begin VB.CommandButton btnNuevo 
      ...
      Height          =   855
      Left            =   360
      Picture         =   "Cat_Documentos.frx":038C
      Style           =   1  'Graphical
      TabIndex        =   45
      Top             =   7080
      Width           =   1215
   ...
   Begin VB.CommandButton btnImprimir 
      ...
      Height          =   855
      Left            =   4320
      Picture         =   "Cat_Documentos.frx":074D
      Style           =   1  'Graphical
      TabIndex        =   44
      Top             =   7080
      Visible         =   0   'False
   ...
   Begin VB.CommandButton btnEliminar 
      ...
      Height          =   855
      Left            =   3000
      Picture         =   "Cat_Documentos.frx":0A17
      Style           =   1  'Graphical
      TabIndex        =   43
      Top             =   7080
      Visible         =   0   'False
      ...
      Begin VB.Frame FrmOpt 
         ...
         Begin VB.Frame FrmOpc 
            ...
            Begin VB.CommandButton BtnDelete 
               ...
               Height          =   855
               Left            =   10920
               Picture         =   "Cat_Documentos.frx":0D8D
               Style           =   1  'Graphical
               TabIndex        =   16
               Top             =   240
               Visible         =   0   'False
            ...
            Begin VB.CommandButton BtnNew 
               ...
               Height          =   855
               Left            =   10080
               Picture         =   "Cat_Documentos.frx":10CB
               Style           =   1  'Graphical
               TabIndex        =   15
               Top             =   240
               Visible         =   0   'False
   ...
   End
End
Attribute VB_Name = "Cat_Documentos"
