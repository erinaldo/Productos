    ...
    Select Case Index
        ...
        Case 5:
            With CC_Cat_Documentos
                .Caption = "Control de Movimientos y Tipos de Movimientos"
                .Top = MenuCartera.Top + MenuCartera.Height
                .Left = MenuCartera.Left
                .Show
            End With
