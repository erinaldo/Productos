...
/****** Object:  StoredProcedure [dbo].[sel_SurtidosDetalle]    Script Date: 03/08/2011 09:27:57 ******/
...
/****** Object:  StoredProcedure [dbo].[sel_SurtidosDetalle]    Script Date: 03/08/2011 09:27:58 ******/
SET ANSI_NULLS OFF
GO
...
begin
	...
	select 99 as Tipo, 0 as Subtotal, 0 as Iva, sum(t.Total) as Total
		from (
		select distinct USU.Clave, ABN.ABNId, ABT.Importe as Total
