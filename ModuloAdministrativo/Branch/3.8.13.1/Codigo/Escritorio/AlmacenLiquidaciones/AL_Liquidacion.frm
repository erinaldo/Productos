...
On Error Resume Next
    ...
    StrCmd = "execute up_Ventas " & IdCedis & ", " & IdSurtido & ", " & LstDTipoVenta(0, cmbTipoVenta.ListIndex - 1) & ", " & _
            ...
            Usuario & "', " & IIf(LstDTipoVenta(0, cmbTipoVenta.ListIndex - 1) = 1 And ContadoGeneral, 4, 1)
    If Rs.State Then Rs.Close
    Rs.Open StrCmd, Cnn
    ...
    With AL_Facturas
        ...
        .Direccion = LstDClientes(14, LstClientes.SelectedItem.Index - 1)
...
'                If MsgBox("La información se perderá. ¿ Desea continuar ?", vbQuestion + vbYesNo, App.Title) = vbYes Then
            MousePointer = 11
                    ...
                    StrCmd = "execute up_Ventas " & IdCedis & ", " & IdSurtido & ", " & _
                            LstDFacturas(2, LstFacturas.SelectedItem.Index - 1) & ", " & _
                            LstDFacturas(4, LstFacturas.SelectedItem.Index - 1) & ", '" & LstDFacturas(3, LstFacturas.SelectedItem.Index - 1) & "', '" & FormatDate(Fecha) & "', 0, 0, '" & Usuario & "', 3"
                    If Rs.State Then Rs.Close
                    Rs.Open StrCmd, Cnn
...
On Error Resume Next
    ...
    With AL_Facturas
        ...
        .TxtCliente.Text = LstDFacturas(6, LstFacturas.SelectedItem.Index - 1) & " - " & LstDFacturas(7, LstFacturas.SelectedItem.Index - 1)
        .TxtRFC.Text = LstDFacturas(IIf(Not LstConfiguraLiquidacion(7), 17, 18), LstFacturas.SelectedItem.Index - 1)
        .TxtSucursal.Text = LstDFacturas(IIf(Not LstConfiguraLiquidacion(7), 15, 16), LstFacturas.SelectedItem.Index - 1) & " (CB: " & LstDFacturas(IIf(Not LstConfiguraLiquidacion(7), 11, 12), LstFacturas.SelectedItem.Index - 1) & ") " & LstDFacturas(IIf(Not LstConfiguraLiquidacion(7), 14, 15), LstFacturas.SelectedItem.Index - 1)
        .TxtListaPrecios.Text = LstDFacturas(IIf(Not LstConfiguraLiquidacion(7), 20, 21), LstFacturas.SelectedItem.Index - 1) & " - " & LstDFacturas(IIf(Not LstConfiguraLiquidacion(7), 21, 22), LstFacturas.SelectedItem.Index - 1)
        ...
        .RFC = LstDFacturas(IIf(Not LstConfiguraLiquidacion(7), 17, 18), LstFacturas.SelectedItem.Index - 1)
        .Nombre = LstDFacturas(IIf(Not LstConfiguraLiquidacion(7), 14, 15), LstFacturas.SelectedItem.Index - 1)
        .Tel = LstDFacturas(IIf(Not LstConfiguraLiquidacion(7), 19, 20), LstFacturas.SelectedItem.Index - 1)
        .Direccion = LstDFacturas(IIf(Not LstConfiguraLiquidacion(7), 18, 19), LstFacturas.SelectedItem.Index - 1)
...
On Error Resume Next
    ...
    LstDFacturas = GetDataLVL(RsC, LstFacturas, 3, IIf(Not LstConfiguraLiquidacion(7), 14, 15), IIf(Not LstConfiguraLiquidacion(7), "0|1|0|1|0|7|7|7|0|0|0|0", "0|1|0|1|0|7|7|7|7|0|0|0|0"))
End Sub
