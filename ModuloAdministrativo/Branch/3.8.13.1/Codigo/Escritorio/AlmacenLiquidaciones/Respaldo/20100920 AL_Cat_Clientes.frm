...
Begin VB.Form AL_Cat_Clientes 
   ...
   Begin VB.CommandButton btnActualizar 
      ...
      Height          =   495
      Left            =   2040
      Picture         =   "20100920 AL_Cat_Clientes.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   58
      Top             =   7800
      Width           =   1695
   ...
   Begin VB.CommandButton btnNuevo 
      ...
      Height          =   495
      Left            =   240
      Picture         =   "20100920 AL_Cat_Clientes.frx":0996
      Style           =   1  'Graphical
      TabIndex        =   57
      Top             =   7800
      Width           =   1695
   ...
   Begin VB.CommandButton btnImprimir 
      ...
      Height          =   495
      Left            =   5640
      Picture         =   "20100920 AL_Cat_Clientes.frx":1024
      Style           =   1  'Graphical
      TabIndex        =   60
      Top             =   7800
      Width           =   1695
   ...
   Begin VB.CommandButton btnEliminar 
      ...
      Height          =   495
      Left            =   3840
      Picture         =   "20100920 AL_Cat_Clientes.frx":173F
      Style           =   1  'Graphical
      TabIndex        =   59
      Top             =   7800
      Width           =   1695
   ...
   Begin TabDlg.SSTab SSTab 
      ...
      Begin VB.Frame FrmOpt 
         ...
         Begin VB.ComboBox Combo1 
            ...
            Height          =   360
            ItemData        =   "20100920 AL_Cat_Clientes.frx":1EDB
            Left            =   6600
            List            =   "20100920 AL_Cat_Clientes.frx":1EDD
            Style           =   2  'Dropdown List
            TabIndex        =   126
            Top             =   4920
            Visible         =   0   'False
      ...
      Begin VB.Frame FrmOpt 
         ...
         Begin VB.ComboBox CboCadena2 
            CausesValidation=   0   'False
            Height          =   360
            ItemData        =   "20100920 AL_Cat_Clientes.frx":1EDF
            Left            =   2880
            List            =   "20100920 AL_Cat_Clientes.frx":1EE1
            Style           =   2  'Dropdown List
            TabIndex        =   13
            Top             =   1800
            Width           =   2625
...
'
            StrCmd = "up_Sucursales " & IdCedis & ", " & IdRuta & ", " & IdCliente & ", '" & IdSucursal & "', '" & _
                    ...
                    Stat & "',0, '" & UCase(Trim(TxtDatos(27).Text)) & "'," & IIf(Nuevo, 1, 2)
            If Rs.State Then Rs.Close
            Rs.Open StrCmd, Cnn
...
On Error Resume Next
    Select Case Index
        Case 0 To 2: KeyAscii = itEntero(KeyAscii)
