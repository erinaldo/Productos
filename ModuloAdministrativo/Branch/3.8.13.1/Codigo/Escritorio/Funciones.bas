...
Global strImpFactPiezas, strImpFactSucursal, IdCedisUsuario
...
On Error GoTo Err_ValidaCierre:
        ...
        StrCmd = "execute sel_VentasContado " & IdCed & ", '" & FormatDate(FechaS) & "', 3"
        If RsC.State Then RsC.Close
        RsC.Open StrCmd, Cnn
        If Not RsC.EOF Then
            StrCmd = "execute sel_VentasContado " & IdCed & ", '" & FormatDate(FechaS) & "', 1"
            If RsC.State Then RsC.Close
            RsC.Open StrCmd, Cnn
            If RsC.EOF Then
...
Function Numeros_x_Letras(valor As Long) As String
    ...
    unidad = Array("", "Un ", "Dos ", "Tres ", "Cuatro ", "Cinco ", "Seis ", "Siete ", "Ocho ", "Nueve ", "Diez ", "Once ", "Doce ", "Trece ", "Catorce ", "Quince ", "Dieciseis ", "Diecisiete ", "Dieciocho ", "Diecinueve ")
