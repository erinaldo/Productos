...
/****** Object:  StoredProcedure [dbo].[sp_tg_exportManagement]    Script Date: 12/23/2010 09:44:26 ******/
							...
							if(@IdClienteContadoTmp is not null)
                             ...
                             begin
								...
								if not exists( select Folio from RouteADM.dbo.Ventas where IdCedis = @ClaveCEDI and IdSurtido = @Surtido and IdTipoVenta = @TipoVenta and Folio = @FolioN )
                             		exec RouteADM.dbo.up_VentasFactura @ClaveCEDI, @Surtido, @TipoVenta, @Folio, @SerieFactContado, @FolioN, @SerieN, 1 
                             end
