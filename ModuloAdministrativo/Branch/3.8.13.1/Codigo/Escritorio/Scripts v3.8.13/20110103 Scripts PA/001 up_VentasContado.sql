...
/****** Object:  StoredProcedure [dbo].[up_VentasContado]    Script Date: 01/03/2011 12:02:12 ******/
...
begin
	...
	update VentasContado set Folio = @Status, Serie = @Serie where IdCedis = @IdCedis and Fecha = @Fecha and Folio = @Folio 
