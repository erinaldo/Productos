...
/****** Object:  StoredProcedure [dbo].[up_Precios]    Script Date: 01/12/2011 15:55:32 ******/
...
begin
	...
	begin
		...
		if @Decimales = 1
			begin
				insert into ROUTE.dbo.tmp_PrecioProductoVig select cast( @Lista as varchar(10)), cast( @Producto as varchar(10)), 5, getdate(), cast( @Precio as decimal (10,5) ), 1, getdate(), null 
				insert into ROUTE.dbo.tmp_PrecioProductoVig select cast( @Lista as varchar(10)), cast( @Producto as varchar(10)), 7, getdate(), cast( @Precio as decimal (10,5) ), 1, getdate(), null 	
			end
		else		
		...
		begin
			...
			begin
				if @Decimales = 1
					begin
						insert into ROUTE.dbo.tmp_PrecioProductoVig select cast( @Lista as varchar(10)), cast( @Producto as varchar(10)), 5, getdate(), cast( @Precio  as decimal (10,5) ), 1, getdate(), null
						insert into ROUTE.dbo.tmp_PrecioProductoVig select cast( @Lista as varchar(10)), cast( @Producto as varchar(10)), 7, getdate(), cast( @Precio  as decimal (10,5) )*.001, 1, getdate(), null
					end
				else
						insert into ROUTE.dbo.tmp_PrecioProductoVig select cast( @Lista as varchar(10)), cast( @Producto as varchar(10)), 1, getdate(), cast( @Precio  as decimal (10,5) ), 1, getdate(), null
