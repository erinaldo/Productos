/****** Object:  StoredProcedure [dbo].[sp_importConsignacionesADM]    Script Date: 10/29/2010 13:37:48 ******/
SET ANSI_NULLS ON
GO
...
--SET @Opc = 1
	...
	BEGIN
		...
		BEGIN
			...
			SET @FolioRoute = Convert(varchar,@IdCedis) +  RIGHT('00000000' + convert(varchar,@Folio),8 ) --CONVERT(VARCHAR(8),@Folio)
