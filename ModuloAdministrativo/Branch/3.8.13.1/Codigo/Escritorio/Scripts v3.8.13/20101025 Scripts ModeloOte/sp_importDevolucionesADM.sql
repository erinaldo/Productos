/****** Object:  StoredProcedure [dbo].[sp_importDevolucionesADM]    Script Date: 10/29/2010 13:12:59 ******/
SET ANSI_NULLS ON
GO
...
GO
 ...
 --Description:	INTERFAZ DE ENTRADA DE DEVOLUCIONES DEL MODULO ADMINISTRATIVO A ROUTE
 --=============================================
ALTER PROCEDURE [dbo].[sp_importDevolucionesADM] 
@IdCedis as bigint,
@IdSurtido as bigint
