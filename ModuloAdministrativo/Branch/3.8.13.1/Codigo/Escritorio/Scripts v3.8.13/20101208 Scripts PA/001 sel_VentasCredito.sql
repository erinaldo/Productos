...
/****** Object:  StoredProcedure [dbo].[sel_VentasCredito]    Script Date: 12/08/2010 12:32:00 ******/
...
if @Opc = 1 -- Encabezado
	...
	VentasDetalle.Subtotal as SubtotalD, VentasDetalle.Cantidad*VentasDetalle.Precio*VentasDetalle.Iva as IvaD, VentasDetalle.Total as TotalD, Ventas.Serie 
	from Ventas 
...
if @Opc = 2 -- Detalle
	...
	VentasDetalle.Subtotal, VentasDetalle.Cantidad*VentasDetalle.Precio*VentasDetalle.Iva as Iva, VentasDetalle.Total
	from VentasDetalle 
	inner join Productos on Productos.IdProducto = VentasDetalle.IdProducto
