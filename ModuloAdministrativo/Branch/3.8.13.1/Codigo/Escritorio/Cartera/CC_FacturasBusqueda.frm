...
On Error GoTo Err_btnArchivo:
    ...
    LstDFacturas = GetDataLVL(Rs, LstFacturas, 2, 15, "0|0|4|0|0|0|4|0|0|0|0|3|3|3")
...
On Error Resume Next
    ...
    For i = 1 To LstFacturas.ListItems.Count
        If LstFacturas.ListItems(i).Checked Then
            If OptConsulta(1).Value Then
                strIds = strIds & " ( Ventas.IdCedis = " & LstDFacturas(0, i - 1) & " and Ventas.IdSurtido = " & LstDFacturas(16, i - 1) & " and Ventas.IdTipoVenta = " & LstDFacturas(1, i - 1) & " and Ventas.Serie = ''" & LstDFacturas(6, i - 1) & "'' and Ventas.Folio = " & LstDFacturas(7, i - 1) & ") or "
                strFolios = strFolios & "Ced" & IdCedis & LstDFacturas(6, i - 1) & "-" & LstDFacturas(7, i - 1) & ", "
            Else
                strIds = strIds & "''" & LstDFacturas(16, i - 1) & "'', "
                strFolios = strFolios & "Ced" & IdCedis & "PedT" & LstDFacturas(16, i - 1) & ", "
            End If
        End If
    Next
...
On Error Resume Next
    ...
    For i = 1 To LstFacturas.ListItems.Count
        If LstFacturas.ListItems(i).Checked Then
            SubTotal = SubTotal + CDbl(LstDFacturas(13, LstFacturas.ListItems(i).Index - 1))
            Iva = Iva + CDbl(LstDFacturas(14, LstFacturas.ListItems(i).Index - 1))
            Total = Total + CDbl(LstDFacturas(15, LstFacturas.ListItems(i).Index - 1))
            j = j + 1
        End If
        If LstFacturas.ListItems(i).Checked Then
            ConteoRegistrosChecados = ConteoRegistrosChecados + 1
