        ...
        Case "MODELOORIENTE":
            With CC_RptFacturaModelo
                ...
                If ChkImpresion(3) Then
                    Select Case OptCons
                    Case 1, 2:
                        StrCmd = "exec up_FacturasImpresion '" & strIds & "', '" & Trim(TxtFolio.Text) & "', '" & Usuario & "', " & OptCons
                        If Rs.State Then Rs.Close
                        Rs.Open StrCmd, Cnn
                    Case 5:
                        StrCmd = "exec up_FacturasImpresion '''C" & Format(IdCedis, "00") & "Ped" & Format(IdPedido, "000000000") & "''', '" & Trim(TxtFolio.Text) & "', '" & Usuario & "', " & OptCons
                        If Rs.State Then Rs.Close
                        Rs.Open StrCmd, Cnn
                    Case 0
