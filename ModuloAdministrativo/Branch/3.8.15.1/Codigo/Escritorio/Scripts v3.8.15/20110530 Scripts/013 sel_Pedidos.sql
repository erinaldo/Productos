...
/****** Object:  StoredProcedure [dbo].[sel_Pedidos]    Script Date: 06/07/2011 10:09:49 ******/
...
begin 
	...
	Pedidos.IdSurtido, Pedidos.Serie, Pedidos.Folio, ISNULL(case Trp.TipoFase when ''0'' then ''B'' when null  then '''' else ''E'' end,'''') as Emitida
	from Pedidos
