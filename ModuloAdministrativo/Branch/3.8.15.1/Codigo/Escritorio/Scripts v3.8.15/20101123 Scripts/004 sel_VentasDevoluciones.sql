...
/****** Object:  StoredProcedure [dbo].[sel_VentasDevoluciones]    Script Date: 11/24/2010 10:03:11 ******/
...
begin
	...
	VentasDetalle.Cantidad as 'Cantidad', isnull(VenDev.Cantidad,0) as Devolucion, ISNULL(VenDev2.Cantidad,0) as OtrasDev, isnull(VenDev.Cantidad,0) + ISNULL(VenDev2.Cantidad,0) as TotalDev,
