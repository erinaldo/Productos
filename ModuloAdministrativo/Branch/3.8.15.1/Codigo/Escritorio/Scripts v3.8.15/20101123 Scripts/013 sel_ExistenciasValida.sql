...
/****** Object:  StoredProcedure [dbo].[sel_ExistenciaValida]    Script Date: 11/26/2010 21:03:45 ******/
...
begin
        ...
        select Productos.IdProducto, Producto, isnull(Surtido - DevBuena - DevMala - Obsequios - VentaContado - VentaCredito,0) as 'Existencia', Productos.Iva, Decimales
        from Productos 
