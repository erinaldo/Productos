...
/****** Object:  StoredProcedure [dbo].[Rep_Movimientos]    Script Date: 04/03/2011 17:30:21 ******/
...
begin
	...
	order by Anticipos.FolioAnticipo, MovimientosFacturas.CargoAbono, MovimientosFacturas.IdTipoDocumento, Ventas.IdCliente, Ventas.Serie, Ventas.Folio 
end
