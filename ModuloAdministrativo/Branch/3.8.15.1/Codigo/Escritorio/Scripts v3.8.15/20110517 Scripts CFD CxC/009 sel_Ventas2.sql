...
/****** Object:  StoredProcedure [dbo].[sel_Ventas2]    Script Date: 05/18/2011 04:10:48 ******/
...
begin
	...
	isnull(FacturasOxxo.SerieOX,'') as SerieOX, isnull(FacturasOxxo.FolioOX,0) as FolioOX, Ventas.Status, Ventas.Login, ClienteSucursal.RFC 
	from Ventas 	
