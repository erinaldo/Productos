...
/****** Object:  StoredProcedure [dbo].[sel_VentasContadoReporte]    Script Date: 05/03/2011 12:51:01 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[sel_VentasContadoReporte]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[sel_VentasContadoReporte]
GO
...
CREATE PROCEDURE [dbo].[sel_VentasContadoReporte]
@IdCedis as bigint,
@IdSurtido as bigint,
