...
/****** Object:  StoredProcedure [dbo].[sel_ExistenciaValidaDev]    Script Date: 05/03/2011 16:35:12 ******/
...
begin
		...
		isnull(VentasDetalle.Subtotal, 0) as 'Subtotal', isnull(abs(VentasDetalle.Cantidad)*VentasDetalle.Precio*VentasDetalle.Iva, 0) as 'Impuestos', 
