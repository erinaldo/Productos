...
Private Sub btnNueva_Click()
    ...
    StrCmd = "execute up_FacturaOxxo " & IdCedis & ", 2, '" & TxtSerie.Text & "', " & TxtFolio.Text & ", '" & FormatDate(DTPFecha.Value) & "', " & CLng(LstClientes.SelectedItem) & ", " & TxtDiasCredito.Text & ", '" & Usuario & "', " & IIf(CFDCedis = "1", 2, 1)
...
Err_AltaFOxxo:
    ...
    If Err.Number = -2147217873 Then
        ...
        StrCmd = "select  isnull ( max ( folio )+1, 1)  from Ventas where IdCedis = " & IdCedis & " and IdTipoVenta = 2 and Serie = '" & SerieOxxo & "'"
        If Rs.State Then Rs.Close
        Rs.Open StrCmd, Cnn
        If Not Rs.EOF Then
