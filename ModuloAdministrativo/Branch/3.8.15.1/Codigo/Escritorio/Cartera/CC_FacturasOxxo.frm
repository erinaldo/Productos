...
On Error GoTo Err_FacturaGlobal:
    ...
    If Not IsNull(LstFacturasOxxo.SelectedItem) Then
        ...
        Else
            ...
            StrFoliosImpresos = StrFoliosImpresos & Trim(LstFacturasOxxo.SelectedItem) & "-" & CLng(LstDFacturasOxxo.SelectedItem(1)) & ", "
            
            StrSql1 = StrSql1 & " ( Ventas.IdCedis = " & CLng(LstDFacturasOxxo(0, LstFacturasOxxo.SelectedItem.Index - 1)) & " and Ventas.IdTipoVenta = " & CLng(LstDFacturasOxxo(13, LstFacturasOxxo.SelectedItem.Index - 1)) & " and Ventas.Serie = ''" & Trim(LstFacturasOxxo.SelectedItem) & "'' and Ventas.Folio = " & CLng(LstDFacturasOxxo.SelectedItem.SubItems(1)) & " ) or "
            StrSql2 = StrSql2 & " ( VentasDetalle.IdCedis = " & CLng(LstDFacturasOxxo(0, LstFacturasOxxo.SelectedItem.Index - 1)) & " and VentasDetalle.IdTipoVenta = " & CLng(LstDFacturasOxxo(13, LstFacturasOxxo.SelectedItem.Index - 1)) & " and VentasDetalle.Serie = ''" & Trim(LstFacturasOxxo.SelectedItem) & "'' and VentasDetalle.Folio = " & CLng(LstDFacturasOxxo.SelectedItem.SubItems(1)) & " ) or "
            StrSql3 = StrSql3 & " ( FacturasOxxo.IdCedisOX = " & CLng(LstDFacturasOxxo(0, LstFacturasOxxo.SelectedItem.Index - 1)) & " and FacturasOxxo.IdTipoVentaOX = " & CLng(LstDFacturasOxxo(13, LstFacturasOxxo.SelectedItem.Index - 1)) & " and FacturasOxxo.SerieOX = ''" & Trim(LstFacturasOxxo.SelectedItem) & "'' and FacturasOxxo.FolioOX = " & CLng(LstDFacturasOxxo.SelectedItem.SubItems(1)) & " ) or "
        End If
        ImpCount = ImpCount + 1
    Else
        Exit Sub
