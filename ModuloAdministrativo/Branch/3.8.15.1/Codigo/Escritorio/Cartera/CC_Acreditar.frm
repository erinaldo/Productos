...
Begin VB.Form CC_Acreditar 
   BackColor       =   &H00FFFFFF&
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "Acreditación de CxC"
   ClientHeight    =   3585
   ClientLeft      =   45
   ClientTop       =   315
   ClientWidth     =   8475
   ...
   Begin VB.ComboBox cmbStatus 
      Height          =   360
      ItemData        =   "CC_Acreditar.frx":0000
      Left            =   3720
      List            =   "CC_Acreditar.frx":000D
   ...
   End
End
Attribute VB_Name = "CC_Acreditar"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Public IdCedis, IdTipoVenta, Folio, Serie, VentanaFacturas As Boolean
Public Fecha As Date, Mes
...
'    End If
    ...
    StrCmd = "execute up_VentasAcredita " & IdCedis & ", " & IdTipoVenta & _
    ", '" & Folio & "', '" & Serie & "', '" & FormatDate(Fecha) & "', '" & Usuario & _
    "', '" & FormatDate(Fecha) & "', '" & Trim(TxtFolioE.Text) & "', '" & Trim(TxtObservaciones.Text) & _
...
On Error Resume Next
    ...
    StrCmd = "execute sel_VentasAcredita " & IdCedis & ", " & IdTipoVenta & ", '" & Serie & "', '" & Folio & "', 1"
    If Rs.State Then Rs.Close
    Rs.Open StrCmd, Cnn
    If Not Rs.EOF Then
...
Function ValidaDatosAcreditacion() As Boolean
    ...
    StrCmd = "execute sel_VentasAcreditaValida " & IdCedis & ", " & IdTipoVenta & ", '" & Serie & "', '" & Folio & "', 1"
    If Rs.State Then Rs.Close
    Rs.Open StrCmd, Cnn
    If Not Rs.EOF Then
