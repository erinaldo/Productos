...
Private Sub GroupFooter1_Format()
    ...
    StrCmd = "execute sel_SurtidosDetalle " & IdCedi & ", '" & FormatDate(FldFechaCorta.Text) & "', " & FldSurtido.Text & ", 0, 16"
    ...
    If Not RsC3.EOF Then
        ...
        SubRptConceptos.object.DataSrcDET.Recordset = RsC3
    End If
...
'    End If
    ...
    If LstConfiguraLiquidacion(0) <> "N" Then
        StrCmd = "execute sel_ComisionesLiquidacion " & IdCedi & ", " & FldSurtido.Text & ", '" & FormatDate(FldFechaCorta) & "', '" & FormatDate(FldFechaCorta) & "'"
