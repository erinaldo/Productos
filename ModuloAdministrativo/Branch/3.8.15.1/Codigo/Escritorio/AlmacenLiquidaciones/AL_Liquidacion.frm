...
On Error GoTo Err_DelFact:
    ...
    Else
        If Not IsEmpty(LstFacturas) Then
            ...
            If MsgBox("¿ Está seguro que desea Eliminar la Venta " & LstDFacturas(3, LstFacturas.SelectedItem.Index - 1) & " - " & LstDFacturas(4, LstFacturas.SelectedItem.Index - 1) & " del Cliente " & Chr(13) & Chr(10) & LstDFacturas(7, LstFacturas.SelectedItem.Index - 1) & " por " & FormatCurrency(LstDFacturas(10, LstFacturas.SelectedItem.Index - 1), 2, vbTrue) & " ?", vbQuestion + vbYesNo, App.Title) = vbYes Then
