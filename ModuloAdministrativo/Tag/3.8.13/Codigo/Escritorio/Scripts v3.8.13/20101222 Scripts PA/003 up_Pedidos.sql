...
/****** Object:  StoredProcedure [dbo].[up_Pedidos]    Script Date: 12/22/2010 11:44:41 ******/
...
begin
	...
	insert into Ventas values (@IdCedis, @IdSurtido, @IdTipoVenta, @Folio, @Serie, @FechaEntrega, @IdCliente, 0, 0, @IdSucursal, @DiasCredito)	
