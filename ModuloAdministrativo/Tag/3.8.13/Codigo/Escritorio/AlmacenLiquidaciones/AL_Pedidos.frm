...
On Error GoTo Err_ImportaPedido:
    ...
    StrCmd = "execute up_Pedidos " & IdCedis & ", " & IdPedido & ", " & LstDPedidos(2, LstPedidos.SelectedItem.Index - 1) & ", '" & _
            ...
            FormatDate(CDate(LstDPedidos(8, LstPedidos.SelectedItem.Index - 1))) & "', '" & LstDPedidos(7, LstPedidos.SelectedItem.Index - 1) & "', " & IdCliente & ", '" & IdSucursal & "', " & IdSurtido & ", '', 0, 3"
    If Rs.State Then Rs.Close
    Rs.Open StrCmd, Cnn
