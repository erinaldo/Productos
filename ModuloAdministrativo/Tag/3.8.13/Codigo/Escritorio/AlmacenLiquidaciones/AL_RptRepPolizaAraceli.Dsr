...
Private Sub ActiveReport_Activate()
    ...
    Set SubRptVentasContado.object = New AL_RptRepPolizaAraceliVentaContado
End Sub
...
On Error Resume Next
    ...
    StrCmd = "execute sel_PolizaAraceli " & IdCedis & ", '" & FormatDate(FldFechaPoliza.Text) & "',  '" & FormatDate(FldFechaPoliza.Text) & "', 5"
    If RsC3.State Then RsC3.Close
    RsC3.Open StrCmd, Cnn
    If Not RsC3.EOF Then
        SubRptVentasContado.Visible = True
        SubRptVentasContado.object.DataSrc.DataSourceName = Cnn
        SubRptVentasContado.object.DataSrc.Recordset = RsC3
    Else
        SubRptVentasContado.Visible = False
    End If
