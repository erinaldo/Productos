...
Private Sub btnNueva_Click()
    ...
    MousePointer = 11
    StrCmd = "execute up_FacturaOxxo " & IdCedis & ", 2, '" & TxtSerie.Text & "', 0, '" & IIf(BIdioma = "us_english", Format(DTPFecha.Value, "mm/dd/yyyy"), Format(DTPFecha.Value, "dd/mm/yyyy")) & "', " & CLng(LstClientes.SelectedItem) & ", '" & Usuario & "', 1"
