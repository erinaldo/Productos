...
Begin VB.Form CSG_Consignas 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton cmdAccion 
         ...
         Index           =   2
         Left            =   3840
         Picture         =   "CSG_Consignas.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   36
         Top             =   7320
         Width           =   1695
      ...
      Begin VB.CommandButton cmdAccion 
         ...
         Index           =   1
         Left            =   2070
         Picture         =   "CSG_Consignas.frx":05FE
         Style           =   1  'Graphical
         TabIndex        =   3
         Top             =   7320
         Width           =   1695
      ...
      Begin VB.CommandButton cmdAccion 
         ...
         Index           =   4
         Left            =   5580
         Picture         =   "CSG_Consignas.frx":0F94
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   7320
         Width           =   1695
      ...
      Begin VB.CommandButton cmdAccion 
         ...
         Index           =   0
         Left            =   240
         Picture         =   "CSG_Consignas.frx":16AF
         Style           =   1  'Graphical
         TabIndex        =   1
         Top             =   7320
         Width           =   1695
   ...
   End
End
Attribute VB_Name = "CSG_Consignas"
...
Const ctEditaConsignaSurtido = "Editar los Detalles de la Liquidación"
...
Sub HabilitaObjetos(TipoMovimiento As String, Accion As String)
    ...
    For i = 0 To 3: cmdAccion(i).Enabled = False: Next
...
Sub LimpiaObjetos(TipoMovimiento As String, Accion As String)
    ...
    RutaSurtidoRegistro = IIf(IdSurtidoEntrega = 0, "", "Liquidación " & Format(IdSurtidoEntrega, "0000000") & " - Ruta " & IdRutaEntrega)
    RutaSurtidoDevolucion = IIf(IdSurtidoDevolucion = 0, "", "Liquidación " & Format(IdSurtidoDevolucion, "0000000") & " - Ruta " & IdRutaDevolucion)
        ...
        Case 1          'caso de guardar nueva consigna o cambios a una consigna
            ...
            Select Case vAccionConsigna
                ...
                Case ctEditaConsignaSurtido
                    ...
                    If MsgBox("Se registrarán las movimientos de la consigna para la ruta " & IdRutaEntrega & ", Liquidación " & IdSurtidoEntrega & ", ¿ Desea continuar ?", vbQuestion + vbYesNo + vbDefaultButton1, App.Title) = vbNo Then Exit Sub
                
                Case ctDevolverConsigna
                
                    If MsgBox("Se registrarán las ventas de la consigna para la ruta " & IdRutaDevolucion & ", Liquidación " & IdSurtidoDevolucion & ", ¿ Desea continuar ?", vbQuestion + vbYesNo + vbDefaultButton1, App.Title) = vbNo Then Exit Sub
            ...
            Select Case vAccionConsigna
                Case ctNuevaConsigna
                    'insertar los datos de la consigna (cliente y Liquidación)
                ...
                Case ctEditaConsignaSurtido
                    'Aplica la captura de productos de la consigna en el Liquidación de la ruta y en el inventario
                    IdRutaEntrega = IdRutaConsigna
                    IdSurtidoEntrega = IdSurtidoConsigna
                ...
                Case ctDevolverConsigna
                    ...
                    StrCmd = "execute sel_Consignas " & IdCedis & ", " & IdConsigna & ", 0, '', 6"
                    If Rs.State Then Rs.Close
                    Rs.Open StrCmd, Cnn
                    If Not Rs.EOF Then
                        MousePointer = 0
                        If MsgBox("Existe Producto Pendiente por Devolver. " & Chr(13) & Chr(10) & _
                        "¿ Deseas que el producto se registre como devolución ?", vbQuestion + vbYesNo, App.Title) = vbYes Then
                            StrCmd = "execute up_Consignas " & IdCedis & ", " & IdConsigna & ", 0, '',0,0,'',0, 0, 0, '19000101',0,0,'','','',4"
                            If RsC.State Then RsC.Close
                            RsC.Open StrCmd, Cnn
                        Else
                            MousePointer = 0
                            MsgBox "¡ Complete la Devolución del producto !", vbInformation + vbOKOnly, App.Title
                            Exit Sub
                        End If
                    End If
        ...
        Case 0      'caso de Folio
            ...
            If KeyAscii = "13" Then
                ...
                Select Case vTipoEdicionConsigna
                    ...
                    Case 2      'caso de cambios en el Liquidación de la consigna
                        vTipoMovimiento = ctTipoMovimientoSalida
                        ''IdRutaDevolucion = 0: IdSurtidoDevolucion = 0
                        vAccionConsigna = ctEditaConsignaSurtido
                ...
                Select Case vAccionConsigna
                    ...
                    Case ctEditaConsignaSurtido     'caso de registro de entrega de consigna
                        ...
                        If ValFaltante Then
                            ...
                            'agrega o actualiza la cantidad del Liquidación de la consigna, se debe considerar el precio de venta al cliente
            ...
            If Trim(TxtDatos(5).Text) <> "" Then
                ...
                Select Case vAccionConsigna
                    ...
                    Case ctEditaConsignaSurtido     'caso de registro de entrega de consigna
                        ...
                        'checar el sig query, para que solo tome el Liquidación y devoluciones originales de
