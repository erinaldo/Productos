...
On Error GoTo Err_CancelaPromocion:
    ...
    If MsgBox("¡ Al Cancelar el Movimiento se dará de Baja el Acuerdo para los Cedis seleccionados !. ¿ Desea continuar ?", vbQuestion + vbYesNo, App.Title) = vbNo Then Exit Sub
