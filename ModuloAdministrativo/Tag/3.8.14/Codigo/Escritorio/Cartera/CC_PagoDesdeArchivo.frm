        ...
        If Insertado Then
            ...
            Else
                ...
                Else
                    ...
                    If Rs.EOF Then
                        TxtNoCargados.Text = TxtNoCargados.Text & Linea & "  , Motivo: La Factura no existe." & Chr(13) & Chr(10)
                        Print #NfPagosNo, Linea & ", Motivo: La Factura no existe."
                        TotalNoCargados = TotalNoCargados + 1
                    Else
                        If Rs.Fields(7) = 0 And CargoA = "A" Then
                            TxtNoCargados.Text = TxtNoCargados.Text & Linea & "  , Motivo: La Factura no tiene Saldo pendiente de Aplicar." & Chr(13) & Chr(10)
                            Print #NfPagosNo, Linea & ", Motivo: La Factura no tiene Saldo pendiente de Aplicar."
                            TotalNoCargados = TotalNoCargados + 1
                        Else
                            ...
                            If CDbl(Saldo) < (CDbl(Datos(7)) + CDbl(Datos(8))) And CargoA = "A" Then
                                ...
                                TxtNoCargados.Text = TxtNoCargados.Text & Linea & "  , Aviso: El Pago fue mayor al Saldo de la Factura. Se Aplicó un abono por " & Saldo & ", Aplicado " & Chr(13) & Chr(10)
                                Print #NfPagosNo, Linea & ", Aviso: El Pago fue mayor al Saldo de la Factura. Se Aplicó un abono por, " & Saldo & ", Aplicado "
