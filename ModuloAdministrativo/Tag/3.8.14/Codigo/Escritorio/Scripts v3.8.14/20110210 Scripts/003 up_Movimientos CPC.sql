...
/****** Object:  StoredProcedure [dbo].[up_Movimientos]    Script Date: 02/10/2011 12:47:42 ******/
...
begin
	...
	insert into Movimientos values (@IdCedis, @IdMovimiento, @Fecha, @IdDocumento, @CargoAbono, 0, @Referencia, @ReferenciaBancos, @Observaciones, @Status, @Login, getdate() )
end
