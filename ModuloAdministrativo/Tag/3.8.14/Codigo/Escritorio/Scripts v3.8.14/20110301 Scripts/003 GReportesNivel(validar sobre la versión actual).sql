...
/****** Object:  StoredProcedure [dbo].[Gsp_NivelReporte]    Script Date: 03/08/2011 09:02:54 ******/
...
begin 
	...
	begin
		...
		left(CS.NombreCorto,60) NombreSucursal, FAC.Folio as Folio, sum(ABT.Importe) as Total 
		...
		and ABN.MUsuarioID not in (''10000'') 
