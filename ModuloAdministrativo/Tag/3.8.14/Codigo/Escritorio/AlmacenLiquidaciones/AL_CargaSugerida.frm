...
Begin VB.Form AL_CargaSugerida 
   ...
   Begin VB.Frame FrmOpt 
      ...
      Begin VB.CommandButton btnImprimir 
         ...
         Height          =   495
         Left            =   8400
         Picture         =   "AL_CargaSugerida.frx":0710
         Style           =   1  'Graphical
         TabIndex        =   18
         Top             =   360
         Width           =   1695
   ...
   Begin VB.Frame FrmOpt 
      ...
      Begin VB.CommandButton btnCalculaC 
         ...
         Height          =   495
         Left            =   9240
         Picture         =   "AL_CargaSugerida.frx":0E2B
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   240
         Width           =   1455
   ...
   Begin VB.Frame FrmOpt 
      ...
      Begin VB.CommandButton btnCalcular 
         ...
         Height          =   495
         Left            =   9120
         Picture         =   "AL_CargaSugerida.frx":1395
         Style           =   1  'Graphical
         TabIndex        =   20
         Top             =   720
         Width           =   1455
...
Dim Opc
    ...
    If Opc = 5 Then
        StrCmd = "execute sel_CargasSugeridas " & IdCedis & ", " & IdRuta & ", '" & FormatDate(AL_CargaSugerida.DTPFecha.Value) & "', 0, 6"
        If Rs.State Then Rs.Close
        Rs.Open StrCmd, Cnn
    End If
