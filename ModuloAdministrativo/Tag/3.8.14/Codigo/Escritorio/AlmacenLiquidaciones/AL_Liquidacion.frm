...
On Error GoTo Err_AplicaC:
    ...
    If MsgBox("¿ Está seguro que desea Aplicar la Liquidación " & IIf(LstSurtidos.SelectedItem Is Nothing, "", LstSurtidos.SelectedItem) & " ?. " & Chr(13) & Chr(10) & "Una vez Aplicada no podrá modificarla. ", vbQuestion + vbYesNo, App.Title) = vbNo Then
        Exit Sub
    End If
