...
MousePointer = 11
    ...
    Select Case SSTab.Tab
        Case 0:
            ...
            MousePointer = 0
            MsgBox "¡ El Documento: " & LstDEntradas(3, LstEntradas.SelectedItem.Index - 1) & " (" & IIf(LstDEntradas(8, LstEntradas.SelectedItem.Index - 1) = "S", "Salida", "Entrada") & ") ha sido Aplicado !", vbInformation + vbOKOnly, App.Title
