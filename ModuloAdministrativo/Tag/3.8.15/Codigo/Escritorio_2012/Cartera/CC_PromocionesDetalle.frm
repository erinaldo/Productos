...
Begin VB.Form CC_PromocionesDetalle 
   ...
   Begin VB.OptionButton OptDetalle 
      BackColor       =   &H00FFFFFF&
      Caption         =   "Ventas que NO Aplicaron el Acuerdo"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   8.25
         Charset         =   0
   ...
   Begin VB.OptionButton OptDetalle 
      BackColor       =   &H00FFFFFF&
      Caption         =   "Ventas con Aplicación de Acuerdo"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   8.25
         Charset         =   0
   ...
   Begin VB.Frame FrmDatos 
      ...
      Begin VB.Label Label2 
         Alignment       =   1  'Right Justify
         BackColor       =   &H00FFFFFF&
         Caption         =   "Número de Ventas Afectadas"
         BeginProperty Font 
            Name            =   "Arial"
            Size            =   9
            Charset         =   0
...
On Error GoTo btnImprimeDetallePromocion:
    With CC_RptPromocionesDetalle
        ...
        .LblTitulo.Caption = IIf(OptDetalle(0).Value, "Detalle de Aplicación de Acuerdos", "Detalle de Ventas que NO Aplicaron el Acuerdo")
        .LblDatos.Caption = ""
        .IdPromo = IdPromocionD
        '.LblCedis.Caption = LstDCedis(0, cmbCedis.ListIndex - 1) & " - " & LstDCedis(1, cmbCedis.ListIndex - 1)
        
        StrCmd = "execute sel_PromocionesAplicadasDetalle " & IdAplicacionD & ", " & IdPromocionD & ", " & IIf(OptDetalle(0).Value, 0, 1)
...
On Error Resume Next
    ...
    If Rs.State Then Rs.Close
    Rs.Open StrCmd, Cnn
    LstDDetalle = GetDataLVL(Rs, LstDetalle, 1, 12, "0|0|0|0|0|0|0|0|0|9|9|0")
    
    StrCmd = "execute sel_PromocionesAplicadasDetalle " & IdAplicacionD & ", " & IdPromocionD & ", " & IIf(OptDetalle(0).Value, 2, 3)
    If Rs.State Then Rs.Close
    Rs.Open StrCmd, Cnn
    If Not Rs.EOF Then
