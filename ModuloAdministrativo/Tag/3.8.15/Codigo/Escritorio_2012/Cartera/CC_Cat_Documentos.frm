...
On Error Resume Next
    If Opcion = 1 Or Opcion = 2 Then
        ...
        If SSTab.Tab = 1 Then
            ...
            StrCmd = "execute up_DocumentosTipo '" & IdDoc & "', '" & Trim(TxtIdDocD.Text) & "', '" & CargoAbono & "', '" & Trim(TxtNombreD.Text) & "', " & IIf(ChkCFD.Value, 1, 0) & ", '" & IIf(CmbStatusD.ListIndex = 1, "A", "B") & "', " & Opcion
            If RsC.State Then RsC.Close
            RsC.Open StrCmd, Cnn
...
Private Sub LstDocumentos_ItemClick(ByVal item As MSComctlLib.ListItem)
On Error Resume Next
...
Private Sub LstTipoDoc_ItemClick(ByVal item As MSComctlLib.ListItem)
On Error Resume Next
    ...
    ChkCFD.Value = IIf(LstDTipoDoc(3, LstTipoDoc.SelectedItem.Index - 1) = "NO", 0, 1)
    CmbStatusD.ListIndex = IIf(UCase(Trim(LstDTipoDoc(4, LstTipoDoc.SelectedItem.Index - 1))) = "ACTIVO", 1, 2)
End Sub
...
On Error Resume Next
    ...
    Select Case SSTab.Tab
        Case 0:
            MuestraDocumentos
            LstDocumentos_ItemClick LstDocumentos.SelectedItem
            LlenaCombos
        Case 1:
            MuestraTipos
            LstTipoDoc_ItemClick LstTipoDoc.SelectedItem
            LlenaStatusD
    End Select
End Sub
...
On Error Resume Next
    ...
    If RsC.State Then RsC.Close
    RsC.Open StrCmd, Cnn
    LstDTipoDoc = GetDataLVL(RsC, LstTipoDoc, 1, 4, "0|0|0|0")
End Sub
