...
Dim SerieN, FolioN
    ...
    Dim z As Integer, clienteid As String
    'obtener el primer idcliente seleccionado del list view
    For z = 1 To LstClientes.ListItems.Count
        If LstClientes.ListItems(z).Checked Then
            clienteid = LstClientes.ListItems(z).SubItems(2)
            Exit For
        End If
    Next
    
    If Not ValidaMetodosDePago(clienteid, IdCedis) Then Exit Sub
    ...
    If CFDCedis = "1" Then
        ...
        If (bPorFacturar) Then
            ...
            With CC_MetodoPago
                ...
                .lblIDCliente.Caption = clienteid
                .Show vbModal
            End With
            
            If Not Facturar Then Exit Sub
        ...
        Actividad = 1
         ...
         For i = 1 To LstFacturas.ListItems.Count
            If LstFacturas.ListItems(i).Checked Then
                ...
                Else
                    StrCmd = "execute up_VentasFactura " & LstDFacturas(0, i - 1) & ", " & LstDFacturas(1, i - 1) & ", " & LstDFacturas(6, i - 1) & ", '" & LstDFacturas(5, i - 1) & "', 0, '', '" & metodoPago & "','" & banco & "','" & numCta & "', " & Actividad & ", 1"
                    If Rs.State Then Rs.Close
                    Rs.Open StrCmd, Cnn
