...
Begin VB.Form CC_Movimientos2 
   ...
   Begin VB.Frame FrmOpt 
      ...
      Begin VB.CommandButton btnActualizar 
         ...
         Height          =   495
         Left            =   3600
         Picture         =   "CC_Movimientos2.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   7680
         Width           =   1575
      ...
      Begin VB.Frame FrmDatos 
         ...
         Begin VB.CommandButton btnFacturas 
            ...
            Height          =   495
            Left            =   10800
            Picture         =   "CC_Movimientos2.frx":0996
            Style           =   1  'Graphical
            TabIndex        =   29
            Top             =   240
            Width           =   495
      ...
      Begin VB.CommandButton btnNuevo 
         ...
         Height          =   495
         Left            =   240
         Picture         =   "CC_Movimientos2.frx":0DAA
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   7680
         Width           =   1575
      ...
      Begin VB.CommandButton btnEliminar 
         ...
         Height          =   495
         Left            =   1920
         Picture         =   "CC_Movimientos2.frx":1438
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   7680
         Width           =   1575
      ...
      Begin VB.CommandButton btnAplica 
         ...
         Height          =   495
         Left            =   5280
         Picture         =   "CC_Movimientos2.frx":1B48
         Style           =   1  'Graphical
         TabIndex        =   11
         Top             =   7680
         Width           =   1575
      ...
      Begin VB.CommandButton btnImprimeFactura 
         ...
         Height          =   495
         Left            =   6960
         Picture         =   "CC_Movimientos2.frx":21DF
         Style           =   1  'Graphical
         TabIndex        =   12
         Top             =   7680
         Width           =   1575
   ...
   End
End
Attribute VB_Name = "CC_Movimientos2"
