...
Dim Encabezado
    ...
    For i = 1 To LstFacturas.ListItems.Count
        If LstFacturas.ListItems(i).Checked Then
            StrCmd = "execute up_FacturasOxxo " & Encabezado & ", " & LstDFacturas(0, LstFacturas.ListItems(i).Index - 1) & ", " & LstDFacturas(16, LstFacturas.ListItems(i).Index - 1) & ", '" & LstDFacturas(1, LstFacturas.ListItems(i).Index - 1) & "', " & LstDFacturas(2, LstFacturas.ListItems(i).Index - 1) & ", '" & Usuario & "', 1"
            If Rs.State Then Rs.Close
            Rs.Open StrCmd, Cnn
        End If
    Next
    
    StrCmd = "execute up_FacturaOxxo " & IdCedisOX & ", " & IdTipoVentaOX & ", '" & SerieOX & "', " & FolioOX & ", '01/01/1900', 0, 0, '','','', '" & Usuario & "', 5"
    If Rs.State Then Rs.Close
    Rs.Open StrCmd, Cnn
...
Private Sub LstFacturas_DblClick()
    On Error Resume Next
    DetalleDeFactura LstDFacturas(0, LstFacturas.SelectedItem.Index - 1), LstDFacturas(16, LstFacturas.SelectedItem.Index - 1), LstDFacturas(1, LstFacturas.SelectedItem.Index - 1), LstDFacturas(2, LstFacturas.SelectedItem.Index - 1), Top, Left, Width, Height, 0
End Sub
...
On Error Resume Next
    ...
    For i = 1 To LstFacturas.ListItems.Count
        If LstFacturas.ListItems(i).Checked Then
            SubTotal = SubTotal + CDbl(LstFacturas.ListItems(i).ListSubItems(7))
            Iva = Iva + CDbl(LstFacturas.ListItems(i).ListSubItems(8))
            Total = Total + CDbl(LstFacturas.ListItems(i).ListSubItems(9))
            j = j + 1
        End If
    Next
