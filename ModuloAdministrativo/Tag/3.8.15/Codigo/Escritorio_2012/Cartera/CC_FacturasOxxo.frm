...
Private Sub btnEliminar_Click()
    ...
    End If
        ...
        If Not RsC.EOF Then
            ...
            If Not IsNull(RsC.Fields(8)) And RsC.Fields(8) <> "" Then
...
On Error Resume Next
    ...
    If Not ValidaMetodosDePago(LstCadenas.SelectedItem.Text, IdCedis) Then Exit Sub
    ...
    With CC_FacturasOxxoAlta
        ...
        .SerieOxxo = SerieOxxo
        .lblIDCliente = LstCadenas.SelectedItem.Text
