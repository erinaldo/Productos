VERSION 5.00
Begin {82282820-C017-11D0-A87C-00A0C90F29FC} CC_RptMovimiento2 
   Caption         =   "Reporte de Movimientos a Ventas"
   ClientHeight    =   11460
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   18960
   Icon            =   "CC_RptMovimiento2.dsx":0000
   StartUpPosition =   2  'CenterScreen
   WindowState     =   2  'Maximized
   _ExtentX        =   33443
   _ExtentY        =   20214
   SectionData     =   "CC_RptMovimiento2.dsx":08CA
End
Attribute VB_Name = "CC_RptMovimiento2"
