...
On Error Resume Next
    ...
    If Accion = 1 Then
        ...
        Unload Me
    Else
        AL_Liquidacion.IdCargaSugerida = LstDCargas(4, LstCargas.SelectedItem.Index - 1)
        AL_Liquidacion.TipoCargaSugerida = LstDCargas(3, LstCargas.SelectedItem.Index - 1)
        Unload Me
    End If
...
Private Sub Form_Load()
    Select Case Accion
        Case 1: MuestraCargasAnteriores
        Case 2: MuestraCargasDisponibles
    End Select
End Sub
...
On Error Resume Next
    ...
    StrCmd = "execute sel_CargasSugeridas " & IdCedis & ", " & IdRuta & ", '19000101', 0, " & Opc & ", 7"
    If Rs.State Then Rs.Close
    Rs.Open StrCmd, Cnn
    LstDCargas = GetDataLVL(Rs, LstCargas, 0, 1, "0|0")
End Sub

Sub MuestraCargasDisponibles()
On Error Resume Next

    StrCmd = "execute sel_CargasSugeridasFolio " & IdCedis & ", '" & FormatDate(Fecha) & "', " & IdRuta & ", '', 2"
    If Rs.State Then Rs.Close
    Rs.Open StrCmd, Cnn
    LstDCargas = GetDataLVL(Rs, LstCargas, 4, 7, "6|6|6|0")
End Sub
