...
Begin VB.Form Cat_Precios 
   ...
   Begin TabDlg.SSTab SSTab 
      ...
      TabPicture(0)   =   "Cat_Precios.frx":0000
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "LblOpt(0)"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).Control(1)=   "FrmOpt(3)"
      Tab(0).Control(1).Enabled=   0   'False
      Tab(0).ControlCount=   2
      TabCaption(1)   =   "Precios y Productos"
      TabPicture(1)   =   "Cat_Precios.frx":001C
      ...
      TabPicture(2)   =   "Cat_Precios.frx":0038
