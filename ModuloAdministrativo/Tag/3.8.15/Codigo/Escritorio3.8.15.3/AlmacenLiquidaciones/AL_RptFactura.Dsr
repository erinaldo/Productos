VERSION 5.00
Begin {82282820-C017-11D0-A87C-00A0C90F29FC} AL_RptFactura 
   Caption         =   "Imprimir Venta"
   ClientHeight    =   11460
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   18960
   Icon            =   "AL_RptFactura.dsx":0000
   StartUpPosition =   2  'CenterScreen
   WindowState     =   2  'Maximized
   _ExtentX        =   33443
   _ExtentY        =   20214
   SectionData     =   "AL_RptFactura.dsx":08CA
End
Attribute VB_Name = "AL_RptFactura"
...
Private Sub Detail_Format()
    STotal = STotal + DataSrc.Recordset.Fields(20).Value
End Sub
