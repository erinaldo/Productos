...
On Error Resume Next
    ...
    Select Case Index
        Case 0:
            If Not ValidaModulo("FGLOB", True) Then Exit Sub
        ...
        Case 1:
            ...
            With CC_Movimientos
                .Caption = "Aplicación de Movimientos a Ventas"
                .Top = MenuCartera.Top + MenuCartera.Height
                .Left = MenuCartera.Left
                .Show
                .ZOrder (0)
        ...
        Case 2:
            If Not ValidaModulo("ACUE", True) Then Exit Sub
            With CC_Promociones
                .Left = MenuCartera.Left
                .Top = MenuCartera.Top + MenuCartera.Height
                .Show
        ...
        Case 6:
            ...
            With CC_FacturasBusqueda
                .Caption = "Consulta e Impresión de Ventas y/o Facturas"
                .Left = MenuCartera.Left
                .Top = MenuCartera.Top + MenuCartera.Height
                .Show
                .ZOrder (0)
