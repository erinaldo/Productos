...
Begin VB.Form Cat_Usuarios 
   ...
   Begin TabDlg.SSTab SSTab 
      ...
      TabPicture(0)   =   "Cat_Usuarios.frx":0000
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "LblOpt(3)"
      Tab(0).Control(1)=   "FrmOpt(2)"
      Tab(0).ControlCount=   2
      TabCaption(1)   =   "Cedis"
      TabPicture(1)   =   "Cat_Usuarios.frx":001C
      ...
      TabPicture(2)   =   "Cat_Usuarios.frx":0038
      ...
      TabPicture(3)   =   "Cat_Usuarios.frx":0054
   ...
   End
End
Attribute VB_Name = "Cat_Usuarios"
