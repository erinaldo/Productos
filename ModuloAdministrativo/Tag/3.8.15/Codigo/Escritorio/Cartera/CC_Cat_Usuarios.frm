...
On Error Resume Next
    ...
    StrCmd = "execute up_Usuarios 999, '" & UCase(TxtLogin.Text) & "', '" & IIf(Trim(TxtPassword.Text) <> "password", Trim(TxtPassword.Text), Passw) & "', '" & UCase(TxtNombre.Text) & "', '" & UCase(TxtApPaterno.Text) & "', '" & UCase(TxtApMaterno.Text) & "', '" & IIf(CmbTipoUsuario.ListIndex = 1, "A", "B") & "', " & Opcion
