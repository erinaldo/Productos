VERSION 5.00
Begin {82282820-C017-11D0-A87C-00A0C90F29FC} CC_RptVentasLey 
   Caption         =   "Reporte de Ventas CASA LEY"
   ClientHeight    =   11460
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   16935
   Icon            =   "CC_RptVentasLey.dsx":0000
   StartUpPosition =   2  'CenterScreen
   WindowState     =   2  'Maximized
   _ExtentX        =   29871
   _ExtentY        =   20214
   SectionData     =   "CC_RptVentasLey.dsx":08CA
End
Attribute VB_Name = "CC_RptVentasLey"
