...
/****** Object:  StoredProcedure [dbo].[up_VendedoresSaldosValida]    Script Date: 01/18/2011 15:06:35 ******/
...
/****** Object:  StoredProcedure [dbo].[up_VendedoresSaldosValida]    Script Date: 01/18/2011 15:06:36 ******/
SET ANSI_NULLS ON
GO
...
begin
	...
	select @Financiado = 0	
	select @Financiado = SUM(VSFD.Monto)
