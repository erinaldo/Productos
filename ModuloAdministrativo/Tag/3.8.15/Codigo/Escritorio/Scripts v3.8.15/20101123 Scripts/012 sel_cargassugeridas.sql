...
/****** Object:  StoredProcedure [dbo].[sel_CargasSugeridas]    Script Date: 11/26/2010 19:21:17 ******/
...
begin
	...
	, InventarioKardex.Teorico - ISNULL(sum(SurDet.Surtido),0) as 'Inv. Final', (InventarioKardex.Teorico - ISNULL(sum(SurDet.Surtido),0)) * Conversion as 'Inv. FinalK',
