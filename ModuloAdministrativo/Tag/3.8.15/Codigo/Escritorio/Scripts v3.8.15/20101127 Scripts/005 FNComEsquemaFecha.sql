...
/****** Object:  UserDefinedFunction [dbo].[FN_ComisionesEsquemaFecha]    Script Date: 11/29/2010 15:13:43 ******/
...
AS  
	...
	(
		...
		sum(Total) * isnull(ComVendM.Porcentaje,0) as AbonoMerma, sum(Total) * isnull(ComVendV.Porcentaje,0) as AbonoVolumen
		from Surtidos
