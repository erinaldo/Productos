...
--create table tempComisiones(IdCedis bigint, FechaFinal datetime, IdVendedor bigint, Nomina varchar(20), Vendedor varchar(200), 
...
begin
	...
	where VS.IdCedis = @IdCedi and VS.IdVendedor = @IdVendedor and VS.Fecha between  @FechaInicial  and  @FechaFinal  		
	...
	select @IdCedi, @FechaFinal, @IdVendedor, @Nomina, @Vendedor, @VentaTotal, @Comision, @AbonoMerma, @AbonoVolumen, @CargoMerma, @SaldoVendedor, @TotalPago, 
