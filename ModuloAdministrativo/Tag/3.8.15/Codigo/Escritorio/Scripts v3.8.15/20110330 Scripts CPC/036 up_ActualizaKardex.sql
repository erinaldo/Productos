...
/****** Object:  StoredProcedure [dbo].[up_ActualizaKardex]    Script Date: 04/04/2011 11:57:20 ******/
...
begin
	...
	select VentasDetalle.IdCedis, VentasDetalle.IdSurtido, VentasDetalle.IdProducto, @Fecha, 0,0,0,0,0,0, AVG(VentasDetalle.Precio), AVG(VentasDetalle.Iva) 
	from VentasDetalle 
