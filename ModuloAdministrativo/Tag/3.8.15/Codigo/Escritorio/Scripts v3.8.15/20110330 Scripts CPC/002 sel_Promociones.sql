...
/****** Object:  StoredProcedure [dbo].[sel_Promociones]    Script Date: 03/30/2011 15:37:52 ******/
...
if @Opc = 1
	...
	case Cascada when 1 then 'S' else 'N' end as Cascada, 
	case Otras when 1 then 'S' else 'N' end as Otras, 
	case Ventas when 1 then 'S' else 'N' end as Ventas, 
	Login, FechaEdicion 
	from Promociones
