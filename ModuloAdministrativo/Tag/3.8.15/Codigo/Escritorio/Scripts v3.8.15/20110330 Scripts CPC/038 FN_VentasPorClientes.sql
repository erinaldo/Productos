...
/****** Object:  UserDefinedFunction [dbo].[FN_VentasPorCliente]    Script Date: 04/05/2011 23:36:58 ******/
...
AS  
	...
	where Ventas.Fecha between @fechainicial and @fechafinal and Ventas.IdCedis = @IdCedis and Ventas.Serie not in (select Serie from FacturacionGlobal)
