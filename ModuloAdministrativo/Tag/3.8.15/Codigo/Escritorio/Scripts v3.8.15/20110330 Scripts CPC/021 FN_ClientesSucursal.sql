...
/****** Object:  UserDefinedFunction [dbo].[FN_ClienteSucursal]    Script Date: 03/31/2011 21:43:24 ******/
...
(
	...
	where IdSucursal like '%' + @IdSucursal + '%' and NombreSucursal like '%' + @NombreSucursal + '%' 
	and ( Clientes.IdCliente like '%' + @Cliente + '%' or Clientes.RazonSocial like '%' + @Cliente + '%' ) 
)
