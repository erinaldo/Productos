...
/****** Object:  StoredProcedure [dbo].[sp_importDatoFiscalCPC]    Script Date: 06/06/2011 12:25:13 ******/
...
declare @idSucursal as varchar(20)
		...
		delete from [Route].[dbo].[TRPVtaAcreditada] where TransProdID = @TransprodIdFactura 
