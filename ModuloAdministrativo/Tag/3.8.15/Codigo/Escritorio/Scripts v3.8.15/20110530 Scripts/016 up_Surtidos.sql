...
/****** Object:  StoredProcedure [dbo].[up_Surtidos]    Script Date: 06/07/2011 10:20:24 ******/
...
begin
	...
	exec Route.dbo.SP_CancelarVentas @IdCedis, @IdSurtido, @Fecha, @IdRuta, @ClaveUsuario
	...
	delete from VentasFacturaCFD where IdCedis = @IdCedis and IdSurtido = @IdSurtido
	...
	delete from VentasPromociones where IdCedis = @IdCedis and IdSurtido = @IdSurtido
