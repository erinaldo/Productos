...
/****** Object:  StoredProcedure [dbo].[sel_FacturasBusqueda]    Script Date: 05/26/2011 17:18:49 ******/
...
begin
	...
	isnull(Trp.Folio,''N'') as Facturada, isnull(Trp.FechaFacturacion, '''') as ''F. Impresión'', 
	...
	left outer join Route.dbo.TransProd Trp on Trp.TransProdId = VentasFacturaCFD.TransProdId and Trp.Tipo = 8
