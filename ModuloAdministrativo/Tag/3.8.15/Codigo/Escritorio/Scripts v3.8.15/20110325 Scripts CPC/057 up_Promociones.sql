...
/****** Object:  StoredProcedure [dbo].[up_Promociones]    Script Date: 03/27/2011 23:12:03 ******/
...
if @Opc = 1 
begin
	insert into promociones values (@IdPromocion, @Nombre, @Observaciones, @FechaInicial, @FechaFinal, @IdDocumento, @IdTipoDocumento, 'A', @Login, GETDATE())
end
