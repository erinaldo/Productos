...
/****** Object:  StoredProcedure [dbo].[sel_Sucursales]    Script Date: 06/22/2011 10:06:27 ******/
...
--		end as Status, 
		...
		ISNULL(SUC.DiasCredito, 0) as 'Dias Crédito', ISNULL(SUC.LimiteCredito, 0) as 'Crédito', isnull(SUC.CRTienda, '') as CRTienda 
