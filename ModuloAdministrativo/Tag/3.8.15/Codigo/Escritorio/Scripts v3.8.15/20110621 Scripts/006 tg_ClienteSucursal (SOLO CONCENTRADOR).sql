...
-- inserta domicilio de entrega
	...
	update ROUTE.dbo.ClienteDomicilio 
		...
		Colonia = I.Colonia, Localidad = I.Localidad, Poblacion = I.Poblacion, Entidad = I.Entidad, Pais = I.Pais, GLN = left(TDA_GLN,13), CRTienda = left(I.CRTienda,5), NombreTienda=left(I.NombreSucursal,30)
...
-- inserta domicilio fiscal
	...
	update ROUTE.dbo.ClienteDomicilio 
		...
		Colonia = I.ColoniaF, Localidad = I.LocalidadF, Poblacion = I.PoblacionF, Entidad = I.EntidadF, Pais = I.PaisF, GLN = '', CRTienda = '', NombreTienda=''
	from ROUTE.dbo.ClienteDomicilio as CD, Inserted as I
	where ClienteClave = cast (case IdCedis when 1 then 'A' 
			when 2 then 'B' 
			when 3 then 'C' 
