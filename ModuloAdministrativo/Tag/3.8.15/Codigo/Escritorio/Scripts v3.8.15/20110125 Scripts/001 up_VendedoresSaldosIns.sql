/****** Object:  StoredProcedure [dbo].[up_VendedoresSaldosIns]    Script Date: 01/25/2011 11:09:50 ******/
...
begin
			...
			where IdCedis = @IdCedis and IdVendedor = @IdVendedor and IdTipoSaldo = 'EF' and ( Fecha < @Fecha or (IdSurtido <> @IdSurtido and Fecha = @Fecha))
			...
			if not exists(select IdVendedor from VendedoresSaldos where IdCedis = @IdCedis and IdVendedor = @IdVendedor and Fecha = @Fecha and IdTipoSaldo = 'EF' and IdSurtido = @IdSurtido )
