...
/****** Object:  StoredProcedure [dbo].[sel_PedidosDetalle]    Script Date: 05/03/2011 16:55:58 ******/
...
if @Opc = 1
	...
	((PedidosDetalle.Cantidad * PedidosDetalle.Precio ) - PedidosDetalle.DctoImp )* PedidosDetalle.Iva as 'Impuestos', PedidosDetalle.Total as 'Total'
	from PedidosDetalle
...
if @Opc = 2
begin
        select Productos.IdProducto, Producto, isnull(Cantidad,0), isnull(Entregado,0), isnull(DctoPorc,0), 
        isnull(DctoImp,0), 0 as Impuestos, --Productos.Iva, 
        Decimales
        from Productos 
