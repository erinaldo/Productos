...
select P.IdProducto as 'Clave', P.CodBarras as 'C. Barras', P.PRODUCTO as 'Producto', dbo.FN_CalculaImpuestos(0,0,0,P.IdProducto) as Impuestos, P.CONVERSION as 'Conversion', isnull(M.MARCA, 'Sin Marca') as 'Marca', isnull(G.Grupo, 'Sin Grupo') as 'Grupo', isnull(F.FAMILIA, 'Sin Familia') as 'Familia', isnull(S.SubFamilia, 'Sin SubFamilia') as 'SubFamilia', isnull(r.presentacion, 'Sin Presentación') as 'Presentación', F.FechaAlta,
case P.Status 
        when 'A' then 'Activo'
        else 'Baja'
        end as 'Estatus',
