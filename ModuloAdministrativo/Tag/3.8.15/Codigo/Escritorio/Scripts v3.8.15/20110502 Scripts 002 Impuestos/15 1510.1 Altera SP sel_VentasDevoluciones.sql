...
/****** Object:  StoredProcedure [dbo].[sel_VentasDevoluciones]    Script Date: 05/03/2011 16:38:49 ******/
...
begin
	...
	((abs(VentasDetalle.Cantidad) * VentasDetalle.Precio ) - VentasDetalle.DctoImp )* VentasDetalle.Iva as 'Impuestos', VentasDetalle.Total as 'Total'
	from VentasDetalle
