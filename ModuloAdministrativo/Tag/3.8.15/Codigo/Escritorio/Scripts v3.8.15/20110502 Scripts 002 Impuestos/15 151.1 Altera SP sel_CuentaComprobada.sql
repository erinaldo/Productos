...
/****** Object:  StoredProcedure [dbo].[sel_CuentaComprobada]    Script Date: 05/03/2011 16:32:17 ******/
...
begin
	...
	select 0 as Orden, 'TOTAL VENTAS DE CONTADO' as Concepto, isnull(SUM(VEND.Cantidad * PreciosDetalle.Precio * (1+(dbo.FN_CalculaImpuestos(0,0,0,Productos.IdProducto)))),0) as Total
	from Ventas VEN
	...
	select 1 as Orden, 'COBRANZA A CLIENTES' as Concepto, isnull(sum(ABN.Total),0) + isnull((select sum(MOVF.Total) 
