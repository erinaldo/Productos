...
/****** Object:  StoredProcedure [dbo].[up_TransferenciaContenedor]    Script Date: 05/16/2011 12:20:09 ******/
...
AS
	...
	(Select IdPedido from [Contenedor].[RouteADM].DBO.Pedidos Where IdCedis = @IdCedis and FechaPedido Between (getdate()-7) and (getdate()+7)) 
	...
	Where IdCedis = @IdCedis and FechaPedido Between (getdate()-7) and (getdate()+7) 
	...
	from  PedidosImpuestos where IdCedis = @IdCedis and cast(IdPedido as varchar(10))+'-'+cast(IdTipoVenta as varchar(10))+'-'+
	cast(IdProducto as varchar(10)) not in (Select cast(IdPedido as varchar(10))+'-'+cast(IdTipoVenta as varchar(10))+'-'+
	cast(IdProducto as varchar(10)) from [Contenedor].[RouteADM].DBO.PedidosDetalle where IdCedis = @IdCedis)
	...
	from  PedidosPromociones where IdCedis = @IdCedis and cast(IdPedido as varchar(10))+'-'+cast(IdTipoVenta as varchar(10))+'-'+
	cast(IdProducto as varchar(10)) not in (Select cast(IdPedido as varchar(10))+'-'+cast(IdTipoVenta as varchar(10))+'-'+
	cast(IdProducto as varchar(10)) from [Contenedor].[RouteADM].DBO.PedidosDetalle where IdCedis = @IdCedis)
