...
(Select IdCorto from [Contenedor].[RouteADM].DBO.VendedoresSaldosFinancia Where IdCedis = @IdCedis and Fecha Between (getdate()-7) and (getdate()+7)) 
Delete from [Contenedor].[RouteADM].DBO.VendedoresSaldosFinancia
Where IdCedis = @IdCedis and Fecha Between (getdate()-7) and (getdate()+7) 
...
from VendedoresSaldosFinancia Where IdCedis = @IdCedis and Fecha Between (getdate()-7) and (getdate()+7) 
