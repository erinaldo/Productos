...
/****** Object:  StoredProcedure [dbo].[up_Surtidos]    Script Date: 11/18/2010 09:26:28 ******/
...
begin
	...
	delete from VendedoresCargosAbonos where IdCedis = @IdCedis and Fecha in ( select Fecha 
		from Surtidos where IdCedis = @IdCedis and IdSurtido = @IdSurtido )
	
	delete from VendedoresSaldosFinancia where IdCedis = @IdCedis and IdSurtido = @IdSurtido 
	delete from VendedoresSaldosFinanciaD where IdCedis = @IdCedis and IdSurtido = @IdSurtido 
