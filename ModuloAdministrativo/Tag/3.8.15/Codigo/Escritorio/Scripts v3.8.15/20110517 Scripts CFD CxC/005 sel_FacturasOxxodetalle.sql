...
/****** Object:  StoredProcedure [dbo].[sel_FacturasOxxoDetalle]    Script Date: 05/18/2011 03:34:49 ******/
...
--	if @CedisOx <> cast(@IdCedis as varchar(5)) set @SerieOxxo = 'OX' + ltrim(rtrim( cast(@IdCedis as varchar(5)) ))
	...
	where ( Ventas.Fecha between @FechaInicial and @FechaFinal and Ventas.Serie <> @SerieOxxo and Ventas.Serie <> 'FG' and Ventas.Saldo > 0 
