...
Dim LstExistenciaDia, LstStatusSurtido
    Dim FechaVacia As Date
    'Se cambia la validacion porque daba error en algunos equipos con formatos distintos
    If FechaSel = FechaVacia Then FechaSel = UltimoDia
