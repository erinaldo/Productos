VERSION 5.00
Begin {82282820-C017-11D0-A87C-00A0C90F29FC} AL_RptRepCambios 
   Caption         =   "Cambios Físicos"
   ClientHeight    =   11430
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   18960
   ...
   _ExtentX        =   33443
   _ExtentY        =   20161
   SectionData     =   "AL_RptRepCambios.dsx":0000
End
Attribute VB_Name = "AL_RptRepCambios"
