...
Dim MARCA, GRUPO, FAMILIA, SUBFAMILIA As Long
...
If LblEdicion.Caption = "Consultar" Then Exit Sub
    ...
    Select Case SSTab.Tab
        ...
        Case 4:
            ...
            If Trim(TxtClave.Text) = "" Or Trim(TxtProd.Text) = "" Or Trim(TxtConv.Text) = "" Or Trim(CboMarca.Text) = "" Or Trim(CboGrupo3.Text) = "" Or Trim(CboFamilia2.Text) = "" Or Trim(CboSubFam.Text) = "" Then
                MsgBox "¡ Teclee los Datos para Actualizar !", vbInformation + vbOKOnly, App.Title
                Exit Sub
            End If
...
'                    End If
            ...
            StrCmd = "execute up_Productos " & UCase(TxtClave.Text) & ", '" & UCase(TxtCodBarr.Text) & "',  " _
                    & " '" & UCase(TxtProd.Text) & "', 0, " & Trim(TxtConv.Text) & ", " _
...
On Error Resume Next
    ...
    Else
        StrCmd = "exec sel_subfamilias " & ListaDeFAmilias(0, CboFamilia2.ListIndex - 1) & ", 2"
    End If
